...
var j = (s, i, t) => i in s ? f(s, i, { enumerable: !0, configurable: !0, writable: !0, value: t }) : s[i] = t;
var q = (s, i) => {
  for (var t in i)
    f(s, t, { get: i[t], enumerable: !0 });
}, z = (s, i, t, e) => {
  if (i && typeof i == "object" || typeof i == "function")
    for (let n of P(i))
      !S.call(s, n) && n !== t && f(s, n, { get: () => i[n], enumerable: !(e = H(i, n)) || e.enumerable });
  return s;
};
var V = (s) => z(f({}, "__esModule", { value: !0 }), s);
var r = (s, i, t) => (j(s, typeof i != "symbol" ? i + "" : i, t), t);
...
}, B = (s) => s.reduce((i, t) => i + t, 0) / s.length || 0, F = (s, i) => s.reduce((e, n) => e + (n - i) ** 2) / (s.length - 1) || 0, D = (async () => {
}).constructor, O = (s) => s.constructor === D;
...
var p = class extends EventTarget {
  ...
  async run() {
    ...
    for (await this.bench.setup(this, "run"), this.opts.beforeAll != null && await this.opts.beforeAll.call(this); (t < this.bench.time || this.runs < this.bench.iterations) && !((o = this.bench.signal) != null && o.aborted); ) {
      ...
      let h = 0;
      try {
        h = this.bench.now(), n ? await this.fn() : this.fn();
      } catch (v) {
    ...
    {
      let h = e[0], c = e[e.length - 1], v = t / this.runs, L = 1e3 / v, b = B(e), T = F(e, b), k = Math.sqrt(T), g = k / Math.sqrt(e.length), y = e.length - 1, x = w[String(Math.round(y) || 1)] || w.infinity, M = g * x, K = M / b * 100 || 0, A = e[Math.ceil(e.length * (75 / 100)) - 1], R = e[Math.ceil(e.length * (99 / 100)) - 1], _ = e[Math.ceil(e.length * (99.5 / 100)) - 1], I = e[Math.ceil(e.length * (99.9 / 100)) - 1];
  ...
  async warmup() {
    ...
    for (this.bench.setup(this, "warmup"); (e < this.bench.warmupTime || this.runs < this.bench.warmupIterations) && !((n = this.bench.signal) != null && n.aborted); ) {
      try {
...
var u = class extends EventTarget {
  constructor(t = {}) {
    ...
    r(this, "setup");
    r(this, "teardown");
    this.now = (e = t.now) != null ? e : this.now, this.warmupTime = (n = t.warmupTime) != null ? n : this.warmupTime, this.warmupIterations = (o = t.warmupIterations) != null ? o : this.warmupIterations, this.time = (l = t.time) != null ? l : this.time, this.iterations = (m = t.iterations) != null ? m : this.iterations, this.signal = t.signal, this.setup = (h = t.setup) != null ? h : () => {
