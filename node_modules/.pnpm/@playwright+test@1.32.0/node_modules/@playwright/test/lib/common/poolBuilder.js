...
class PoolBuilder {
  ...
  _buildTestTypePool(testType, testErrors) {
    if (!this._testTypePools.has(testType)) {
      var _this$_project$use, _this$_project, _this$_project2;
      const optionOverrides = {
        overrides: (_this$_project$use = (_this$_project = this._project) === null || _this$_project === void 0 ? void 0 : _this$_project.use) !== null && _this$_project$use !== void 0 ? _this$_project$use : {},
        location: {
          file: `project#${(_this$_project2 = this._project) === null || _this$_project2 === void 0 ? void 0 : _this$_project2._internal.id}`,
          line: 1,
          column: 1
        }
      };
