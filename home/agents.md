...
为AI智能体提供Manim动画生成能力，可创建3Blue1Brown风格的数学动画。

- **Stars:** ⭐️ 993
- **Tags:** `agent-skills` `manim` `animation` `code-generation`
- **最后活动时间:** 2026-01-23
...
将任意 GitHub 仓库自动转换为标准化 AI Agent 技能的工具，是扩展 AI Agent 能力的核心基础设施。

- **Stars:** ⭐️ 588
- **Tags:** `ai-agent` `skill-framework` `automation` `github`
- **最后活动时间:** 2026-01-22
