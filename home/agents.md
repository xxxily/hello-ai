...
Gemini Deep Research的开源替代方案，基于搜索结果利用AI自动生成研究报告。

- **Stars:** ⭐️ 2.1k
- **Tags:** `deep-research` `ai-agent` `report-generation`
- **最后活动时间:** 2025-12-15
...
ARC-AGI基准测试的突破性求解器，用于评估AI系统的抽象推理与泛化能力。

- **Stars:** ⭐️ 1.3k
- **Tags:** `arc-agi` `reasoning` `benchmark` `agi` `solver`
- **最后活动时间:** 2025-12-16
...
面向搜索代理的大规模强化学习开源项目，探索智能搜索策略。

- **Stars:** ⭐️ 569
- **Tags:** `reinforcement-learning` `search-agents` `autonomous`
- **最后活动时间:** 2025-11-26
...
基于LLM Agent的研究创意开发框架，通过思维链方式革新科研创意生成流程。

- **Stars:** ⭐️ 506
- **Tags:** `llm-agent` `research-automation` `chain-of-thought` `idea-generation`
- **最后活动时间:** 2025-01-15
...
隐蔽的浏览器自动化框架，支持无检测的网页交互，适用于AI智能体的网页浏览和自动化任务。

- **Stars:** ⭐️ 848
- **Tags:** `browser-automation` `web-scraping` `webdriver` `stealth`
- **最后活动时间:** 2025-04-25
