...
基于领域专家方法论构建AI技能的框架，让AI助手站在巨人的肩膀上提供专业服务。

- **Stars:** ⭐️ 1.6k
- **Tags:** `ai-skills` `agent-framework` `expert-system`
- **最后活动时间:** 2026-02-16
...
一个长达10小时的AI全自动编程实验项目，展示AI代理如何自主完成编程任务。

- **Stars:** ⭐️ 1.0k
- **Tags:** `ai-agent` `autonomous-coding` `ai-experiment`
- **最后活动时间:** 2026-02-13
