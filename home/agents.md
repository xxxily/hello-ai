...
开源的通信基础设施平台，为智能体和产品提供通知、邮件、短信等集成支持。简化多渠道消息传递的开发流程。
...
### [minds-platform](https://github.com/mindsdb/minds-platform)

开源AI应用平台，支持构建可控的生产级AI系统，集成Agent、RAG、LLM等核心能力。

- **Stars:** ⭐️ 39.2k
- **Tags:** `agents` `llms` `rag` `mcp` `artificial-intelligence`
- **最后活动时间:** 2026-05-28
...
将个人知识与经验转化为可复用的 AI Agent 技能，支持 Claude Code、Codex 等多种智能体框架。助力数字生命的知识蒸馏与技能生成。

- **Stars:** ⭐️ 23.9k
- **Tags:** `agent-skills` `ai-agent` `claude-code` `llm-agent` `skill-generator`
- **最后活动时间:** 2026-08-21

### [go-micro](https://github.com/micro/go-micro)

基于Go语言的AI智能体框架与服务架构，专为构建分布式系统和微服务而设计。它提供了强大的MCP支持，帮助开发者快速构建可扩展的AI智能体应用。
...
一款专为AI编程代理设计的终端多路复用器，支持同时管理和编排多个AI Agent在终端中协同工作。

- **Stars:** ⭐️ 21.6k
- **Tags:** `ai-agents` `agent-orchestration` `terminal` `rust` `cli`
- **最后活动时间:** 2026-07-28
...
开源的MCP数据库服务器，支持PostgreSQL、MySQL、MongoDB等多种数据库，让AI智能体能够安全高效地访问和操作数据。
...
开源智能体框架，用于构建和管理AI代理应用。

- **Stars:** ⭐️ 15.8k
- **Tags:** `agent-framework` `ai-agents`
- **最后活动时间:** 2026-06-04
...
OpenClaw 技能目录，汇集各类可复用的 AI Agent 技能模块。
...
为AI智能体提供一台可操作的计算机，让智能体能够像人类一样操控桌面环境并自主完成复杂任务。
...
一个用于并行编码智能体的编排框架，能够自动规划任务、生成智能体并处理CI修复和代码审查。

- **Stars:** ⭐️ 8.6k
- **Tags:** `agent-fleet` `multi-agent` `orchestration` `parallel-coding` `claude-code`
- **最后活动时间:** 2026-07-27

### [aos-ce](https://github.com/unicity-aos/aos-ce)

AOS社区版是一个开源的智能体操作系统，旨在为AI代理提供运行和管理环境。它可以帮助开发者更高效地构建和编排复杂的自主智能体。
...
### [capsule-memory](https://github.com/unicity-aos/capsule-memory)

跨会话记忆组件，通过钩子读取本地记忆状态并注入到系统提示词中。是Unicity AOS系统的一部分，用于增强智能体的上下文连贯性。

- **Stars:** ⭐️ 8.4k
- **Tags:** `agent-memory` `context-management` `agent-framework`
- **最后活动时间:** 2026-07-09
...
### [capsule-identity](https://github.com/unicity-aos/capsule-identity)

系统提示词构建器，从工作区配置和spark.toml中组装智能体身份。是Unicity AOS生态的一部分，用于动态定义智能体行为。

- **Stars:** ⭐️ 8.4k
- **Tags:** `system-prompt` `agent-identity` `agent-framework`
- **最后活动时间:** 2026-07-02
...
### [capsule-fs](https://github.com/unicity-aos/capsule-fs)

为AI智能体设计的文件系统工具集，支持读写、替换、搜索、移动等操作，并通过VFS airlock保障安全访问。
...
灵活强大的多AI智能体管理框架，支持复杂对话处理和多模型编排。
...
面向 DeepSeek 智能体的任务感知推理路由套件，提供运行时注入器与路由器预设，用于按任务分发不同推理模式。
...
为AI智能体提供共享脚本工具集，支持多仓库复用，简化智能体开发流程。
...
MobileBuildMCP 是一个 Model Context Protocol (MCP) 服务器和 CLI 工具，为 iOS 和 macOS 项目中的智能体开发提供工具支持。它帮助开发者在移动平台上构建和管理 AI 代理应用。

- **Stars:** ⭐️ 6.4k
- **Tags:** `MCP` `Model Context Protocol` `AI Agents` `Xcode`
- **最后活动时间:** 2026-09-23
...
AI代理治理工具包，提供策略执行、零信任身份、执行沙箱和可靠性工程。完整覆盖OWASP Agentic Top 10安全标准。
...
微软推出的自然语言Web接口协议参考实现，让网站能够通过自然语言进行查询和交互。
...
DeepSeek智能体相关资源合集，涵盖Agent框架与应用案例。
...
轻量级多智能体框架，支持目标自动分解为任务并并行执行，兼容Claude、GPT及本地模型。
...
一个开源的云端智能体构建模板，帮助开发者快速搭建和部署AI Agent应用。

- **Stars:** ⭐️ 5.8k
- **Tags:** `agent` `ai` `cloud-agents` `template`
- **最后活动时间:** 2026-08-29
...
为LLM智能体应用提供简单灵活的强化学习桥梁框架，支持多种RL算法与Agent场景。
...
Hermes Agent 技能、工具、集成和资源的精选列表，由 Nous Research 开发。
...
一个用于注入代码库标准并编写更好规格说明的系统，支持规格驱动开发流程。
...
Hermes Agent 的进化式自我优化框架，利用 DSPy 和 GEPA 技术自动优化智能体的技能、提示词和代码。
...
一个用于构建智能体的强大框架，支持JavaScript和TypeScript。提供沙盒环境和工作流编排功能，方便开发者快速构建AI应用。
...
面向后人类工作流设计的AI智能体命令行工具，为每个人机和计算机任务提供统一的智能体单元。

- **Stars:** ⭐️ 5.2k
- **Tags:** `ai-agent` `cli` `automation` `workflow`
- **最后活动时间:** 2026-08-27
...
无状态状态机协调器，用于管理推理与行动（ReAct）循环。Unicity AOS生态系统的重要组成部分。
...
为Claude提供图像处理能力的技能工具集，扩展AI助手的视觉交互与图像理解功能。
...
腾讯开源的AI Agent长期记忆解决方案，通过四级渐进式管道实现完全本地化的记忆存储，零外部API依赖。

- **Stars:** ⭐️ 4.4k
- **Tags:** `ai-agent` `long-term-memory` `embedding` `vector-search` `local-first`
- **最后活动时间:** 2026-05-28
...
专为AI智能体设计的Bash执行工具，让智能体能够安全地执行Shell命令。
...
专为AI智能体设计的命令行工具包，能将图片转换为包含OCR、布局和语义信息的结构化JSON数据。有效弥补了纯文本大语言模型在视觉理解方面的不足，为Agent提供视觉证据支持。
...
### [directories](https://github.com/leerob/directories)

MCP服务器和规则发现目录，帮助开发者快速找到适合AI助手的Model Context Protocol服务器资源。
...
轻量级多智能体协调工具，帮助开发者轻松编排多个AI Agent协同工作。

- **Stars:** ⭐️ 3.9k
- **Tags:** `multi-agent` `agent-coordination` `orchestration`
- **最后活动时间:** 2026-09-07
...
轻量级、可编程的组件化规则引擎，支持将AI Agent像普通组件一样进行编排。提供独特的DSL设计，支持同步/异步、动态编排、多语言脚本和热部署。
...
多智能体自动化工作流框架，支持ChatGPT、Claude、Gemini等多种AI模型，实现复杂的AI代理编排与自动化任务。
...
DeepSeek Harness 的两阶段预设方案，提供最小对齐的引导启动及完整的标准工具集。专为 LLM 智能体设计，增强工具调用能力。
...
OpenClaw AI机器人网关的中国IM平台整合Docker版本，预配置飞书、钉钉、QQ机器人、企业微信等主流平台插件，支持快速部署多平台AI机器人。

- **Stars:** ⭐️ 3.8k
- **Tags:** `ai-bot` `chatbot` `docker` `feishu` `dingtalk` `wechat-work`
- **最后活动时间:** 2026-04-14
...
### [skills](https://github.com/browserbase/skills)

Claude Agent SDK 配套的网页浏览工具，为 AI 智能体提供网络访问能力。

- **Stars:** ⭐️ 3.7k
- **Tags:** `claude` `agent` `web-browsing` `sdk`
- **最后活动时间:** 2026-09-09
...
AI智能体设计模式合集，涵盖多智能体协作、工具调用等核心架构模式。
...
实时多AI协作工具，支持Claude、Codex和Gemini之间的协同工作，具备持久化上下文和最小化token开销。
...
一个强大的AI智能体提示词工程框架，旨在通过结构化的提示词引导大模型进行深度推理与任务编排。它能够帮助开发者快速构建具备复杂逻辑处理能力的自主智能体。
...
Google Flights 的 MCP 服务器和 Python 库，支持通过 Model Context Protocol 让 AI 智能体查询航班信息。
...
Pi扩展工具，支持异步子智能体委派、截断处理、工件管理与会话共享功能。有效提升多智能体编排与协作效率。
...
- **Stars:** ⭐️ 3.0k
- **Tags:** `inference-time-control` `ai-agents` `global-workspace` `cognitive-architecture`
- **最后活动时间:** 2026-09-14

### [agent-os](https://github.com/rivet-dev/agent-os)

专为AI Agent设计的轻量级开源操作系统，基于WebAssembly和V8隔离技术，实现约6毫秒冷启动，成本仅为沙箱方案的1/32。
...
为Claude Code和AI智能体提供的69个营销技能集合，涵盖SEO、广告投放与邮件营销等核心领域。
...
专为 AI Agent 设计的 JS 逆向 MCP Server，内置反检测功能，支持浏览器自动化操作与代码分析。
...
设计师技能集合，包含用于设计流程的智能体技能、命令和插件，覆盖从研究到UI设计、交互和交付的全流程。
...
完全开源的 TypeScript Agent SDK，无 CLI 依赖，可作为 claude-agent-sdk 的替代方案。
...
通用 Rust 多路复用器，提供类型化 SDK，可从代码驱动任何 CLI 或 TUI 应用程序。支持 AI 智能体与终端应用进行交互，适用于构建自动化智能体系统。

- **Stars:** ⭐️ 2.6k
- **Tags:** `ai` `agent` `cli` `terminal` `rust` `multiplexer`
- **最后活动时间:** 2026-08-09
...
一个与AI代理协作创建项目的平台，支持Claude Code和Codex CLI等工具，提供终端和IDE集成环境。

- **Stars:** ⭐️ 2.5k
- **Tags:** `agents` `ai` `ide` `terminal` `collaboration`
- **最后活动时间:** 2026-05-17

### [nitrostack](https://github.com/nitrocloudofficial/nitrostack)

全栈 TypeScript 框架，用于构建、测试和部署生产级 MCP 服务器及 AI 原生应用。助力开发者快速搭建模型上下文协议相关的智能体工具。
...
一个运行时基底，将智能体的执行转化为可逆的类 Git 轨迹，支持元智能体观察、分叉、重放和回滚任何运行。它专为元智能体监督、优化和训练其他智能体而构建。
...
智能体技能（Agent Skills）平台，支持构建经过测试的技能并通过自定义市场治理其全生命周期，包括证据、发现、更新、回滚、隔离与跨 17 个平台分发。面向 Claude Code、Codex、Cursor 等 AI 编程工具的技能生态。

- **Stars:** ⭐️ 2.4k
- **Tags:** `ai-agents` `agent-skills` `claude-code` `codex` `cursor` `evals` `developer-tools`
- **最后活动时间:** 2026-09-15
...
飞书官方出品的 OpenClaw 飞书/Lark Channel 插件，实现 AI 智能体与飞书平台的无缝集成。

- **Stars:** ⭐️ 2.4k
- **Tags:** `openclaw` `lark` `feishu` `agent-plugin`
- **最后活动时间:** 2026-07-22
...
面向工业4.0资产运维的AI智能体基准测试框架，包含460+场景、4种专业智能体和多智能体编排蓝图，支持预测性维护和时序预测等应用。
...
便携式智能体配置方案，包含记忆、技能和协议，可在Claude Code、Cursor、Windsurf等多个AI工具间无缝切换。
...
便携式AI智能体编排框架，支持186个智能体，零运行时依赖，提供机械协议强制执行。
...
### [prp](https://github.com/Wirasm/prp)

为智能体工程提供提示词和工作流编排的工具包。旨在简化和增强AI代理的开发流程。
...
生产级多智能体编排平台，支持JSON定义智能体、多层记忆系统和内置可观测性。已在200+企业AI智能体项目中实战验证。
...
将钉钉机器人连接到OpenClaw网关的插件，支持AI Card流式响应。

- **Stars:** ⭐️ 2.1k
- **Tags:** `agents` `dingtalk` `openclaw` `connector`
- **最后活动时间:** 2026-09-03
...
macOS 桌面应用，通过纯 SSH 安全管理 Hermes AI 智能体，无需网关或暴露端口。
...
为 Claude 打造的小红书内容创作技能包，让 AI 智能体能够生成符合小红书风格的笔记与文案。适合内容创作者将 AI 融入日常运营流程。
...
一个AI代理编排框架，通过确定性、无幻觉的自 orchestration 让代理工作流能够管理极其复杂的任务。

- **Stars:** ⭐️ 1.8k
- **Tags:** `agent-orchestration` `ai-agents` `agentic-workflow` `claude-code`
- **最后活动时间:** 2026-09-16

### [mindfs](https://github.com/a9gent/mindfs)

随时随地访问个人AI代理和工作站数据的文件系统工具，支持跨平台数据同步与管理。
...
AI Agent Harness 工程资源精选列表，涵盖项目、工具、基准测试和实用指南。
...
面向70个巴西公共API的MCP服务器，为AI智能体提供本地化数据访问能力。
...
基于MCP协议的渗透测试智能体框架，集成205个安全工具和17个专业代理，支持OWASP Top 10漏洞扫描与利用链分析。无需API密钥，可自带LLM进行自动化安全测试。
...
terravision 是一款专业的云架构图生成工具，能够从 Terraform 代码或 JSON 图自动生成包含官方 AWS、Azure 和 GCP 图标的精美架构图。它还集成了 MCP 服务器和代理技能，助力 AI 代理生成专业文档。

- **Stars:** ⭐️ 1.6k
- **Tags:** `agent-skill` `architecture-diagram` `cloud-architecture` `diagrams-as-code` `llm-tools` `mcp-server`
- **最后活动时间:** 2026-09-14
...
一个长周期计算机使用框架，支持AI代理在桌面应用和CLI中长时间运行并保持任务状态。具备可恢复进度、状态审计以及Claude Code等原生集成功能。
...
为AI智能体提供永久记忆的轻量级解决方案，仅需426个Token的提示词即可实现即插即用。
...
LLM驱动的代理运行时，支持动态DAG规划和并发执行，兼容OpenAI接口。
...
一个类型安全的 macOS iMessage SDK，零依赖，可用于构建 AI 智能体的消息通信能力。
...
支持200K+上下文和10M记忆的AI代理操作系统，兼容LangChain、Claude和OpenAI API。
...
Meta-Harness论文的官方参考代码，专注于为大语言模型智能体提供工程化测试框架。

- **Stars:** ⭐️ 1.4k
- **Tags:** `llm-agents` `harness-engineering` `evaluation`
- **最后活动时间:** 2026-07-11

### [sc-agent-skills-files](https://github.com/https-deeplearning-ai/sc-agent-skills-files)

sc-agent-skills-files包含丰富的智能体技能文件，支持快速构建和部署AI代理系统。无论是单机还是多机环境，都能轻松实现复杂任务自动化。

- **Stars:** ⭐️ 1.4k
- **Tags:** `agent-frameworks` `ai-agents` `skills` `automation`
- **最后活动时间:** 2026-06-08
...
一个用于构建、评估和部署GUI智能体的框架，支持在线强化学习训练、标准化基准测试和真机部署。

- **Stars:** ⭐️ 1.4k
- **Tags:** `agent-rl` `gui-agents` `mobile-agent` `online-rl`
- **最后活动时间:** 2026-06-03
...
### [nanobot](https://github.com/obot-platform/nanobot)

基于MCP协议构建AI智能体的开发框架，帮助开发者快速搭建具备工具调用能力的Agent应用。
...
OpenYao 公开 Skill 合集，将决策分析、商业研究、文档生成等流程沉淀为可复用的 AI 资产。
...
一个用于程序化编排数千个智能体的图编排框架，支持大规模智能体工作流管理。

- **Stars:** ⭐️ 1.3k
- **Tags:** `agents` `orchestration` `workflow` `graph`
- **最后活动时间:** 2026-07-03

### [helmor](https://github.com/dohooo/helmor)

开源本地多智能体软件开发工作台，支持Claude Code和Codex等编码代理的编排与协作。
...
统一的智能体控制平面，支持调用 OpenCode、Hermes、Claude 和 Cursor 等多种代理。提供集中的 AI 网关和沙箱管理功能。
...
Hermes Agent生态系统地图，汇集Nous Research的Hermes智能体相关工具、技能和集成资源。
...
聚合 Gemini、Grok、豆包等主流 AI 搜索能力的统一接口平台，支持链接爬取和工作流集成。

- **Stars:** ⭐️ 1.3k
- **Tags:** `deep-search` `multi-agent-systems` `knowledge-graph` `claude-skills`
- **最后活动时间:** 2026-04-27
...
OpenClaw 原生工作流 Shell，将技能和工具转化为可组合的自动化管道，支持本地优先的类型化宏引擎。
...
让你快速组建个人 AI 团队办公室，多个智能体基于共享上下文协作，支持 Claude Code、Codex 及本地 LLM。
...
基于LangChain框架构建的AI智能体技能集合，用于扩展大语言模型应用的能力。
...
一个AI Agent技能模块，帮助开发者优化Xcode增量构建和完整构建性能，通过运行基准测试和调整构建设置提升开发效率。
...
开源的AI智能体编排平台，基于Rust原生开发，支持多提供商接入，可在本地机器上运行，注重数据主权与隐私保护。
...
为 OpenClaw 提供无限记忆能力的扩展插件，显著增强 AI 智能体的长期记忆和上下文保持能力。

- **Stars:** ⭐️ 1.2k
- **Tags:** `openclaw` `memory` `ai-agent` `context`
- **最后活动时间:** 2026-09-16

### [imbox](https://github.com/martinrusev/imbox)

专为智能体工作流设计的Python IMAP库，支持AI代理自动化处理邮件和邮箱操作。
...
快速打包和部署本地AI智能体的工具，让团队在几分钟内即可完成智能体部署。
...
FilmAgent多智能体框架，实现虚拟3D空间中的端到端电影自动化制作。基于DeepSeek和Unity3D构建，支持多智能体协作完成电影创作流程。
...
面向 AI 智能体记忆系统的评测排行榜，对比各类记忆方案在基准任务上的表现。帮助开发者选择最适合自己智能体的长期记忆实现。
...
分层智能体循环优化器，用于优化AI Agent的层级执行循环和决策流程。
...
用于定义和运行持久化工作流的核心包，支持微服务编排、数据管道以及智能体工作流等复杂业务流程。
...
MCP服务器，将Claude转化为高效编程智能体，实现100%基准测试通过率，大幅降低token消耗和运行时间。
...
一款支持持久化执行的分布式工作流自动化引擎，可用于构建可靠的智能体编排系统。
...
Hermes Agent的无损上下文管理插件，基于DAG的消息引擎确保零消息丢失，为AI智能体提供可靠的上下文追踪能力。
...
可扩展至350万token的记忆代理框架，支持任意智能体工作流的强化学习训练。
...
一个通用的C# GOAP（目标导向行动规划）库，适用于游戏AI和Unity开发，支持复杂智能体行为规划。
...
Pi 编程智能体的插件、钩子、工具、技能和资源合集，专注于 LLM 智能体开发。

- **Stars:** ⭐️ 1.1k
- **Tags:** `agentic-ai` `llm` `pi-agent`
- **最后活动时间:** 2026-06-03
...
为智能体提供各种实用技能的集合库，增强代理的执行能力与工具调用范围。
...
一个用于生成AI智能体技能和数字人设的工具。支持Claude Code和模型蒸馏等功能。
...
零依赖、亚毫秒级AI记忆系统，专为Hermes智能体设计。支持高效记忆存储与检索。

- **Stars:** ⭐️ 1.1k
- **Tags:** `agents` `ai` `memory-system` `hermes`
- **最后活动时间:** 2026-06-12
...
- **Stars:** ⭐️ 1.1k
- **Tags:** `ai-agents` `agent-skills` `automation`
- **最后活动时间:** 2026-06-25
...
这是一个Meta Muse集成和社区连接器技能的源代码支持目录，包含能力、认证和权限说明。该项目为开发AI代理提供了全面的资源和指南。

- **Stars:** ⭐️ 1.1k
- **Tags:** `agentic-ai` `ai-agents` `connectors` `muse`
- **最后活动时间:** 2026-09-24
...
AI编码智能体的工作流编排工具，支持从任务定义到PR合并的全流程自动化。
...
为OpenClaw智能体提供的33个实战营销技能库，涵盖文案写作、SEO、邮件营销、付费广告等多个领域。

- **Stars:** ⭐️ 1.0k
- **Tags:** `marketing` `agents` `copywriting` `seo` `email-marketing`
- **最后活动时间:** 2026-06-02
...
一个用于以图编程方式编排数千个AI智能体的框架，支持大规模智能体协调与调度。
...
Claude Cowork风格的开源替代方案，为构建者提供围绕AI智能体的本地优先工作记忆。
...
为OpenClaw智能体提供全面安全防护的工具，通过技能、插件和监控器实现安全保护，被称为OpenClaw的诺顿。
...
中兴（ZTE）开源的基于大模型的多智能体协作系统，支持任务拆解、规划与多 Agent 协同完成复杂工作流。
...
一种将文件夹结构作为智能体架构的方法论。通过文件系统结构替代传统的框架级编排，实现可解释的上下文管理。
...
开源实时数字人智能体平台，支持构建语音优先的AI代理，集成WebRTC、角色记忆、工具调用、RAG检索及数字人视频输出。
...
Rails框架，用于构建AI智能体应用程序，提供完整的Agent应用开发支持。
...
面向AI智能体的即时通讯工具，提供共享上下文与记忆、监督执行以及跨供应商智能体审计功能。
...
高性能多智能体环境引擎，支持超大规模（数百万级）智能体的强化学习模拟，并附带多个参考环境。由 Farama 基金会维护，是多智能体强化学习（MARL）研究的经典平台。

- **Stars:** ⭐️ 968
- **Tags:** `multi-agent` `reinforcement-learning` `MARL` `environments` `simulation`
- **最后活动时间:** 2026-09-13
...
基于Claude Opus的命令行智能体框架，允许AI在对话中动态创建和管理自身工具。持续扩展其能力边界。
...
golive-skill 是一个开源的零依赖 Node CLI，专为 AI 代理产品提供一键部署服务。您可以轻松管理托管、数据库、域名、邮件和支付等基础设施，无需第三方账户或后端支持。

- **Stars:** ⭐️ 930
- **Tags:** `AgentSkill` `AI-Deployment` `NodeCLI`
- **最后活动时间:** 2026-09-25
...
Claude Code智能体编排框架，支持四层路由、会话持久化、并行智能体隔离、生命周期钩子等企业级特性。
...
开源的AI沙箱基础设施，支持代码执行、浏览器操作和AI智能体运行环境。
...
MasterAgent 致力于打造 100% 在设备上运行的 AI 智能体。在高通 NPU 硬件上，延迟低至亚 100 毫秒，且零云依赖。

- **Stars:** ⭐️ 915
- **Tags:** `agent-framework` `ai-agent` `edge-ai` `on-device`
- **最后活动时间:** 2026-09-09
...
### [claude_agent_teams_ui](https://github.com/777genius/claude_agent_teams_ui)

一个基于Claude的多智能体团队协作平台，让AI代理自主完成任务、互相沟通和代码审查，用户只需通过看板管理即可。
...
开源聊天机器人框架，支持多种平台集成，内置NLU能力，可构建智能对话机器人。
...
基于 JAX 的多智能体强化学习（MARL）环境与算法库，提供高吞吐量的硬件加速支持。

- **Stars:** ⭐️ 854
- **Tags:** `marl` `reinforcement-learning` `jax`
- **最后活动时间:** 2026-09-10
...
基于图结构的代码智能平台，支持多智能体协作编程，具备代码库感知能力，告别传统的grep搜索模式。

- **Stars:** ⭐️ 851
- **Tags:** `ai-agents` `code-intelligence` `lsp` `cli`
- **最后活动时间:** 2026-07-17

### [kweaver-core](https://github.com/kweaver-ai/kweaver-core)

企业级决策智能体框架，提供语义建模、实时访问、运行时控制和TraceAI功能，帮助AI系统在复杂企业环境中可靠地推理和执行。
...
为 AI 智能体提供高保真 HTML 设计与原型指导的技能模块。
...
面向 Pi 编码智能体的高级开发 Harness，集成 SDD/OpenSpec、子智能体、严格 TDD 证据与代码审查护栏。
...
开源智能体工程平台，提供追踪、评估和指标功能，帮助调试和改进AI智能体。支持LangGraph、CrewAI等多种框架集成。
...
基于 Spring Boot、Spring AI 和 JobRunr 构建的 Java 版智能体框架。为 Java 开发者提供便捷的 AI Agent 开发与任务调度能力。
...
Hermes智能体控制中心模板，支持从单一VPS代理管理专业团队和编排工作流。
...
透明开放的AI智能体守护进程，提供可组合的运行时框架，支持开发者构建可信赖的智能体应用。
...
Agent-as-a-Router 的官方实现，通过智能体模型路由来高效处理编程任务。

- **Stars:** ⭐️ 738
- **Tags:** `agent` `model-routing` `coding` `llm`
- **最后活动时间:** 2026-06-29

### [datafoundry](https://github.com/datagallery-lab/datafoundry)

开源AI工作台，将数据源、知识、工具和智能体运行时统一为受治理的交互式分析工作区。专为数据分析场景打造的智能体编排平台。
...
专为Claude Code设计的AI智能体团队脚手架，支持19个角色协同工作与多LLM调度。提供规范驱动的开发流程与多层防御机制，覆盖Web、小程序及Apple原生应用。
...
### [agent-skills](https://github.com/laravel/agent-skills)
...
一个人机协同的AI系统，用于编排专家和机器组成的项目团队。它能够智能调度人类专家与AI机器协同完成复杂任务。

- **Stars:** ⭐️ 713
- **Tags:** `human-in-the-loop` `ai-system` `orchestration` `workflow`
- **最后活动时间:** 2026-04-28
...
### [looper](https://github.com/ksimback/looper)
...
革命性的区块链数据流处理框架，支持将链上及链下数据无缝集成至目标存储以供 AI 代理查询分析。
...
面向AI智能体安全与安全的诊断护栏框架。为AI Agent提供运行时的安全防护和诊断能力，防止越权和有害操作，适合构建企业级安全的智能体系统。
...
多智能体AI系统的协调层框架，帮助开发者构建和管理多个AI智能体之间的协作与通信。
...
AI智能体支付的自愈基础设施，支持90.3%自动恢复，专为多智能体系统设计。
...
企业级AI Agent技能工具，可自动为任何企业生成AI应用场景地图报告，助力企业AI战略规划与落地。
...
一个AI模型编排工具，允许将任意模型分配特定角色并应用于目标导向的工作流中。

- **Stars:** ⭐️ 628
- **Tags:** `ai-orchestration` `agent` `workflow` `llm`
- **最后活动时间:** 2026-09-01
...
为长时间运行的AI智能体提供上下文管理的引擎，帮助智能体在复杂任务中保持连贯性和记忆。
...
轻量级、清晰且完全可扩展的AI智能体基础设施框架，使用Rust构建。易于学习、可定制任何组件，适合快速构建和部署AI助手应用。
...
### [Prowl](https://github.com/onevcat/Prowl)

Prowl 是一款原生 macOS 编码代理编排器，旨在帮助开发者构建高效的智能编码工作流。

- **Stars:** ⭐️ 621
- **Tags:** `macos` `agent` `orchestrator` `coding` `ai`
- **最后活动时间:** 2026-09-24

### [phpMyFAQ](https://github.com/thorsten/phpMyFAQ)

开源FAQ系统，支持MCP协议，可让AI助手直接检索和访问FAQ知识库内容。
...
基于Rust构建的Agentic OS，提供运行时、安全、可观测性及无Token响应压缩。有效降低Token使用量与成本。

- **Stars:** ⭐️ 620
- **Tags:** `agent-runtime` `agentic-os` `ai-agents` `rust` `token-optimization`
- **最后活动时间:** 2026-09-08
...
### [Agentkey](https://github.com/chainbase-labs/Agentkey)

一个插件工具，帮助AI智能体连接网络搜索、社交媒体及区块链数据，实现零配置接入。
...
专为大型语言模型（LLM）智能体设计的分布式框架。支持构建可扩展的分布式智能体系统，解决复杂任务编排问题。

- **Stars:** ⭐️ 611
- **Tags:** `llm-agents` `distributed-systems` `agent-framework`
- **最后活动时间:** 2026-09-08

### [Dressage](https://github.com/Accio-Lab/Dressage)

为任意Agent和沙箱环境设计的可扩展强化学习框架。支持高效的策略训练与多智能体协同。
...
面向 AI Agent 的记忆层基础设施，为各类应用场景提供持久化记忆能力。帮助智能体跨会话保留上下文，提升长期任务表现。
...
为 Hermes CLI 智能体提供的自定义皮肤（视觉主题）集合，可个性化终端 AI 代理的外观体验。

- **Stars:** ⭐️ 591
- **Tags:** `cli` `ai-agent` `theming` `customization`
- **最后活动时间:** 2026-06-28

### [moosestack](https://github.com/514-labs/moosestack)

一个用于在应用中构建分析功能的智能体框架，基于 ClickHouse 和 Redpanda 等高性能分析基础设施。
...
针对 AI 智能体和 MCP 服务器的开源对抗模拟工具，用于 AI 安全红队测试。
...
基于 Spring AI Alibaba 构建的多智能体编排框架，支持 MCP 协议、技能与记忆系统，以及钉钉、飞书、Telegram 等多渠道接入。
...
将应用程序和AI模型链接起来构建强大AI工作流的工具。支持快速编排和组合不同的AI能力。
...
### [agent-skills-launch-pack_](https://github.com/chenjin-cmd/agent-skills-launch-pack_)

agent-skills-launch-pack是一个智能体技能的启动包，集成多种AI代理功能和工具。快速上手构建个性化AI代理，适用于各种应用场景。

- **Stars:** ⭐️ 570
- **Tags:** `agent-skills` `ai-agents` `launch-pack` `automation`
- **最后活动时间:** 2026-07-08
...
可编译的 Agent 行为框架，支持 MCP 协议和 A2A（Agent-to-Agent）通信，构建智能体协作系统。
...
### [agentos](https://github.com/framersai/agentos)

构建自主AI智能体的框架，支持自适应智能、涌现行为、多模态RAG和HEXACO人格系统。
...
实现A2A协议的OpenClaw插件，提供智能体间双向通信网关能力。
...
为Agent-to-Agent协议引入加密货币支付能力，让AI智能体能够通过链上支付实现服务变现，复兴HTTP 402的支付理念。
...
OpenClaw/Hermes智能体的任务控制中心，提供统一的Agent管理与监控能力。
...
os 是一款开源 AI 代理平台，助力组织创建和部署可定制的 AI 代理，支持多种 LLM 提供商、实时聊天、语音交互、文档训练、分析、用户管理、SSO 认证以及可嵌入的 widget 组件。采用 React 19、Redux Toolkit、Radix UI 和 Tailwind CSS 构建，适合自托管的企业级应用。

- **Stars:** ⭐️ 542
- **Tags:** `agentic-ai` `ai-agents` `ai-platform` `rag` `voice-ai`
- **最后活动时间:** 2026-09-25
...
为 Claude 提供的 DuckDB 数据分析技能，使 AI 智能体能够直接执行高效的数据查询与分析任务。是连接智能体与本地数据分析工作流的实用扩展。

- **Stars:** ⭐️ 538
- **Tags:** `claude-skills` `duckdb` `data-analysis` `sql` `agent-skills`
- **最后活动时间:** 2026-04-23
...
用于多生态系统AI智能体协调的Atlas SDK。支持跨链连接、协调和结算AI智能体任务。
...
将任何想法转化为由AI驱动的自主运营公司。该平台集成了多智能体协作、工作流编排与企业级架构，实现数字化公司的自动化运转。
...
自托管编程智能体平台，支持在隔离沙箱中运行 Claude Code、Codex、Hermes 等编码智能体，并配备保险库代理确保安全。
...
Dedalus 智能体平台的官方 Python SDK，帮助开发者快速接入 Agents API 并构建生产级 AI 智能体应用。开箱即用，适合快速搭建自动化智能体工作流。

- **Stars:** ⭐️ 517
- **Tags:** `python` `sdk` `ai-agents` `api` `agent-framework`
- **最后活动时间:** 2026-05-15

### [managed-agents](https://github.com/sandbaseai/managed-agents)

开源的CMA兼容多智能体运行时，支持结合Ollama、vLLM、Claude或GPT等任意模型进行本地部署。内置MCP工具、场景模板及可视化仪表盘，专为企业团队设计。
...
类似Next.js开发体验的LangGraph智能体构建框架。简化AI智能体的开发流程。
...
GEO领域的AI员工开源方案，包含GEO技能包及构成AI员工技术栈的智能体和CLI列表。

- **Stars:** ⭐️ 510
- **Tags:** `ai-employee` `domain-ai` `claude-skills` `mcp`
- **最后活动时间:** 2026-07-04
...
亚马逊云科技 Bedrock AgentCore 的 Python CLI 快速上手工具包，帮助开发者一键初始化、配置并将 AI 智能体部署到 AgentCore 运行时。是构建和托管生产级 AI Agent 的便捷入口。
...
pinloop-cli 是一个专为 coding agents 设计的职位搜索工具，搜索全球各行业白领职位的数百万个职位，每小时刷新一次，帮助开发者快速找到理想的工作。

- **Stars:** ⭐️ 508
- **Tags:** `ai-agents` `job-search` `cli` `coding-agents`
- **最后活动时间:** 2026-09-24
...
AgentX 是一款 GPU 加速的跨平台桌面应用，将 AI 智能体带入你的日常工作流。提供原生、流畅的 Agent 桌面体验。
...
dscode 是一个基于 DeepSeek 的持久化编码智能体 harness，集成了持久 shell、Ultra 子代理、自动审批、Chrome MCP 和会话遥测功能。它帮助开发者在终端环境中实现高效的代码审查和自动化开发流程。

- **Stars:** ⭐️ 506
- **Tags:** `AI-Agent` `DeepSeek` `Coding-Agent` `LLM` `Terminal-TUI`
- **最后活动时间:** 2026-09-25

### [BookWorm](https://github.com/foxminchan/BookWorm)

基于Aspire微服务架构与多智能体系统的实践项目。展示了如何在.NET环境中集成AI Agent构建复杂应用。
...
motion-skills 提供了50个开源技能，帮助您的AI编码代理制作运动图形、动画和视频，包括动态字体、数据可视化、解释器、TikTok/Reels、WebGL和Manim等。14个可安装包，由iart.ai的AI运动代理开发。

- **Stars:** ⭐️ 505
- **Tags:** `AI Agents` `Motion Graphics`
- **最后活动时间:** 2026-09-23
...
### [clearai-dsh](https://github.com/Clearailhc/clearai-dsh)

ClearAI 是 DeepSeek Harness 的原生 DSH 插件，引入了 Epistemic Loop 功能，助力科学发现。

- **Stars:** ⭐️ 503
- **Tags:** `AI Agents` `Agent Frameworks`
- **最后活动时间:** 2026-09-23

### [vibe-check-mcp-server](https://github.com/PV-Bhat/vibe-check-mcp-server)

一款为AI智能体提供导师级反馈的MCP服务器工具，有效防止复杂工作流中的隧道视野和过度设计问题。帮助AI智能体保持简洁高效的推理与执行路径。

- **Stars:** ⭐️ 502
- **Tags:** `mcp-server` `ai-agents` `agentic-workflow` `error-handling` `workflow-automation`
- **最后活动时间:** 2026-09-11
...
一个开源的Slack智能体网关，支持将团队对话路由至Claude Code、Codex等多种AI代理。提供完善的策略控制、审批机制与审计日志功能。
...
FPF 是一个 AI-native 模式语言框架，专注于系统工程、研究和管理。它通过共享的人工智能推理机制，支持架构决策、证据分析、权衡考量和方法工程。

- **Stars:** ⭐️ 500
- **Tags:** `first-principles` `ai-agents` `human-ai-collaboration` `systems-engineering`
- **最后活动时间:** 2026-09-25

### [iFly-Skills](https://github.com/iflytek/iFly-Skills)

科大讯飞官方技能集合，涵盖语音识别、OCR、翻译、校对和多模态AI能力，助力快速构建智能应用。

- **Stars:** ⭐️ 332
- **Tags:** `agent` `iflytek` `speech-recognition` `ocr` `multimodal`
- **最后活动时间:** 2026-04-12
...
基于Claude Code构建的AI驱动求职系统，支持14种技能模式、Go仪表盘、PDF生成和批量处理功能。

- **Stars:** ⭐️ 69.5k
- **Tags:** `ai-agent` `claude` `job-search` `automation` `cli`
- **最后活动时间:** 2026-08-31
...
一个轻量级的编码智能体，支持 Deepseek、Kimi 和 Qwen 等开源模型。帮助开发者通过自然语言快速完成代码编写与执行任务。
...
基于 DeepSeek 模型的终端编码代理工具，支持在命令行中运行 AI 编程助手。
...
一个强大的AI智能体平台，能够自动处理并完成委派的各种任务。它集成了LLM、RAG和多种数据库，提供高效的数据分析与业务智能解决方案。

- **Stars:** ⭐️ 39.4k
- **Tags:** `agents` `ai` `llms` `rag` `mcp` `analytics`
- **最后活动时间:** 2026-07-01
...
基于Anthropic Agents SDK的轻量级AI智能体，支持连接WhatsApp、Telegram、Slack等多平台，具备记忆和定时任务功能。
...
用于蒸馏任何人思维方式的工具，可提取心智模型、决策启发式和表达DNA。

- **Stars:** ⭐️ 29.7k
- **Tags:** `ai` `cognitive-model` `distillation` `agent`
- **最后活动时间:** 2026-07-27
...
基于 Moonbit 构建的自主智能体项目，探索代理的自治能力与执行逻辑。
...
一个创意十足的AI Agent技能项目，模拟PIP场景来激发AI代理的高能动性表现，适合研究Agent行为和提示工程。

- **Stars:** ⭐️ 19.7k
- **Tags:** `agent` `agency` `prompt-engineering` `skills`
- **最后活动时间:** 2026-09-09
...
开源的深度研究智能体项目，能够自动化执行复杂的网络搜索与信息整合任务。类似于OpenAI的Deep Research，为信息检索提供强大的AI工作流。

- **Stars:** ⭐️ 12.7k
- **Tags:** `deep-research` `ai-agent` `automation` `llm`
- **最后活动时间:** 2026-08-10

### [ironclaw](https://github.com/nearai/ironclaw)

专注于隐私、安全与可扩展性的智能体操作系统，支持WASM扩展。
...
开源情报聚合平台，整合卫星追踪、航班监控、地震监测等数据源，支持接入AI Agent进行智能分析与关联发现。
...
开源的ML工程师智能体，能够阅读论文、训练模型并部署机器学习模型，自动化完成ML工程任务。

- **Stars:** ⭐️ 10.8k
- **Tags:** `machine-learning` `ml-agent` `autonomous-agent` `model-training`
- **最后活动时间:** 2026-09-14
...
张雪峰AI技能，专注于高考志愿、考研和职业规划的实战思维框架，由女娲.skill生成。
...
一个面向Unicity网络的Web3钱包和智能体平台，集成了加密钱包、私信和市集功能。
...
使用自然语言命令自动化移动设备的LLM智能体，支持多种大语言模型。
...
基于编码智能体的安全工具，用于发现代码库中的漏洞。帮助开发者自动化安全审计流程。

- **Stars:** ⭐️ 8.0k
- **Tags:** `security` `ai-agent` `vulnerability` `code-analysis`
- **最后活动时间:** 2026-09-23
...
为pi扩展的自主实验循环工具，能够自动化执行科研实验流程。它可以帮助研究人员构建自动化实验智能体，提升科研效率。

- **Stars:** ⭐️ 7.5k
- **Tags:** `autonomous-agents` `experiment-loop` `research-automation`
- **最后活动时间:** 2026-07-15

### [defending-code-reference-harness](https://github.com/anthropics/defending-code-reference-harness)

一套面向安全防御的 AI 智能体技能（Skills）集合，覆盖威胁建模、代码扫描、漏洞分诊与补丁修复。附带可自定义的自主扫描 harness，让智能体自动化执行安全防御流程。

- **Stars:** ⭐️ 7.5k
- **Tags:** `ai-agents` `security` `threat-modeling` `code-scanning` `autonomous-agents`
- **最后活动时间:** 2026-08-06

### [waha](https://github.com/devlikeapro/waha)

WhatsApp HTTP API 服务，支持多种引擎，可快速配置用于构建 AI 聊天机器人和自动化应用。
...
AlphaEvolve的开源实现，结合进化算法与LLM进行代码优化和科学发现。支持分布式进化计算和迭代优化。
...
ANUS 是一个自主AI代理项目，专注于自我维护和规范驱动的开发。它帮助开发者构建自维持的智能系统。

- **Stars:** ⭐️ 6.5k
- **Tags:** `ai-agent` `autonomous-agent` `self-maintaining-repository` `spec-driven-company`
- **最后活动时间:** 2026-09-24
...
轻量级跨平台数据库客户端，内置AI助手支持，支持MySQL、PostgreSQL和SQLite，可通过MCP协议与AI代理集成。
...
为自主编程 Agent 提供可移植的记忆层，支持上下文持久化和知识管理。
...
微信公众号RSS订阅源生成工具，支持AI Agent接入微信公众号，实现智能内容订阅与推送。
...
AI智能体角色技能集合，包含同事、乔布斯等多种人格角色的skill定义，适用于角色扮演和对话场景。
...
企业信息收集工具，支持一键获取控股公司、ICP备案、APP、小程序等信息，已集成MCP协议可供AI助手调用。

- **Stars:** ⭐️ 4.6k
- **Tags:** `mcp` `mcp-server` `cybersecurity` `red-team`
- **最后活动时间:** 2026-03-30

### [autoagent](https://github.com/kevinrgu/autoagent)

一个用于自主智能体（Autonomous Agent）测试与开发的工程框架。旨在简化和加速AI智能体的构建过程。
...
受Serenity启发的AI智能体技能，用于供应链瓶颈股票研究分析。
...
AI人格技能集合，包含同事、老板、前任等多种人格技能定义，由女娲.skill生态系统生成。

- **Stars:** ⭐️ 4.0k
- **Tags:** `ai-agent` `persona` `skills` `awesome-list`
- **最后活动时间:** 2026-08-29
...
一键将学术论文转换为演示文稿的AI智能体工具，利用LLM代理自动生成专业幻灯片。

- **Stars:** ⭐️ 3.8k
- **Tags:** `agentic-ai` `llm-agents` `paper2slides` `presentation-generator`
- **最后活动时间:** 2026-05-20
...
基于 AI Agent 和 MCP 工具链的自动化渗透测试平台。通过自然语言输入，自动完成信息收集、漏洞发现、利用及报告生成的全流程。
...
本地私有的跨平台AI内容发现智能体。能够深度学习用户偏好，并主动在B站、YouTube、小红书等多平台寻找个性化内容。
...
具备权限控制、Token 预算管理和多渠道访问的自主 AI 代理，支持 CLI 和 Telegram 24/7 运行。
...
企业级开源RPA平台，支持多机器人协同和自动化工作流编排，可用于构建智能自动化流程。
...
一个由蓝图驱动的自动化AI科研运行时框架，可编排从想法生成、实验到论文撰写和同行评审的完整AI研究工作流。利用多智能体系统加速科学发现与论文生成。
...
基于 Claude Code Skills 构建的视频剪辑智能体，能够辅助自动化视频编辑流程。
...
基于 Anthropic J-space 全球工作区研究的 AI 认知增强技能套件。支持 DeepSeek Harness、Claude Code 等多智能体框架。

- **Stars:** ⭐️ 3.0k
- **Tags:** `ai-agent` `cognitive-enhancement` `deepseek` `claude-code`
- **最后活动时间:** 2026-09-02
...
结合大语言模型与智能体技术的量化交易解决方案。致力于通过Agentic AI赋能量化分析与交易流程。

- **Stars:** ⭐️ 2.9k
- **Tags:** `agentic-ai` `large-language-models` `quantitative-trading`
- **最后活动时间:** 2026-08-18

### [OpenSwarm](https://github.com/VRSEN/OpenSwarm)

基于 Claude Code 的智能体工具，专注于非编程场景的自动化任务处理与编排。
...
开源GUI视觉-语言-动作(VLA)智能体，支持在Apple M4设备本地运行，实现跨平台桌面自动化操作。OSWorld专项排名第一(58.2%)，数据完全本地处理。
...
为Claude设计的开源情报侦察技能包，包含90+侦察模块、48种密文正则模式和27个攻击路径模板，适用于授权红队测试和漏洞赏金项目。
...
专为小型语言模型优化的编程智能体，支持本地 LLM 和 Ollama，适合资源受限环境。
...
一个精选的自主研究智能体和自我改进系统资源列表，灵感来源于Karpathy的autoresearch。涵盖LLM智能体、实验循环和科学发现工具。
...
本地优先的AI智能体，针对本地大模型优化，支持长上下文窗口与浏览器自动化操作。
...
本地优先的AI智能体桌面应用，具备持久记忆、情感智能和点对点技能经济系统。
...
基于 OpenClaw 的端到端自动化科学研究工作流系统。能够自动生成并产出达到业界最先进水平的科研成果。
...
一个自我改进的AI框架，能够自主提升任何AI模型或智能体在基准任务上的表现。

- **Stars:** ⭐️ 2.2k
- **Tags:** `self-improving-ai` `ai-agents` `benchmark` `autonomous`
- **最后活动时间:** 2026-08-26
...
将Claude Code等AI代理的对话历史自动发布为Huggingface数据集的工具，便于数据集管理和分享。
...
一个支持自适应测试时学习和自主专业化的AI智能体框架。它专注于本地优先的编码智能体开发。
...
专为小型LLM优化的AI编程智能体，使用4B活跃参数模型达到87%基准测试成绩。
...
AI驱动的仓库维护机器人，自动扫描Issues和PRs并智能建议可关闭的项目及原因。
...
### [delivery-harness](https://github.com/diudiu-tech/delivery-harness)

面向即时配送场景的AI Harness参考实现，演示如何用智能体驱动端到端交付工作流。可作为构建行业级AI编排方案的起点。
...
端侧 AI 助手，能够操作终端并在 Android 世界中执行广泛的自动化任务。
...
为AI智能体提供统一实时搜索能力的MCP服务器，支持多种搜索引擎集成。
...
能够自动搜索国内八大主流平台近 30 天内容的 AI Agent 技能模块。综合分析后生成有据可查的研究报告，非常适合市场调研与舆情监控。
...
原生 macOS App Store Connect 工具，支持 MCP 协议，让 AI 智能体能够自动提交 iOS 应用到 App Store。
...
基于GitHub Actions和Web UI的24小时AI科技新闻雷达工具，利用Scout Skill自动追踪AI信息源。适合自动化新闻聚合与智能体信息检索。
...
由 TinyFish 网页代理驱动的自托管实时数据集平台。可自动抓取并生成动态数据集，适用于智能体数据收集场景。
...
一个让AI智能体通过工作流循环完成任务的生态系统，通过迭代执行和导师评估不断改进，并将经验转化为可复用数据以提升未来智能体。
...
chipotlai-max 是一个运行在 Chipotle 被盗计算资源上的 AI 编码代理项目。作为 OpenCode 的 fork，它默认使用 Pepper AI 模型，并通过社区贡献添加了来自 Home Depot、Lowes、Target、Starbucks 等提供商的模型支持。
...
内置终端自动化和Agent间通信功能的tmux配置工具。支持智能体间的协同工作，提升终端环境下的自动化能力。
...
开源游戏自动化客户端与机器人工具，支持 Ragnarok Online 的智能自动化操作。

- **Stars:** ⭐️ 1.5k
- **Tags:** `automation` `bot` `game-ai` `mmorpg`
- **最后活动时间:** 2026-08-09
...
专注于效率和上下文管理的AI编程代理，通过哈希锚定编辑、大规模并行操作和AST操作等优化技术，将API成本降低50-80%。
...
公司研究工具，帮助你瞬间全面了解任何公司的内外情况。基于AI自动化收集并整理企业信息。
...
一个自主逆向工程AI智能体，具备Ghidra代理分析、LLM独立验证和候选校验功能。专为自动化二进制分析与安全审计设计。
...
Claude Code和Codex插件，将代码库转化为自动研究循环。支持自动发现测量指标、基准测试和并行子代理树搜索。

- **Stars:** ⭐️ 1.5k
- **Tags:** `autonomous-agents` `claude-code` `codex` `llm-agents` `evolutionary-algorithms`
- **最后活动时间:** 2026-07-17
...
基于智能体系统的可扩展 articulated 3D 资产生成框架，利用 AI 自动化创建复杂 3D 模型。
...
一个由智能体驱动的自动化CVE发现平台，用于源代码审计、漏洞验证和报告生成。
...
一个自主AI研究助手，能够自动化执行科学研究任务。支持Claude集成，具备智能体技能和自主研究能力。
...
基于Claude Agent SDK构建的iMessage智能代理，支持多智能体架构、记忆管理和自动化集成，可定制化程度高。

- **Stars:** ⭐️ 1.4k
- **Tags:** `claude-agent` `imessage` `multi-agent` `automation`
- **最后活动时间:** 2026-07-13
...
一个集成了完整AI研究团队功能的智能仪表盘平台。通过单一界面即可调度和编排多个AI智能体协同完成科研任务。
...
为AI智能体编译知识库的LLM工具，支持多智能体并行研究和维基生成。
...
将AI智能体可视化为3D NPC的游戏插件，支持社交模拟、地图编辑器和角色工坊，适用于游戏开发中的多智能体场景。
...
一个开源的个人学习智能体，具备三层记忆架构（学习者画像、Wiki知识库、跨对话回忆）和主动调度器。基于Pi SDK构建，提供个人即时通讯渠道和工作区实践实验室。
...
全网新闻聚合AI技能，支持多信息源深度获取和文章正文解读分析。

- **Stars:** ⭐️ 1.3k
- **Tags:** `ai-skill` `news-aggregator` `content-analysis` `agent-skill`
- **最后活动时间:** 2026-05-27

### [recon-skills](https://github.com/uphiago/recon-skills)

包含156个用于侦察和渗透测试的进攻性安全技能，涵盖浏览器指纹规避和反机器人绕过等技术。

- **Stars:** ⭐️ 1.3k
- **Tags:** `security` `penetration-testing` `reconnaissance` `ai-agent`
- **最后活动时间:** 2026-09-01
...
- **Stars:** ⭐️ 1.3k
- **Tags:** `ai-agent` `on-device-ai` `gemma` `mobile-ai`
- **最后活动时间:** 2026-08-06

### [Kai](https://github.com/SimonSchubert/Kai)

能够生成屏幕界面的AI助手，支持Android和iOS跨平台，兼容OpenAI接口。
...
基于分析增强生成（AAG）框架构建的图数据分析智能体系统。致力于挖掘数据间的关联关系，实现自主的图数据分析并释放数据价值。
...
一个开源的MCP服务器，用于在购物时比较产品并在购买前询问买家确认。它支持本地优先和隐私保护，实现人在回路的智能购物代理。

- **Stars:** ⭐️ 1.2k
- **Tags:** `mcp-server` `model-context-protocol` `agentic-commerce` `shopping-agent` `human-in-the-loop`
- **最后活动时间:** 2026-08-22
...
本地优先的个人AI助手，集成知识图谱、语音、视觉、浏览器自动化等功能，支持Ollama本地运行，数据完全保留在本地。

- **Stars:** ⭐️ 1.2k
- **Tags:** `ai-assistant` `local-llm` `ollama` `langchain` `sovereign-ai`
- **最后活动时间:** 2026-05-28

### [opencode-telegram-bot](https://github.com/grinev/opencode-telegram-bot)

通过Telegram远程运行和监控AI编程任务的移动客户端，支持定时任务，可作为轻量级OpenCode替代方案。
...
AI劳动力的协作层，运行一个通过电子邮件协调、共享记忆并不断进化的AI智能体团队。
...
自主研究智能体，能够从问题出发自动完成文献检索并编译生成完整的研究手稿。基于多智能体系统与Claude模型，打造真正的自动化科研助手。
...
- **Stars:** ⭐️ 1.2k
- **Tags:** `ai-agents` `web-scraping` `mcp` `openapi` `playwright`
- **最后活动时间:** 2026-08-30

### [okou](https://github.com/vm0-ai/okou)

Okou 是一款自主智能体平台，可连接团队现有工具，在营销、销售、工程和运营中自主完成工作，全程由用户掌控。
...
基于Claude Agent SDK的开源智能体实践，原生支持飞书群聊，为专业用户打造丝滑的主动式Agent工作流体验。
...
开源的 Android 自主智能体，结合本地/远程 LLM 实现无障碍服务驱动的屏幕自动化操作。支持自我规划与多模态 AI 助手功能。

- **Stars:** ⭐️ 1.1k
- **Tags:** `ai-agent` `android` `automation` `llm` `multimodal`
- **最后活动时间:** 2026-09-04
...
专为AI智能体设计的安全防火墙，保护自主代理免受潜在威胁。提供安全隔离与访问控制机制。
...
为AI代理提供App Store Connect自动化技能，支持iOS/macOS应用的部署、TestFlight测试和CI/CD流程自动化。

- **Stars:** ⭐️ 1.0k
- **Tags:** `ai-skills` `agent-skills` `automation` `app-store-connect` `cicd`
- **最后活动时间:** 2026-09-14

### [cybercode](https://github.com/wk42worldworld/cybercode)

结合 Claude Code 编程能力与 Hermes Agent 自进化能力的智能体项目。能够实现代码生成与智能体自我迭代优化。
...
### [design-judge-skills](https://github.com/SeanJ1ang/design-judge-skills)

基于证据的智能体技能集，用于设计奖项研究、评估、匹配和撰写。专为设计奖项申报与研究评估打造的AI智能体工具。

- **Stars:** ⭐️ 1.0k
- **Tags:** `agent-skills` `design-evaluation` `ai-agents` `design-research`
- **最后活动时间:** 2026-08-24

### [LiveStream-Agent-Studio](https://github.com/HanyuanWang/LiveStream-Agent-Studio)

面向抖音直播电商的 Windows 本地 AI Agent 工作室，打通主播发现、直播洞察、复盘与短视频编导的一体化智能工作流。结合语音转文字能力，为直播电商提供端侧智能解决方案。
...
AI代理的CLI伴侣工具，提供200+命令覆盖33+款Datadog产品，增强AI代理的可观测性能力。
...
基于通义千问（Qwen）构建的通用智能体语言世界模型。旨在为通用智能体提供强大的语言理解与决策能力支持。

- **Stars:** ⭐️ 1.0k
- **Tags:** `qwen` `agent` `world-model` `llm`
- **最后活动时间:** 2026-07-20
...
### [dothething](https://github.com/fluffypony/dothething)

一个自主AI智能体项目，用户只需描述任务，AI即可自动执行完成。

- **Stars:** ⭐️ 939
- **Tags:** `autonomous-agent` `ai-agent` `automation`
- **最后活动时间:** 2026-09-23

### [optim-agent](https://github.com/Optim-Agent/optim-agent)

利用大语言模型智能体作为超参数优化器的自动化机器学习工具。它将AI代理技术与机器学习优化相结合，实现自动化的模型调参。

- **Stars:** ⭐️ 939
- **Tags:** `ai-agents` `automl` `hyperparameter-optimization` `machine-learning` `optimization`
- **最后活动时间:** 2026-08-14

### [forgecad-public-kit](https://github.com/ForgeCAD/forgecad-public-kit)

ForgeCAD的公共配套工具包，提供CAD智能体技能示例和文档链接。支持以代码形式驱动参数化CAD设计。
...
tossinvest-cli 是一款专为 Toss 证券交易优化的非官方 CLI 工具。它支持官方 API 以外的 30+ 强大功能，并集成 AI 代理和模型上下文协议 (MCP)，让终端用户和 AI 代理轻松管理股票投资组合。
...
可自托管的Slack原生AI队友，作为Claude Tag的开源替代方案，支持模型无关接入。
...
ForgeCAD公共配套工具包，提供CAD代理技能示例、文档链接和问题跟踪，支持参数化CAD自动化开发。
...
可自托管的个人AI智能体，支持向量记忆、Composio工具集成和Telegram交互。
...
排名第一的开源SWE-bench Verified实现，专注于自动化软件工程任务的智能体。提供强大的代码修复与问题解决能力。

- **Stars:** ⭐️ 881
- **Tags:** `swe-bench` `agent` `software-engineering` `automation`
- **最后活动时间:** 2026-08-21
...
一个智能体工具，可从学术论文PDF或LaTeX源文件自动生成可编辑的PPT演示文稿。

- **Stars:** ⭐️ 875
- **Tags:** `agent` `ppt-generation` `document-processing` `pdf`
- **最后活动时间:** 2026-06-11

### [dio-agent](https://github.com/digitalinnovationone/dio-agent)

由 DIO 创建的 AI 智能体，旨在辅助和支持用户的学习过程。可作为一个具体的教育类 AI Agent 应用参考。
...
基于 Claude Code CLI 的自主 AI 开发团队编排器，支持 Discord 控制、Linear 集成与认知记忆。可协调多个 AI 智能体协作完成真实开发任务。
...
面向AI代理和编程助手的DeFi工具包，支持资金存入、交易执行和加密钱包管理，兼容Claude Code、Cursor等多种AI框架。
...
基于Claude Code CLI的自主AI开发团队编排器，集成Discord控制和Linear项目管理，具备认知记忆能力。
...
为AI代理设计的支付解决方案，通过代币化支付层连接500+商户礼品卡，支持真实商业交易并节省高达10%费用。
...
AI驱动的自动化研究执行框架，让AI处理执行过程、人类掌控研究方向，每次运行都生成可审查的研究成果。
...
自主AI渗透测试智能体，专为网络安全与漏洞赏金任务设计的自动化工具。

- **Stars:** ⭐️ 807
- **Tags:** `autonomous-agents` `pentesting` `cybersecurity` `automation`
- **最后活动时间:** 2026-07-27

### [AutoR](https://github.com/tangxiangru/AutoR)

一个由AI驱动的自动化科研框架，让AI负责执行具体任务，人类把控研究方向。每次运行都会生成可检查的磁盘研究工件。

- **Stars:** ⭐️ 805
- **Tags:** `agent` `ai-scientist` `auto-research` `llm` `claude`
- **最后活动时间:** 2026-08-22

### [HY-Embodied](https://github.com/Tencent-Hunyuan/HY-Embodied)

面向真实世界智能体的具身基础模型，专注于物理环境中的感知、决策与交互能力。
...
### [Life-Agent-RU-YEE](https://github.com/ru-yee/Life-Agent-RU-YEE)
...
大规模高质量的网络安全评估框架，用于严格测试AI智能体在真实漏洞分析任务中的能力。助力AI安全领域的自动化攻防研究。
...
开源的长时多智能体工作流平台，可将每个 Agent 的输出提炼为紧凑上下文传递给下一个 Agent。适合自动化长时间运行的复杂 AI 任务。

- **Stars:** ⭐️ 787
- **Tags:** `multi-agent` `ai-agents` `workflow-automation` `llm` `orchestration`
- **最后活动时间:** 2026-08-18
...
一个快速、易用的Python原生个人AI助手，支持多种模型，可7x24小时自主工作，具备记忆和技能系统。

- **Stars:** ⭐️ 769
- **Tags:** `agentic-ai` `claude` `python` `autonomous` `ai-assistant`
- **最后活动时间:** 2026-08-27
...
通过游戏化方式构建AI智能体的平台。让用户在互动玩法中创建和编排智能体工作流。
...
SOTA级计算机使用代理，在OSWorld基准测试达82%，支持远程和本地部署的生产级方案。
...
基于自然语言指令驱动的AI Agent框架，支持从命令行直接召唤并执行复杂任务。提供Agent控制室与开发工作流集成。
...
利用大语言模型对解空间进行大规模迭代探索，实现深度推理与复杂问题求解。适合关注 LLM 推理增强与自主智能体搜索策略的开发者。

- **Stars:** ⭐️ 739
- **Tags:** `LLM` `Reasoning` `Autonomous-Agents` `Search`
- **最后活动时间:** 2026-09-05
...
个性化多智能体系统，可24/7自动化研究您的科学问题，支持自定义配置和持续运行。
...
为Claude Code设计的战略性研究思考智能体，支持想法评估、项目分类和结构化头脑风暴，帮助研究者决定研究方向。

- **Stars:** ⭐️ 718
- **Tags:** `ai-agent` `research` `claude` `llm`
- **最后活动时间:** 2026-04-13

### [tiri-agent](https://github.com/easylink-ai-open/tiri-agent)

基于agent-runtime构建的本地智能体后端及Web Shell。提供本地化运行的智能体管理与交互能力。

- **Stars:** ⭐️ 718
- **Tags:** `agent` `local-agent` `web-shell` `agent-runtime`
- **最后活动时间:** 2026-07-02
...
免费CLI智能体工具，复用Gemini、Claude、DeepSeek等浏览器会话，实现文件读写、Bash执行、代码提交等自动化操作。
...
AI智能体社交网络平台，让您的AI智能体与其他用户的AI进行自主通信、协商和协作，同时保持完全的所有者控制。
...
### [yozu-web](https://github.com/lorettawillow-lele/yozu-web)

一个AI旅行决策与执行层的Web应用脚手架，支持着陆页、演示流程、基于来源的行程选项及审批门控协调。

- **Stars:** ⭐️ 695
- **Tags:** `AI` `Travel` `Agent` `WebApp`
- **最后活动时间:** 2026-06-09

### [novel-to-game](https://github.com/worldwonderer/novel-to-game)

利用AI Agent技能将小说转化为有据可依且完全可玩的游戏。支持Claude Code、Codex和Kimi Code等多种代码生成智能体。
...
将人类与AI智能体融合于同一工作空间的协作平台。实现人机团队无缝协同工作。
...
WeChatBridge 是一款专为 macOS 设计的原生工具，支持微信聊天记录一键转发到 AI Agent 与 Obsidian。这使得用户能够方便地将聊天历史集成到 AI 智能体中，显著提升工作效率和信息管理能力。

- **Stars:** ⭐️ 683
- **Tags:** `AI-Agent` `WeChat` `macOS` `Obsidian` `Share-Extension`
- **最后活动时间:** 2026-09-23
...
基于 Qwen Code 构建的极简自主代码代理命令行工具。可帮助开发者自动执行代码编写与修改任务。

- **Stars:** ⭐️ 678
- **Tags:** `cli` `autonomous-agent` `qwen` `code-assistant`
- **最后活动时间:** 2026-08-08
...
自主AI智能体在链上24/7进行无限制德州扑克对弈，使用真实钱包和真实筹码，全程无人类参与。

- **Stars:** ⭐️ 673
- **Tags:** `AI Agents` `Onchain` `Poker` `Autonomous Agents`
- **最后活动时间:** 2026-07-31

### [evenfire](https://github.com/evenfire-ai/evenfire)

Evenfire 是一个智能层平台，专为运行支持真实操作的 LLM 代理而设计。它让用户能够在自己的基础设施上轻松部署和管理 AI 代理，简化了复杂 AI 应用的开发。

- **Stars:** ⭐️ 669
- **Tags:** `LLM` `Agents` `Autonomous Agents` `Infrastructure`
- **最后活动时间:** 2026-09-25
...
开源AI设计智能体，支持自主多步骤创意生成，包括海报、社交媒体、品牌套件、广告创意和视频制作。可自托管的Lovart替代方案，MIT许可。
...
开源的AI智能体桌面应用，替代Codex App、Claude Desktop、Cursor等工具，支持自托管和多容器工作流编排。
...
为AI Agent提供本地记忆系统，支持GPU加速，完全私有化部署，零云端依赖，专为Claude Code设计。
...
为AI智能体构建个性化人格的工具，通过数据注入打造独特的AI角色灵魂。
...
### [grok-animus](https://github.com/asdsa321as/grok-animus)

持久化AI伴侣引擎，为任意LLM提供人格、记忆、梦境和进化能力，打造有生命力的AI伴侣基础框架。
...
专为macOS设计的智能体框架，支持电脑控制、自动化脚本和编码等高级功能。支持18+个本地和云端大模型提供商，深度集成系统级能力。
...
首个以个人模型为核心的自进化AI智能体，具备上下文记忆和自我演进能力。
...
一个自包含的智能体框架，拥有高度优化的核心。类似于 Claude Code，但无依赖且不限制模型。
...
可编译的Agent行为框架，支持自主代理工作流和零知识证明。结合A2A与MCP协议实现复杂自动化任务。
...
一个基于对比表示学习的原始推理与任务系统。旨在探索和实现智能体的推理与任务执行能力。
...
《通用智能体使用指南》旨在帮助开发者轻松上手自进化智能体，涵盖了从基础调用到高级技巧的完整内容。适合希望快速掌握智能体开发的用户。

- **Stars:** ⭐️ 549
- **Tags:** `agent` `generic-agent` `tutorial` `ai`
- **最后活动时间:** 2026-05-12

### [openclaw-auto-dream](https://github.com/LeoYeAI/openclaw-auto-dream)

为OpenClaw智能体提供自动记忆整合功能，模拟AI的睡眠记忆巩固机制，由MyClaw.ai驱动。
...
支持 Claude Code、Codex、Cursor、Gemini 的后台智能体，可集成 Linear、Slack、GitHub、GitLab 等平台，支持自主部署。

- **Stars:** ⭐️ 548
- **Tags:** `agent` `claude-code` `codex` `cursor` `gemini` `automation`
- **最后活动时间:** 2026-04-24

### [synergy](https://github.com/SII-Holos/synergy)

面向开放智能体网络的下一代通用型AI智能体，具备强大的多场景适应能力。
...
持久化AI伴侣引擎，为任意LLM提供人格、记忆、梦境和进化能力，打造有生命的AI伴侣。
...
基于Hermes的AIOps智能体，支持证据驱动的故障响应、审批门控修复和运维手册自动学习。

- **Stars:** ⭐️ 538
- **Tags:** `aiops` `incident-response` `automation` `agent`
- **最后活动时间:** 2026-05-18

### [activity-frames](https://github.com/nossa-y/activity-frames)

将日常工作转化为智能体可执行的结构化工作流，完全本地化运行并支持MCP协议。

- **Stars:** ⭐️ 536
- **Tags:** `ai-agents` `mcp` `local-llm` `workflow`
- **最后活动时间:** 2026-08-26

### [loom](https://github.com/husu/loom)

一个用于编写接口文档的AI智能体，支持Vibe coding方式。自带友好的文档查看工具与接口Mock工具。

- **Stars:** ⭐️ 534
- **Tags:** `ai-agent` `api-documentation` `mock` `sdd`
- **最后活动时间:** 2026-05-28

### [grokbot-field-notes](https://github.com/unicodef1wn/grokbot-field-notes)

这是 xAI Grok Bot 团队 72 小时实时构建的规则、剧本、机器人角色和故障日志。Drop AGENTS.md 到你的仓库中，即可快速开始构建 AI 代理。

- **Stars:** ⭐️ 533
- **Tags:** `xai` `grok` `grokbot` `ai-agents`
- **最后活动时间:** 2026-09-20
...
UniVA 通用视频智能体官方代码库，面向视频理解与操作的自主智能体系统。
...
claude-ops 是一个专为 Claude 设计的商业操作系统，集成 57 种技能和 21 个智能体，支持 WhatsApp、Email、Slack 等统一收件箱。它实现自主 PR 合并、AWS 监控、电商运营和营销自动化，是一个全自动化的 AI 业务工具。

- **Stars:** ⭐️ 523
- **Tags:** `ai-agent` `autonomous-agent` `claude` `business-operations` `devops`
- **最后活动时间:** 2026-09-23
...
命令行工具，可基于任意大模型并行运行多个研究智能体，大幅提升深度调研的效率。适合自动化文献检索与信息汇总。

- **Stars:** ⭐️ 522
- **Tags:** `research-agents` `cli` `llm` `parallel-agents` `research-automation`
- **最后活动时间:** 2026-08-31
...
### [openvort](https://github.com/openvort/openvort)

开源AI员工平台，可在企业微信、钉钉、飞书中创建与真实团队协作的AI员工，支持插件系统和技能扩展。

- **Stars:** ⭐️ 521
- **Tags:** `ai-agent` `ai-employee` `llm` `chatbot` `enterprise`
- **最后活动时间:** 2026-04-27

### [lyrie-ai](https://github.com/OTT-Cybersecurity-LLC/lyrie-ai)

全球首个自主AI网络安全智能体，专注于威胁情报分析和零日漏洞检测，由OTT Cybersecurity LLC开发。
...
TypeSafe Jev 是一个源代码支持的 TypeSafe System One 模型资源指南，包含 SDK、实时演示、代理工具和独立评估。这是一个全面的 AI 代理和 LLM 资源集合，帮助开发者掌握前沿的 typed-decisions 和 semantic-routing 技术。

- **Stars:** ⭐️ 517
- **Tags:** `AI Agents` `LLM` `TypeSafe AI`
- **最后活动时间:** 2026-09-24

### [awesome-jev-projects](https://github.com/logicrw/awesome-jev-projects)

awesome-jev-projects 是一个开源生态雷达项目，专注于AI代理和类型安全AI。它通过源代码支持的发现工具，帮助开发者探索和发现开源AI项目，并提供自动GitHub同步功能。

- **Stars:** ⭐️ 516
- **Tags:** `ai-agents` `awesome-list` `typesafe-ai` `developer-tools`
- **最后活动时间:** 2026-09-24
...
一个能够围绕任意目标构建实时生物安全世界模拟的 AI 智能体。展示了自主 Agent 在专业领域的建模与推演能力。
...
开源的IT自动化基准测试框架，通过模拟真实故障场景评估AI智能体在故障检测、根因分析与自动修复方面的表现。适合研究和对比LLM驱动的AIOps智能体能力。
...
一个等距3D沙盒项目，可绘制商店并生成大模型人格代理，观察它们在店内的购物行为。
...
为 Hermes Agent 提供 Android 设备控制能力的桥接应用与 Python 工具集，让智能体直接操作安卓设备。
...
基于 ElizaOS 和 OpenClaw 的自主 AI 智能体项目，支持多种智能体技能与插件扩展。

- **Stars:** ⭐️ 389
- **Tags:** `autonomous-agents` `elizaos` `openclaw` `agent-skills`
- **最后活动时间:** 2026-04-24
...
开源AI求职申请工具包，可为每个职位自动定制生成简历和求职信，并通过MCP协议驱动隐身浏览器完成自动投递。将大模型能力与反检测浏览器自动化结合，是AI Agent求职场景的实用利器。
...
在 Docker 中运行 Android 模拟器的完整方案，支持 noVNC 远程访问与视频录制，并内置 MCP 服务器。可让 AI 智能体直接操控 Android 设备，实现移动端自动化测试与智能操作。
...
强大的浏览器自动化测试库，支持Chromium、Firefox和WebKit，广泛用于AI智能体的网页交互与自动化任务。
...
基于 Chrome DevTools 协议的 Go 语言浏览器自动化库，无需额外依赖即可驱动 Chrome/Chromium。广泛用于网页抓取、自动化测试，也可作为 AI 智能体与网页交互的底层引擎。

- **Stars:** ⭐️ 13.3k
- **Tags:** `browser-automation` `golang` `chrome-devtools-protocol` `headless-browser` `web-scraping`
- **最后活动时间:** 2026-07-14

### [SeleniumBase](https://github.com/seleniumbase/SeleniumBase)

强大的浏览器自动化和测试框架，支持反检测功能，可用于AI智能体的网页交互自动化操作。
...
基于Python的强大网页自动化工具，结合浏览器控制与请求管理，适用于AI智能体的网页操作与数据采集场景。

- **Stars:** ⭐️ 12.5k
- **Tags:** `web-automation` `browser-control` `python`
- **最后活动时间:** 2026-09-14

### [pipedream](https://github.com/PipedreamHQ/pipedream)

快速连接API的工作流自动化平台，支持无代码/低代码开发，可用于构建AI驱动的自动化流程和智能工作流。
...
B站自动化任务工具，支持多种部署方式，集成 AI 功能实现智能任务执行。
...
基于容器的Selenium Grid解决方案，支持大规模浏览器自动化测试，可用于AI智能体的网页交互任务。
...
轻量级Python Web自动化库，简化Selenium操作，适合AI Agent进行网页交互和自动化任务。

- **Stars:** ⭐️ 8.3k
- **Tags:** `web-automation` `selenium` `browser-control`
- **最后活动时间:** 2026-08-10
...
基于UI自动化的Windows微信客户端RPA工具，可实现消息自动收发与简单微信机器人。常被用于接入大语言模型，快速搭建微信AI助手。
...
基于Chrome DevTools Protocol的高级浏览器自动化与网页抓取库，支持无头浏览器操作，适用于AI智能体的网页交互场景。

- **Stars:** ⭐️ 7.1k
- **Tags:** `browser-automation` `web-scraping` `chrome-devtools` `headless`
- **最后活动时间:** 2026-08-11

### [pydoll](https://github.com/autoscrape-labs/pydoll)

基于CDP的浏览器自动化库，无需WebDriver即可实现真实的浏览器交互，支持反检测和验证码处理，适合构建AI智能体的网页操作能力。
...
一个简洁的SWE风格浏览器智能体框架，在长周期网页任务上达到SOTA效果。

- **Stars:** ⭐️ 6.0k
- **Tags:** `browser-agent` `web-automation` `agent-framework`
- **最后活动时间:** 2026-08-03
...
深入分析反机器人保护系统和浏览器指纹检测技术，提供绕过方法，帮助AI智能体实现更稳定的网页数据采集。

- **Stars:** ⭐️ 5.1k
- **Tags:** `browser-fingerprinting` `bot-detection` `stealth` `webscraping`
- **最后活动时间:** 2026-07-27
...
一款用于创建和运行RPA 2.0工作流的自动化工具，支持浏览器和Telegram等平台的自动化操作。
...
全能协议分析工具，集成浏览器抓包、MITM代理、指纹伪装和AI分析功能，通过MCP Server无缝对接AI Agent和IDE。

- **Stars:** ⭐️ 3.7k
- **Tags:** `ai-tools` `protocol-analysis` `mitm-proxy` `mcp-server`
- **最后活动时间:** 2026-09-16
...
让AI智能体在真实浏览器中测试你的代码，实现自动化端到端测试。

- **Stars:** ⭐️ 3.6k
- **Tags:** `agent` `browser` `test` `automation`
- **最后活动时间:** 2026-05-06

### [playwright-go](https://github.com/mxschmitt/playwright-go)

Playwright 的 Go 语言实现，提供统一的 API 控制 Chromium、Firefox 和 WebKit 浏览器。非常适合用于构建 AI 智能体的网页自动化和测试任务。

- **Stars:** ⭐️ 3.5k
- **Tags:** `browser-automation` `playwright` `go` `headless-chrome`
- **最后活动时间:** 2026-09-14
...
支持小红书自动发布、评论和检索的Codex技能插件，兼容OpenClaw、Codex、CC等平台。
...
自动抓取Udemy优惠券并注册付费课程的自动化脚本。利用Web自动化技术帮助用户免费获取学习资源。
...
一个轻量级、高性能的Rust CLI工具，通过Chrome DevTools Protocol驱动真实浏览器。专为编程智能体设计，提供强大的浏览器自动化能力。

- **Stars:** ⭐️ 3.1k
- **Tags:** `agent` `browser-automation` `llm` `rust` `cli`
- **最后活动时间:** 2026-08-27
...
基于Python的Web自动化工具，功能强大且优雅，适用于AI智能体的浏览器自动化操作。
...
一款专注于隐私保护的浏览器内核，提供统一的指纹防御机制。能够有效绕过Cloudflare、Akamai、DataDome等反爬虫检测。
...
具备自学习能力的浏览器自动化基础设施，可大幅削减AI智能体的Token消耗。通过优化命令执行帮助降低AI操作成本。
...
一款能够绕过反机器人系统的浏览器自动化工具，AI可编写网络钩子并通过简单对话实现像素级UI克隆。
...
基于WebDriver的高级API，用于程序化控制网页交互，适合AI智能体进行浏览器自动化操作。

- **Stars:** ⭐️ 2.0k
- **Tags:** `automation` `webdriver` `rust` `browser`
- **最后活动时间:** 2026-09-01
...
一款基于DeepSeek的浏览器扩展，提供集成了MCP工具、记忆和自动化技能的AI智能体工作区。支持网页搜索、工具调用及对话导出，极大提升浏览器的AI交互体验。

- **Stars:** ⭐️ 1.9k
- **Tags:** `deepseek` `ai-agent` `browser-extension` `mcp` `automation` `typescript`
- **最后活动时间:** 2026-08-13

### [browserless](https://github.com/microlinkhq/browserless)

生产级无头浏览器服务，支持截图、PDF生成和网页抓取，为AI智能体提供浏览器自动化能力。
...
免费的多引擎网页搜索MCP工具，支持Bing、百度、DuckDuckGo、Brave等多个搜索引擎，无需API密钥即可使用。
...
基于下一代WebDriver BiDi协议的Firefox自动化框架，专为AI智能体网页交互设计，支持绕过检测机制。
...
Android GUI 智能体框架，能够通过视觉、规划和操作真实移动应用 GUI 来实现手机端 AI 自动化。
...
用于Puppeteer或2D平面的鼠标轨迹模拟库，能生成逼真的人类鼠标移动路径。常用于自动化测试与RPA场景以绕过机器人检测。

- **Stars:** ⭐️ 1.6k
- **Tags:** `puppeteer` `automation` `mouse-simulation` `rpa`
- **最后活动时间:** 2026-09-13

### [hermes-browser-extension](https://github.com/abundantbeing/hermes-browser-extension)

Hermes Agent 的浏览器侧边栏扩展，可将网页上下文连接到本地 Hermes 运行时，实现本地优先的 AI 浏览器自动化。
...
基于Playwright的隐身版Python浏览器自动化库，专为AI智能体和爬虫设计，可绕过Cloudflare等反爬检测。
...
免费开源的浏览器端机器人检测库，可识别 Selenium、Playwright、Puppeteer 等自动化工具。完全在客户端运行，无需服务器，MIT 许可无使用限制。

- **Stars:** ⭐️ 1.5k
- **Tags:** `bot-detection` `browser` `automation` `fingerprinting`
- **最后活动时间:** 2026-09-13

### [boss-zhipin-scraper](https://github.com/eatmoreduck/boss-zhipin-scraper)

探索AI代理在职场自动化中的潜力！boss-zhipin-scraper 是一个Chrome CDP协议驱动的BOSS直聘职位爬虫工具。它能够复用真实登录态、绕过字体反爬机制，并输出带薪资技能分析的JSON/CSV数据。

- **Stars:** ⭐️ 1.5k
- **Tags:** `ai-agents` `browser-automation` `scraper` `chrome-cdp` `claude-skills`
- **最后活动时间:** 2026-09-17
...
Rust实现的Chrome DevTools Protocol API，支持浏览器自动化操作，可用于AI智能体的网页交互与自动化任务。

- **Stars:** ⭐️ 1.4k
- **Tags:** `browser-automation` `chrome-devtools` `rust` `web-scraping`
- **最后活动时间:** 2026-04-03
...
### [web-agent](https://github.com/firecrawl/web-agent)

开源的网页数据智能体，专为结构化网络研究优化，能够自动化执行网页数据采集和分析任务。

- **Stars:** ⭐️ 1.2k
- **Tags:** `web-agent` `automation` `data-extraction`
- **最后活动时间:** 2026-04-19

### [gemma4-browser-extension](https://github.com/nico-martin/gemma4-browser-extension)

基于 Transformers.js 和 Gemma 4 的设备端 AI 智能体 Chrome 扩展，无需联网即可运行。

- **Stars:** ⭐️ 1.2k
- **Tags:** `browser-extension` `gemma` `transformers-js` `on-device-ai` `chrome`
- **最后活动时间:** 2026-08-13

### [reverse-api-engineer](https://github.com/nottelabs/reverse-api-engineer)

将网站自动逆向为 API 的智能体，结合 Playwright 与 OpenAPI 生成可复用接口。

- **Stars:** ⭐️ 1.2k
- **Tags:** `ai-agents` `web-scraping` `openapi` `playwright` `mcp`
- **最后活动时间:** 2026-08-30
...
一款免费开源的反检测浏览器，专为网页抓取和多账号管理设计。支持引擎级指纹伪装，内置170+设备配置，完美适配自动化测试与AI智能体操作。
...
### [tg-signer](https://github.com/amchii/tg-signer)

一个自动化的Telegram机器人工具，支持自动签到、消息监控转发以及AI自动回复等功能。可用于群组、频道和私聊的自动化管理。

- **Stars:** ⭐️ 1.0k
- **Tags:** `telegram` `bot` `automation` `ai-reply`
- **最后活动时间:** 2026-09-01
...
轻量级 UI Agent，通过自然语言指令驱动 Web 和 Android 平台的 UI 自动化任务，无需编写脚本即可实现自动化操作。
...
为AI Agent提供跨平台网页数据获取能力的工具，支持55+平台（Bilibili、Twitter/X、YouTube、Reddit等），复用Chrome登录会话，无需API密钥即可实时抓取数据。

- **Stars:** ⭐️ 921
- **Tags:** `ai-agent` `browser-automation` `web-scraping` `data-fetching`
- **最后活动时间:** 2026-04-20

### [grok-register-panel](https://github.com/lij768423-svg/grok-register-panel)

Grok批量注册引擎结合实时Web监控面板，支持并发、ASN黑名单、代理池和Turnstile验证。该项目帮助用户高效使用xAI的Grok服务。

- **Stars:** ⭐️ 904
- **Tags:** `grok` `automation` `playwright` `dashboard`
- **最后活动时间:** 2026-09-25
...
### [libretto](https://github.com/cashew-labs/libretto)
...
用于构建和维护浏览器自动化的AI工具包，支持Claude Code和Codex集成。
...
为AI编程代理提供可视化验证能力的工具，能够记录浏览器会话、截取屏幕截图、收集错误并打包验证产物，帮助人类验证AI代理构建的内容。

- **Stars:** ⭐️ 853
- **Tags:** `ai-agents` `browser-automation` `verification` `screenshots`
- **最后活动时间:** 2026-04-14
...
### [browser-use-mcp-server](https://github.com/kontext-security/browser-use-mcp-server)
...
Java版本的Puppeteer实现，支持Chrome和Firefox的无头浏览器自动化操作，适用于网页爬虫和自动化测试场景。

- **Stars:** ⭐️ 805
- **Tags:** `puppeteer` `browser-automation` `java` `web-scraping`
- **最后活动时间:** 2026-07-24
...
### [figranium](https://github.com/figranium/figranium)
...
通过远程云会话执行复杂自动化脚本，集成代理、自动验证码解决及JavaScript渲染功能。

- **Stars:** ⭐️ 666
- **Tags:** `headless-browser` `web-scraping` `automation` `ai-search`
- **最后活动时间:** 2026-09-16

### [fortress](https://github.com/tiliondev/fortress)

fortress 是一个先进的 Chromium 浏览器引擎，通过简单的代码更改即可添加隐身功能，有效阻止爬虫和浏览器代理被检测和封禁。它特别适合构建智能代理和自动化测试项目。

- **Stars:** ⭐️ 647
- **Tags:** `anti-bot` `browser-automation` `stealth` `chromium` `automation`
- **最后活动时间:** 2026-07-23

### [burner-agents](https://github.com/NotPBShaw/burner-agents)

一个由一次性智能体组成的集群，用于不可追踪的自动化网页交互。

- **Stars:** ⭐️ 646
- **Tags:** `ai-agents` `autonomous-agents` `browser-automation` `stealth-browser` `web-automation`
- **最后活动时间:** 2026-06-16

### [burner-agents](https://github.com/TimFryAI/burner-agents)

一个由一次性智能体组成的集群，用于不可追踪的网页交互。用户将任务委托给智能体，完成后销毁，不留任何痕迹。

- **Stars:** ⭐️ 646
- **Tags:** `ai-agents` `autonomous-agents` `browser-automation` `privacy`
- **最后活动时间:** 2026-06-16

### [ash-agents](https://github.com/PengZhang64/ash-agents)

一个用于隐蔽式Web交互的可弃用AI智能体集群，专注于浏览器自动化与隐私保护。

- **Stars:** ⭐️ 646
- **Tags:** `ai-agents` `browser-automation` `stealth-browser` `privacy`
- **最后活动时间:** 2026-07-16

### [terminal](https://github.com/browser-use/terminal)
...
### [desktop](https://github.com/browser-use/desktop)

Browser Use 的桌面客户端应用，允许用户在本地环境中运行基于AI的浏览器自动化代理。

- **Stars:** ⭐️ 643
- **Tags:** `agent-browser` `browser-agent` `browser-use` `desktop-app` `ai-automation`
- **最后活动时间:** 2026-08-03
...
一个用于浏览器感知与控制的命令行工具，支持标签页扫描、JS执行、截图和CDP调试等功能。非常适合用于构建AI网页自动化智能体和Web工具排障。

- **Stars:** ⭐️ 593
- **Tags:** `browser-automation` `cli` `cdp` `agent`
- **最后活动时间:** 2026-08-02
...
.NET平台的直观浏览器自动化库，适用于AI智能体的网页交互和自动化测试场景。

- **Stars:** ⭐️ 565
- **Tags:** `browser-automation` `dotnet` `selenium` `testing`
- **最后活动时间:** 2026-09-02
...
Playwright 的 Ruby 客户端，可直接驱动 Chromium/Firefox/WebKit 浏览器进行自动化操作。作为浏览器自动化基础设施，它是构建网页智能体与自动化采集流程的可靠选择。

- **Stars:** ⭐️ 513
- **Tags:** `playwright` `ruby` `browser-automation` `web-automation` `testing`
- **最后活动时间:** 2026-09-11

### [bang-motion](https://github.com/bangtutorial/bang-motion)

Bang-motion 是一个浏览器动作图形代理技能，支持 Claude Code、Codex、Gemini CLI 和 Cursor，提供开场、推广、横幅等动态视频效果。

- **Stars:** ⭐️ 513
- **Tags:** `ai-agents` `browser-automation` `motion-graphics` `claude-code` `creative-apps`
- **最后活动时间:** 2026-09-15

### [terminal](https://github.com/TitasGailius/terminal)

在终端中通过 TUI 驱动浏览器自动化（基于 CDP），让浏览器任务操作更高效直观。

- **Stars:** ⭐️ 512
- **Tags:** `browser-automation` `cdp` `tui` `terminal`
- **最后活动时间:** 2026-04-18
...
### [ash-agents](https://github.com/EthanXiang777/ash-agents)

一个用于不可追踪网页交互的一次性智能体集群工具。它结合了隐身浏览器与自主代理技术，实现高度隐私的Web自动化操作。
...
### [reddit-research-skills](https://github.com/lignertys/reddit-research-skills)
