...
多智能体协作框架，让多个AI角色协同完成软件开发，实现自然语言编程的愿景。

- **Stars:** ⭐️ 66.2k
- **Tags:** `Multi-Agent` `LLM` `GPT` `Automation`
- **最后活动时间:** 2026-01-21
...
可视化AI智能体构建平台，支持拖拽式创建LangChain工作流，无需编码即可构建RAG应用和聊天机器人。

- **Stars:** ⭐️ 51.1k
- **Tags:** `Low-code` `LangChain` `Visual Builder` `AI Agents`
- **最后活动时间:** 2026-03-26
...
AI分析查询引擎，支持在实时数据上构建自推理智能体，集成多种数据库和LLM，实现智能数据分析与RAG应用开发。
...
事件驱动的智能体编排平台，为AI Agent应用提供持久、高弹性的工作流执行引擎。
...
快速、轻量且完全自主的AI个人助手基础设施，支持跨平台部署和组件替换。
...
轻量级AI智能体框架，支持容器化安全部署，可连接WhatsApp、Telegram、Slack等多平台。
...
OpenAI官方推出的轻量级多智能体编排教育框架，探索人体工程学的智能体协调模式。

- **Stars:** ⭐️ 21.2k
- **Tags:** `Multi-Agent` `OpenAI` `Orchestration`
- **最后活动时间:** 2025-03-11

### [rasa](https://github.com/RasaHQ/rasa)

开源对话式AI框架，用于构建文本和语音对话系统，支持NLU和对话管理。
...
一站式AI智能体开发平台，提供可视化工具简化Agent创建、调试和部署流程，支持低代码/无代码快速构建AI应用。

- **Stars:** ⭐️ 20.3k
- **Tags:** `Agent` `Low-Code` `RAG` `Workflow`
- **最后活动时间:** 2026-03-25
...
为编码智能体提供记忆增强能力的工具，让AI助手能够记住和复用上下文信息。
...
Kortix平台提供AI智能体构建、管理和训练能力，帮助开发者快速开发和部署AI Agent应用。
...
优化的多智能体协作学习框架，专注于现实世界任务自动化与复杂任务编排。
...
Google开源的Python智能体开发工具包，支持代码优先方式构建、评估和部署复杂AI智能体。
...
开源智能体AI数据助手，专为下一代AI+数据产品打造。

- **Stars:** ⭐️ 18.4k
- **Tags:** `Agents` `Database` `RAG`
- **最后活动时间:** 2026-03-26

### [agentic](https://github.com/transitive-bullshit/agentic)

将API快速转换为付费MCP服务的工具，帮助开发者快速部署AI代理服务。

- **Stars:** ⭐️ 18.1k
- **Tags:** `mcp` `agents` `api-monetization` `ai-infrastructure`
- **最后活动时间:** 2026-02-11

### [gemini-fullstack-langgraph-quickstart](https://github.com/google-gemini/gemini-fullstack-langgraph-quickstart)

基于 Gemini 2.5 和 LangGraph 快速构建全栈 AI Agent 应用的入门模板，适合开发者快速上手智能体开发。

- **Stars:** ⭐️ 18.0k
- **Tags:** `Gemini` `LangGraph` `Agent` `Fullstack`
- **最后活动时间:** 2026-03-21

### [eliza](https://github.com/elizaOS/eliza)

为所有人设计的自主智能体框架，支持多平台部署和插件扩展，让开发者轻松构建和部署AI智能体应用。
...
面向客户服务的AI智能体对话控制框架，专注上下文工程和客户交互优化，支持多种LLM后端。

- **Stars:** ⭐️ 17.8k
- **Tags:** `AI Agents` `Customer Service` `Context Engineering`
- **最后活动时间:** 2026-03-26

### [DocsGPT](https://github.com/arc53/DocsGPT)

企业级私有AI平台，支持Agent构建、文档分析、RAG检索和多模型接入。
...
领先的AI智能体工程平台，提供构建LLM应用的完整框架和工具链。
...
开发者优先的开源自主AI智能体框架，支持快速构建、管理和运行自主智能体。

- **Stars:** ⭐️ 17.3k
- **Tags:** `Autonomous Agents` `LLM` `开源框架`
- **最后活动时间:** 2025-01-22
...
面向科研、工程、金融和写作领域的Claude Agent技能集合，支持生物信息学、基因组学、材料科学等多学科研究场景。

- **Stars:** ⭐️ 16.3k
- **Tags:** `Claude` `Agent Skills` `Scientific AI`
- **最后活动时间:** 2026-03-25

### [RagaAI-Catalyst](https://github.com/raga-ai-hub/RagaAI-Catalyst)

AI智能体可观测性、监控和评估框架，支持多智能体系统追踪调试和执行图分析。

- **Stars:** ⭐️ 16.1k
- **Tags:** `AI Observability` `Agent Monitoring` `LLM Tracing`
- **最后活动时间:** 2026-02-11
...
基于通义千问的智能体框架，支持函数调用、MCP、代码解释器、RAG等功能，并提供Chrome扩展。

- **Stars:** ⭐️ 15.8k
- **Tags:** `agent-framework` `qwen` `llm` `function-calling` `rag` `mcp`
- **最后活动时间:** 2026-03-04
...
上下文工程AI代理技能集合，涵盖多代理架构和生产级代理系统的上下文管理。

- **Stars:** ⭐️ 14.3k
- **Tags:** `Context Engineering` `Multi-Agent` `AI Agents`
- **最后活动时间:** 2026-03-22
...
开源的MCP数据库工具箱服务器，支持多种数据库连接，让AI智能体能够安全高效地与数据库交互。

- **Stars:** ⭐️ 13.5k
- **Tags:** `MCP` `Database` `Agent`
- **最后活动时间:** 2026-03-26

### [memU](https://github.com/NevaMind-AI/memU)

为24/7主动型AI智能体设计的记忆系统，支持Claude与MCP协议，实现智能上下文感知与持久化存储。
...
多智能体工作空间管理器，用于协调和管理多个AI代理的协作环境。

- **Stars:** ⭐️ 13.0k
- **Tags:** `multi-agent` `workspace` `agent-manager` `ai-agent`
- **最后活动时间:** 2026-03-24

### [gorilla](https://github.com/ShishirPatil/gorilla)

专注于训练和评估大语言模型进行函数调用的开源项目，是构建AI智能体的核心基础设施。
...
开源数字人Agent框架，支持2.5D/3D数字人连接大语言模型与业务系统，兼容OpenAI和DeepSeek等主流模型。
...
开源安全的AI智能体执行环境，为AI代理提供代码解释器和真实工具支持，助力企业级智能体开发。
...
企业级智能体工作流平台，支持多智能体编排与MCP协议，助力构建下一代超级智能体应用。
...
Dify DSL工作流程精选合集，分享实用的AI智能体工作流配置。

- **Stars:** ⭐️ 10.3k
- **Tags:** `dify` `workflow` `ai-agent` `llm` `automation`
- **最后活动时间:** 2026-03-25

### [PocketFlow](https://github.com/The-Pocket/PocketFlow)

仅100行代码的极简LLM框架，专注于智能体构建智能体，支持工作流编排。

- **Stars:** ⭐️ 10.3k
- **Tags:** `LLM Framework` `Workflow` `Lightweight`
- **最后活动时间:** 2026-03-09

### [skills](https://github.com/huggingface/skills)

为AI智能体提供Hugging Face生态系统能力的工具库，让智能体能够轻松调用各种AI模型和功能。
...
结果驱动的智能体开发框架，支持自我进化和持续改进，集成多AI提供商与人机协作机制。

- **Stars:** ⭐️ 9.8k
- **Tags:** `Agent Framework` `Self-improving` `Autonomous Agents`
- **最后活动时间:** 2026-03-26

### [valuecell](https://github.com/ValueCell-ai/valuecell)

社区驱动的多智能体金融应用平台，支持股票、加密货币等金融场景的AI智能体协作。

- **Stars:** ⭐️ 9.8k
- **Tags:** `Multi-Agent` `Finance` `AI`
- **最后活动时间:** 2026-03-09

### [ai-town](https://github.com/a16z-infra/ai-town)

MIT开源的AI虚拟小镇 starter kit，让AI角色在其中生活、聊天和社交，可自定义部署。
...
面向Java开发者的智能体AI框架，支持多智能体协作、图工作流和上下文工程。

- **Stars:** ⭐️ 9.0k
- **Tags:** `Agent Framework` `Java` `Multi-Agent`
- **最后活动时间:** 2026-03-21
...
全自动化、零代码的LLM智能体框架，让用户无需编程即可构建和部署AI Agent应用。
...
基于模型上下文协议(MCP)构建AI智能体的框架，提供简洁的工作流模式。
...
可扩展的AI工作流开发框架，内置画布、表单、变量等组件，帮助开发者快速构建AI工作流平台。

- **Stars:** ⭐️ 7.8k
- **Tags:** `Workflow` `AI Automation` `No-Code` `TypeScript`
- **最后活动时间:** 2026-03-23
...
专为金融和银行业设计的智能体框架，支持MCP协议、RAG集成，提供高可靠性的企业级AI解决方案。
...
灵活强大的多AI智能体管理框架，支持复杂对话编排，可对接OpenAI、Anthropic Claude和AWS Bedrock等多种模型。
...
Stream开源的视觉智能体框架，支持快速构建基于任意模型的视觉Agent，利用边缘网络实现超低延迟实时交互。
...
单二进制运行时，用于构建和运行自主智能体，无需Python或Node.js即可快速开发AI代理应用。
...
可定制的3D智能体AI研究平台，支持基于智能体的AI实验。为AI智能体研究提供仿真环境。

- **Stars:** ⭐️ 7.3k
- **Tags:** `agent-based` `simulation` `3d-platform`
- **最后活动时间:** 2023-01-04

### [adk-go](https://github.com/google/adk-go)

Google开源的Go语言AI智能体开发工具包，支持多智能体协作、MCP协议和Vertex AI集成。
...
开源智能体技能构建器，通过可视化工作流定义技能，支持多平台运行。可将技能作为基础设施构建Slack/飞书机器人和API接口。
...
基于OpenAI Realtime API的高级智能体模式演示项目，展示实时语音交互的Agent架构。

- **Stars:** ⭐️ 6.8k
- **Tags:** `openai` `realtime-api` `agents` `voice` `demo`
- **最后活动时间:** 2026-01-07

### [nullclaw](https://github.com/nullclaw/nullclaw)

使用 Zig 编写的极速、轻量级全自主 AI 助手基础设施框架，专注于高性能和最小化资源占用。

- **Stars:** ⭐️ 6.8k
- **Tags:** `ai` `assistant` `zig` `autonomous` `infrastructure`
- **最后活动时间:** 2026-03-24

### [julep](https://github.com/julep-ai/julep)

面向AI智能体的无服务器工作流部署平台，支持大规模部署AI工作流，提供完整的智能体开发框架。
...
开源自托管的云智能体集群，管理协作式AI智能体团队，支持Web3和区块链集成。

- **Stars:** ⭐️ 6.5k
- **Tags:** `Agent Cluster` `Web3` `Self-hosted`
- **最后活动时间:** 2026-03-26
...
企业级多智能体编排框架，生产就绪，支持复杂AI代理系统的构建与大规模协作部署。
...
环境智能库，提供AI代理开发框架，支持结构化输出和聊天机器人构建。
...
一个像素风格的AI智能体协作可视化面板，将不可见的工作状态转化为有趣的角色空间，支持多智能体协作和日常笔记功能。

- **Stars:** ⭐️ 6.1k
- **Tags:** `multi-agent` `ai-assistant` `dashboard` `pixel-art` `agent-collaboration`
- **最后活动时间:** 2026-03-11

### [openai-cs-agents-demo](https://github.com/openai/openai-cs-agents-demo)

使用OpenAI Agents SDK构建的智能客服系统演示，展示Agent在实际业务场景中的应用。

- **Stars:** ⭐️ 5.9k
- **Tags:** `openai` `agents-sdk` `customer-service` `demo`
- **最后活动时间:** 2025-12-18
...
模块化AI智能体构建框架，支持原子化组件设计，便于构建复杂AI工作流。
...
CrewAI 框架的官方示例集合，展示如何使用多智能体协作自动化工作流程。

- **Stars:** ⭐️ 5.8k
- **Tags:** `crewai` `agents` `automation` `examples`
- **最后活动时间:** 2026-03-25

### [PraisonAI](https://github.com/MervinPraison/PraisonAI)

低代码多智能体AI框架，支持100+大语言模型，具备规划、研究和编码能力，可自动部署到多平台。
...
可视化AI智能体工作流开发平台，支持图形化界面快速迭代和调试Agent，高效构建复杂智能体应用。

- **Stars:** ⭐️ 5.7k
- **Tags:** `Agent` `Workflow` `可视化` `LLM`
- **最后活动时间:** 2025-07-20

### [klavis](https://github.com/Klavis-AI/klavis)

MCP集成平台，让AI智能体能够可靠地使用各种工具，支持大规模部署和OAuth2认证。
...
200+ 即插即用的 n8n 工作流模板，融合向量数据库、嵌入和 LLM 的 AI 自动化方案。

- **Stars:** ⭐️ 5.6k
- **Tags:** `n8n` `AI Workflows` `LLM` `Automation`
- **最后活动时间:** 2025-08-01
...
WhatsApp MCP服务器，让AI模型能够通过Model Context Protocol与WhatsApp进行交互，实现智能体与消息平台的无缝集成。

- **Stars:** ⭐️ 5.5k
- **Tags:** `MCP` `WhatsApp` `AI Integration`
- **最后活动时间:** 2025-07-13
...
AI 智能体操作系统，为 AI Agent 提供底层运行环境和管理能力。
...
开源AI原生应用开发平台，集成RAG、智能体、函数调用等核心能力。

- **Stars:** ⭐️ 5.4k
- **Tags:** `Agent` `RAG` `Function Call` `Vector`
- **最后活动时间:** 2024-12-02

### [1code](https://github.com/21st-dev/1code)

编程代理编排层，统一协调 Claude Code、Codex 等多个 AI 编码代理。

- **Stars:** ⭐️ 5.3k
- **Tags:** `orchestration` `claude-code` `codex` `coding-agents`
- **最后活动时间:** 2026-03-06

### [superduper](https://github.com/superduper-io/superduper)

端到端AI应用开发框架，集成LLM推理、RAG检索、向量搜索等核心能力，简化AI应用全流程开发与部署。
...
基于Git生态的人机协作项目管理工具，支持人类与AI Agent协同管理任务。
...
递归开放元智能体框架，用于构建高性能多智能体系统的元智能体框架。

- **Stars:** ⭐️ 5.0k
- **Tags:** `Meta-Agent` `Multi-Agent` `Framework`
- **最后活动时间:** 2026-02-16
...
多LLM智能体部署框架，提供任务解决和仿真两种框架模式。

- **Stars:** ⭐️ 5.0k
- **Tags:** `Multi-Agent` `LLM` `Simulation`
- **最后活动时间:** 2024-09-09
...
基于自然语言构建生产级智能体工作流的框架，支持浏览器自动化、计算机操作和RAG等能力。

- **Stars:** ⭐️ 4.9k
- **Tags:** `Agentic Workflow` `Browser Automation` `LLM Agents`
- **最后活动时间:** 2026-03-03
...
COLM 2024论文开源项目，提供语言智能体的开放平台，支持代码生成与工具学习。

- **Stars:** ⭐️ 4.7k
- **Tags:** `Agent平台` `工具学习` `学术研究`
- **最后活动时间:** 2024-11-18

### [Yuxi-Know](https://github.com/xerrors/Yuxi-Know)

结合LightRAG知识库的知识图谱智能体平台，支持DeepAgents、MinerU PDF与MCP协议。
...
Cloudflare官方推出的AI智能体开发框架，支持在边缘端构建和部署持久化的AI Agent，集成Durable Objects和Workflows。
...
基于Kotlin多平台构建的AI原生多智能体开发平台，覆盖软件开发生命周期的全部7个阶段。
...
零代码智能体自动生成平台，无需复杂编排即可快速构建AI Agent，支持运行控制、数据处理和MCP工具集成。
...
将任意浏览器变成终端，随时随地管理和控制你的AI代理。支持远程访问和代理编排。
...
知名开发者 Anthony Fu 精心策划的智能体技能集合，为 AI Agent 提供丰富的能力模块。

- **Stars:** ⭐️ 4.3k
- **Tags:** `Agent` `Skills` `vibe-coding`
- **最后活动时间:** 2026-03-16

### [llama-stack-apps](https://github.com/llamastack/llama-stack-apps)

Meta Llama Stack API的智能代理组件，提供构建AI代理的核心能力。

- **Stars:** ⭐️ 4.3k
- **Tags:** `llama` `ai-agent` `meta` `framework`
- **最后活动时间:** 2025-08-05

### [wanwu](https://github.com/UnicomAI/wanwu)

中国联通推出的企业级多租户AI智能体开发平台，支持智能体、工作流和RAG应用构建，提供模型管理功能。
...
### [ms-agent](https://github.com/modelscope/ms-agent)

轻量级智能代理框架，支持复杂任务的自主执行、深度搜索和代码生成。
...
强大的开源在线代码执行系统，支持沙箱隔离，为AI智能体提供安全的代码运行环境。
...
基于JVM的AI智能体开发框架，支持构建可预测、容错的企业级AI Agent，兼容OpenAI、Anthropic、Ollama等多种LLM后端。
...
轻量级多智能体LLM编程框架，支持任务编排、RAG检索增强生成和函数调用。
...
ChatGPT代码解释器的开源实现，支持LangChain和LLM代理。

- **Stars:** ⭐️ 3.9k
- **Tags:** `ChatGPT` `Code Interpreter` `LangChain`
- **最后活动时间:** 2024-11-07

### [oasis](https://github.com/camel-ai/oasis)

开放智能体社会交互模拟平台，支持百万级AI智能体的大规模社会仿真实验，探索AI社会行为与交互模式。
...
Auto-GPT官方插件集合，扩展自主智能体的能力边界。

- **Stars:** ⭐️ 3.8k
- **Tags:** `auto-gpt` `plugins` `agents` `llm`
- **最后活动时间:** 2024-04-29
...
最简单懒人的多智能体应用构建框架，集成LangChain、LlamaIndex，支持微调、RAG和知识图谱等功能。
...
强大的LLM命令行工具和工作流管理器核心包。支持构建复杂的LLM工作流和自动化流程。

- **Stars:** ⭐️ 3.7k
- **Tags:** `LLM` `Workflow` `CLI`
- **最后活动时间:** 2026-03-05

### [docetl](https://github.com/ucbepic/docetl)

基于LLM智能体的数据处理与ETL系统，支持文档分析、语义数据处理和非结构化数据工作流自动化。
...
Claude Code的上下文管理框架，通过hooks实现状态持久化和智能体编排，支持隔离上下文窗口的MCP执行。

- **Stars:** ⭐️ 3.6k
- **Tags:** `Claude Code` `MCP` `Agent Orchestration`
- **最后活动时间:** 2026-01-26
...
### [chatbot](https://github.com/zhaoyingjun/chatbot)

支持本地训练的聊天机器人框架，包含SLM训练脚本和多种实际场景的Agent实现，适合构建智能对话系统。

- **Stars:** ⭐️ 3.6k
- **Tags:** `Chatbot` `Agent` `SLM` `PyTorch`
- **最后活动时间:** 2025-10-09
...
IBM开源的AI网关与代理服务，统一管理MCP、A2A及REST/gRPC接口，提供安全护栏和可观测性能力。
...
一种自然语言脚本工具，用于构建能与系统交互的AI助手。

- **Stars:** ⭐️ 3.3k
- **Tags:** `agent` `scripting` `automation`
- **最后活动时间:** 2026-02-28

### [SimpleMem](https://github.com/aiming-lab/SimpleMem)

为LLM智能体提供高效终身记忆能力的框架，支持记忆压缩、语义检索和MCP协议集成。
...
将Agent技能作为记忆层的上下文数据平台，为AI智能体提供可观测性能力和自演化学习支持。
...
面向JVM生态的AI智能体框架，支持Java、Kotlin和Spring，提供多智能体编排与协作能力。
...
开源智能体框架，用于构建和部署AI Agent应用，支持多种LLM后端。
...
动态AI智能体自动化平台，支持跨多种AI提供商进行指令管理和复杂任务编排，具备自适应记忆和插件系统。

- **Stars:** ⭐️ 3.2k
- **Tags:** `AI Agent` `LLM` `Automation` `OpenAI` `ChromaDB`
- **最后活动时间:** 2026-03-26

### [openclaw-mission-control](https://github.com/abhi1693/openclaw-mission-control)

AI智能体编排仪表板，用于管理AI智能体、分配任务并通过OpenClaw网关协调多智能体协作。
...
基于MCP协议的服务器，让AI助手能够直接读取和操作Obsidian笔记库，实现知识库与AI的无缝集成。

- **Stars:** ⭐️ 3.1k
- **Tags:** `MCP` `Obsidian` `AI Integration`
- **最后活动时间:** 2025-06-28

### [hiclaw](https://github.com/alibaba/hiclaw)

协作式多智能体操作系统，通过Matrix房间实现透明的人机协同任务编排与多Agent团队协作。
...
.NET平台上的AI多智能体框架，支持构建企业级聊天机器人和多智能体系统。
...
- **Stars:** ⭐️ 3.0k
- **Tags:** `TensorFlow` `Reinforcement Learning` `DQN`
- **最后活动时间:** 2026-01-16

### [Core](https://github.com/cheshire-cat-ai/core)

轻量级AI智能体微服务框架，支持MCP协议、函数调用和向量搜索，Docker一键部署。
...
支持计划优先开发工作流的AI智能体框架，具备审批执行机制，支持多语言和自动测试功能。

- **Stars:** ⭐️ 3.0k
- **Tags:** `AI-Agents` `Automation` `Code-Generation` `Developer-Tools`
- **最后活动时间:** 2026-03-25

### [Pearl](https://github.com/facebookresearch/Pearl)

Meta团队开源的生产级强化学习智能体库，提供完整的RL算法实现和工具链。
...
macOS MCP服务器，让AI智能体能够截图并进行视觉问答。
...
为AI智能体提供多模态生成媒体技能，支持Claude Code、Cursor等工具的图像、视频和音频生成。

- **Stars:** ⭐️ 3.0k
- **Tags:** `mcp` `multimodal-ai` `ai-agents`
- **最后活动时间:** 2026-03-16
...
无代码平台快速构建自定义LLM智能体，支持语义搜索和多种向量数据库集成。

- **Stars:** ⭐️ 2.9k
- **Tags:** `No-Code` `Agent Builder` `LLM`
- **最后活动时间:** 2024-06-17

### [mini-agi](https://github.com/muellerberndt/mini-agi)

基于OpenAI API的轻量级通用AI智能体框架，提供简洁的代理实现方案，适合快速构建和实验AI代理应用。

- **Stars:** ⭐️ 2.9k
- **Tags:** `AI Agent` `GPT-4` `OpenAI`
- **最后活动时间:** 2023-06-14
...
多基准测试排名第一的AI智能体框架，支持多种主流模型，专注于深度研究和复杂任务自动化。
...
大模型工具学习开源方案，提供ChatGPT插件开发框架与工具集成能力。

- **Stars:** ⭐️ 2.8k
- **Tags:** `llm` `tool-learning` `chatgpt-plugins` `agent-framework`
- **最后活动时间:** 2023-12-05

### [multiagent-particle-envs](https://github.com/openai/multiagent-particle-envs)

多智能体粒子环境，用于协作-竞争混合场景研究。

- **Stars:** ⭐️ 2.7k
- **Tags:** `multi-agent` `reinforcement-learning` `environment` `research`
- **最后活动时间:** 2024-04-09
...
支持持续学习与进化的AI智能体框架，结合元学习和强化学习让Agent在交互中不断获得新技能。
...
用于构建弹性语言智能体的图框架，支持TypeScript/Node.js，以图结构设计和编排AI工作流。
...
构建自进化AI代理生态系统的框架，支持多代理协作。

- **Stars:** ⭐️ 2.7k
- **Tags:** `ai` `ai-agents` `llms` `multi-agent-systems` `rag`
- **最后活动时间:** 2026-01-07
...
EMNLP 2024论文项目，用于快速构建多模态语言Agent的框架，支持原型开发与生产部署。

- **Stars:** ⭐️ 2.6k
- **Tags:** `多模态Agent` `EMNLP-2024` `RAG`
- **最后活动时间:** 2025-03-19

### [limboai](https://github.com/limbonaut/limboai)

为Godot 4引擎提供行为树和状态机AI框架，用于构建智能游戏角色和NPC行为系统。

- **Stars:** ⭐️ 2.6k
- **Tags:** `behavior-tree` `state-machines` `godot` `game-ai`
- **最后活动时间:** 2026-03-13
...
开源的自主智能体记忆层，集成知识图谱和RAG技术，支持智能体自我改进。

- **Stars:** ⭐️ 2.6k
- **Tags:** `memory-layer` `knowledge-graph` `rag` `autonomous-agents`
- **最后活动时间:** 2024-10-22
...
事件驱动的多智能体AI系统框架，支持构建复杂的多步骤工作流和AI代理编排。
...
AI编排系统核心框架，专为全栈开发设计，支持AI智能体的自动化编排与协作开发流程。
...
将AI智能体转化为可互操作、可观测、可组合的微服务，支持智能体间通信与编排。

- **Stars:** ⭐️ 2.4k
- **Tags:** `Agent Orchestration` `Microservice` `Agent Communication`
- **最后活动时间:** 2026-03-25

### [CodeMachine-CLI](https://github.com/moazbuilds/CodeMachine-CLI)

开源AI编程智能体编排工具，支持将多个AI编码代理组织成可重复、长时间运行的工作流，提升开发自动化效率。

- **Stars:** ⭐️ 2.4k
- **Tags:** `AI Agents` `Workflow Orchestration` `CLI`
- **最后活动时间:** 2026-02-25
...
OpenClaw团队版多智能体框架，支持LLM驱动的自主代理协作与编排。
...
创新的自修改框架，支持AI代理快速开发，集成FastAPI和Streamlit的全栈解决方案。

- **Stars:** ⭐️ 2.3k
- **Tags:** `Agent Framework` `Fullstack` `Self-Modifying`
- **最后活动时间:** 2024-05-01

### [rasa_core](https://github.com/RasaHQ/rasa_core)

开源对话AI框架，支持文本和语音的智能对话机器人开发。

- **Stars:** ⭐️ 2.3k
- **Tags:** `chatbot` `conversational-ai` `nlp` `dialogue-system` `rasa`
- **最后活动时间:** 2019-06-05

### [LLMStack](https://github.com/trypromptly/LLMStack)

无代码多智能体框架，支持集成自定义数据快速构建LLM智能体、工作流和应用程序。

- **Stars:** ⭐️ 2.3k
- **Tags:** `No-code` `Multi-agent` `LLM`
- **最后活动时间:** 2024-12-11
...
基于OpenClaw的智能体团队构建工具，一键创建多智能体协作系统。

- **Stars:** ⭐️ 2.3k
- **Tags:** `multi-agent` `agent-team` `automation`
- **最后活动时间:** 2026-02-26

### [OpenAGI](https://github.com/agiresearch/OpenAGI)

当大语言模型遇见领域专家，构建智能Agent应用的开源框架。

- **Stars:** ⭐️ 2.3k
- **Tags:** `llm` `agent` `agi` `framework`
- **最后活动时间:** 2024-11-28

### [lagent](https://github.com/InternLM/lagent)

轻量级LLM智能体构建框架，帮助开发者快速构建基于大语言模型的智能代理应用。
...
基于 OneBot 标准的 Python 异步机器人框架，支持多平台接入和插件扩展，适合构建智能对话机器人。

- **Stars:** ⭐️ 2.2k
- **Tags:** `bot` `python` `async` `onebot` `chatbot`
- **最后活动时间:** 2023-06-01

### [pymarl](https://github.com/oxwhirl/pymarl)

Python多智能体强化学习框架，支持多种MARL算法和研究实验。

- **Stars:** ⭐️ 2.2k
- **Tags:** `multi-agent` `reinforcement-learning` `python`
- **最后活动时间:** 2022-12-08

### [agentUniverse](https://github.com/agentuniverse-ai/agentUniverse)

LLM多智能体框架，帮助开发者轻松构建多智能体协作应用，支持灵活的智能体编排与协作模式。
...
- **Stars:** ⭐️ 2.1k
- **Tags:** `ComfyUI` `Agent框架` `MCP` `多模态`
- **最后活动时间:** 2026-03-08

### [agentic-project-management](https://github.com/sdi2200262/agentic-project-management)

面向复杂项目的多智能体工作流管理框架，支持结构化任务分配与协作，集成Cursor、Claude Code等AI助手。
...
基于Firecrawl的可视化AI智能体工作流构建器，支持拖拽式网页抓取管道。

- **Stars:** ⭐️ 2.1k
- **Tags:** `agent-builder` `visual-workflow` `web-scraping` `no-code`
- **最后活动时间:** 2025-10-20

### [AgentStack](https://github.com/agentstack-ai/AgentStack)

快速构建健壮AI代理的开发框架，简化智能体开发流程。

- **Stars:** ⭐️ 2.1k
- **Tags:** `ai-agent` `agent-framework` `developer-tools`
- **最后活动时间:** 2025-07-11

### [fit-framework](https://github.com/ModelEngine-Group/fit-framework)

企业级AI开发框架，提供多语言函数引擎FIT、流式编排引擎WaterFlow及Java生态的LangChain替代方案FEL，支持插件热插拔与智能部署。

- **Stars:** ⭐️ 2.1k
- **Tags:** `AI Framework` `Java` `Agent` `LangChain Alternative`
- **最后活动时间:** 2026-03-13

### [NeMo-Agent-Toolkit](https://github.com/NVIDIA/NeMo-Agent-Toolkit)

NVIDIA开源AI智能体工具包，高效连接和优化多智能体协作系统。
...
极简但专业的单智能体演示项目，展示智能体核心执行流程和生产级特性，适合学习 Agent 架构设计。
...
让AI智能体从经验中学习的上下文引擎，支持记忆管理与经验积累。
...
专为AI代理设计的任务管理工具，支持思维链、反思和依赖追踪，将自然语言转化为结构化开发任务。

- **Stars:** ⭐️ 2.1k
- **Tags:** `MCP` `Task Manager` `AI Agent`
- **最后活动时间:** 2025-08-21

### [claude-agents](https://github.com/iannuttall/claude-agents)

Claude Code专用自定义子代理集合，扩展Claude的自动化能力和工作流程。

- **Stars:** ⭐️ 2.0k
- **Tags:** `claude` `agents` `claude-code` `automation`
- **最后活动时间:** 2025-07-25

### [maddpg](https://github.com/openai/maddpg)

多智能体Actor-Critic算法实现，支持协作与竞争场景。

- **Stars:** ⭐️ 2.0k
- **Tags:** `multi-agent` `maddpg` `reinforcement-learning` `deep-learning`
- **最后活动时间:** 2024-04-01
...
基于Spring Boot 3 + Spring AI构建的AI智能体应用，涵盖RAG、MCP、Tool Calling等核心技术实践。

- **Stars:** ⭐️ 1.9k
- **Tags:** `Spring AI` `AI Agent` `RAG` `MCP`
- **最后活动时间:** 2026-01-07
...
开源无代码AI智能体构建平台，可视化创建和部署智能体应用。

- **Stars:** ⭐️ 1.9k
- **Tags:** `no-code` `agent-platform` `visual-builder`
- **最后活动时间:** 2026-02-25
...
实现Claude Code与Codex的无缝协作，将单代理转换为多代理系统，显著提升开发效率。

- **Stars:** ⭐️ 1.8k
- **Tags:** `codex` `mcp` `multi-agent` `claude-code`
- **最后活动时间:** 2026-01-13
...
将大语言模型改造为具备永久记忆、工具调用和多智能体协作能力的完整系统。
...
大规模多智能体强化学习平台，支持复杂环境下的智能体训练与研究。

- **Stars:** ⭐️ 1.8k
- **Tags:** `deep-learning` `multi-agent` `reinforcement-learning`
- **最后活动时间:** 2022-10-22

### [evolver](https://github.com/EvoMap/evolver)

基于基因组进化协议的AI智能体自我进化引擎，支持智能体持续优化。
...
### [agent-skills](https://github.com/apify/agent-skills)

Apify智能体技能集合，为AI代理提供丰富的预构建能力模块。
...
基于veRL扩展的LLM/VLM智能体强化学习训练框架，支持Group-in-Group策略优化，适用于智能体训练场景。

- **Stars:** ⭐️ 1.7k
- **Tags:** `LLM Agents` `Reinforcement Learning` `Agent Training` `veRL`
- **最后活动时间:** 2026-02-27

### [claude-code-plugins-plus-skills](https://github.com/jeremylongshore/claude-code-plugins-plus-skills)

Claude Code插件市场，包含340+插件和1367+智能体技能，支持MCP协议。

- **Stars:** ⭐️ 1.7k
- **Tags:** `claude` `plugins` `agent-skills`
- **最后活动时间:** 2026-03-26
...
提供交互式用户反馈功能的MCP服务器，增强AI代理的人机交互能力。

- **Stars:** ⭐️ 1.7k
- **Tags:** `mcp` `feedback` `human-in-the-loop` `agents`
- **最后活动时间:** 2025-05-26

### [swarm](https://github.com/parruda/swarm)

基于Ruby的AI智能体系统框架，支持单进程编排、语义搜索持久记忆和节点工作流。包含SwarmMemory和SwarmCLI工具。

- **Stars:** ⭐️ 1.7k
- **Tags:** `Ruby` `Agent Framework` `Workflow`
- **最后活动时间:** 2026-02-17
...
为AI智能体提供安全沙箱环境，支持嵌入式部署、状态持久化和硬件隔离，确保智能体执行的安全性与可控性。
...
基于.NET Razor和Spectre.Console构建智能体TUI应用的框架，支持开发交互式终端AI代理应用。
...
开源的React.js自主LLM智能体框架，支持无头模式灵活集成，轻松构建基于GPT-4的自主代理应用。

- **Stars:** ⭐️ 1.7k
- **Tags:** `React` `Agent Framework` `GPT-4`
- **最后活动时间:** 2024-04-12

### [coding-agent-template](https://github.com/vercel-labs/coding-agent-template)

基于Vercel Sandbox和AI Gateway的多智能体AI编程平台模板。支持构建分布式代码生成与执行环境。

- **Stars:** ⭐️ 1.6k
- **Tags:** `ai-agent` `coding` `multi-agent` `vercel` `sandbox`
- **最后活动时间:** 2026-02-12

### [AgentFlow](https://github.com/lupantech/AgentFlow)

智能体系统优化框架，专注于LLM驱动的多智能体系统流程优化与工具增强。

- **Stars:** ⭐️ 1.6k
- **Tags:** `agentic-ai` `multi-agent-systems` `llms` `optimization`
- **最后活动时间:** 2026-02-08
...
### [code-act](https://github.com/xingyaoww/code-act)

ICML 2024论文实现，通过可执行代码动作提升LLM智能体表现。

- **Stars:** ⭐️ 1.6k
- **Tags:** `llm-agent` `llm-framework` `code-generation`
- **最后活动时间:** 2024-05-23
...
Agent Client Protocol的无头CLI客户端，用于管理有状态的AI智能体会话连接。
...
为AI代理提供n8n工作流自动化平台的MCP接口，实现智能工作流编排。

- **Stars:** ⭐️ 1.6k
- **Tags:** `mcp` `n8n` `workflow` `automation`
- **最后活动时间:** 2025-07-09
...
JSON驱动的多智能体协作框架，支持Claude、Gemini、Qwen等多种LLM的CLI编排与工作流自动化。
...
快速轻量级的去中心化智能体开发框架，支持轻松构建多智能体系统。
...
面向企业工作流自动化的 Agentic AI 框架，支持代码审查和 DevOps 场景。
...
GenAI应用开发框架，支持结构化数据交互、事件驱动流程和多模型无缝切换。
...
ICLR 2025论文项目，实现智能体系统的自动化设计。

- **Stars:** ⭐️ 1.5k
- **Tags:** `agents` `automated-design` `agentic-systems` `research`
- **最后活动时间:** 2025-01-28
...
100%本地化、开源的自主认知智能体框架，支持完全离线运行的自主代理系统。

- **Stars:** ⭐️ 1.5k
- **Tags:** `Local AI` `Autonomous Agents` `Privacy-First`
- **最后活动时间:** 2024-03-17

### [lemmy](https://github.com/badlogic/lemmy)

基于LLM的工具封装框架，支持构建智能体工作流和自动化任务编排。

- **Stars:** ⭐️ 1.5k
- **Tags:** `llm` `agents` `workflow` `automation`
- **最后活动时间:** 2025-08-13

### [NagaAgent](https://github.com/RTGS2017/NagaAgent)

简洁强大的个人助理智能体框架，支持智能交互、多智能体协作和无缝工具集成。

- **Stars:** ⭐️ 1.5k
- **Tags:** `agents` `mcp` `mcp-client` `multi-agent`
- **最后活动时间:** 2026-03-21

### [awesome_ai_agents](https://github.com/jim-schwoebel/awesome_ai_agents)

收录1500+个AI智能体相关资源和工具的精选列表，涵盖智能体框架、多智能体系统和工作流。
...
革命性AI智能体编排工具，动态生成定制化AI代理团队，支持Autogen和CrewAI框架。

- **Stars:** ⭐️ 1.5k
- **Tags:** `Agent Orchestration` `Groq` `Multi-Agent`
- **最后活动时间:** 2024-12-23

### [mcp](https://github.com/MicrosoftDocs/mcp)

微软官方MCP服务器，为LLM和AI智能体提供实时可信的Microsoft文档与代码示例，支持权威文档检索能力。
...
强大的MCP协议Slack服务器，让AI助手无缝连接Slack，支持DM、群聊和历史消息智能获取。
...
IJCAI 2024论文实现，自动生成GPT角色并协作完成复杂任务的多智能体框架。

- **Stars:** ⭐️ 1.5k
- **Tags:** `multi-agent` `gpt` `autonomous-agents`
- **最后活动时间:** 2025-09-09
...
为AI代理提供网页质量优化技能，基于Lighthouse和Core Web Vitals进行性能测试与可访问性检测。

- **Stars:** ⭐️ 1.5k
- **Tags:** `agent-skills` `web-performance` `lighthouse`
- **最后活动时间:** 2026-03-13

### [loopgpt](https://github.com/farizrahman4u/loopgpt)

模块化Auto-GPT框架，支持灵活组合和扩展。为构建自主AI智能体提供可定制的架构基础。
...
开源智能体工具平台社区版，提供API集成和智能体工具链支持。

- **Stars:** ⭐️ 1.5k
- **Tags:** `agentic-ai` `api` `integrations`
- **最后活动时间:** 2026-02-20

### [agent-protocol](https://github.com/agi-inc/agent-protocol)

AI 智能体交互通用协议，技术栈无关的标准化接口。

- **Stars:** ⭐️ 1.5k
- **Tags:** `agents` `ai` `protocol` `api` `llms`
- **最后活动时间:** 2025-04-08

### [langgraph-swarm-py](https://github.com/langchain-ai/langgraph-swarm-py)

基于LangGraph的多智能体框架，满足复杂多代理系统需求。
...
可扩展工具的智能体框架，专为复杂推理任务设计，支持工具增强的大语言模型应用。
...
一款桌面应用，支持隔离、并行的智能体开发环境，为AI Agent开发提供高效的工作空间管理。
...
开源 AI 助手框架，支持技能系统和智能体架构设计，可扩展的自动化助手开发平台。
...
n8n工作流与AI智能体模板集合，包含丰富的自动化示例。

- **Stars:** ⭐️ 1.4k
- **Tags:** `n8n` `AI Agents` `Automation` `Templates`
- **最后活动时间:** 2026-03-02

### [Adala](https://github.com/HumanSignal/Adala)

一个自主数据标注智能体框架，利用AI代理自动化数据标注流程，支持GPT-4等大语言模型。
...
为AI智能体循环设计的数据原语，提供持久化、实时会话数据流传输能力，支持可靠的智能体状态管理。
...
即插即用库，让AI智能体通过代码执行调用MCP和UTCP工具。

- **Stars:** ⭐️ 1.4k
- **Tags:** `ai-agents` `mcp` `model-context-protocol` `toolchain`
- **最后活动时间:** 2026-02-08

### [sequential-workflow-designer](https://github.com/nocode-js/sequential-workflow-designer)

可定制化的无代码工作流设计器组件，用于构建AI智能体流程自动化应用，零外部依赖。
...
CrewAI代理能力扩展工具集，增强AI代理的功能和执行能力。

- **Stars:** ⭐️ 1.4k
- **Tags:** `crewai` `ai-agents` `tools` `framework`
- **最后活动时间:** 2025-10-23

### [KaibanJS](https://github.com/kaiban-ai/KaibanJS)

JavaScript原生多智能体框架，采用看板式管理方法。让开发者能够轻松构建和协调多个AI代理协作完成任务。

- **Stars:** ⭐️ 1.4k
- **Tags:** `multi-agent-systems` `javascript` `agentic-framework` `kanban`
- **最后活动时间:** 2026-03-20

### [ControlFlow](https://github.com/prefect-archive/ControlFlow)

AI代理控制框架，让开发者精确掌控代理行为。基于Prefect构建，提供强大的工作流编排能力。

- **Stars:** ⭐️ 1.4k
- **Tags:** `agentic-framework` `workflow` `prefect` `llm`
- **最后活动时间:** 2025-08-22

### [hugging-multi-agent](https://github.com/datawhalechina/hugging-multi-agent)

基于MetaGPT的多智能体入门与开发教程，帮助快速理解Agent和多智能体概念并开始编码实践。

- **Stars:** ⭐️ 1.4k
- **Tags:** `multi-agent` `metagpt` `agent` `tutorial` `llm`
- **最后活动时间:** 2024-05-10
...
用于构建下一代视频交互和工作流的AI视频智能体框架。

- **Stars:** ⭐️ 1.3k
- **Tags:** `ai-agents` `video-editing` `framework`
- **最后活动时间:** 2026-01-23
...
快速配置多智能体AI开发环境的工具包，包含编码智能体、会话管理和协调基础设施。
...
简洁的代理开发工具包(ADK)。支持MCP协议，让开发者快速构建和部署AI代理应用。

- **Stars:** ⭐️ 1.3k
- **Tags:** `agent-development-kit` `mcp-client` `adk` `llm`
- **最后活动时间:** 2025-08-23
...
通过简单的钩子事件跟踪实现Claude Code代理的实时监控。

- **Stars:** ⭐️ 1.3k
- **Tags:** `observability` `multi-agent` `claude-code` `monitoring`
- **最后活动时间:** 2026-02-08

### [agentic-commerce-protocol](https://github.com/agentic-commerce-protocol/agentic-commerce-protocol)

由OpenAI和Stripe维护的智能体商务协议，连接买家、AI智能体与商家的开放标准。
...
一站式多智能体强化学习库，集成多种MARL算法，支持PyTorch和Ray。

- **Stars:** ⭐️ 1.3k
- **Tags:** `multi-agent` `reinforcement-learning` `pytorch` `rllib`
- **最后活动时间:** 2024-11-28
...
### [minions](https://github.com/HazyResearch/minions)

大小语言模型协作框架，实现不同规模LLM协同工作以优化性能与成本。

- **Stars:** ⭐️ 1.3k
- **Tags:** `llm` `collaboration` `multi-model` `orchestration`
- **最后活动时间:** 2026-03-12

### [codefuse-chatbot](https://github.com/codefuse-ai/codefuse-chatbot)

服务于软件开发生命周期的智能助手，基于多智能体框架，集成DevOps工具和代码仓库RAG。

- **Stars:** ⭐️ 1.3k
- **Tags:** `multi-agent` `devops` `rag` `knowledge-graph`
- **最后活动时间:** 2024-07-01

### [chatgpt-tool-hub](https://github.com/goldfishh/chatgpt-tool-hub)

开源ChatGPT工具生态系统，支持将多种工具与ChatGPT结合，用自然语言完成各种任务。

- **Stars:** ⭐️ 1.3k
- **Tags:** `chatgpt` `tools` `agent` `automation`
- **最后活动时间:** 2024-01-17
...
综合性 Python AI 开发库，支持 NLP、多模态 LLM、智能体、知识图谱等研究与开发，集成 MCP 协议。
...
Google开源的AI智能体开发工具包，采用代码优先方式构建、评估和部署复杂AI智能体。
...
使用在线强化学习微调LLM智能体的框架，实现LLM与RL的结合。

- **Stars:** ⭐️ 1.2k
- **Tags:** `llm` `reinforcement-learning` `agent` `fine-tuning`
- **最后活动时间:** 2024-03-19

### [AgentNetworkProtocol](https://github.com/agent-network-protocol/AgentNetworkProtocol)

开源的智能体通信协议，定义智能体之间的连接方式，构建开放安全的协作网络。
...
为Openclaw提供强大预构建Agent工作流的增强工具，帮助快速部署智能自动化流程。
...
用于构建MCP智能体的开发框架，简化AI智能体的创建和部署流程。

- **Stars:** ⭐️ 1.2k
- **Tags:** `mcp` `ai-agents` `agent-framework`
- **最后活动时间:** 2026-03-24
...
基于 Cloudflare 的 AI 智能体开发入门套件，帮助开发者快速构建和部署 AI Agent 应用。
...
Azure MCP服务器，将Azure云服务能力集成到AI代理中，实现云端AI能力调用。

- **Stars:** ⭐️ 1.2k
- **Tags:** `mcp` `azure` `ai-agent` `cloud`
- **最后活动时间:** 2026-02-06
...
将Claude Code封装为MCP服务器，实现代理嵌套代理的创新架构。
...
创新的角色扮演式LLM代理框架，支持多代理协作解决复杂任务。

- **Stars:** ⭐️ 1.2k
- **Tags:** `camel` `agent-framework` `autogpt` `langchain`
- **最后活动时间:** 2026-02-05

### [sandbox-agent](https://github.com/rivet-dev/sandbox-agent)

沙箱环境中安全运行AI编程智能体的工具，支持HTTP控制，兼容主流代理框架。
...
TypeScript AI 平台，支持自主智能体、软件开发智能体和聊天机器人。

- **Stars:** ⭐️ 1.2k
- **Tags:** `ai-agents` `agents` `typescript` `llm` `ai-software-engineer`
- **最后活动时间:** 2025-12-22
...
Chameleon论文代码实现，支持即插即用的组合式推理与工具调用。

- **Stars:** ⭐️ 1.1k
- **Tags:** `compositional-reasoning` `tool-use` `llm` `gpt-4`
- **最后活动时间:** 2023-12-23
...
AI后端框架，支持将AI代理作为微服务构建和运行，具备可扩展性、可观测性和身份认证能力。
...
面向AI编程智能体的多智能体编排框架，支持Claude Code、Pi等多种运行时适配器的灵活插件化架构。
...
武士主题的多智能体编排系统，通过tmux实现Claude Code并行任务调度，采用层级架构设计。
...
半结构化智能体框架，工作流随智能体发现动态构建，而非预先定义。

- **Stars:** ⭐️ 1.1k
- **Tags:** `ai-agents` `autonomous-agents` `llm` `claude-code`
- **最后活动时间:** 2025-12-01
...
### [make-it-heavy](https://github.com/Doriandarko/make-it-heavy)

模拟Grok Heavy功能的Python多智能体编排框架，支持并行部署多个专业AI代理进行综合分析。

- **Stars:** ⭐️ 1.1k
- **Tags:** `multi-agent` `agent-orchestration` `parallel-agents`
- **最后活动时间:** 2025-07-16
...
协作式AI电子表格平台，支持将单元格链接为强大的流水线，实时实验和评估LLM响应，帮助团队高效构建AI应用。

- **Stars:** ⭐️ 1.1k
- **Tags:** `AI Spreadsheet` `LLM Ops` `RAG` `Agent Pipeline`
- **最后活动时间:** 2026-03-25

### [flock](https://github.com/Onelevenvy/flock)

基于工作流的低代码平台，快速构建聊天机器人、RAG 和多智能体协作应用。
...
多智能体系统框架，支持多Agent协作与工作流编排，适用于处理复杂任务场景。
...
### [tribe](https://github.com/StreetLamb/tribe)

低代码多智能体团队构建工具，支持LangChain和LangGraph框架，简化智能体编排流程。

- **Stars:** ⭐️ 1.1k
- **Tags:** `Multi-agent` `Low-code` `LangChain`
- **最后活动时间:** 2025-10-27

### [workflow-builder-template](https://github.com/vercel-labs/workflow-builder-template)

可视化AI工作流自动化平台，支持智能体和工作流编排。
...
Gmail MCP 服务器，支持自动认证，让 AI 助手通过自然语言管理 Gmail。

- **Stars:** ⭐️ 1.1k
- **Tags:** `mcp` `mcp-server` `gmail` `claude` `ai-assistant`
- **最后活动时间:** 2025-08-06

### [BubbleLab](https://github.com/bubblelabai/BubbleLab)

开源工作流引擎，支持AI智能体编排与自动化，可独立运行、托管和扩展。
...
基于OpenAI Assistants API的多智能体系统构建框架，支持工具链接与扩展记忆。

- **Stars:** ⭐️ 1.1k
- **Tags:** `OpenAI Assistants` `Multi-Agent` `SDK`
- **最后活动时间:** 2024-09-09

### [botframework-solutions](https://github.com/microsoft/botframework-solutions)

微软 Bot Framework 企业级对话 AI 解决方案，用于构建高级对话体验。

- **Stars:** ⭐️ 1.1k
- **Tags:** `bot-framework` `conversational-ai` `azure` `enterprise`
- **最后活动时间:** 2022-06-29
...
一个轻量级AI运行时沙箱，支持用自然语言描述并自动执行工作流，简化AI代理的开发与部署流程。
...
Schema-Guided Reasoning智能体框架，提供结构化输出和函数调用的代理系统设计能力。

- **Stars:** ⭐️ 1.1k
- **Tags:** `Agent` `Schema-Guided` `Function Calling` `LLM`
- **最后活动时间:** 2026-03-18
...
构建由LLM控制的智能体框架，探索自主代理的核心能力。

- **Stars:** ⭐️ 1.0k
- **Tags:** `llm` `agents` `langchain` `deep-learning`
- **最后活动时间:** 2025-06-23
...
基于Cloudflare Workers的实时协作平台，支持构建多智能体系统和AI驱动的实时应用。
...
远程MCP服务器资源合集，为AI模型提供标准化的上下文协议和工具调用能力。
...
开源生成式UI框架，专为AI代理和Copilot应用设计，支持动态可视化界面生成。
...
首个自改进代理解决方案。结合群体智能和多代理协作，实现AI系统的持续自我优化。

- **Stars:** ⭐️ 1.0k
- **Tags:** `self-improvement` `swarm-intelligence` `multi-agent` `gpt`
- **最后活动时间:** 2026-02-05
...
AI智能体舰队指挥中心，统一编排Claude Code、Codex CLI、Gemini CLI、Aider等多种AI代理的集中管理平台。
...
AI智能体设计模式合集，涵盖智能体架构与编排的最佳实践。

- **Stars:** ⭐️ 1.0k
- **Tags:** `agents` `design-patterns` `ai-agents`
- **最后活动时间:** 2025-09-05

### [agentica](https://github.com/wrtnlabs/agentica)

TypeScript AI函数调用框架，利用编译器技术增强LLM函数调用能力。
...
AutoGen多智能体框架的Web可视化界面。提供直观的交互方式来构建和管理多代理LLM应用。

- **Stars:** ⭐️ 993
- **Tags:** `autogen` `ai-agents` `visualization` `multi-agent`
- **最后活动时间:** 2024-11-14
...
实现Google Agent-to-Agent (A2A)协议的Python库，支持AI智能体之间的无缝通信与协作，构建可互操作的智能体生态系统。

- **Stars:** ⭐️ 984
- **Tags:** `a2a` `agent-protocol` `ai-agents` `multi-agent` `python`
- **最后活动时间:** 2025-09-06
...
- **Stars:** ⭐️ 981
- **Tags:** `mcp` `ai-agent` `cloudbase` `serverless` `cursor`
- **最后活动时间:** 2026-03-26

### [CityFlow](https://github.com/cityflow-project/CityFlow)

面向大规模城市交通场景的多智能体强化学习仿真环境，支持交通信号控制研究。

- **Stars:** ⭐️ 980
- **Tags:** `multi-agent` `reinforcement-learning` `traffic-simulation` `environment`
- **最后活动时间:** 2025-08-19

### [plato-research-dialogue-system](https://github.com/uber-archive/plato-research-dialogue-system)

Plato研究对话系统，一个灵活的对话AI智能体开发平台，支持构建多轮对话应用。

- **Stars:** ⭐️ 979
- **Tags:** `conversational-ai` `dialogue-system` `nlp` `deep-learning`
- **最后活动时间:** 2020-09-15
...
连接Ollama与MCP服务器的桥梁，使本地LLM能够使用Model Context Protocol工具。

- **Stars:** ⭐️ 971
- **Tags:** `ollama` `mcp` `local-llm` `agent-tools`
- **最后活动时间:** 2025-04-20

### [acp](https://github.com/i-am-bee/acp)

AI智能体、应用程序与人类之间通信的开放协议标准。

- **Stars:** ⭐️ 969
- **Tags:** `agent-protocol` `communication` `interoperability` `ai-agent`
- **最后活动时间:** 2025-08-25
...
创建可执行文档来展示智能体工作成果，便于演示和分享 AI 智能体的执行过程。

- **Stars:** ⭐️ 960
- **Tags:** `agent` `documentation` `visualization`
- **最后活动时间:** 2026-03-14
...
为人在回路(Human-in-the-loop)AI Agent设计的收件箱交互界面，优化人机协作体验。

- **Stars:** ⭐️ 957
- **Tags:** `human-in-the-loop` `agent-ux` `interaction`
- **最后活动时间:** 2026-03-25

### [tersa](https://github.com/vercel-labs/tersa)

开源的AI工作流构建画布工具，支持可视化创建和编排AI工作流程，集成Anthropic和OpenAI等主流AI服务。
...
易于使用的基础设施，帮助研究人员测试和评估AI代理的各种能力。

- **Stars:** ⭐️ 939
- **Tags:** `agent-simulation` `llm-agents` `evaluation` `research-infrastructure`
- **最后活动时间:** 2023-11-18

### [takopi](https://github.com/banteg/takopi)

AI 代理桥接工具，支持 Claude、Codex 等通过 Telegram 进行交互。
...
基于Groq的混合智能体架构实现，高效协调多个AI模型协作。

- **Stars:** ⭐️ 937
- **Tags:** `mixture-of-agents` `groq` `multi-agent`
- **最后活动时间:** 2024-08-09

### [Agentarium](https://github.com/Thytu/Agentarium)

开源AI智能体仿真框架，用于创建和管理复杂的交互式环境，支持智能体的行为、学习和进化。
...
- **Stars:** ⭐️ 927
- **Tags:** `llm` `reinforcement-learning` `agent` `tool-use`
- **最后活动时间:** 2026-03-02

### [maestro](https://github.com/its-maestro-baby/maestro)

专为CLI智能体设计的终端控制台工具，类似Bloomberg终端的AI代理操作界面。

- **Stars:** ⭐️ 921
- **Tags:** `cli` `agents` `terminal` `automation`
- **最后活动时间:** 2026-03-19

### [mcp-framework](https://github.com/QuantGeekDev/mcp-framework)

TypeScript框架，用于快速构建MCP（模型上下文协议）服务器，简化AI智能体集成。
...
### [pgmcp](https://github.com/andyzeng/3dmatch-toolbox)

PostgreSQL自然语言查询MCP服务器，让AI代理能够用自然语言与数据库交互。

- **Stars:** ⭐️ 897
- **Tags:** `mcp` `postgres` `natural-language` `agent`
- **最后活动时间:** 2025-10-14
...
开源多智能体扩展系统，在终端中自主编排前沿模型进行协作推理，支持工具调用和测试时扩展。
...
MCP服务器实现，为AI助手提供远程记忆库管理能力，支持跨会话的状态持久化。

- **Stars:** ⭐️ 880
- **Tags:** `Memory Bank` `MCP` `Context Management`
- **最后活动时间:** 2025-08-20
...
一个让AI智能体更智能、低成本、自我进化的开源平台，支持社区协作与共享。
...
本地优先的AI代理办公模拟器，编排Claude Code、Codex CLI、Gemini CLI等多个AI代理作为虚拟自主公司运行。

- **Stars:** ⭐️ 865
- **Tags:** `AI-Agents` `Agent-Orchestration` `CLI` `Automation`
- **最后活动时间:** 2026-03-16
...
开源平台，用于快速开发和稳健部署定制化的生成式AI应用程序。

- **Stars:** ⭐️ 847
- **Tags:** `Agent框架` `生成式AI` `企业级`
- **最后活动时间:** 2025-01-16
...
### [Magick](https://github.com/Oneirocom/Magick)

一个创新的AI构建工具包，支持可视化脚本和无代码开发。集成多种LLM和向量数据库，让AI开发更简单高效。

- **Stars:** ⭐️ 836
- **Tags:** `Agent` `No-Code` `Visual-Scripting` `LangChain`
- **最后活动时间:** 2025-06-24

### [Autogen_GraphRAG_Ollama](https://github.com/karthik-codex/Autogen_GraphRAG_Ollama)

整合GraphRAG、AutoGen和Ollama的本地多智能体RAG超级机器人，完全免费离线运行。

- **Stars:** ⭐️ 836
- **Tags:** `multi-agent` `graphrag` `autogen` `ollama` `local-llm`
- **最后活动时间:** 2024-07-20
...
基于Git的对话式AI Agent记忆存储系统，支持版本控制和记忆管理。
...
生产级MCP服务器框架，用于构建、部署和扩展安全的AI Agent基础设施。内置认证、可观测性、调试器和遥测功能。

- **Stars:** ⭐️ 818
- **Tags:** `MCP` `AI Agent` `Framework` `Observability`
- **最后活动时间:** 2026-01-31
...
模型无关的即插即用智能体框架，通过MCP工具驱动，支持LangChain/LangGraph构建自主AI智能体。
...
开源协作式AI智能体框架，支持分布式异构Agent协同完成复杂任务。

- **Stars:** ⭐️ 811
- **Tags:** `agents` `collaborative-ai` `llm` `genai`
- **最后活动时间:** 2025-10-04

### [WilmerAI](https://github.com/SomeOddCodeGuy/WilmerAI)

一款老牌LLM语义路由器，支持多层提示词路由和复杂工作流，可扩展任何连接LLM的应用程序。

- **Stars:** ⭐️ 807
- **Tags:** `llm` `semantic-router` `prompt-routing` `ai-workflow`
- **最后活动时间:** 2026-02-09
...
微软M365 Agent SDK，简化构建全栈多渠道AI智能体，支持Teams、Copilot Studio等平台。
...
Auto-GPT 插件开发模板，为开发者提供快速构建自定义插件的起点。

- **Stars:** ⭐️ 789
- **Tags:** `auto-gpt` `plugin` `agent` `framework`
- **最后活动时间:** 2024-07-16
...
### [platform-war-public](https://github.com/LYiHub/platform-war-public)

一个基于GraphRAG的聊天机器人框架，能够从社交平台用户评论中创建多LLM智能体，并让它们就特定话题进行辩论。

- **Stars:** ⭐️ 787
- **Tags:** `graphrag` `llm-agents` `chatbot` `multi-agent` `debate-system`
- **最后活动时间:** 2024-12-14
...
多智能体自主系统框架，支持代码审查、CI/CD集成，兼容多种AI模型提供商。
...
基于JAX的多智能体强化学习库，支持高性能GPU加速训练。

- **Stars:** ⭐️ 777
- **Tags:** `marl` `multiagent-reinforcement-learning` `jax`
- **最后活动时间:** 2026-01-14

### [CodeFuse-muAgent](https://github.com/codefuse-ai/CodeFuse-muAgent)

由知识图谱引擎驱动的创新智能体框架，支持多智能体协作和记忆管理。

- **Stars:** ⭐️ 776
- **Tags:** `multi-agent` `knowledge-graph` `memory-management` `tool-learning`
- **最后活动时间:** 2025-01-15

### [AgentCPM](https://github.com/OpenBMB/AgentCPM)

端到端基础设施，用于训练和评估各类LLM智能体。

- **Stars:** ⭐️ 775
- **Tags:** `LLM Agents` `Training` `Evaluation`
- **最后活动时间:** 2026-02-09
...
微软官方Python机器人框架，支持构建跨平台智能对话机器人，可对接Slack、Skype等多种消息平台。

- **Stars:** ⭐️ 768
- **Tags:** `bot-framework` `chatbot` `python` `microsoft`
- **最后活动时间:** 2026-01-05
...
轻量级AI智能体框架，具备记忆、工具和思维树能力，支持多智能体协作和主流大模型。
...
开放式大脑基础设施层，提供统一数据库、AI网关和聊天通道，支持任意AI模型接入，无中间件无SaaS依赖。
...
AI Agent行为缓存系统，支持学习和回放复杂行为模式，提升Agent执行效率。

- **Stars:** ⭐️ 759
- **Tags:** `agent-cache` `behavior-learning` `ai-memory` `agent-framework`
- **最后活动时间:** 2025-06-15

### [mcp-marketplace](https://github.com/cline/mcp-marketplace)

Cline官方MCP服务器市场，开发者可提交MCP服务器供数百万用户发现和安装，是构建AI Agent工具链的重要资源平台。

- **Stars:** ⭐️ 759
- **Tags:** `mcp` `marketplace` `ai-agents` `cline`
- **最后活动时间:** 2025-06-24
...
- **Stars:** ⭐️ 754
- **Tags:** `multi-agent` `cognitive-architecture` `agent-teams`
- **最后活动时间:** 2025-07-19
...
私有智能体集群框架，每个Agent拥有独立桌面环境，支持Claude、Gemini等主流模型的自托管K8s部署。
...
一个用于构建、扩展和实验科学智能体的平台，支持科学研究自动化和智能实验。

- **Stars:** ⭐️ 747
- **Tags:** `agent` `scientific-research` `platform`
- **最后活动时间:** 2026-03-04
...
### [production-grade-agentic-system](https://github.com/FareedKhan-dev/production-grade-agentic-system)

生产级智能体系统七大核心层级架构指南，构建企业级AI应用。

- **Stars:** ⭐️ 745
- **Tags:** `agents` `langchain` `langgraph` `production` `architecture`
- **最后活动时间:** 2025-12-18

### [open-agent](https://github.com/AFK-surf/open-agent)

开源的AI智能体框架，作为Claude Agent SDK和ChatGPT Agents的替代方案。

- **Stars:** ⭐️ 744
- **Tags:** `agents` `agentic-ai` `multiagent-systems` `framework`
- **最后活动时间:** 2025-10-10
...
### [blades](https://github.com/go-kratos/blades)
...
开源AI原生低代码自动化平台，支持API编排、工作流自动化和AI智能体集成。
...
GPT代理框架，专注于API调用和自动化工作流程编排。

- **Stars:** ⭐️ 734
- **Tags:** `gpt-agent` `api-automation` `framework` `workflow`
- **最后活动时间:** 2023-06-23
...
使用纯Bash/JavaScript/Python函数轻松创建LLM工具和代理。

- **Stars:** ⭐️ 726
- **Tags:** `ai` `ai-agents` `llm` `function-calling` `mcp`
- **最后活动时间:** 2025-06-25

### [aegra](https://github.com/ibbybuilds/aegra)

开源 LangGraph Platform 替代方案，基于 FastAPI 和 PostgreSQL 构建自托管 AI 智能体后端。零供应商锁定，完全掌控你的智能体基础设施。
...
微信ClawBot连接器，支持与各类AI智能体进行集成和交互的SDK工具。
...
AI代理驱动的自动视图组件渲染器，支持Claude、Llama等LLM，可自动生成前端UI组件。

- **Stars:** ⭐️ 704
- **Tags:** `AI Agent` `Frontend` `LLM` `TypeScript`
- **最后活动时间:** 2025-05-30

### [secure-exec](https://github.com/rivet-dev/secure-exec)

轻量级安全代码执行沙箱，专为AI Agent设计，无需容器即可安全执行LLM生成的代码。
...
企业级LLMOps平台，支持多模型Agent开发（OpenAI/DeepSeek/文心/通义），集成知识库管理、工作流自动化，支持一键Docker部署。
...
基于MCP的开源代码执行实现，支持程序化工具调用。

- **Stars:** ⭐️ 695
- **Tags:** `mcp` `agent` `langchain` `code-execution`
- **最后活动时间:** 2026-01-21

### [memorizz](https://github.com/RichmondAlake/memorizz)

AI应用记忆层Python库，利用主流数据库优化Agent记忆管理与语义检索。
...
基于LangGraph的ReAct智能体，集成MCP协议，提供Streamlit界面动态配置和部署AI代理。

- **Stars:** ⭐️ 691
- **Tags:** `langgraph` `mcp` `agents` `react` `streamlit`
- **最后活动时间:** 2025-04-14

### [mindmeld](https://github.com/cisco/mindmeld)

开源对话式AI平台，专为深度领域语音接口和聊天机器人设计。
...
基于AI的聊天流程框架，支持个性化ChatGPT工作流构建与自动化编排。

- **Stars:** ⭐️ 688
- **Tags:** `ChatGPT` `Workflow` `Automation`
- **最后活动时间:** 2023-03-29
...
AI记忆层实现，支持短期/长期存储、语义聚类和记忆衰减机制。

- **Stars:** ⭐️ 684
- **Tags:** `Memory` `Context-Aware` `Semantic`
- **最后活动时间:** 2026-03-18
...
类似GPT Builder的GUI平台，支持RAG管道、对话应用和多代理流程自动化。

- **Stars:** ⭐️ 678
- **Tags:** `ai` `autogen` `crewai` `rag` `llm` `docker`
- **最后活动时间:** 2025-07-21
...
本地托管Web搜索MCP服务器，让本地大语言模型具备网络搜索能力，支持LM Studio等工具。

- **Stars:** ⭐️ 669
- **Tags:** `MCP` `Web搜索` `本地LLM`
- **最后活动时间:** 2025-08-08

### [autocontext](https://github.com/greyhaven-ai/autocontext)

递归自改进的智能体框架，帮助智能体在任何任务上取得成功。
...
阿里巴巴国际AI业务推出的智能体应用开发框架，基于Google-ADK和Ali-LangEngine构建。
...
基于Mem0的MCP服务器，为AI代理提供长期记忆能力，同时可作为Python MCP开发模板。

- **Stars:** ⭐️ 663
- **Tags:** `mcp` `mem0` `memory` `agents` `python`
- **最后活动时间:** 2025-04-13
...
统一管理 AI Agent 的钩子、命令、技能和配置文件的框架工具。

- **Stars:** ⭐️ 655
- **Tags:** `agents` `claude` `framework` `automation`
- **最后活动时间:** 2026-02-04
...
声明式AI工作流语言，用于构建可组合的AI流程。面向开发者和普通用户的Agent编排工具。
...
通过MCP协议用自然语言控制Unreal Engine 5.5+，AI驱动的3D世界构建工具，可创建城镇、城堡、迷宫等复杂场景。
...
飞书AI智能体插件集成方案，提供OpenClaw与飞书平台的无缝对接配置指南，支持Webhook和WebSocket连接。

- **Stars:** ⭐️ 636
- **Tags:** `Feishu` `AI Agent` `Chatbot` `Lark`
- **最后活动时间:** 2026-03-09

### [Pocket-Flow-Framework](https://github.com/Osly-AI/Pocket-Flow-Framework)

让大语言模型实现自我编程的框架，支持LLM自主生成和执行代码。

- **Stars:** ⭐️ 634
- **Tags:** `llm` `self-programming` `agent-framework` `code-generation`
- **最后活动时间:** 2026-03-06
...
开源工具包，用于大规模构建和部署Claude Skills、代码代理和自定义斜杠命令，提升AI开发效率。

- **Stars:** ⭐️ 631
- **Tags:** `Claude Code` `Skill Templates` `AI Agents` `Workflow`
- **最后活动时间:** 2025-11-12
...
基于OpenAI Gym的多智能体环境集合，支持协作式强化学习研究。

- **Stars:** ⭐️ 629
- **Tags:** `multi-agent` `reinforcement-learning` `openai-gym` `environment`
- **最后活动时间:** 2024-07-07
...
专为 Claude Code 设计的 QA 代理集合，提供实用的质量保证自动化能力。

- **Stars:** ⭐️ 625
- **Tags:** `claude-code` `qa-agents` `automation` `testing`
- **最后活动时间:** 2025-08-04

### [clawvault](https://github.com/Versatly/clawvault)

AI 智能体的结构化记忆系统，让 Agent 拥有持久化记忆能力。
...
轻量级LLM交互框架，支持结构化函数调用和输出，兼容未经JSON微调的模型。

- **Stars:** ⭐️ 624
- **Tags:** `llm-agent` `function-calling` `llamacpp` `llm-framework`
- **最后活动时间:** 2026-03-09
...
企业级强类型工作流引擎，支持MCP协议与可视化脚本，专为AI自动化流程设计。

- **Stars:** ⭐️ 618
- **Tags:** `workflow` `MCP` `low-code` `automation`
- **最后活动时间:** 2026-03-25

### [toolkami](https://github.com/aperoc/toolkami)

简洁易用的智能体开发框架，让构建 AI 智能体变得简单高效。

- **Stars:** ⭐️ 618
- **Tags:** `agent` `framework` `tools` `llm`
- **最后活动时间:** 2026-03-16

### [mem-agent-mcp](https://github.com/firstbatchxyz/mem-agent-mcp)

记忆代理MCP服务器，为AI智能体提供持久化记忆管理能力。

- **Stars:** ⭐️ 617
- **Tags:** `mcp` `memory` `agent` `ai`
- **最后活动时间:** 2025-11-17

### [AnyTool](https://github.com/HKUDS/AnyTool)

AI智能体的通用工具使用层，支持MCP协议和工具编排。

- **Stars:** ⭐️ 616
- **Tags:** `ai-agents` `mcp` `tool-orchestration` `tool-use`
- **最后活动时间:** 2026-02-28
...
LLM链式推理编排框架，支持多模型协作完成复杂任务，集成多种AI能力。

- **Stars:** ⭐️ 609
- **Tags:** `agent` `llm` `orchestration` `langchain` `multimodal`
- **最后活动时间:** 2023-04-11

### [FlashLearn](https://github.com/Pravko-Solutions/FlashLearn)

将LLM集成到任何流水线中的轻量框架，支持fit/predict模式、JSON驱动流程和内置并发处理。

- **Stars:** ⭐️ 609
- **Tags:** `llm` `ai-agents` `python` `agent-framework`
- **最后活动时间:** 2025-03-10
...
用于构建商业代理的工具集，支持游戏和电商场景。

- **Stars:** ⭐️ 606
- **Tags:** `ai` `agents` `agent-framework` `mcp` `gaming`
- **最后活动时间:** 2026-03-01
...
Schema-Guided对话数据集，用于构建任务型对话系统和虚拟助手。

- **Stars:** ⭐️ 600
- **Tags:** `dialogue-systems` `nlp` `assistant` `dataset`
- **最后活动时间:** 2023-08-07
...
为AI代理提供App Store Connect自动化能力的技能包，支持TestFlight部署、CI/CD集成等DevOps操作。

- **Stars:** ⭐️ 599
- **Tags:** `ai-skills` `agent-skills` `app-store-connect` `cicd` `automation`
- **最后活动时间:** 2026-03-23

### [openai-assistant-swarm](https://github.com/Mintplex-Labs/openai-assistant-swarm)

OpenAI助手集群管理框架，自动分配任务给专业化助手协同工作。

- **Stars:** ⭐️ 597
- **Tags:** `ai-agents` `openai-assistant` `function-calling` `npm`
- **最后活动时间:** 2023-11-18
...
### [stealth](https://github.com/hellostealth/stealth)

Ruby开源聊天机器人框架，支持文本和语音对话机器人开发。

- **Stars:** ⭐️ 596
- **Tags:** `chatbot-framework` `conversational-ai` `voice-bot` `ruby`
- **最后活动时间:** 2025-10-19

### [SkillNet](https://github.com/zjunlp/SkillNet)

AI技能创建、评估与连接平台。基于知识图谱和大语言模型，帮助构建和管理AI代理技能生态。
...
面向 AI 研究智能体的新框架与基准测试平台。

- **Stars:** ⭐️ 591
- **Tags:** `ai` `agents` `benchmark` `research` `ml`
- **最后活动时间:** 2025-08-10

### [spotify-mcp](https://github.com/varunneal/spotify-mcp)

基于 MCP 协议的 Spotify 集成工具，让 LLM 能够与 Spotify 交互，实现音乐播放控制与信息查询。

- **Stars:** ⭐️ 590
- **Tags:** `mcp` `spotify` `llm-integration` `agent-tools`
- **最后活动时间:** 2026-03-11
...
人与 AI 员工协同工作的赛博办公室，提供可视化六边形拓扑工作区支持自主协作与技能进化。

- **Stars:** ⭐️ 588
- **Tags:** `ai-agents` `human-ai-collaboration` `workspace` `autonomous`
- **最后活动时间:** 2026-03-26

### [chatdev](https://github.com/10cl/chatdev)

AI智能体构建平台，可用于创建游戏NPC或强大的自动化代理工具。

- **Stars:** ⭐️ 587
- **Tags:** `ai-agents-framework` `gpts` `prompt-engineering` `promptflow`
- **最后活动时间:** 2024-08-05

### [AgentTorch](https://github.com/AgentTorch/AgentTorch)

一个用于大规模人群模拟的可微分智能体框架，支持自动微分和科学计算，适用于复杂系统的建模与仿真。
...
Python编写的开源AI智能体框架，支持快速构建智能应用。

- **Stars:** ⭐️ 583
- **Tags:** `agents` `framework` `python` `ai-agents`
- **最后活动时间:** 2025-03-10
...
将任何工作流转换为可复用的AI代理技能，支持Claude Code、Copilot、Cursor等14+平台，一次编写到处运行。
...
### [langgraph-mcp](https://github.com/esxr/langgraph-mcp)

LangGraph与MCP协议的集成模板，帮助开发者快速构建支持模型上下文协议的AI智能体应用。

- **Stars:** ⭐️ 578
- **Tags:** `langgraph` `mcp` `agent` `langchain`
- **最后活动时间:** 2025-02-25

### [mcp-handler](https://github.com/vercel/mcp-handler)

轻量级 MCP 服务器框架，支持在 Next.js、Nuxt、Svelte 等多框架中快速搭建 AI 模型上下文协议服务。
...
面向强化学习训练和基准测试的综合框架，专为通用工具使用的AI智能体开发而设计。
...
并行运行大量AI编程代理的CLI工具，利用git worktrees实现高效的多代理协作开发。

- **Stars:** ⭐️ 573
- **Tags:** `AI Agents` `CLI` `Parallelization`
- **最后活动时间:** 2025-06-04

### [pydantic-deepagents](https://github.com/vstorm-co/pydantic-deepagents)

基于Pydantic-AI构建的Python深度智能体框架，支持规划、文件操作、子代理委托和结构化输出，仅需10行代码即可构建生产级自主AI代理。

- **Stars:** ⭐️ 570
- **Tags:** `Agent Framework` `Pydantic` `MCP`
- **最后活动时间:** 2026-03-19
...
基于Claude Code子代理的AI驱动开发工作流系统，支持多代理协作与自动化流程。

- **Stars:** ⭐️ 566
- **Tags:** `agent` `claude-code` `multi-agent-system` `workflow`
- **最后活动时间:** 2025-08-08

### [openagi](https://github.com/aiplanethub/openagi)

开源AGI智能体框架，为构建自主AI代理提供完整的开发基础设施。

- **Stars:** ⭐️ 565
- **Tags:** `agents` `agi` `llm` `generative-ai` `openagi`
- **最后活动时间:** 2025-02-25

### [evo-ai](https://github.com/EvolutionAPI/evo-ai)

开源AI智能体创建和管理平台，支持多种AI模型和服务集成，兼容CrewAI和LangGraph等框架。

- **Stars:** ⭐️ 564
- **Tags:** `agent` `ai` `mcp` `langgraph` `crewai`
- **最后活动时间:** 2025-06-02

### [icepick](https://github.com/hatchet-dev/icepick)

轻量级AI智能体编排框架，提供零成本抽象帮助构建可扩展的Agent应用。

- **Stars:** ⭐️ 561
- **Tags:** `agent-framework` `orchestration` `typescript` `llm`
- **最后活动时间:** 2025-07-29
...
AI代理与人类的协作连接平台，提供共享记忆和上下文存储能力。支持多代理协同演进和上下文工程。

- **Stars:** ⭐️ 559
- **Tags:** `AI Memory` `Context Store` `Agent` `LLM`
- **最后活动时间:** 2026-03-26
...
### [echokit_server](https://github.com/second-state/echokit_server)

开源语音代理平台，集成ASR、TTS、LLM和MCP，支持ESP32等边缘设备。

- **Stars:** ⭐️ 554
- **Tags:** `voice-agent` `voice-assistant` `llm` `edge-ai`
- **最后活动时间:** 2026-02-15

### [openclaw-dashboard](https://github.com/tugcantopaloglu/openclaw-dashboard)

为OpenClaw AI代理设计的实时监控仪表板，支持MFA安全认证、成本追踪、实时数据流和内存浏览器等功能。

- **Stars:** ⭐️ 553
- **Tags:** `AI Agents` `Dashboard` `Monitoring` `Claude`
- **最后活动时间:** 2026-03-17
...
### [agentlabs](https://github.com/agentlabs-dev/agentlabs)

通用AI Agent前端框架，让你专注于构建后端逻辑，前端界面由它自动处理。

- **Stars:** ⭐️ 542
- **Tags:** `ai-agents` `ai-agents-framework` `frontend`
- **最后活动时间:** 2025-02-06
...
面向自主智能体的数字生命框架，为构建具有自主行为能力的AI代理提供基础设施支持。

- **Stars:** ⭐️ 541
- **Tags:** `autonomous-agents` `agent-framework` `digital-being`
- **最后活动时间:** 2025-02-26

### [Context-Gateway](https://github.com/Compresr-ai/Context-Gateway)

智能体代理服务，为AI智能体工作流提供即时历史压缩和上下文优化工具。
...
### [toolkit-ai](https://github.com/toolkit-ai/toolkit-ai)

AI智能体工具生成框架，能够自动生成并使用LangChain工具和ChatGPT插件。

- **Stars:** ⭐️ 535
- **Tags:** `langchain` `chatgpt-plugins` `tool-generation` `agent-framework`
- **最后活动时间:** 2023-04-19

### [fastapi-mcp-langgraph-template](https://github.com/NicholasGoh/fastapi-mcp-langgraph-template)

现代化智能体编排模板，集成MCP、LangGraph等工具，支持快速迭代和可扩展部署。

- **Stars:** ⭐️ 534
- **Tags:** `langgraph` `mcp` `fastapi` `agentic-orchestration`
- **最后活动时间:** 2026-03-03

### [fastagency](https://github.com/ag2ai/fastagency)

快速将多智能体工作流部署到生产环境的框架，支持 AutoGen 和 Mesop。

- **Stars:** ⭐️ 532
- **Tags:** `autogen` `multiagent` `llm` `agents`
- **最后活动时间:** 2026-02-23

### [VirtualTaobao](https://github.com/eyounx/VirtualTaobao)

基于OpenAI Gym接口的虚拟淘宝模拟器，适用于推荐系统和强化学习研究。

- **Stars:** ⭐️ 531
- **Tags:** `reinforcement-learning` `simulation` `openai-gym` `e-commerce`
- **最后活动时间:** 2019-11-18
...
实时监控多个Claude Code和Codex会话的AI代理行为，支持高效协调代理集群。

- **Stars:** ⭐️ 525
- **Tags:** `agent-monitoring` `claude-code` `codex` `real-time`
- **最后活动时间:** 2026-03-02
...
基于Pydantic AI构建的Apache Airflow SDK，支持LLM和AI Agent工作流编排，简化AI任务的调度与管理。

- **Stars:** ⭐️ 523
- **Tags:** `Airflow` `LLM` `AI Agents` `SDK`
- **最后活动时间:** 2025-09-25

### [apple-health-mcp](https://github.com/neiltron/apple-health-mcp)

MCP服务器，支持通过自然语言和SQL查询Apple Health健康数据。
...
直观的LLM智能体提示框架，通过简单自然语言提示构建复杂的多功能智能体思维链。

- **Stars:** ⭐️ 518
- **Tags:** `llm` `agents` `prompt-engineering` `framework`
- **最后活动时间:** 2024-12-20
...
模块化AI智能体技能库，为智能体提供全栈开发、逻辑规划、多媒体处理等专业能力，使其像人类专家一样系统化解决问题。
...
Go语言实现的LLM智能体开发框架，支持自主代理、RAG和向量数据库集成。
...
让大语言模型在本地执行代码的自然语言计算机接口，支持Python和JavaScript，实现代码自动化执行。
...
开源自动化代理平台，可创建监控代理自动执行任务，支持RSS监控、网页抓取和事件触发，适合构建AI工作流自动化系统。
...
在浏览器中组装、配置和部署自主AI智能体的平台，支持创建自定义AI代理完成复杂任务。

- **Stars:** ⭐️ 35.9k
- **Tags:** `AI Agents` `AutoGPT` `LangChain`
- **最后活动时间:** 2025-04-29
...
首个真正的AI开发者代理，能够自主完成软件开发全流程，从需求到代码实现。

- **Stars:** ⭐️ 33.8k
- **Tags:** `AI Developer` `Code Generation` `GPT-4`
- **最后活动时间:** 2025-11-10

### [storm](https://github.com/stanford-oval/storm)

斯坦福LLM驱动知识研究系统，自动调研主题并生成带引用的完整长篇报告，EMNLP 2024论文。
...
微软开源的LLM与ML模型协作系统，实现多模态任务自动编排与执行。

- **Stars:** ⭐️ 24.6k
- **Tags:** `Agent` `Multi-Modal` `Microsoft`
- **最后活动时间:** 2025-07-29

### [Open-AutoGLM](https://github.com/zai-org/Open-AutoGLM)

开源的手机AI智能体模型与框架，让AI能够操作手机完成各种任务。

- **Stars:** ⭐️ 24.6k
- **Tags:** `phone-agent` `ai-agent` `mobile-automation`
- **最后活动时间:** 2026-03-06

### [OmniParser](https://github.com/microsoft/OmniParser)

基于纯视觉的屏幕解析工具，专为GUI智能体设计，能够理解界面元素并支持自动化操作。

- **Stars:** ⭐️ 24.6k
- **Tags:** `GUI Agent` `Vision` `Screen Parsing`
- **最后活动时间:** 2025-09-12
...
斯坦福大学经典研究项目，模拟人类行为的生成式AI智能体，可交互的虚拟社区实验。

- **Stars:** ⭐️ 21.0k
- **Tags:** `generative-agents` `simulation` `llm` `research`
- **最后活动时间:** 2024-08-05

### [devika](https://github.com/stitionai/devika)

开源的智能体软件工程师，作为Devin的开源替代方案，能够自主完成软件工程任务。

- **Stars:** ⭐️ 19.5k
- **Tags:** `ai-agent` `software-engineering` `autonomous-agent` `devin-alternative`
- **最后活动时间:** 2025-09-25
...
简洁的深度研究Agent实现，结合搜索引擎和LLM进行迭代式主题深挖。

- **Stars:** ⭐️ 18.6k
- **Tags:** `Agent` `Research` `GPT` `O3-mini`
- **最后活动时间:** 2025-09-08

### [DeepResearch](https://github.com/Alibaba-NLP/DeepResearch)

阿里通义开源的深度研究智能体，专注于信息检索与深度分析，支持复杂研究任务的自动化执行。

- **Stars:** ⭐️ 18.5k
- **Tags:** `研究Agent` `阿里通义` `信息检索`
- **最后活动时间:** 2026-02-27

### [agent-zero](https://github.com/agent0ai/agent-zero)

自主AI智能体框架，支持Linux环境运行，具备自主决策和任务执行能力。
...
多LLM协作框架，让多个大语言模型像议会一样共同讨论并回答复杂问题，通过集体智慧提升回答质量。

- **Stars:** ⭐️ 16.1k
- **Tags:** `LLM` `Multi-Agent` `Collaboration`
- **最后活动时间:** 2025-11-22

### [Second-Me](https://github.com/mindverse/Second-Me)

训练你的AI数字分身，放大个人能力，连接世界。

- **Stars:** ⭐️ 15.4k
- **Tags:** `ai-agent` `digital-twin` `personal-ai` `self-training`
- **最后活动时间:** 2025-09-30
...
自主AI智能体循环，持续运行直至完成所有PRD需求项，实现自动化任务执行。
...
- **Stars:** ⭐️ 13.6k
- **Tags:** `autonomous-agents` `ai-coding`
- **最后活动时间:** 2026-03-23
...
多智能体编排系统，配备9个专业AI代理、实时仪表盘、模型配置和完整审计追踪功能。
...
全自动开放式科学发现的AI科学家系统，实现从假设生成到论文撰写的完整科研自动化流程。

- **Stars:** ⭐️ 12.5k
- **Tags:** `ai-scientist` `automated-research` `scientific-discovery` `autonomous-agents`
- **最后活动时间:** 2025-12-19
...
微软开源的AI驱动研发自动化工具，专注于数据和模型的高价值R&D流程自动化。

- **Stars:** ⭐️ 12.1k
- **Tags:** `Agent` `Automation` `LLM` `Data Science`
- **最后活动时间:** 2026-03-25

### [claude-engineer](https://github.com/Doriandarko/claude-engineer)

基于Claude-3.5-Sonnet的交互式CLI工具，支持自主生成和管理工具，助力软件开发。

- **Stars:** ⭐️ 11.2k
- **Tags:** `Claude` `CLI` `Agent` `Code Assistant`
- **最后活动时间:** 2024-12-12

### [trae-agent](https://github.com/bytedance/trae-agent)

基于LLM的智能体，专为通用软件工程任务设计，可自动化代码开发流程。
...
个人AI代理基础设施，旨在增强人类能力的智能代理系统。

- **Stars:** ⭐️ 10.5k
- **Tags:** `ai-infrastructure` `agents` `productivity` `human-augmentation`
- **最后活动时间:** 2026-03-22

### [self-operating-computer](https://github.com/OthersideAI/self-operating-computer)

让多模态AI模型自主操作电脑的框架，通过模拟鼠标键盘实现自动化任务执行。

- **Stars:** ⭐️ 10.2k
- **Tags:** `Automation` `Multimodal` `Computer Control`
- **最后活动时间:** 2025-09-19

### [UI-TARS](https://github.com/bytedance/UI-TARS)

开创性的GUI自动化交互原生智能体，能够自主理解和操作图形用户界面。

- **Stars:** ⭐️ 10.0k
- **Tags:** `gui-agent` `autonomous-agent` `desktop-automation`
- **最后活动时间:** 2026-01-27
...
专注于复杂任务求解的自主LLM智能体框架，支持多步骤推理与工具调用。

- **Stars:** ⭐️ 8.5k
- **Tags:** `autonomous-agents` `llm` `task-solving`
- **最后活动时间:** 2024-08-12
...
面向复杂研究和预测任务的深度研究Agent，在BrowseComp基准上表现优异。

- **Stars:** ⭐️ 8.3k
- **Tags:** `AI Agent` `Deep Research` `Benchmark`
- **最后活动时间:** 2026-03-24

### [ralph-claude-code](https://github.com/frankbria/ralph-claude-code)

Claude Code的自主AI开发循环工具，具备智能退出检测能力。
...
基于自然语言指令的移动设备自动化Agent，支持LLM无关的Android自动化操作。

- **Stars:** ⭐️ 8.0k
- **Tags:** `移动自动化` `Android` `AI Agent`
- **最后活动时间:** 2026-03-26
...
OpenClaw AI协作助手，打造智能AI工作伙伴。

- **Stars:** ⭐️ 7.6k
- **Tags:** `ai-agent` `ai-coworker` `automation`
- **最后活动时间:** 2026-03-03

### [universe](https://github.com/openai/universe)

OpenAI开发的AI通用智能测量与训练平台，跨游戏和网站环境。

- **Stars:** ⭐️ 7.5k
- **Tags:** `ai-training` `reinforcement-learning` `agi`
- **最后活动时间:** 2018-04-05

### [kimi-cli](https://github.com/MoonshotAI/kimi-cli)

Kimi Code CLI 是一款智能命令行编程助手，帮助开发者通过终端完成代码编写和任务自动化。
...
基于LLM的多智能体角色模拟平台，用于增强想象力和获取商业洞察，支持复杂场景的虚拟角色仿真。

- **Stars:** ⭐️ 7.4k
- **Tags:** `Multi-Agent` `Simulation` `Persona`
- **最后活动时间:** 2026-02-27
...
游戏智能体框架，帮助你创建能学习玩任何游戏的AI/Bot，结合计算机视觉和深度学习技术。

- **Stars:** ⭐️ 7.0k
- **Tags:** `Game AI` `Reinforcement Learning` `Python`
- **最后活动时间:** 2022-11-07
...
基于大语言模型的多智能体网络搜索引擎框架，通过智能体协作实现智能搜索与信息整合。
...
基于大语言模型的开源具身智能体，在Minecraft中实现自主探索与技能学习。

- **Stars:** ⭐️ 6.8k
- **Tags:** `Embodied AI` `LLM Agent` `Minecraft`
- **最后活动时间:** 2024-04-03

### [AppAgent](https://github.com/TencentQQGYLab/AppAgent)

基于大语言模型的多模态智能体框架，能够像人类用户一样操作智能手机应用。

- **Stars:** ⭐️ 6.6k
- **Tags:** `Agent` `Multimodal` `Smartphone` `LLM`
- **最后活动时间:** 2025-03-19

### [street-fighter-ai](https://github.com/linyiLYi/street-fighter-ai)

街头霸王 II 冠军版的 AI 游戏代理，展示游戏 AI 的强化学习应用。

- **Stars:** ⭐️ 6.5k
- **Tags:** `game-ai` `reinforcement-learning` `agent` `street-fighter`
- **最后活动时间:** 2024-05-14

### [Awesome-GPT-Agents](https://github.com/fr0gger/Awesome-GPT-Agents)

精选的网络安全领域GPT智能体资源列表，涵盖多种AI代理应用场景。

- **Stars:** ⭐️ 6.5k
- **Tags:** `GPT` `Agents` `Cybersecurity` `LLM`
- **最后活动时间:** 2024-07-21
...
开源的 AI 产品设计代理，帮助自动化产品设计流程。

- **Stars:** ⭐️ 6.2k
- **Tags:** `design-agent` `product-design` `ai-agent` `open-source`
- **最后活动时间:** 2026-02-04

### [open-deep-research](https://github.com/nickscamara/open-deep-research)

开源深度研究Agent，能够推理大量网页数据并生成研究报告。

- **Stars:** ⭐️ 6.2k
- **Tags:** `AI Agent` `Deep Research` `Web Scraping`
- **最后活动时间:** 2025-05-07
...
闲鱼平台智能客服机器人系统，支持多专家协同决策、智能议价和7×24小时自动值守。
...
AI驱动的软件开发多智能体系统，将自然语言需求转化为可运行的软件代码。
...
以数据为中心的自进化自主语言Agent框架，支持Agent自主学习和演进。

- **Stars:** ⭐️ 5.9k
- **Tags:** `Autonomous Agents` `LLM` `Language Model`
- **最后活动时间:** 2024-09-26

### [ottomator-agents](https://github.com/coleam00/ottomator-agents)

托管在oTTomator Live Agent Studio平台上的开源AI智能体集合，提供多种可运行的AI Agent示例。

- **Stars:** ⭐️ 5.5k
- **Tags:** `ai-agents` `open-source` `automation`
- **最后活动时间:** 2025-11-09
...
端到端自主研究工作流平台，协助研究人员实现研究想法的自动化执行。

- **Stars:** ⭐️ 5.4k
- **Tags:** `autonomous-agents` `research-automation` `workflow`
- **最后活动时间:** 2025-08-20

### [MineContext](https://github.com/volcengine/MineContext)

主动式上下文感知AI伙伴，结合Context-Engineering技术实现智能记忆检索与主动式助手功能。
...
自主研究智能体，能够持续搜索网页、阅读内容并推理，直到找到答案或超出token预算。
...
AI驱动的数据科学智能体团队，以10倍效率完成数据分析、特征工程、模型训练等任务。

- **Stars:** ⭐️ 5.1k
- **Tags:** `Agents` `Data Science` `Automation`
- **最后活动时间:** 2026-01-28

### [gaianet-node](https://github.com/GaiaNet-AI/gaianet-node)

去中心化AI Agent服务部署平台，支持快速安装、运行和部署自主智能体服务。

- **Stars:** ⭐️ 5.0k
- **Tags:** `Decentralized AI` `AI Agents` `MCP`
- **最后活动时间:** 2025-10-13

### [Viper](https://github.com/FunnyWolf/Viper)

AI驱动的红队对抗模拟平台，结合LLM实现自动化渗透测试与安全评估。

- **Stars:** ⭐️ 5.0k
- **Tags:** `红队工具` `安全测试` `AI Agent`
- **最后活动时间:** 2026-01-18

### [mindcraft](https://github.com/mindcraft-bots/mindcraft)

基于LLM的Minecraft AI智能体，使用Mineflayer实现自主游戏行为。
...
自主科学研究创新系统，实现AI驱动的自动化科研流程。

- **Stars:** ⭐️ 5.0k
- **Tags:** `ai-researcher` `autonomous-agents` `scientific-innovation`
- **最后活动时间:** 2025-10-16

### [gibberlink](https://github.com/PennyroyalTea/gibberlink)

两个AI对话代理在确认彼此身份后，从英语切换到声音级协议进行通信的实验项目。

- **Stars:** ⭐️ 4.8k
- **Tags:** `ai-agent` `communication-protocol` `conversational-ai`
- **最后活动时间:** 2025-07-28
...
为后人类工作流设计的智能代理，每个任务配备专属代理单元。

- **Stars:** ⭐️ 4.7k
- **Tags:** `ai-agent` `workflow-automation` `task-automation`
- **最后活动时间:** 2026-01-23
...
一款专注于群组聊天的多平台智能体机器人，支持DeepSeek等大模型，可作为赛博网友在QQ等平台进行智能对话。
...
基于Node.js和TypeScript构建的轻量级AI代理，支持无缝任务执行。
...
基于Claude Code的协调式子代理开发团队，展示多代理协作模式。

- **Stars:** ⭐️ 4.1k
- **Tags:** `claude` `ai-agent` `multi-agent` `development`
- **最后活动时间:** 2025-10-30

### [OpenManus-RL](https://github.com/OpenManus/OpenManus-RL)

LLM智能体强化学习调优的直播开发项目，探索RL在Agent中的应用。
...
端到端AI工程代理，集成开发者工具，支持自主规划、执行和迭代，适用于企业级自部署场景。

- **Stars:** ⭐️ 3.5k
- **Tags:** `AI Agent` `Developer Tools` `Self-hosted`
- **最后活动时间:** 2026-03-18
...
层次化多智能体系统，支持深度研究和通用任务自动分解执行。

- **Stars:** ⭐️ 3.3k
- **Tags:** `multi-agent` `autonomous-agents` `task-planning` `hierarchical`
- **最后活动时间:** 2026-03-10

### [AgentBench](https://github.com/THUDM/AgentBench)

ICLR 2024发表的LLM智能体综合评测基准，全面评估大模型作为智能体的能力。

- **Stars:** ⭐️ 3.3k
- **Tags:** `Benchmark` `LLM Agent` `ICLR 2024`
- **最后活动时间:** 2026-02-08
...
NeurIPS 2023论文实现，提出语言智能体的言语强化学习方法，让LLM通过自我反思提升推理能力。

- **Stars:** ⭐️ 3.1k
- **Tags:** `LLM Agents` `Reinforcement Learning` `Research`
- **最后活动时间:** 2025-01-14

### [OpenAI_Agent_Swarm](https://github.com/daveshap/OpenAI_Agent_Swarm)

分层自主智能体集群框架，实现多智能体协作与层级化管理。

- **Stars:** ⭐️ 3.1k
- **Tags:** `agent-swarm` `autonomous-agents` `hierarchical`
- **最后活动时间:** 2024-02-16

### [CyberStrikeAI](https://github.com/Ed1s0nZ/CyberStrikeAI)

AI原生安全测试平台，集成100+安全工具和智能编排引擎，支持角色化测试和技能系统，适用于渗透测试和红队演练。

- **Stars:** ⭐️ 3.1k
- **Tags:** `AI安全` `渗透测试` `智能体`
- **最后活动时间:** 2026-03-25

### [AutoGPT-Next-Web](https://github.com/ElricLiu/AutoGPT-Next-Web)

在浏览器中组装、配置和部署自主AI智能体的Web应用，支持一键免费部署。

- **Stars:** ⭐️ 3.0k
- **Tags:** `AutoGPT` `AI Agents` `Next.js`
- **最后活动时间:** 2025-02-10
...
一款通用型生物医学AI智能体，能够自主完成生物医学研究任务和实验设计。
...
Together AI的混合智能体架构，在AlpacaEval上达到65.1%高分。

- **Stars:** ⭐️ 2.9k
- **Tags:** `mixture-of-agents` `llm` `ensemble`
- **最后活动时间:** 2025-01-07

### [VirtualWife](https://github.com/yakami129/VirtualWife)

虚拟数字人项目，支持B站直播和多种AI后端（OpenAI、Ollama）。

- **Stars:** ⭐️ 2.8k
- **Tags:** `virtual-human` `chatgpt` `ollama` `openai` `livestream` `docker`
- **最后活动时间:** 2024-10-27
...
企业级AI智能体库，提供开源替代方案，涵盖强化学习、MCP协议、VR办公等多个前沿领域。

- **Stars:** ⭐️ 2.7k
- **Tags:** `ai-agents` `reinforcement-learning` `mcp` `open-source`
- **最后活动时间:** 2026-01-30

### [ralphy](https://github.com/michaelshimeles/ralphy)

自主循环执行脚本，可连续运行Claude Code、Codex、Cursor Agent等多个AI编程智能体直至完成PRD需求。

- **Stars:** ⭐️ 2.7k
- **Tags:** `Autonomous` `Multi-Agent` `Automation`
- **最后活动时间:** 2026-02-05
...
利用强化学习训练LLM推理智能体的框架，支持在交互式随机环境中进行训练。
...
通过自然语言提示自动构建机器学习模型的智能体平台，实现从Prompt到ML模型的自动化流程。

- **Stars:** ⭐️ 2.6k
- **Tags:** `agentic-ai` `machine-learning` `mlops` `multiagent`
- **最后活动时间:** 2026-03-06

### [SalesGPT](https://github.com/filip-michalsky/SalesGPT)

基于上下文感知的AI销售代理，可自动化销售外联流程。

- **Stars:** ⭐️ 2.6k
- **Tags:** `sales-agent` `llm-agent` `automation` `sales-automation`
- **最后活动时间:** 2024-09-17

### [Free-Auto-GPT](https://github.com/IntelligenzaArtificiale/Free-Auto-GPT)

免费版AutoGPT，无需付费API即可运行的自主AI代理，可独立执行任务。

- **Stars:** ⭐️ 2.5k
- **Tags:** `AutoGPT` `Autonomous Agent` `Free API`
- **最后活动时间:** 2024-06-19

### [Cradle](https://github.com/BAAI-Agents/Cradle)

BAAI团队开发的首个通用计算机控制框架，让AI智能体能够通过推理和自我改进完成各种计算机任务。

- **Stars:** ⭐️ 2.5k
- **Tags:** `AI Agent` `GCC` `Computer Control` `VLM`
- **最后活动时间:** 2024-11-07

### [Auto-GPT-ZH](https://github.com/kaqijiang/Auto-GPT-ZH)

Auto-GPT中文版本，支持AI自主任务执行与自动化工作流，适合中文用户学习与实践AI智能体应用。

- **Stars:** ⭐️ 2.5k
- **Tags:** `Auto-GPT` `智能体` `中文`
- **最后活动时间:** 2025-08-15
...
全自主AI智能体，可通过终端、浏览器和编辑器执行复杂任务和项目。

- **Stars:** ⭐️ 2.5k
- **Tags:** `autonomous-agent` `code-agent` `llms` `automation`
- **最后活动时间:** 2024-04-29

### [AI-Scientist-v2](https://github.com/SakanaAI/AI-Scientist-v2)

基于智能体树搜索的自动化科学发现系统，实现工作坊级别的全自动科研能力。支持端到端的科学假设生成与验证。

- **Stars:** ⭐️ 2.4k
- **Tags:** `ai-scientist` `autonomous-agents` `scientific-discovery` `tree-search`
- **最后活动时间:** 2025-12-19

### [fulling](https://github.com/FullAgent/fulling)

AI驱动的全栈工程师智能体，基于Claude实现代码生成与项目管理。

- **Stars:** ⭐️ 2.4k
- **Tags:** `AI Agent` `Full-stack` `Claude`
- **最后活动时间:** 2026-03-18
...
可扩展的AI代码审查和QA代理，支持MCP协议，自动化代码质量检测和质量保证流程。
...
近端策略优化(PPO)最小化PyTorch实现，强化学习经典算法。

- **Stars:** ⭐️ 2.3k
- **Tags:** `ppo` `reinforcement-learning` `policy-gradient`
- **最后活动时间:** 2024-07-09

### [rlpyt](https://github.com/astooke/rlpyt)

PyTorch强化学习研究框架，提供多种RL算法实现。

- **Stars:** ⭐️ 2.3k
- **Tags:** `reinforcement-learning` `pytorch` `rl-framework`
- **最后活动时间:** 2021-01-04

### [RA.Aid](https://github.com/ai-christianson/RA.Aid)

自主软件开发AI智能体，能够独立完成代码编写和软件开发任务。

- **Stars:** ⭐️ 2.2k
- **Tags:** `ai-agent` `autonomous-coding` `software-development`
- **最后活动时间:** 2026-01-30

### [MineDojo](https://github.com/MineDojo/MineDojo)

基于互联网规模知识构建的开放式具身智能体研究平台，以Minecraft为环境。

- **Stars:** ⭐️ 2.2k
- **Tags:** `embodied-agent` `minecraft` `internet-scale` `open-ended`
- **最后活动时间:** 2024-03-18

### [deep-research-web-ui](https://github.com/AnotiaWang/deep-research-web-ui)

支持 DeepSeek R1 的 AI 研究助手，结合搜索引擎与网页抓取进行迭代式深度研究，提供友好的 Web UI 界面。
...
顶级GUI智能体解决方案，支持手机操作自动化，由StepFun团队开发。

- **Stars:** ⭐️ 2.1k
- **Tags:** `gui-agents` `phone-use-agent` `autonomous-agents`
- **最后活动时间:** 2026-03-14
...
可通过curl访问的计算机终端，为AI智能体提供远程执行能力。
...
一种无代理方法，自动解决软件开发问题，无需复杂代理架构即可处理代码任务。

- **Stars:** ⭐️ 2.0k
- **Tags:** `agent` `llm` `software-development`
- **最后活动时间:** 2024-12-22
...
精心策划的339+ AI智能体技能集合，涵盖生产力、开发、营销、金融等多个领域。
...
基于视觉语言模型的Android自动化工具，实现手机端智能操作与任务执行。

- **Stars:** ⭐️ 2.0k
- **Tags:** `Android自动化` `移动智能体` `VLM`
- **最后活动时间:** 2026-01-08
...
全能AI伴侣平台，集成虚拟主播、直播、Discord/QQ机器人、Home Assistant等多种智能体能力。
...
基于Qwen3-VL实现的计算机使用代理，支持浏览器和桌面应用的GUI自动化智能交互。

- **Stars:** ⭐️ 2.0k
- **Tags:** `computer-use` `gui-agent` `mcp`
- **最后活动时间:** 2026-03-26

### [spacebot](https://github.com/spacedriveapp/spacebot)

面向团队和社区的多用户AI代理，支持自动化工作流和企业级消息集成。
...
达尔文哥德尔机器：自我进化智能体的开放式进化研究项目。

- **Stars:** ⭐️ 2.0k
- **Tags:** `self-improving-agents` `evolution` `autonomous-agents`
- **最后活动时间:** 2025-08-13

### [macOS-use](https://github.com/browser-use/macOS-use)

让Mac应用程序对AI智能体可访问的工具，实现AI代理对macOS系统的自动化操作与控制。

- **Stars:** ⭐️ 1.9k
- **Tags:** `macos` `ai-agent` `automation` `accessibility`
- **最后活动时间:** 2025-03-05

### [open-computer-use](https://github.com/e2b-dev/open-computer-use)

基于开源LLM和E2B沙箱的AI计算机使用代理。
...
虚拟开发团队助手，利用AI代理帮助完成软件开发任务的自动化工具。

- **Stars:** ⭐️ 1.9k
- **Tags:** `ai-agent` `gpt` `development` `automation`
- **最后活动时间:** 2023-08-01

### [beikeshop](https://github.com/beikeshop/beikeshop)

基于Laravel的开源电商平台，集成AI智能体支持，支持多语言多货币及可视化自定义设计。

- **Stars:** ⭐️ 1.9k
- **Tags:** `ecommerce` `laravel` `chatgpt` `ai-agents`
- **最后活动时间:** 2026-03-25

### [dash](https://github.com/agno-agi/dash)

自学习数据智能体，基于6层上下文进行数据分析和问答，灵感来自OpenAI内部实现。

- **Stars:** ⭐️ 1.8k
- **Tags:** `data-agent` `self-learning` `context-aware`
- **最后活动时间:** 2026-03-25

### [SolidGPT](https://github.com/AI-Citizen/SolidGPT)

面向开发者的 AI 搜索代理，支持代码库对话和知识检索，提升开发效率。

- **Stars:** ⭐️ 1.8k
- **Tags:** `Search Agent` `Developer Tools` `GPT-4`
- **最后活动时间:** 2025-01-12

### [multi-agent-emergence-environments](https://github.com/openai/multi-agent-emergence-environments)

OpenAI's research environment for studying emergent tool use and multi-agent autocurricula, demonstrating how complex behaviors emerge from simple multi-agent interactions.

- **Stars:** ⭐️ 1.8k
- **Tags:** `Multi-Agent` `Reinforcement Learning` `Emergent Behavior`
- **最后活动时间:** 2024-07-30
...
自进化的操作系统级对话智能体，无缝集成到OS中自动化日常任务。

- **Stars:** ⭐️ 1.8k
- **Tags:** `os-agent` `self-improving` `embodied-agent` `automation`
- **最后活动时间:** 2024-09-09
...
CVPR 2025开源端到端视觉-语言-动作模型，专为GUI智能体和计算机操作设计。
...
基于迁移学习的对话AI系统，利用GPT-2实现最先进的对话生成能力。

- **Stars:** ⭐️ 1.8k
- **Tags:** `chatbots` `gpt-2` `transfer-learning` `dialog`
- **最后活动时间:** 2023-06-12

### [NLP-Knowledge-Graph](https://github.com/lihanghang/NLP-Knowledge-Graph)

自然语言处理与知识图谱技术研究项目，涵盖对话系统、大模型应用、智能体等前沿领域。
...
为LLM提供插件能力的智能代理框架，支持复杂任务自动化。使用Rust构建，高效可靠。

- **Stars:** ⭐️ 1.7k
- **Tags:** `Agent` `LLM` `Plugins` `Rust`
- **最后活动时间:** 2024-04-11

### [airda](https://github.com/hitsz-ids/airda)

面向数据分析的多智能体系统，能够理解数据需求并自动生成SQL和Python代码，支持数据查询、可视化和机器学习任务。

- **Stars:** ⭐️ 1.7k
- **Tags:** `multi-agent` `data-analysis` `sql-generation` `python-code-generation`
- **最后活动时间:** 2025-01-07

### [GPTeam](https://github.com/101dotxyz/GPTeam)

开源的多智能体模拟平台，让多个AI代理协同工作完成复杂任务。

- **Stars:** ⭐️ 1.7k
- **Tags:** `agents` `multi-agent` `autogpt` `gpt-4`
- **最后活动时间:** 2026-03-19
...
强大的自托管AI智能体平台，可作为OpenAI API的完整替代方案，支持消费级硬件本地运行，注重隐私保护。

- **Stars:** ⭐️ 1.7k
- **Tags:** `Self-hosted` `Local AI` `Privacy`
- **最后活动时间:** 2026-03-25
...
### [ava-whatsapp-agent-course](https://github.com/neural-maze/ava-whatsapp-agent-course)

构建WhatsApp智能代理的完整课程项目，集成语音识别、语音合成和向量数据库技术。

- **Stars:** ⭐️ 1.6k
- **Tags:** `Agent` `WhatsApp` `STT` `TTS`
- **最后活动时间:** 2025-10-20

### [neural-mmo](https://github.com/openai/neural-mmo)

OpenAI 发布的大规模多智能体游戏环境，用于训练和评估智能体。

- **Stars:** ⭐️ 1.6k
- **Tags:** `Multi-Agent Systems` `Game Environment` `Research`
- **最后活动时间:** 2023-07-21
...
面向LLM的多智能体语言游戏环境，用于研究和开发AI的沟通协作能力。

- **Stars:** ⭐️ 1.5k
- **Tags:** `multi-agent` `llm` `language-games` `collaboration`
- **最后活动时间:** 2025-08-11

### [OpenAdapt](https://github.com/OpenAdaptAI/OpenAdapt)

开源生成式流程自动化工具，利用 LLM 和多模态模型实现 AI 驱动的智能流程自动化。

- **Stars:** ⭐️ 1.5k
- **Tags:** `agents` `process-automation` `LLM` `multimodal`
- **最后活动时间:** 2026-03-04

### [raptor](https://github.com/gadievron/raptor)

将Claude Code转化为通用AI安全代理，支持攻防安全操作，通过规则配置和子代理编排安全工具。
...
首个全栈开源自进化通用AI智能体，提供完全本地化部署方案，可作为Manus等平台的替代方案。

- **Stars:** ⭐️ 1.5k
- **Tags:** `AI Agent` `Full-stack` `Local Deployment`
- **最后活动时间:** 2026-02-03

### [TheoremExplainAgent](https://github.com/TIGER-AI-Lab/TheoremExplainAgent)

ACL 2025 oral 论文，基于视频的多模态LLM定理理解解释代理，结合RAG生成动画讲解。

- **Stars:** ⭐️ 1.5k
- **Tags:** `LLM Agent` `Video Generation` `Math Reasoning`
- **最后活动时间:** 2025-07-27

### [godot-steering-ai-framework](https://github.com/GDQuest/godot-steering-ai-framework)

Godot游戏引擎的AI运动控制框架，支持2D和3D环境中的智能体转向行为和复杂AI运动模式。

- **Stars:** ⭐️ 1.5k
- **Tags:** `ai` `steering-behaviors` `game-ai` `godot` `agents`
- **最后活动时间:** 2024-09-13

### [fiction](https://github.com/fictionco/fiction)

智能体数字自我平台，构建个人数字孪生代理。

- **Stars:** ⭐️ 1.5k
- **Tags:** `ai` `agents` `digital-twin` `agentic`
- **最后活动时间:** 2025-10-16

### [Auto-Deep-Research](https://github.com/HKUDS/Auto-Deep-Research)

全自动个人AI研究助手，支持深度研究和自动化任务执行。

- **Stars:** ⭐️ 1.5k
- **Tags:** `agent` `automation` `research-assistant` `llm`
- **最后活动时间:** 2025-10-16

### [ai-legion](https://github.com/eumemic/ai-legion)

由大语言模型驱动的自主智能体平台，支持多智能体协作执行复杂任务，适合构建分布式AI系统。

- **Stars:** ⭐️ 1.4k
- **Tags:** `LLM` `Multi-Agent` `Autonomous`
- **最后活动时间:** 2025-05-27
...
一个基于插件的多智能体系统，用于学术论文的写作、审阅和编辑，支持LaTeX和Overleaf集成。
...
NeurIPS 2025论文，赋予大推理模型深度研究能力，支持复杂网络搜索与报告生成。

- **Stars:** ⭐️ 1.4k
- **Tags:** `deep-research` `reasoning-agent` `web-search` `autonomous`
- **最后活动时间:** 2025-12-08

### [diplomacy_cicero](https://github.com/facebookresearch/diplomacy_cicero)

Meta的Cicero AI智能体代码，能够在外交游戏中进行开放域自然语言谈判，展示AI的战略推理能力。

- **Stars:** ⭐️ 1.4k
- **Tags:** `ai-agent` `natural-language` `diplomacy` `negotiation`
- **最后活动时间:** 2025-04-17

### [core](https://github.com/RedPlanetHQ/core)

个人智能管家构建平台，打造专属 AI 助手。
...
多智能体协作框架，支持为任何项目组建AI Agent团队协同工作。

- **Stars:** ⭐️ 1.4k
- **Tags:** `multi-agent` `ai-team` `agent-framework`
- **最后活动时间:** 2026-03-26

### [PhoneDriver](https://github.com/OminousIndustries/PhoneDriver)

基于Qwen3-VL的安卓手机控制智能体，实现自动化手机操作。

- **Stars:** ⭐️ 1.4k
- **Tags:** `Phone-Control` `Agent` `Qwen3-VL`
- **最后活动时间:** 2025-10-24

### [AIlice](https://github.com/myshell-ai/AIlice)

完全自主的通用AI智能体，基于LLM构建，具备强大的自主决策与执行能力。
...
基于大语言模型的自主智能体，通过RESTful API控制真实世界应用程序。

- **Stars:** ⭐️ 1.4k
- **Tags:** `llm` `autonomous-agent` `rest-api` `automation`
- **最后活动时间:** 2024-06-07

### [MiroFish-Offline](https://github.com/nikmcfly/MiroFish-Offline)

离线多智能体仿真与预测引擎，集成Neo4j图数据库和Ollama本地模型栈，支持群体智能模拟。
...
基于Playwright的Windows计算机操作智能体，支持原生桌面自动化。
...
AI 驱动的 GitHub Action，可自动分析 Issue 并生成 Pull Request 代码。

- **Stars:** ⭐️ 1.4k
- **Tags:** `GitHub Actions` `Automation` `Agent`
- **最后活动时间:** 2026-03-05

### [FinnewsHunter](https://github.com/DemonDamon/FinnewsHunter)

基于AgenticX的多智能体金融情报平台，支持实时新闻分析、情绪融合和Alpha因子挖掘。
...
多智能体协作编码系统，包含编排器、探索器和编码代理，通过智能上下文共享协同工作，在Stanford Terminal Bench排行榜上获得第13名。

- **Stars:** ⭐️ 1.4k
- **Tags:** `Multi-Agent` `Coding` `Autonomous`
- **最后活动时间:** 2025-11-03

### [ReCall](https://github.com/Agent-RL/ReCall)

通过强化学习让LLM学会推理与搜索、工具调用的研究项目，提升智能体的自主决策和工具使用能力。

- **Stars:** ⭐️ 1.4k
- **Tags:** `agent` `llm` `reinforcement-learning` `tool-use` `function-calling`
- **最后活动时间:** 2025-05-16

### [AgentCPM-GUI](https://github.com/OpenBMB/AgentCPM-GUI)

端侧Android GUI智能体，通过强化微调增强推理能力，高效执行应用操作任务。

- **Stars:** ⭐️ 1.3k
- **Tags:** `gui-agent` `android` `reinforcement-learning` `on-device`
- **最后活动时间:** 2026-01-11
...
BabyAGI智能体的Web界面，便于在浏览器中运行和开发自主AI代理任务。

- **Stars:** ⭐️ 1.3k
- **Tags:** `babyagi` `agent` `autonomous` `langchain` `nextjs`
- **最后活动时间:** 2024-10-24

### [pywinassistant](https://github.com/a-real-ai/pywinassistant)

开源图形界面自动化智能体框架，通过自然语言控制Windows GUI操作。

- **Stars:** ⭐️ 1.3k
- **Tags:** `computer-using-agent` `gui-automation` `spatial-reasoning`
- **最后活动时间:** 2025-02-13

### [onecli](https://github.com/onecli/onecli)

开源凭证保险库，让AI智能体安全访问各类服务而无需暴露密钥，支持MCP协议。
...
基于Google Gemini和LangChain的AI驱动渗透测试自动化CLI工具，可编排智能化的渗透测试工作流程。

- **Stars:** ⭐️ 1.3k
- **Tags:** `ai-penetration-testing` `gemini-ai` `langchain` `automation` `security`
- **最后活动时间:** 2026-02-27

### [langmanus](https://github.com/Darwin-lfl/langmanus)

社区驱动的AI自动化框架，结合LLM与专业工具实现复杂任务的自动化处理。
...
高效的自进化智能体系统，通过强化学习实现智能体的自主进化能力。
...
一个具有代理能力的机器学习工程师自动化工具，探索Agentic AI应用。

- **Stars:** ⭐️ 1.3k
- **Tags:** `agentic-ai` `automl` `machine-learning`
- **最后活动时间:** 2025-12-07

### [envpool](https://github.com/sail-sg/envpool)

基于C++的高性能并行环境执行引擎，专为强化学习环境设计，支持Atari、MuJoCo等多种环境。
...
EMNLP 2025 Oral论文项目，为个性化AI智能体提供记忆操作系统，支持长期记忆与RAG检索增强。
...
Claude Code 持续循环运行工具，可自主创建 PR、等待检查并自动合并。
...
将旧手机转变为AI智能体，通过ADB实现屏幕理解和自动化操作。

- **Stars:** ⭐️ 1.3k
- **Tags:** `mobile-agent` `adb-automation` `screen-understanding`
- **最后活动时间:** 2026-02-28

### [agent-device](https://github.com/callstackincubator/agent-device)

供AI智能体控制iOS和Android设备的命令行工具。
...
面向长周期自主科学发现的统一智能体框架，支持假设生成、代码编写与论文撰写。
...
MCP 服务器，让多个 Claude Code 实例之间实现即时消息通信。
...
基于 Claude Code Skills 构建的视频剪辑智能体，支持自动化视频处理与编辑流程。

- **Stars:** ⭐️ 1.2k
- **Tags:** `claude` `video-editing` `agent` `automation`
- **最后活动时间:** 2026-02-09

### [agi](https://github.com/hyperspaceai/agi)

首个分布式AGI系统，数千个自主AI代理协作训练模型、通过P2P共享实验，推动AI突破。

- **Stars:** ⭐️ 1.2k
- **Tags:** `AGI` `AI Agents` `Distributed AI` `P2P`
- **最后活动时间:** 2026-03-26

### [KwaiAgents](https://github.com/KwaiKEG/KwaiAgents)

基于大语言模型的通用信息检索代理系统，支持自主信息搜索。

- **Stars:** ⭐️ 1.2k
- **Tags:** `autonomous-agents` `llm` `information-seeking` `chatgpt`
- **最后活动时间:** 2024-06-19

### [agent](https://github.com/stakpak/agent)

开源自主代理，7x24小时驻守服务器自动部署和维护应用程序。
...
- **Stars:** ⭐️ 1.2k
- **Tags:** `ai` `data-science` `llm` `machine-learning`
- **最后活动时间:** 2026-02-12
...
基于视觉语言模型的开源GUI智能体，可实现端到端的图形界面自动化操作。
...
从零开始实现一个简洁清晰的深度搜索智能体，适合学习Agent开发原理与实践。

- **Stars:** ⭐️ 1.1k
- **Tags:** `deep-search` `agent` `ai-agent` `search-agent`
- **最后活动时间:** 2025-08-19

### [enterprise-deep-research](https://github.com/SalesforceAIResearch/enterprise-deep-research)

Salesforce开源的企业级深度研究智能体系统，支持多智能体协作与LLM基准测试。
...
多成员、结构化长期记忆的容器化AI代理系统。支持复杂记忆管理和多代理协作。

- **Stars:** ⭐️ 1.1k
- **Tags:** `long-memory` `agent-system` `containerized` `ai`
- **最后活动时间:** 2026-03-25
...
面向虚拟3D空间端到端电影自动化的多智能体框架，支持自动化影视创作流程。
...
完全自主的AI软件开发助手，支持低代码/无代码开发模式，实现智能化的编程辅助体验。
...
面向自动驾驶的可扩展多智能体强化学习训练平台，支持复杂交通场景仿真。

- **Stars:** ⭐️ 1.1k
- **Tags:** `autonomous-driving` `reinforcement-learning` `multi-agent` `simulator`
- **最后活动时间:** 2025-01-31

### [MedRAX](https://github.com/bowang-lab/MedRAX)

ICML 2025论文，面向胸部X光分析的医疗推理智能体，结合LangChain实现临床诊断推理。

- **Stars:** ⭐️ 1.1k
- **Tags:** `medical-ai` `reasoning-agent` `chest-xray` `healthcare`
- **最后活动时间:** 2025-10-31

### [ToRA](https://github.com/microsoft/ToRA)

ICLR'24论文项目，工具集成推理LLM智能体，专注于解决复杂数学推理问题。

- **Stars:** ⭐️ 1.1k
- **Tags:** `llm` `mathematical-reasoning` `tool-learning` `agents`
- **最后活动时间:** 2024-02-22
...
### [terminal-velocity](https://github.com/mind-protocol/terminal-velocity)

一部由10个AI智能体团队自主协作创作的小说，展示了多智能体自主协作的创意写作能力。

- **Stars:** ⭐️ 1.1k
- **Tags:** `ai-agents` `autonomous-agents` `creative-writing` `multi-agent`
- **最后活动时间:** 2025-01-06

### [evo.ninja](https://github.com/agentcoinorg/evo.ninja)

多功能通用型AI智能体，能够自主适应和执行各类任务。

- **Stars:** ⭐️ 1.1k
- **Tags:** `autonomous-agent` `generalist-agent` `ai-agent`
- **最后活动时间:** 2024-07-19
...
DeepMind IMPALA架构的TensorFlow实现，支持可扩展分布式深度强化学习。

- **Stars:** ⭐️ 1.0k
- **Tags:** `reinforcement-learning` `distributed` `deepmind` `impala`
- **最后活动时间:** 2019-03-13

### [generative-agents](https://github.com/mkturkcan/generative-agents)

斯坦福生成式智能体论文的本地实现，低成本模拟人类行为的交互式智能体。

- **Stars:** ⭐️ 994
- **Tags:** `generative-agents` `autonomous-agents` `simulation`
- **最后活动时间:** 2025-01-16

### [OpenAlpha_Evolve](https://github.com/shyamsaktawat/OpenAlpha_Evolve)

受DeepMind AlphaEvolve启发的开源框架，实现自主编程代理和进化算法优化。

- **Stars:** ⭐️ 992
- **Tags:** `coding-agent` `evolutionary-algorithm` `llm` `autonomous-agents`
- **最后活动时间:** 2025-05-31

### [always-on-ai-assistant](https://github.com/disler/always-on-ai-assistant)

基于 Deepseek-V3 和 RealtimeSTT 的常驻 AI 助手模式，适合工程开发场景。

- **Stars:** ⭐️ 986
- **Tags:** `ai-assistant` `deepseek` `realtime-stt` `voice`
- **最后活动时间:** 2025-01-12
...
### [Molt-Pi-Maker](https://github.com/DmitrySolana/Molt-Pi-Maker)

一个基于Claude Code CLI的AI代理开发指南工具，帮助开发者构建和优化AI工作流程。

- **Stars:** ⭐️ 981
- **Tags:** `ai-agent` `claude-code` `development-tools`
- **最后活动时间:** 2026-02-01

### [cali](https://github.com/callstackincubator/cali)

AI智能体辅助构建React Native应用，提升移动端开发效率。

- **Stars:** ⭐️ 975
- **Tags:** `ai-agent` `react-native` `code-generation`
- **最后活动时间:** 2025-01-16
...
NeurIPS'23 Spotlight论文，首个基于LLM的通用网页智能体及基准测试。

- **Stars:** ⭐️ 963
- **Tags:** `web-agent` `llm` `benchmark`
- **最后活动时间:** 2025-11-05

### [AgentK](https://github.com/mikekelly/AgentK)

自进化模块化的自动代理AGI系统，探索通用人工智能的自主发展路径。

- **Stars:** ⭐️ 962
- **Tags:** `agi` `autonomous-agent` `self-evolving` `autoagentic`
- **最后活动时间:** 2024-09-04

### [testzeus-hercules](https://github.com/test-zeus-ai/testzeus-hercules)

世界首个开源测试代理，支持UI、API、安全、可访问性和视觉验证。无需编码即可实现端到端测试自动化。

- **Stars:** ⭐️ 954
- **Tags:** `testing-agent` `qa-automation` `playwright` `agentic-ai`
- **最后活动时间:** 2026-03-25

### [overcooked_ai](https://github.com/HumanCompatibleAI/overcooked_ai)

人机协作基准测试环境，用于研究完全协作的AI智能体。多智能体协作研究标准基准。

- **Stars:** ⭐️ 947
- **Tags:** `multi-agent` `cooperative-ai` `benchmark`
- **最后活动时间:** 2025-03-22

### [osim-rl](https://github.com/stanfordnmbl/osim-rl)

基于肌肉骨骼模型的强化学习环境，用于生物力学和运动控制的AI研究。

- **Stars:** ⭐️ 945
- **Tags:** `reinforcement-learning` `biomechanics` `simulation-environment`
- **最后活动时间:** 2022-01-24
...
专为 LLM 智能体设计的记忆系统，实现智能体的上下文记忆能力。
...
基于多智能体的自主红队测试服务，利用AI进行渗透测试和安全漏洞检测。
...
LLM驱动的代码仓库智能代理，自动生成文档并帮助开发者快速理解代码库，支持RAG检索和仓库级调试。

- **Stars:** ⭐️ 925
- **Tags:** `Agent` `Documentation` `RAG` `Code Assistant`
- **最后活动时间:** 2024-12-23

### [fairo](https://github.com/facebookresearch/fairo)

模块化具身智能体架构与平台，用于构建和部署机器人及具身AI应用。

- **Stars:** ⭐️ 920
- **Tags:** `embodied-ai` `robotics` `autonomous-agents`
- **最后活动时间:** 2026-03-19

### [IMO25](https://github.com/lyang36/IMO25)

基于Gemini、OpenAI和XAI API构建的AI智能体系统，专门用于解决国际数学奥林匹克竞赛难题。

- **Stars:** ⭐️ 919
- **Tags:** `ai-agent` `mathematical-reasoning` `olympiad` `problem-solving`
- **最后活动时间:** 2025-10-01

### [yoyo-evolve](https://github.com/wong2/weixin-agent-sdk)

自我进化的编程智能体，每天自动提交代码改进自身能力。
...
多智能体资源优化平台，提供强化学习即服务(RaaS)，解决真实世界资源优化问题。

- **Stars:** ⭐️ 909
- **Tags:** `multi-agent` `reinforcement-learning` `resource-optimization` `rl-algorithms`
- **最后活动时间:** 2025-04-24
...
像人类一样操作Android设备的AI智能体，结合无障碍服务实现移动端智能交互与任务自动化。

- **Stars:** ⭐️ 886
- **Tags:** `Agent` `Android` `Automation`
- **最后活动时间:** 2026-01-13

### [724-office](https://github.com/wangziqi06/724-office)

自进化AI代理系统，支持26种工具、三层记忆架构和自修复功能，实现7×24小时自主运行。

- **Stars:** ⭐️ 885
- **Tags:** `Autonomous Agent` `MCP` `Self-evolving`
- **最后活动时间:** 2026-03-17

### [open-deep-research](https://github.com/fdarkaou/open-deep-research)

OpenAI和Gemini深度研究功能的开源替代方案，支持自动化研究和信息聚合。

- **Stars:** ⭐️ 882
- **Tags:** `deep-research` `ai-agent` `openai-alternative` `research-automation`
- **最后活动时间:** 2025-02-12

### [HARL](https://github.com/PKU-MARL/HARL)

异构智能体强化学习算法官方PyTorch实现。多智能体协作研究重要工具。

- **Stars:** ⭐️ 881
- **Tags:** `reinforcement-learning` `multi-agent` `heterogeneous-agents`
- **最后活动时间:** 2025-04-27
...
### [multi-agent-postgres-data-analytics](https://github.com/disler/multi-agent-postgres-data-analytics)

基于多智能体架构的PostgreSQL数据分析工具，通过AI智能体实现自然语言交互式数据查询与分析。

- **Stars:** ⭐️ 875
- **Tags:** `multi-agent` `postgres` `data-analytics` `ai-agents`
- **最后活动时间:** 2024-07-24

### [OpenManus](https://github.com/henryalps/OpenManus)

开源的通用AI智能体，复现Manus AI的核心能力，可自主执行复杂任务。

- **Stars:** ⭐️ 873
- **Tags:** `autonomous-agent` `general-ai` `task-automation`
- **最后活动时间:** 2025-06-26
...
基于LangChain构建的弹性多功能智能体框架，能够执行各种用户请求，如同eval方法一样灵活强大。

- **Stars:** ⭐️ 870
- **Tags:** `langchain` `agent` `autonomous-agent` `llm`
- **最后活动时间:** 2023-05-30
...
基于大语言模型的智能体项目，专注于新型自动化范式——智能体流程自动化(Agentic Process Automation)。

- **Stars:** ⭐️ 860
- **Tags:** `llm-agent` `automation` `agentic-workflow`
- **最后活动时间:** 2023-12-27

### [ralphex](https://github.com/umputun/ralphex)

扩展的Ralph循环工具，支持AI驱动的自主计划执行与代码审查自动化。

- **Stars:** ⭐️ 852
- **Tags:** `automation` `claude-code` `codex` `ai-agents`
- **最后活动时间:** 2026-03-25
...
NeurIPS 2025论文实现，为LLM智能体提供代理式记忆系统，增强代理的记忆与推理能力。

- **Stars:** ⭐️ 836
- **Tags:** `llm-agents` `memory-system` `agentic` `neurips2025`
- **最后活动时间:** 2026-03-05

### [reaper](https://github.com/ghostsecurity/reaper)

一款AI驱动的安全测试代理工具，用于实时验证和检测Web应用漏洞。
...
EMNLP'25论文，通过强化学习高效训练RAG搜索智能体。

- **Stars:** ⭐️ 827
- **Tags:** `search-agent` `rag` `reinforcement-learning` `agentic-ai`
- **最后活动时间:** 2025-11-05

### [microagents](https://github.com/aymenfurter/microagents)

具备自我编辑能力的AI智能体框架，支持动态修改提示词和Python代码。

- **Stars:** ⭐️ 803
- **Tags:** `llm` `gpt-4` `agents` `self-modifying`
- **最后活动时间:** 2024-03-15

### [babyagi-asi](https://github.com/oliveirabruno01/babyagi-asi)

自主且自我改进的AI智能体框架，结合链式思维和程序思维探索AGI方向。

- **Stars:** ⭐️ 800
- **Tags:** `AGI` `Self-Improving` `Autonomous`
- **最后活动时间:** 2023-06-02

### [autobe](https://github.com/wrtnlabs/autobe)

AI驱动的TypeScript后端代码生成代理，结合编译器技术自动生成100%可运行的CRUD服务端代码。
...
展现LLM人类行为模拟能力的智能体系统，探索AI社交交互前沿。

- **Stars:** ⭐️ 785
- **Tags:** `ai-agent` `llm` `langchain` `simulation`
- **最后活动时间:** 2023-09-21

### [playground](https://github.com/MultiAgentLearning/playground)

多智能体学习研究平台，专注于AI智能体的多智能体协作与学习算法研究。

- **Stars:** ⭐️ 784
- **Tags:** `multi-agent` `reinforcement-learning` `research` `simulation`
- **最后活动时间:** 2023-12-19

### [ClawTeam-OpenClaw](https://github.com/win4r/ClawTeam-OpenClaw)

多智能体群体协调框架，基于OpenClaw实现智能体集群协作与群体智能编排。
...
NeurIPS 2025论文，智能体驱动的任意图像到4K超分辨率系统，结合LLM实现自动化图像修复工作流。

- **Stars:** ⭐️ 775
- **Tags:** `agentic-ai` `super-resolution` `llm` `image-restoration`
- **最后活动时间:** 2025-09-24

### [fuzzforge_ai](https://github.com/FuzzingLabs/fuzzforge_ai)

AI驱动的工作流自动化平台，专注于AppSec、模糊测试和攻击性安全自动化。
...
自主AI代理，能够接单工作、完成任务、获取报酬并持续自我学习进化。

- **Stars:** ⭐️ 770
- **Tags:** `ai-agent` `autonomous-agent` `llm` `tool-use`
- **最后活动时间:** 2026-03-14

### [evolving_personality](https://github.com/agent-topia/evolving_personality)

基于卡尔·荣格理论的LLM智能体MBTI人格动态演化框架，让AI人格通过交互自然成长。

- **Stars:** ⭐️ 769
- **Tags:** `personality` `llm-agent` `mbti` `psychology`
- **最后活动时间:** 2026-03-17

### [data-to-paper](https://github.com/Technion-Kishony-lab/data-to-paper)

AI驱动的科学研究平台，自动化从数据分析到论文撰写的完整科研流程，支持研究过程的透明追溯与可重复性验证。

- **Stars:** ⭐️ 767
- **Tags:** `自主智能体` `科学研究` `LLM应用`
- **最后活动时间:** 2025-07-19

### [LLaVA-Plus-Codebase](https://github.com/LLaVA-VL/LLaVA-Plus-Codebase)

大型语言与视觉助手，支持插件式学习和技能调用。

- **Stars:** ⭐️ 766
- **Tags:** `multimodal-agent` `tool-use` `vision-language` `large-multimodal-models`
- **最后活动时间:** 2024-02-01

### [auto-gpt-web](https://github.com/jina-ai/auto-gpt-web)

AutoGPT的Web桌面客户端，让用户设定目标后由AI自主完成，基于Electron构建。

- **Stars:** ⭐️ 763
- **Tags:** `AutoGPT` `Agent` `GPT-4`
- **最后活动时间:** 2023-04-13

### [nao](https://github.com/getnao/nao)

开源分析代理，支持文本转SQL、数据分析和商业智能，可部署聊天界面和Slack机器人。
...
基于CrewAI的智能视频编辑助手，自动化处理视频内容创作流程。

- **Stars:** ⭐️ 749
- **Tags:** `CrewAI` `Video Editing` `Agents`
- **最后活动时间:** 2026-02-16

### [handy-multi-agent](https://github.com/datawhalechina/handy-multi-agent)

基于CAMEL框架的多智能体教程，从零开始构建智能体社会，深入理解多智能体协作机制。

- **Stars:** ⭐️ 748
- **Tags:** `multi-agent` `camel` `llm-agents` `agent-framework`
- **最后活动时间:** 2026-01-16
...
AI驱动的PC桌面自动化智能体，支持智能任务执行和桌面操作自动化。
...
AI Agent技能集合，用于解决CTF安全挑战，支持Web渗透、二进制漏洞、密码学、逆向工程、取证分析等多种安全领域。
...
语言无关的AI审计智能体，自动构建知识图谱进行深度迭代代码推理。
...
使用Keras和深度确定性策略梯度（DDPG）算法训练AI玩TORCS赛车游戏。

- **Stars:** ⭐️ 729
- **Tags:** `reinforcement-learning` `ddpg` `autonomous-driving` `keras`
- **最后活动时间:** 2017-12-04
...
自动投递求职申请的AI智能体，支持任意网站和表单。

- **Stars:** ⭐️ 722
- **Tags:** `agents` `job-application` `automation` `form-filling`
- **最后活动时间:** 2026-03-08
...
7×24小时桌面AI智能体，支持远程访问、文件管理和内置AI浏览器，为用户提供全天候视觉AI助手服务。

- **Stars:** ⭐️ 713
- **Tags:** `AI Agent` `Desktop` `Remote Access`
- **最后活动时间:** 2026-03-18

### [langup-ai](https://github.com/jiran214/langup-ai)

AGI社交网络机器人。支持B站直播数字人、视频自动回复、语音交互等功能。

- **Stars:** ⭐️ 713
- **Tags:** `social-bot` `bilibili` `digital-human` `langchain`
- **最后活动时间:** 2024-03-30
...
### [AI-Investigator](https://github.com/muratcankoylan/AI-Investigator)

基于Claude 3.5 Sonnet和Firecrawl的自动化内容分析框架，可分析网站内容并生成结构化报告。

- **Stars:** ⭐️ 705
- **Tags:** `自动化分析` `Claude` `报告生成`
- **最后活动时间:** 2024-11-05
...
通过强化学习激励大语言模型的搜索能力，提升LLM在复杂检索任务中的表现。

- **Stars:** ⭐️ 700
- **Tags:** `llm` `search` `reinforcement-learning` `reasoning`
- **最后活动时间:** 2025-08-05
...
使用深度强化学习训练AI智能体自主玩马里奥游戏的项目，展示了RL在游戏领域的应用。

- **Stars:** ⭐️ 695
- **Tags:** `reinforcement-learning` `deep-learning` `game-ai` `pytorch`
- **最后活动时间:** 2016-05-26

### [cuga-agent](https://github.com/cuga-project/cuga-agent)

开源企业级通用智能体，支持Web和API复杂任务执行，集成OpenAPI/MCP，具备推理能力和策略感知特性。
...
共生型AI智能体，能够记忆对话内容、主动挑战用户观点并扩展认知能力。
...
多智能体协调系统，类似AI智能体的Trello看板管理工具，帮助组织和编排多个AI代理的协作任务。

- **Stars:** ⭐️ 690
- **Tags:** `AI Agents` `Multi-agent` `Coordination`
- **最后活动时间:** 2026-02-23

### [sd-webui-agent-scheduler](https://github.com/SipherAGI/sd-webui-agent-scheduler)

面向生成式AI的开源调度智能体，支持任务队列管理和自动化调度执行。

- **Stars:** ⭐️ 690
- **Tags:** `scheduling-agent` `generative-ai` `automation` `stable-diffusion`
- **最后活动时间:** 2025-01-13
...
自编程AI代理项目。基于GPT-4构建，探索AI自主编写和改进代码的能力。

- **Stars:** ⭐️ 677
- **Tags:** `self-coding` `autonomous-agents` `gpt-4` `agi`
- **最后活动时间:** 2023-09-05
...
一个能够自我进化的AI编程Agent，每天自动提交代码迭代，探索AI自主编程的边界。
...
### [Test-Agent](https://github.com/codefuse-ai/Test-Agent)

基于LLM的软件测试智能体，赋能自动化测试流程，国内首个工业级测试Agent解决方案。

- **Stars:** ⭐️ 667
- **Tags:** `llm-agent` `software-testing` `automation` `testing-tools`
- **最后活动时间:** 2024-03-04

### [GA3C](https://github.com/NVlabs/GA3C)

A3C深度强化学习算法的CPU/GPU混合实现，用于训练自主智能体。

- **Stars:** ⭐️ 662
- **Tags:** `reinforcement-learning` `a3c` `deep-learning` `gpu` `autonomous-agents`
- **最后活动时间:** 2020-02-25

### [TorchCraftAI](https://github.com/TorchCraft/TorchCraftAI)

用于构建星际争霸游戏 AI 智能体的开源平台，支持强化学习研究。

- **Stars:** ⭐️ 657
- **Tags:** `reinforcement-learning` `starcraft` `ai-agents` `game-ai`
- **最后活动时间:** 2021-08-31
...
TRPO及相关强化学习算法的模块化实现，适用于策略优化研究与应用。

- **Stars:** ⭐️ 648
- **Tags:** `reinforcement-learning` `trpo` `policy-optimization` `deep-rl`
- **最后活动时间:** 2018-05-20
...
基于大语言模型的Minecraft通用智能体，具备文本知识与记忆能力。

- **Stars:** ⭐️ 638
- **Tags:** `llms` `minecraft` `autonomous-agent` `reinforcement-learning`
- **最后活动时间:** 2023-06-05
...
自主软件工程AI智能体舰队，支持PR规划、编码、测试和发布全流程，采用多智能体协作架构。
...
AI驱动的软件工程多智能体系统，通过研究者和开发者智能体自动化代码实现。
...
### [trainable-agents](https://github.com/choosewhatulike/trainable-agents)

Character-LLM研究项目代码与数据集，用于训练可扮演角色的智能体。

- **Stars:** ⭐️ 616
- **Tags:** `llm` `agent` `character` `sft`
- **最后活动时间:** 2024-10-29
...
### [Options-Analytics-Agent](https://github.com/nuglifeleoji/Options-Analytics-Agent)

基于LangGraph构建的金融期权分析智能体，支持Polygon.io实时数据、智能缓存和持久化记忆，专为交易员和分析师设计。

- **Stars:** ⭐️ 610
- **Tags:** `langgraph` `ai-agent` `options-trading` `financial-analysis`
- **最后活动时间:** 2025-12-15

### [xLAM](https://github.com/SalesforceAIResearch/xLAM)

大型动作模型系列，专为赋能AI智能体系统而设计。
...
专注于治疗推理的AI智能体，能够调用多种工具进行药物相关决策支持。

- **Stars:** ⭐️ 607
- **Tags:** `agents` `therapeutics` `reasoning-agent` `tool-use`
- **最后活动时间:** 2025-07-30

### [Agently-Daily-News-Collector](https://github.com/AgentEra/Agently-Daily-News-Collector)

基于 Agently AI 框架的自动化新闻采集工作流，展示 LLM Agent 在信息收集场景的实际应用。

- **Stars:** ⭐️ 606
- **Tags:** `llm-agent` `news-agent` `automation` `workflow`
- **最后活动时间:** 2026-03-10
...
多智能体强化学习基准测试库，支持快速比较不同MARL算法、任务和模型，注重可复现性和标准化。

- **Stars:** ⭐️ 591
- **Tags:** `marl` `benchmark` `multi-agent` `reinforcement-learning` `pytorch`
- **最后活动时间:** 2026-02-07

### [dreamGPT](https://github.com/DivergentAI/dreamGPT)

利用LLM幻觉进行新颖性探索的智能体框架，支持创意生成与自动化探索。

- **Stars:** ⭐️ 590
- **Tags:** `llm` `agents` `generative-model` `automation`
- **最后活动时间:** 2024-05-07
...
AI海洋世界多智能体平台，支持社交协作、任务分配与计算资源共享。开源实现SeaSeed.ai多智能体系统。

- **Stars:** ⭐️ 588
- **Tags:** `multi-agent` `ai` `agent-platform` `collaboration`
- **最后活动时间:** 2026-02-15

### [dreamer](https://github.com/danijar/dreamer)

通过潜在想象学习行为的强化学习算法，实现基于世界模型的控制策略学习。

- **Stars:** ⭐️ 585
- **Tags:** `world-models` `reinforcement-learning` `deep-learning` `model-based-rl`
- **最后活动时间:** 2021-09-10

### [ScreenAgent](https://github.com/niuzaisheng/ScreenAgent)

IJCAI 2024论文，基于视觉语言大模型的计算机控制智能体，可实现屏幕操作自动化。

- **Stars:** ⭐️ 583
- **Tags:** `Computer Control` `VLM` `Agent`
- **最后活动时间:** 2024-11-25

### [powermem](https://github.com/oceanbase/powermem)

AI驱动的长期记忆系统，为AI代理提供精准、敏捷、经济的上下文管理能力，支持向量数据库存储。
...
本地 AI 智能体搜索工具，支持网络搜索和自托管应用集成。

- **Stars:** ⭐️ 579
- **Tags:** `ai` `agents` `search` `local` `self-hosted`
- **最后活动时间:** 2024-11-17
...
二合一AI开发者与项目管理工具，AI智能体可在Todoist中规划整个项目并逐任务编写代码。

- **Stars:** ⭐️ 574
- **Tags:** `ai-agent` `code-generation` `project-management` `automation`
- **最后活动时间:** 2025-10-02

### [auto-tinder](https://github.com/joelbarmettlerUZH/auto-tinder)

使用AI自动玩Tinder的自动化代理项目，展示目标检测和决策系统的应用。

- **Stars:** ⭐️ 566
- **Tags:** `ai-agent` `automation` `tensorflow` `object-detection`
- **最后活动时间:** 2025-02-11

### [openhanako](https://github.com/liliMozi/openhanako)

基于Electron构建的个人AI智能体，具备记忆、个性和自主能力。
...
ICLR 2024：面向语言智能体的开源基础模型，支持代码生成和文本推理。

- **Stars:** ⭐️ 557
- **Tags:** `language-model` `code-generation` `text-reasoning` `agents`
- **最后活动时间:** 2023-10-28

### [brainstormers](https://github.com/Azzedde/brainstormers)

专业头脑风暴智能体套件，每个智能体提供独特视角和定制方法，帮助用户生成创新解决方案。

- **Stars:** ⭐️ 556
- **Tags:** `ai-agents` `nextjs`
- **最后活动时间:** 2025-08-02
...
智能AI个人助手，具备记忆、技能和定时任务功能，真正理解用户需求，帮助处理工作和生活中的各种事务。

- **Stars:** ⭐️ 553
- **Tags:** `ai-agent` `personal-assistant` `claude` `automation`
- **最后活动时间:** 2026-03-26

### [Auto-GPT-MetaTrader-Plugin](https://github.com/isaiahbjork/Auto-GPT-MetaTrader-Plugin)

AutoGPT的MetaTrader插件，让AI智能体能够连接MT4/MT5交易账户进行自动化交易操作。

- **Stars:** ⭐️ 548
- **Tags:** `AutoGPT` `Trading` `MetaTrader`
- **最后活动时间:** 2023-11-12

### [Magic-Insight](https://github.com/luguanglong/Magic-Insight)

一站式数据智能体，支持文档、数据库、业务系统和图像等多种数据格式的智能分析与洞察，通过RAG技术实现单对话框多源数据问答。

- **Stars:** ⭐️ 548
- **Tags:** `Data Agent` `RAG` `ChatBI` `数据分析`
- **最后活动时间:** 2024-11-06
...
基于kimi-k2-thinking模型的AI写作智能体，能够自主创作小说和故事，具备深度推理能力。

- **Stars:** ⭐️ 545
- **Tags:** `ai-writing` `creative-agent` `story-generation` `autonomous`
- **最后活动时间:** 2026-01-29

### [infinite-agentic-loop](https://github.com/disler/infinite-agentic-loop)

实验性无限代理循环项目，演示双提示系统下的自主代理运行模式。

- **Stars:** ⭐️ 544
- **Tags:** `agents` `claude-code` `autonomous` `experimental`
- **最后活动时间:** 2026-03-09

### [VideoAgent](https://github.com/HKUDS/VideoAgent)

一体化视频智能体框架，支持视频理解、编辑与重构的全流程处理。
...
### [Game-Bot](https://github.com/ardamavi/Game-Bot)

通过观察人类玩家学习游戏的AI智能体，使用深度学习和强化学习技术。

- **Stars:** ⭐️ 543
- **Tags:** `deep-learning` `reinforcement-learning` `game-ai` `keras`
- **最后活动时间:** 2023-05-27

### [Multi-Agents-Debate](https://github.com/Skytliang/Multi-Agents-Debate)

首个探索大语言模型多智能体辩论的开创性工作。

- **Stars:** ⭐️ 540
- **Tags:** `multi-agent` `debate` `llm` `nlp`
- **最后活动时间:** 2025-12-16

### [Arnold](https://github.com/glample/Arnold)

基于强化学习的DOOM游戏智能体，使用Q-learning实现自主游戏。

- **Stars:** ⭐️ 537
- **Tags:** `reinforcement-learning` `game-ai` `doom-agent` `q-learning`
- **最后活动时间:** 2022-01-20

### [zeptoclaw](https://github.com/qhkm/zeptoclaw)

开源AI助手项目，基于Rust构建的智能代理工具。
...
模块化多智能体系统，专为科学研究辅助而设计。

- **Stars:** ⭐️ 533
- **Tags:** `multi-agent` `scientific-research` `modular`
- **最后活动时间:** 2026-02-09

### [OpenResearcher](https://github.com/TIGER-AI-Lab/OpenResearcher)

一个完全开放的长周期深度研究轨迹合成管道，结合LLM和检索技术实现自动化研究流程，支持复杂研究任务的自主探索与合成。
...
基于Minecraft的智能体能力基准测试平台，用于评估强化学习智能体的综合能力。

- **Stars:** ⭐️ 528
- **Tags:** `artificial-intelligence` `reinforcement-learning` `agents` `benchmark` `minecraft`
- **最后活动时间:** 2024-01-23
...
为AI智能体设计的CLI伴侣工具，提供200+命令覆盖33+款Datadog产品，让AI代理能够轻松执行可观测性操作。

- **Stars:** ⭐️ 522
- **Tags:** `cli` `ai-agent` `datadog` `observability` `agent-tools`
- **最后活动时间:** 2026-03-26

### [gpt-assistant](https://github.com/BuilderIO/gpt-assistant)

实验性自主GPT代理，具备浏览器访问能力以完成复杂任务。

- **Stars:** ⭐️ 521
- **Tags:** `autonomous-agent` `gpt` `browser-automation` `ai-assistant`
- **最后活动时间:** 2023-04-26

### [BitFun](https://github.com/GCWing/BitFun)

新一代AI助手，内置代码代理和协作代理，具备记忆、个性化和进化能力。

- **Stars:** ⭐️ 518
- **Tags:** `ai-agent` `code-agent` `cowork-agent` `remote-desktop`
- **最后活动时间:** 2026-03-26

### [RepoMaster](https://github.com/QuantaAlpha/RepoMaster)

开源AI代码代理，能够理解并操作GitHub仓库，实现自主任务解决，是Claude-Code的开源替代方案。

- **Stars:** ⭐️ 512
- **Tags:** `code-agent` `autonomous-agents` `github` `swe-agent`
- **最后活动时间:** 2025-11-05

### [Cyber-AutoAgent](https://github.com/westonbrown/Cyber-AutoAgent)

用于自主网络安全的AI智能体，支持自动化网络操作和安全任务。

- **Stars:** ⭐️ 509
- **Tags:** `cybersecurity` `autonomous-agent` `security-automation` `ai-agent`
- **最后活动时间:** 2025-11-29

### [WebShop](https://github.com/princeton-nlp/WebShop)

NeurIPS 2022论文项目，基于语言Agent的电商交互环境，支持真实网页操作任务。

- **Stars:** ⭐️ 509
- **Tags:** `language-agents` `web-interaction` `rl` `shopping`
- **最后活动时间:** 2024-09-06

### [Rikugan](https://github.com/buzzer-re/Rikugan)

面向IDA Pro和Binary Ninja的逆向工程AI代理，自动化二进制分析流程。
...
腾讯AI Lab开源的深度研究智能体，专注于复杂推理与知识检索任务。

- **Stars:** ⭐️ 508
- **Tags:** `agent` `llm` `research-agent`
- **最后活动时间:** 2025-10-17

### [DeepGamingAI_FIFA](https://github.com/ChintanTrivedi/DeepGamingAI_FIFA)

基于深度学习的FIFA 18游戏AI机器人，能够自主操控游戏进行足球比赛。

- **Stars:** ⭐️ 508
- **Tags:** `deep-learning` `game-ai` `fifa` `autonomous-agent`
- **最后活动时间:** 2020-10-04

### [agent-q](https://github.com/sentient-engineering/agent-q)

开源的高级推理与学习框架，为自主AI智能体提供强化学习和搜索规划能力。

- **Stars:** ⭐️ 504
- **Tags:** `autonomous-agents` `reasoning` `reinforcement-learning` `advanced-ai`
- **最后活动时间:** 2024-09-26
...
强大的浏览器自动化API，支持Chrome和Firefox的Headless控制，广泛用于AI智能体的网页交互场景。
...
浏览器自动化框架，为 AI 智能体提供网页交互与自动化测试能力。
...
在浏览器中运行AI智能体的Web界面工具，支持自动化网页交互和任务执行。

- **Stars:** ⭐️ 15.8k
- **Tags:** `AI-Agent` `Browser` `Web-UI` `Automation`
- **最后活动时间:** 2025-08-31

### [maxun](https://github.com/getmaxun/maxun)

开源无代码网页数据提取平台，支持AI智能数据提取，快速将网站转化为结构化API。
...
开源Chrome扩展，支持AI驱动的网页自动化，可使用自有LLM API运行多智能体工作流，是OpenAI Operator的开源替代方案。
...
基于Chrome扩展的MCP服务器，将浏览器功能暴露给Claude等AI助手，支持浏览器自动化、内容分析和语义搜索。

- **Stars:** ⭐️ 10.9k
- **Tags:** `MCP` `Chrome` `Browser Automation`
- **最后活动时间:** 2026-01-06
...
Go语言跨平台RPA和GUI自动化工具，支持自动测试和计算机操作。
...
微软研究院推出的人机协作网页智能体原型，通过直观UI界面实现AI与人类协同完成浏览器自动化任务。
...
让AI代理自主浏览网页的工具包，基于Playwright构建，为浏览器自动化AI代理提供完整沙箱环境。

- **Stars:** ⭐️ 9.3k
- **Tags:** `AI Agents` `Browser Automation` `Playwright`
- **最后活动时间:** 2026-03-01

### [pinchtab](https://github.com/pinchtab/pinchtab)

高性能浏览器自动化桥接与多实例编排工具，支持高级隐身注入和实时仪表板监控。
...
增强智能体浏览器使用能力的工具，支持网页信息抓取、追踪和智能提取，帮助Agent高效获取网页信息。

- **Stars:** ⭐️ 8.1k
- **Tags:** `Web Scraping` `LLM` `Browser Agent`
- **最后活动时间:** 2026-03-24
...
面向Agent的RPA自动化套件，支持低代码/无代码开发，集成MCP协议，适用于个人和企业级自动化场景。

- **Stars:** ⭐️ 7.4k
- **Tags:** `RPA` `Agent` `MCP` `Automation`
- **最后活动时间:** 2026-03-26

### [autoscraper](https://github.com/alirezamika/autoscraper)

基于机器学习的智能网页爬虫工具，可自动识别和提取网页数据，无需手动编写解析规则。

- **Stars:** ⭐️ 7.1k
- **Tags:** `web-scraping` `machine-learning` `automation` `python`
- **最后活动时间:** 2025-06-09

### [steel-browser](https://github.com/steel-dev/steel-browser)

专为AI智能体设计的开源浏览器API，提供开箱即用的沙盒环境，轻松实现网页自动化。

- **Stars:** ⭐️ 6.7k
- **Tags:** `Browser Automation` `AI Agents`
- **最后活动时间:** 2026-03-25

### [venom](https://github.com/vynect/venom)

WhatsApp自动化框架，支持AI聊天机器人、媒体收发和交互模拟，提供免费版和PRO版功能升级。

- **Stars:** ⭐️ 6.6k
- **Tags:** `whatsapp-bot` `chatbot` `automation` `puppeteer`
- **最后活动时间:** 2025-07-06

### [LaVague](https://github.com/lavague-ai/LaVague)

大型动作模型框架，用于开发AI网页智能体，实现浏览器自动化操作。

- **Stars:** ⭐️ 6.3k
- **Tags:** `Web Agent` `Large Action Model` `Browser Automation`
- **最后活动时间:** 2025-01-21

### [TagUI](https://github.com/aisingapore/TagUI)

AI Singapore 开源的免费 RPA 工具，支持自然语言驱动的自动化流程。
...
模型上下文协议服务器，让 AI 应用控制浏览器进行自动化操作，支持 Claude、Cursor 等工具实现智能网页交互。

- **Stars:** ⭐️ 6.2k
- **Tags:** `MCP` `Browser Automation` `AI Agent`
- **最后活动时间:** 2025-04-24

### [shortest](https://github.com/antiwork/shortest)

基于自然语言的AI端到端测试框架，用户可以用自然语言描述测试用例，AI自动执行浏览器自动化测试。

- **Stars:** ⭐️ 5.5k
- **Tags:** `ai-testing` `natural-language` `e2e-testing` `playwright` `anthropic`
- **最后活动时间:** 2025-08-18

### [RPA-Python](https://github.com/tebelorg/RPA-Python)

基于Python的RPA自动化库，结合OpenCV实现跨平台的视觉自动化操作。

- **Stars:** ⭐️ 5.5k
- **Tags:** `rpa` `automation` `python`
- **最后活动时间:** 2025-09-11

### [mcp-playwright](https://github.com/executeautomation/mcp-playwright)

基于Playwright的MCP服务器，支持在Claude Desktop、Cline、Cursor等环境中自动化浏览器和API操作。
...
Claude技能模块，让AI代理获得网页浏览器操作能力，基于Playwright实现自动化交互。

- **Stars:** ⭐️ 4.5k
- **Tags:** `Browser Automation` `Claude Code` `Playwright`
- **最后活动时间:** 2026-03-25
...
### [browser-agent](https://github.com/magnitudedev/browser-agent)

开源的视觉优先浏览器代理，支持自动化网页操作和测试。

- **Stars:** ⭐️ 4.0k
- **Tags:** `ai` `automation` `browser` `playwright` `selenium`
- **最后活动时间:** 2026-02-08

### [pyppeteer](https://github.com/pyppeteer/pyppeteer)

基于Puppeteer的Python无头浏览器自动化库，支持网页抓取和自动化测试，常用于AI智能体的网页浏览能力构建。

- **Stars:** ⭐️ 3.9k
- **Tags:** `automation` `chromium` `puppeteer` `headless-browser`
- **最后活动时间:** 2024-06-29

### [nodriver](https://github.com/ultrafunkamsterdam/nodriver)

Undetected-Chromedriver的继任者，提供快速网页自动化框架，可绕过Captcha、CloudFlare等反机器人系统。

- **Stars:** ⭐️ 3.9k
- **Tags:** `browser-automation` `webscraping` `anti-bot` `python` `selenium`
- **最后活动时间:** 2026-03-11

### [puppeteer-sharp](https://github.com/hardkoded/puppeteer-sharp)

.NET版本的Puppeteer无头浏览器自动化库，支持网页抓取和E2E测试，可用于构建具备网页交互能力的AI智能体。
...
强大的 WhatsApp 自动化工具，支持构建智能聊天机器人和浏览器自动化代理，适用于客服自动化场景。

- **Stars:** ⭐️ 3.4k
- **Tags:** `whatsapp` `chatbot` `automation` `browser-automation`
- **最后活动时间:** 2025-10-04

### [playwright-go](https://github.com/playwright-community/playwright-go)

Go 语言的 Playwright 浏览器自动化库，通过单一 API 控制 Chromium、Firefox 和 WebKit 浏览器。
...
让AI Agent控制浏览器的Chrome扩展，支持有状态沙箱运行Playwright脚本，提供CLI和MCP接口。

- **Stars:** ⭐️ 3.2k
- **Tags:** `Browser` `MCP` `Playwright` `Agent`
- **最后活动时间:** 2026-03-24

### [wppconnect](https://github.com/wppconnect-team/wppconnect)

开源WhatsApp Web自动化框架，支持AI聊天机器人、客服系统和智能交互功能。
...
MCP服务器，让大语言模型能够通过Browserbase和Stagehand控制浏览器进行自动化操作。

- **Stars:** ⭐️ 3.2k
- **Tags:** `mcp` `llm` `browser-automation` `ai` `playwright`
- **最后活动时间:** 2026-03-25

### [automagica](https://github.com/automagica/automagica)

AI驱动的智能RPA自动化平台，支持桌面和网页自动化。

- **Stars:** ⭐️ 3.1k
- **Tags:** `ai` `automation` `rpa` `python` `desktop-automation`
- **最后活动时间:** 2020-10-13

### [ai-crawler-py](https://github.com/oxylabs/ai-crawler-py)

基于自然语言提示的AI网页爬虫，可自动发现相关页面并提取结构化数据。

- **Stars:** ⭐️ 2.8k
- **Tags:** `ai-crawler` `web-crawler` `ai-agents` `web-scraping`
- **最后活动时间:** 2025-10-13
...
让AI代理访问您的Chrome浏览器会话，实现开箱即用的浏览器自动化操作。

- **Stars:** ⭐️ 2.7k
- **Tags:** `Browser Automation` `Chrome` `AI Agents`
- **最后活动时间:** 2026-03-18

### [vimGPT](https://github.com/ishan0102/vimGPT)

结合GPT-4V和Vimium实现AI驱动的网页浏览自动化。

- **Stars:** ⭐️ 2.7k
- **Tags:** `gpt-4v` `browser-automation` `vimium`
- **最后活动时间:** 2024-09-25

### [index](https://github.com/lmnr-ai/index)

SOTA开源浏览器代理，能够自主执行复杂的网页任务。支持Claude和Gemini等模型驱动。

- **Stars:** ⭐️ 2.3k
- **Tags:** `browser-agent` `sota` `web-automation` `llm`
- **最后活动时间:** 2025-06-09

### [bb-browser](https://github.com/epiral/bb-browser)

让浏览器成为API，为AI智能体提供CLI和MCP服务器来控制Chrome浏览器，保留登录状态。
...
基于多模态大语言模型的hCaptcha验证码识别解决方案，结合YOLO和CLIP实现自动化处理。

- **Stars:** ⭐️ 2.2k
- **Tags:** `Captcha` `Multimodal` `Agent` `YOLO`
- **最后活动时间:** 2026-01-28
...
Claude Code 的 Playwright 浏览器自动化技能插件，支持自主编写和执行自动化测试。

- **Stars:** ⭐️ 2.2k
- **Tags:** `claude-code` `browser-automation` `playwright` `e2e-testing`
- **最后活动时间:** 2025-12-19

### [natbot](https://github.com/nat/natbot)

使用GPT-3驱动浏览器的自动化工具，实现网页自动交互。

- **Stars:** ⭐️ 1.9k
- **Tags:** `browser-automation` `agent` `gpt3`
- **最后活动时间:** 2024-06-09

### [open-operator](https://github.com/browserbase/open-operator)

基于Stagehand和Browserbase构建Web代理的模板项目，支持浏览器自动化操作。

- **Stars:** ⭐️ 1.9k
- **Tags:** `web-agent` `browser-automation` `stagehand` `operator`
- **最后活动时间:** 2026-01-22

### [notte](https://github.com/nottelabs/notte)

构建Web智能体的框架，支持在可靠的浏览器基础设施上部署无服务器Web自动化功能。
...
开箱即用的GUI智能体，支持Windows和macOS系统的自动化操作。

- **Stars:** ⭐️ 1.9k
- **Tags:** `gui-agent` `desktop-automation` `computer-use`
- **最后活动时间:** 2025-05-21

### [RPA](https://github.com/A9T9/RPA)

开源RPA软件，集成计算机视觉、OCR和Anthropic Computer Use，支持浏览器自动化。
...
自托管的无头浏览器自动化平台，基于 Camoufox 实现零检测率，专为速度、隐私和可扩展性构建。
...
为Web交互Agent提供视觉工具，支持OCR和GPT-4V，让AI能够理解和操作网页内容。

- **Stars:** ⭐️ 1.8k
- **Tags:** `Vision` `OCR` `Web Agent`
- **最后活动时间:** 2024-11-25

### [Chrome-GPT](https://github.com/richardyc/Chrome-GPT)

基于AutoGPT的Chrome浏览器自动化代理，支持通过自然语言控制桌面浏览器完成复杂任务。

- **Stars:** ⭐️ 1.7k
- **Tags:** `AutoGPT` `Browser Automation` `LangChain`
- **最后活动时间:** 2023-10-25

### [WebRPA](https://github.com/pmh1314520/WebRPA)

一款功能强大的无代码自动化工具，支持拖拽构建工作流，集成OCR识别、人脸识别等AI能力，可快速实现网页数据采集、表单填写和自动化测试。
...
为AI智能体打造的高性能浏览器操作引擎，基于Rust构建，速度提升10倍，支持高效可靠的浏览器自动化任务。

- **Stars:** ⭐️ 1.4k
- **Tags:** `AI Agents` `Browser Automation` `Rust`
- **最后活动时间:** 2026-03-26

### [webarena](https://github.com/web-arena-x/webarena)

真实的网页环境基准测试平台，用于评估自主智能体在复杂真实世界任务中的表现。

- **Stars:** ⭐️ 1.4k
- **Tags:** `Benchmark` `Web Agent` `Evaluation`
- **最后活动时间:** 2025-11-26

### [webllama](https://github.com/McGill-NLP/webllama)

基于Llama-3的智能体，能够通过对话指令自主浏览网页并执行任务。

- **Stars:** ⭐️ 1.4k
- **Tags:** `llama` `web-browsing` `autonomous-agent` `llm`
- **最后活动时间:** 2024-12-10

### [agentql](https://github.com/tinyfish-io/agentql)

连接AI与Web的工具套件，提供查询语言和Playwright集成，支持快速精准地提取网页数据。

- **Stars:** ⭐️ 1.3k
- **Tags:** `AI Agent` `Web Scraping` `Automation`
- **最后活动时间:** 2026-03-26

### [parsera](https://github.com/raznem/parsera)

轻量级LLM网页抓取库，利用大语言模型智能提取网页数据，简化爬虫开发流程。

- **Stars:** ⭐️ 1.3k
- **Tags:** `LLM` `Web Scraping` `Data Extraction`
- **最后活动时间:** 2025-12-17

### [browser-extension](https://github.com/TaxyAI/browser-extension)

基于GPT-4的浏览器自动化扩展，支持智能网页操作和任务执行。

- **Stars:** ⭐️ 1.3k
- **Tags:** `gpt-4` `browser-automation` `extension` `web-agent`
- **最后活动时间:** 2025-01-15

### [open-scouts](https://github.com/firecrawl/open-scouts)

AI驱动的网页监控平台，可创建自动化侦察代理搜索网页内容，并在发现目标时发送邮件提醒。

- **Stars:** ⭐️ 1.3k
- **Tags:** `ai-agents` `web-monitoring` `automation` `web-scraping` `openai`
- **最后活动时间:** 2026-01-30

### [web-eval-agent](https://github.com/refreshdotdev/web-eval-agent)

基于MCP协议的自主Web应用评估服务器，可自动化完成Web应用的测试与调试工作。

- **Stars:** ⭐️ 1.2k
- **Tags:** `MCP` `Web Testing` `Automation`
- **最后活动时间:** 2026-02-11
...
以Web自动化为起点的智能体驱动自动化平台，支持浏览器级别的AI代理操作。

- **Stars:** ⭐️ 1.2k
- **Tags:** `web-automation` `browser-agent` `ai-automation`
- **最后活动时间:** 2025-06-03

### [HyperAgent](https://github.com/hyperbrowserai/HyperAgent)

AI浏览器自动化代理，支持智能网页操作和任务执行。

- **Stars:** ⭐️ 1.2k
- **Tags:** `ai` `agent` `automation` `browser` `playwright`
- **最后活动时间:** 2026-02-14

### [zendriver](https://github.com/cdpdriver/zendriver)

一个快速、异步优先的不可检测网页自动化框架，专为绕过反机器人检测系统设计，支持Docker部署。

- **Stars:** ⭐️ 1.2k
- **Tags:** `browser-automation` `webscraping` `anti-bot` `python` `chrome`
- **最后活动时间:** 2026-03-12

### [browserable](https://github.com/browserable/browserable)

开源可自托管的浏览器自动化库，专为AI智能体设计，支持JavaScript和Playwright。
...
用于Web任务自动化的Gym环境，支持LLM驱动的浏览器智能体训练与评估。

- **Stars:** ⭐️ 1.2k
- **Tags:** `WebAgent` `Browser` `Automation`
- **最后活动时间:** 2026-03-17

### [browserwing](https://github.com/browserwing/browserwing)

将浏览器操作转化为MCP命令或Claude技能，让AI智能体高效可靠地控制浏览器，实现更快的自动化任务执行。

- **Stars:** ⭐️ 1.2k
- **Tags:** `AI Browser` `MCP` `Browser Automation`
- **最后活动时间:** 2026-03-24

### [AIPex](https://github.com/AIPexStudio/AIPex)

注重隐私保护的AI浏览器自动化助手，无需数据迁移，可作为Claude Chrome等工具的开源替代方案。

- **Stars:** ⭐️ 1.1k
- **Tags:** `browser-automation` `AI-agent` `privacy`
- **最后活动时间:** 2026-03-24

### [browser-agent-py](https://github.com/oxylabs/browser-agent-py)

Oxylabs开发的AI浏览器代理工具，支持通过自然语言指令自动化真实用户浏览任务。

- **Stars:** ⭐️ 1.1k
- **Tags:** `ai-agent` `browser-agent` `browser-automation` `natural-language`
- **最后活动时间:** 2025-10-22

### [GPT-4V-Act](https://github.com/ddupont808/GPT-4V-Act)

基于GPT-4V的视觉AI智能体，能够模拟鼠标键盘操作与网页UI进行交互，实现自动化浏览操作。

- **Stars:** ⭐️ 1.1k
- **Tags:** `gpt-4v` `vision-agent` `browser-automation` `web-interaction`
- **最后活动时间:** 2024-12-09

### [WebVoyager](https://github.com/MinorJerry/WebVoyager)

基于大型多模态模型的端到端网页智能体，能够自主浏览网页并完成复杂任务。

- **Stars:** ⭐️ 1.1k
- **Tags:** `web-agent` `multimodal` `browser-automation` `llm-agent`
- **最后活动时间:** 2024-03-04

### [browsernode](https://github.com/leoning60/browsernode)

让网站对AI智能体可访问的浏览器自动化工具，支持AI代理轻松执行在线任务自动化。

- **Stars:** ⭐️ 1.0k
- **Tags:** `Browser Automation` `Playwright` `AI Agents`
- **最后活动时间:** 2025-08-06

### [AutoGPT.js](https://github.com/zabirauf/AutoGPT.js)

在浏览器中运行的Auto-GPT实现，无需后端即可体验自主代理。

- **Stars:** ⭐️ 1.0k
- **Tags:** `autogpt` `browser` `gpt-4` `llm`
- **最后活动时间:** 2024-08-16

### [Browser4](https://github.com/platonai/Browser4)

专为AI智能体设计的高性能协程安全浏览器，支持复杂的网页自动化任务。
...
构建真实世界任务的浏览器代理，支持自动化网页操作。

- **Stars:** ⭐️ 1.0k
- **Tags:** `ai` `agent` `automation` `browser`
- **最后活动时间:** 2023-12-12

### [WebRover](https://github.com/hrithikkoduri/WebRover)

自主网页浏览AI智能体，通过理解用户意图自动操作网页元素完成任务。

- **Stars:** ⭐️ 995
- **Tags:** `web-agent` `browser-automation` `autonomous-agent`
- **最后活动时间:** 2025-02-15

### [browserbee](https://github.com/parsaghaffari/browserbee)

AI 驱动的浏览器助手，类似 Cline 的网页浏览自动化工具。

- **Stars:** ⭐️ 964
- **Tags:** `browser-automation` `ai-assistant` `web-browsing`
- **最后活动时间:** 2025-10-22

### [Botright](https://github.com/Vinyzu/Botright)

高级浏览器自动化框架，支持AI验证码解决和指纹伪装，基于Playwright构建。

- **Stars:** ⭐️ 953
- **Tags:** `ai` `automation` `browser` `captcha` `playwright`
- **最后活动时间:** 2025-12-12
...
ICML'24论文项目，基于GPT-4V等大型多模态模型的通用网页智能体，可自主完成任意网站上的任务操作。

- **Stars:** ⭐️ 839
- **Tags:** `agent` `web-agent` `multimodal` `GPT-4V` `browser-automation`
- **最后活动时间:** 2025-02-03

### [tiktodv3](https://github.com/kangoka/tiktodv3)
...
利用ChatGPT自动生成和执行Playwright浏览器自动化脚本，简化Web自动化流程。

- **Stars:** ⭐️ 836
- **Tags:** `playwright` `chatgpt` `automation` `browser` `web-scraping`
- **最后活动时间:** 2025-07-08

### [browser-use-mcp-server](https://github.com/kontext-dev/browser-use-mcp-server)

MCP服务器，让AI代理通过Cursor等工具直接浏览和操作网页。

- **Stars:** ⭐️ 813
- **Tags:** `MCP` `浏览器自动化` `Playwright`
- **最后活动时间:** 2025-07-10

### [vibetest-use](https://github.com/browser-use/vibetest-use)

基于Browser-Use智能体的自动化QA测试MCP服务器，实现智能化的网页应用测试。

- **Stars:** ⭐️ 779
- **Tags:** `mcp` `browser-automation` `qa-testing` `agents`
- **最后活动时间:** 2025-09-02

### [blast](https://github.com/stanford-mast/blast)

浏览器LLM自动扩展技术，优化大语言模型在浏览器环境中的推理性能。
...
基于浏览器的桌面环境，AI Agent 可通过自然语言操作各种应用程序，实现智能化的桌面自动化体验。

- **Stars:** ⭐️ 757
- **Tags:** `ai-agent` `browser` `natural-language` `desktop`
- **最后活动时间:** 2026-03-24

### [openai-testing-agent-demo](https://github.com/openai/openai-testing-agent-demo)

基于 OpenAI CUA 模型和 Responses API 的 UI 测试智能体演示项目，展示如何使用 AI 自动化浏览器交互测试。

- **Stars:** ⭐️ 755
- **Tags:** `openai` `testing-agent` `browser-automation` `cua`
- **最后活动时间:** 2025-06-17

### [mcp](https://github.com/hyperbrowserai/mcp)

Hyperbrowser的MCP服务器实现，为AI应用提供浏览器自动化能力。

- **Stars:** ⭐️ 752
- **Tags:** `mcp` `browser` `hyperbrowser` `automation`
- **最后活动时间:** 2025-11-20
...
基于GPT-4的浏览器AI智能体，支持自动化网页浏览和交互操作。

- **Stars:** ⭐️ 729
- **Tags:** `browser-agent` `gpt-4` `web-automation` `llm-agent`
- **最后活动时间:** 2023-04-25
...
浏览器控制AI智能体，能够自主搜索并申请互联网上的相关职位，实现求职自动化。

- **Stars:** ⭐️ 675
- **Tags:** `browser-agent` `job-application` `automation` `gpt`
- **最后活动时间:** 2024-09-09

### [hashbrown](https://github.com/liveloveapp/hashbrown)

基于 Angular 和 React 的浏览器智能体框架，用于构建自动化浏览器操作的 AI Agent。
...
基于自然语言的浏览器自动化工具，结合GPT-3实现智能网页操作与RPA流程自动化。

- **Stars:** ⭐️ 630
- **Tags:** `browser-automation` `generative-ai` `gpt-3` `rpa` `selenium`
- **最后活动时间:** 2024-12-21
...
### [AI-Employe](https://github.com/vignshwarar/AI-Employe)

基于 GPT-4 Vision 的浏览器自动化工具，像教人类一样通过视觉演示创建自动化流程。

- **Stars:** ⭐️ 586
- **Tags:** `automation` `gpt-4` `vision` `rpa` `browser-automation`
- **最后活动时间:** 2024-02-19

### [google-search](https://github.com/web-agent-master/google-search)

基于Playwright的Google搜索工具，绕过反爬机制并集成MCP服务器。

- **Stars:** ⭐️ 572
- **Tags:** `ai` `google-search` `mcp-server` `web-scraping` `llm`
- **最后活动时间:** 2025-04-06

### [mcp-pointer](https://github.com/etsd-tech/mcp-pointer)

MCP工具，让AI能够看到你在浏览器中指向的DOM元素，实现视觉交互式编程辅助。

- **Stars:** ⭐️ 570
- **Tags:** `MCP` `Browser` `Claude-Code`
- **最后活动时间:** 2025-11-12

### [gpt4v-browsing](https://github.com/unconv/gpt4v-browsing)

结合GPT-4 Vision API和Puppeteer实现智能网页抓取，支持视觉理解的内容提取。

- **Stars:** ⭐️ 562
- **Tags:** `gpt-4-vision` `web-scraping` `puppeteer` `automation`
- **最后活动时间:** 2024-01-31

### [alumnium](https://github.com/alumnium-hq/alumnium)

AI驱动的测试自动化框架，利用LLM实现智能化浏览器测试和自动化操作。

- **Stars:** ⭐️ 557
- **Tags:** `AI Testing` `LLM` `Browser Automation`
- **最后活动时间:** 2026-03-26

### [auto-commenter](https://github.com/rokpiy/auto-commenter)

Claude技能插件，可在目标社区自动发布个性化评论，支持Reddit等平台自动化互动。

- **Stars:** ⭐️ 546
- **Tags:** `automation` `claude-ai` `mcp` `playwright`
- **最后活动时间:** 2026-03-15

### [WebRPA](https://github.com/FaceAR/OpenFaceIOS)

功能强大的可视化自动化工具，通过拖拽模块快速构建工作流，集成OCR、人脸识别等AI能力，支持网页数据采集和自动化测试。

- **Stars:** ⭐️ 512
- **Tags:** `automation` `ocr` `face-recognition` `playwright` `rpa`
- **最后活动时间:** 2017-05-18

### [surf.new](https://github.com/steel-dev/surf.new)

OpenAI Operator的开源替代方案，实现浏览器自动化操作，让AI智能体能够自主浏览和操作网页。
...
基于Godot 4构建的上帝模拟沙盒游戏，采用多智能体AI社交模拟系统，AI角色具备独立思考和记忆能力。

- **Stars:** ⭐️ 2.2k
- **Tags:** `multi-agent` `ai-simulation` `godot` `social-simulation`
- **最后活动时间:** 2025-12-26
