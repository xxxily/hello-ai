...
[CVPR 2024] 鲁棒密集特征匹配器，可估计像素级密集变换和匹配置信度。

- **Stars:** ⭐️ 1.3k
- **Tags:** `feature-matching` `image-matching` `3d-reconstruction` `computer-vision`
- **最后活动时间:** 2026-01-23
...
基于开放词汇的3D场景图层次化构建项目，用于语言引导的机器人导航与规划。结合自然语言理解实现复杂的空间感知。

- **Stars:** ⭐️ 513
- **Tags:** `3d-scene-graph` `robot-navigation` `open-vocabulary` `embodied-ai`
- **最后活动时间:** 2026-01-19
