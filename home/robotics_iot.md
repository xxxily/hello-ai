...
基于3D表征的可泛化视觉运动策略学习，将扩散模型应用于机器人操作任务。

- **Stars:** ⭐️ 1.3k
- **Tags:** `diffusion-policy` `robotics` `visuomotor-learning` `3d-representation`
- **最后活动时间:** 2025-10-17
...
CVPR 2025 Highlight论文，实时稠密场景重建的深度学习SLAM系统。

- **Stars:** ⭐️ 1.1k
- **Tags:** `slam` `3d-reconstruction` `deep-learning` `cvpr2025`
- **最后活动时间:** 2025-10-18
