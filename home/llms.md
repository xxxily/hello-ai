...
### [ml-aim](https://github.com/apple/ml-aim)

Apple开源的大规模视觉模型研究项目，提供AIMv1和AIMv2的代码与模型权重。

- **Stars:** ⭐️ 1.4k
- **Tags:** `vision-models` `large-scale-models` `pytorch` `jax` `mlx`
- **最后活动时间:** 2025-08-04
...
专注于中型语言模型研究的开源仓库，提供语言模型训练和实验的研究框架。

- **Stars:** ⭐️ 536
- **Tags:** `language-model` `llm` `open-source` `research`
- **最后活动时间:** 2025-06-06
