...
PyTorch官方Android应用示例，展示移动端模型部署最佳实践。

- **Stars:** ⭐️ 1.6k
- **Tags:** `pytorch` `android` `mobile-deployment` `on-device-ai`
- **最后活动时间:** 2024-08-27
...
高性能分布式训练加速框架，显著提升PyTorch大规模训练效率。

- **Stars:** ⭐️ 884
- **Tags:** `pytorch` `distributed-training` `deep-learning` `rust`
- **最后活动时间:** 2024-08-01
...
PyTorch流水线并行框架，用于大规模模型分布式训练和推理加速。

- **Stars:** ⭐️ 786
- **Tags:** `pytorch` `pipeline-parallelism` `distributed-training`
- **最后活动时间:** 2024-08-21
...
PyTorch在iOS平台的示例应用，展示如何在移动端部署和运行AI模型。

- **Stars:** ⭐️ 613
- **Tags:** `pytorch` `ios` `mobile-ai` `on-device-ai`
- **最后活动时间:** 2024-08-28
