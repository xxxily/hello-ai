...
中文语音识别项目，支持普通话自动语音识别。

- **Stars:** ⭐️ 2.0k
- **Tags:** `speech-recognition` `chinese` `mandarin` `pytorch`
- **最后活动时间:** 2024-07-25

### [emotion-recognition-using-speech](https://github.com/x4nth055/emotion-recognition-using-speech)

语音情感识别项目，利用Python和Keras构建模型，从语音信号中识别人类情感。

- **Stars:** ⭐️ 675
- **Tags:** `speech-emotion-recognition` `audio-processing` `keras` `deep-learning`
- **最后活动时间:** 2023-11-03
...
生产级深度学习语音合成工具包，支持多说话人TTS、声音克隆和语音转换。

- **Stars:** ⭐️ 44.9k
- **Tags:** `Text-to-Speech` `Voice Cloning` `Deep Learning` `PyTorch`
- **最后活动时间:** 2024-08-16
...
基于检索的语音转换WebUI，仅需10分钟语音数据即可训练高质量VC模型。

- **Stars:** ⭐️ 35.0k
- **Tags:** `voice-conversion` `rvc` `voice-clone` `deep-learning`
- **最后活动时间:** 2024-11-24
...
基于SoftVC VITS的歌声转换模型，可实现高质量的歌唱声音克隆与转换。

- **Stars:** ⭐️ 28.0k
- **Tags:** `Voice Conversion` `Singing Synthesis` `VITS`
- **最后活动时间:** 2023-11-11

### [DeepSpeech](https://github.com/mozilla/DeepSpeech)

Mozilla开源的端到端语音识别引擎，支持离线实时语音转文字，可运行于树莓派到GPU服务器等多种设备。

- **Stars:** ⭐️ 26.8k
- **Tags:** `Speech Recognition` `Deep Learning` `Offline STT`
- **最后活动时间:** 2025-06-19
...
基于深度神经网络的人声分离GUI工具，支持音轨提取与伴奏分离。

- **Stars:** ⭐️ 24.0k
- **Tags:** `vocal-remover` `audio-separation` `pytorch`
- **最后活动时间:** 2025-03-13
...
业界领先的语音识别开源工具包，支持语音识别、说话人识别等任务。

- **Stars:** ⭐️ 15.4k
- **Tags:** `speech-recognition` `asr` `kaldi` `cuda`
- **最后活动时间:** 2025-09-22

### [tortoise-tts](https://github.com/neonbjb/tortoise-tts)

注重质量的多语音TTS系统，生成高保真自然语音。

- **Stars:** ⭐️ 14.8k
- **Tags:** `TTS` `Multi-voice` `High Quality`
- **最后活动时间:** 2024-11-19
...
高效的文本转语音推理框架，支持高质量语音合成。

- **Stars:** ⭐️ 11.0k
- **Tags:** `TTS` `Speech Synthesis` `Voice AI`
- **最后活动时间:** 2025-04-09

### [piper](https://github.com/rhasspy/piper)

快速、本地化的神经文本转语音系统，适合离线语音合成场景。

- **Stars:** ⭐️ 10.7k
- **Tags:** `text-to-speech` `tts` `speech-synthesis` `neural-tts`
- **最后活动时间:** 2025-08-26
...
Linux平台实时麦克风降噪工具，基于AI算法实现高质量噪声抑制。

- **Stars:** ⭐️ 10.2k
- **Tags:** `noise-suppression` `voice` `audio-processing` `linux`
- **最后活动时间:** 2025-01-13

### [TTS](https://github.com/mozilla/TTS)

Mozilla开源的深度学习文本转语音工具箱，支持Tacotron、VITS等多种模型架构，提供完整的TTS训练和推理流程。

- **Stars:** ⭐️ 10.1k
- **Tags:** `TTS` `Deep Learning` `PyTorch`
- **最后活动时间:** 2023-11-09
...
微软VALL-E X零样本TTS模型的开源实现，支持情感语音合成与声音克隆。

- **Stars:** ⭐️ 8.0k
- **Tags:** `Zero-Shot TTS` `Voice Clone` `VALL-E` `Emotional Speech`
- **最后活动时间:** 2024-02-11
...
端到端文本转语音模型，结合变分自编码器与对抗学习实现高质量语音合成。

- **Stars:** ⭐️ 7.8k
- **Tags:** `TTS` `Speech Synthesis` `PyTorch`
- **最后活动时间:** 2023-12-06
...
MyShell.ai开源的高质量多语言TTS库，支持中英日韩法西等多种语言。

- **Stars:** ⭐️ 7.3k
- **Tags:** `TTS` `Multilingual` `Speech Synthesis`
- **最后活动时间:** 2024-12-24

### [Zonos](https://github.com/Zyphra/Zonos)

基于20万小时多语言语音训练的开源TTS模型，质量媲美顶级TTS服务商。

- **Stars:** ⭐️ 7.2k
- **Tags:** `text-to-speech` `tts` `multilingual` `open-source`
- **最后活动时间:** 2025-03-05

### [dejavu](https://github.com/worldveil/dejavu)

Python音频指纹识别库，可通过音频指纹技术识别和匹配音频文件。

- **Stars:** ⭐️ 6.7k
- **Tags:** `audio-fingerprinting` `audio-recognition` `python`
- **最后活动时间:** 2024-04-22
...
Python音频分析库，提供特征提取、分类、分割等功能，支持多种音频处理应用场景。

- **Stars:** ⭐️ 6.2k
- **Tags:** `audio-analysis` `signal-processing` `machine-learning` `classification`
- **最后活动时间:** 2025-08-04

### [StyleTTS2](https://github.com/yl4579/StyleTTS2)

通过风格扩散和对抗训练实现接近人类水平的文本转语音合成系统。
...
高质量TTS模型的推理和训练库，支持自定义语音合成模型开发。

- **Stars:** ⭐️ 5.6k
- **Tags:** `text-to-speech` `tts` `training` `inference`
- **最后活动时间:** 2024-12-10
...
DeepMind WaveNet论文的TensorFlow实现，用于高质量语音合成和音频生成。

- **Stars:** ⭐️ 5.4k
- **Tags:** `wavenet` `speech-synthesis` `audio-generation` `tensorflow`
- **最后活动时间:** 2023-07-12
...
NVIDIA Tacotron 2语音合成模型PyTorch实现，支持实时语音生成。

- **Stars:** ⭐️ 5.3k
- **Tags:** `tts` `speech-synthesis` `pytorch` `nvidia`
- **最后活动时间:** 2024-06-12
...
基于语音识别技术的Windows桌面工具，可自动识别视频语音并生成SRT字幕文件。
...
VITS快速微调流水线，支持说话人自适应TTS和多对多语音转换。

- **Stars:** ⭐️ 5.0k
- **Tags:** `vits` `text-to-speech` `fine-tuning` `voice-conversion`
- **最后活动时间:** 2025-01-21
...
基于JAX实现的OpenAI Whisper模型，在TPU上可实现高达70倍的语音识别加速。

- **Stars:** ⭐️ 4.7k
- **Tags:** `whisper` `jax` `speech-recognition` `speech-to-text` `tpu`
- **最后活动时间:** 2024-04-03
...
功能丰富的Android TTS应用，内置微软演示接口，支持自定义HTTP请求、导入本地TTS引擎及智能对话识别朗读。

- **Stars:** ⭐️ 4.3k
- **Tags:** `android` `tts` `text-to-speech` `kotlin`
- **最后活动时间:** 2025-08-26
...
开源的 foundational TTS模型，支持生成富有表现力的人类语音，具备零样本语音克隆能力。

- **Stars:** ⭐️ 4.2k
- **Tags:** `TTS` `Voice Clone` `Speech Synthesis`
- **最后活动时间:** 2024-07-30

### [distil-whisper](https://github.com/huggingface/distil-whisper)

Whisper 语音识别模型的蒸馏版本，速度提升 6 倍、体积缩小 50%，词错误率仅增加 1%。

- **Stars:** ⭐️ 4.1k
- **Tags:** `speech-recognition` `whisper` `audio` `distillation` `transformer`
- **最后活动时间:** 2025-01-08

### [speech-to-text-wavenet](https://github.com/buriburisuri/speech-to-text-wavenet)

基于DeepMind WaveNet的端到端英语语音识别系统，支持句子级语音转文本。

- **Stars:** ⭐️ 4.0k
- **Tags:** `Speech Recognition` `WaveNet` `ASR` `TensorFlow`
- **最后活动时间:** 2021-10-08

### [TensorFlowTTS](https://github.com/TensorSpeech/TensorFlowTTS)

基于TensorFlow 2的实时语音合成框架，支持多语言TTS包括中英日韩德语。

- **Stars:** ⭐️ 4.0k
- **Tags:** `TTS` `Speech Synthesis` `TensorFlow` `Multi-language`
- **最后活动时间:** 2024-07-05

### [ClearerVoice-Studio](https://github.com/modelscope/ClearerVoice-Studio)

AI语音处理工具包，提供语音增强、分离和目标说话人提取等SOTA预训练模型。

- **Stars:** ⭐️ 4.0k
- **Tags:** `speech-enhancement` `speech-separation` `audio-processing` `pytorch`
- **最后活动时间:** 2025-08-14

### [DeepFilterNet](https://github.com/Rikorose/DeepFilterNet)

基于深度学习的音频降噪框架，支持实时语音增强和噪声抑制，提供高效的 Rust 和 PyTorch 实现。

- **Stars:** ⭐️ 4.0k
- **Tags:** `deep-learning` `noise-suppression` `speech-enhancement` `audio`
- **最后活动时间:** 2024-10-17

### [deep-voice-conversion](https://github.com/andabi/deep-voice-conversion)

TensorFlow实现的深度神经网络声音转换系统，用于语音风格迁移和变声应用。

- **Stars:** ⭐️ 3.9k
- **Tags:** `voice-conversion` `speech-synthesis` `tensorflow` `style-transfer`
- **最后活动时间:** 2022-09-30

### [encodec](https://github.com/facebookresearch/encodec)

Meta开源的深度学习音频编解码器，支持24kHz单声道和48kHz立体声高保真音频压缩。

- **Stars:** ⭐️ 3.9k
- **Tags:** `audio-codec` `deep-learning` `neural-audio` `meta`
- **最后活动时间:** 2024-01-04
...
### [riffusion-hobby](https://github.com/riffusion/riffusion-hobby)

基于Stable Diffusion的实时音乐生成项目，将音频频谱图作为图像进行扩散生成。

- **Stars:** ⭐️ 3.9k
- **Tags:** `Music Generation` `Diffusion` `Audio` `Stable Diffusion`
- **最后活动时间:** 2024-07-22
...
开源模块化框架，用于构建基于语音的LLM智能体，支持实时对话交互。

- **Stars:** ⭐️ 3.7k
- **Tags:** `Voice AI` `LLM Agents` `Open Source`
- **最后活动时间:** 2024-11-15
...
实现与 AI 的自然语音对话，提供流畅的实时语音交互体验。

- **Stars:** ⭐️ 3.6k
- **Tags:** `voice-chat` `speech-to-text` `real-time` `ai-conversation`
- **最后活动时间:** 2025-07-11
...
Google MusicLM的PyTorch实现，SOTA音乐生成模型，基于注意力网络。

- **Stars:** ⭐️ 3.3k
- **Tags:** `music-generation` `transformers` `pytorch` `deep-learning`
- **最后活动时间:** 2023-09-06
...
基于ML的语音识别Web应用，可直接在浏览器中运行Whisper模型进行语音转文字。

- **Stars:** ⭐️ 3.3k
- **Tags:** `whisper` `speech-recognition` `transformers` `javascript`
- **最后活动时间:** 2024-10-01
...
基于深度学习的语音分析与对比Python工具包，支持声音嵌入和相似度计算。

- **Stars:** ⭐️ 3.2k
- **Tags:** `voice-analysis` `speaker-verification` `deep-learning` `audio`
- **最后活动时间:** 2023-10-12
...
基于Llama-3.1-8B构建的低延迟高质量端到端语音交互模型，对标GPT-4o语音能力。

- **Stars:** ⭐️ 3.1k
- **Tags:** `speech-interaction` `speech-language-model` `speech-to-speech` `multimodal-llm`
- **最后活动时间:** 2025-05-19
...
VALL-E音频语言模型的非官方PyTorch实现，支持零样本语音合成。

- **Stars:** ⭐️ 3.0k
- **Tags:** `VALL-E` `Audio LM` `TTS`
- **最后活动时间:** 2023-05-10

### [tacotron](https://github.com/keithito/tacotron)

Google Tacotron语音合成模型的TensorFlow实现，含预训练模型。

- **Stars:** ⭐️ 3.0k
- **Tags:** `TTS` `TensorFlow` `Speech Synthesis`
- **最后活动时间:** 2023-07-06
...
全自动视频翻译工具，使用Whisper进行语音识别，AI大模型翻译字幕并生成翻译视频。

- **Stars:** ⭐️ 3.0k
- **Tags:** `Video Translation` `Whisper` `Speech Recognition`
- **最后活动时间:** 2025-04-07
...
基于OpenAI Whisper的实时语音转录工具，支持低延迟音频转文字。

- **Stars:** ⭐️ 2.9k
- **Tags:** `whisper` `speech-to-text` `real-time` `transcription`
- **最后活动时间:** 2025-04-15
...
Meta开源的音频驱动逼真虚拟人生成系统，从音频输入生成具有真实感表情和动作的3D虚拟形象。

- **Stars:** ⭐️ 2.9k
- **Tags:** `avatar-generation` `audio-driven` `3d-animation` `multimodal`
- **最后活动时间:** 2024-09-15

### [whisper-vits-svc](https://github.com/PlayVoice/whisper-vits-svc)

歌声转换与克隆的核心引擎，基于VITS和扩散模型实现高质量的歌唱声音转换。

- **Stars:** ⭐️ 2.9k
- **Tags:** `SVC` `Voice Conversion` `VITS` `Audio`
- **最后活动时间:** 2024-04-23

### [Automatic_Speech_Recognition](https://github.com/zzw922cn/Automatic_Speech_Recognition)

基于TensorFlow的中英文端到端自动语音识别系统，支持CNN、RNN等多种深度学习架构。

- **Stars:** ⭐️ 2.8k
- **Tags:** `speech-recognition` `tensorflow` `deep-learning`
- **最后活动时间:** 2023-03-24

### [openai-fm](https://github.com/openai/openai-fm)
...
### [jarvis](https://github.com/Priler/jarvis)
...
基于Spleeter的Windows桌面AI音源分离工具，支持将音频分离为人声、鼓点、贝斯等独立音轨。

- **Stars:** ⭐️ 2.7k
- **Tags:** `Audio Separation` `Spleeter` `Desktop App`
- **最后活动时间:** 2023-10-07

### [riffusion-app-hobby](https://github.com/riffusion/riffusion-app-hobby)

基于Stable Diffusion的实时音乐生成Web应用，通过扩散模型实现音频创作与生成。

- **Stars:** ⭐️ 2.7k
- **Tags:** `audio` `music` `stable-diffusion`
- **最后活动时间:** 2024-07-22
...
Google AudioLM的PyTorch实现，基于语言模型的高质量音频生成。

- **Stars:** ⭐️ 2.6k
- **Tags:** `audio-generation` `transformers` `pytorch`
- **最后活动时间:** 2025-01-12
...
### [STT](https://github.com/coqui-ai/STT)
...
开源多模态大模型，实现GPT-4o级别的实时视觉和语音交互能力。

- **Stars:** ⭐️ 2.5k
- **Tags:** `multimodal` `vision` `speech` `real-time` `gpt-4o`
- **最后活动时间:** 2025-03-28
...
VITS语音合成推理工具，支持高质量日中语音生成。

- **Stars:** ⭐️ 2.4k
- **Tags:** `vits` `text-to-speech` `voice-synthesis`
- **最后活动时间:** 2023-08-22

### [pytorch-kaldi](https://github.com/mravanelli/pytorch-kaldi)

结合PyTorch和Kaldi的混合语音识别系统开发框架，支持DNN/RNN架构。

- **Stars:** ⭐️ 2.4k
- **Tags:** `ASR` `PyTorch` `Kaldi`
- **最后活动时间:** 2022-03-14

### [WaveNet Vocoder](https://github.com/r9y9/wavenet_vocoder)

WaveNet神经声码器PyTorch实现，用于高质量语音合成。

- **Stars:** ⭐️ 2.4k
- **Tags:** `WaveNet` `Vocoder` `Speech Synthesis`
- **最后活动时间:** 2023-07-29

### [hifi-gan](https://github.com/jik876/hifi-gan)

基于生成对抗网络的高保真语音合成声码器，实现高效且高质量的音频生成。
...
DeepMind Tacotron-2的TensorFlow实现，高质量端到端语音合成系统。

- **Stars:** ⭐️ 2.3k
- **Tags:** `speech-synthesis` `text-to-speech` `tensorflow`
- **最后活动时间:** 2023-07-06
...
VALL-E零样本文本转语音模型的PyTorch实现，支持高质量语音合成。

- **Stars:** ⭐️ 2.2k
- **Tags:** `text-to-speech` `tts` `vall-e` `pytorch` `zero-shot`
- **最后活动时间:** 2025-09-10
...
高效的神经声码器实现，用于高质量语音合成，支持与Tacotron等模型配合使用。

- **Stars:** ⭐️ 2.2k
- **Tags:** `声码器` `语音合成` `PyTorch`
- **最后活动时间:** 2022-07-02

### [tensorflow-speech-recognition](https://github.com/pannous/tensorflow-speech-recognition)

基于TensorFlow的语音识别系统，使用Seq2Seq神经网络实现语音转文字。

- **Stars:** ⭐️ 2.2k
- **Tags:** `speech-recognition` `speech-to-text` `tensorflow`
- **最后活动时间:** 2024-01-17

### [FastSpeech2](https://github.com/ming024/FastSpeech2)

微软FastSpeech 2的高效实现，实现快速高质量的端到端文本转语音。

- **Stars:** ⭐️ 2.2k
- **Tags:** `TTS` `语音合成` `PyTorch`
- **最后活动时间:** 2023-10-27

### [deepspeech.pytorch](https://github.com/SeanNaren/deepspeech.pytorch)

基于DeepSpeech2架构的语音识别PyTorch实现，适用于端到端语音转文字任务。

- **Stars:** ⭐️ 2.1k
- **Tags:** `speech-recognition` `deepspeech` `pytorch` `asr`
- **最后活动时间:** 2022-12-13
...
基于扩散模型的音频生成PyTorch实现，支持高质量音频合成。

- **Stars:** ⭐️ 2.1k
- **Tags:** `audio-generation` `diffusion-models` `pytorch` `deep-learning`
- **最后活动时间:** 2023-06-12

### [Qwen2-Audio](https://github.com/QwenLM/Qwen2-Audio)

阿里云官方开源的音频大语言模型，支持音频理解与对话交互。

- **Stars:** ⭐️ 2.1k
- **Tags:** `audio-language-model` `qwen` `alibaba` `multimodal`
- **最后活动时间:** 2025-04-21
...
基于GAN的AI音乐生成模型，能够自动创作多轨道音乐作品。

- **Stars:** ⭐️ 2.0k
- **Tags:** `music-generation` `gan` `tensorflow`
- **最后活动时间:** 2024-06-07

### [deepvoice3_pytorch](https://github.com/r9y9/deepvoice3_pytorch)

基于PyTorch的卷积神经网络文本转语音合成模型实现。

- **Stars:** ⭐️ 2.0k
- **Tags:** `TTS` `PyTorch` `Speech Synthesis`
- **最后活动时间:** 2023-12-19
...
钢琴音频自动转录项目，将钢琴演奏音频转换为MIDI音符序列。

- **Stars:** ⭐️ 2.0k
- **Tags:** `music-transcription` `audio-processing` `piano` `automatic-music-transcription`
- **最后活动时间:** 2023-08-18

### [talk-to-chatgpt](https://github.com/C-Nedelcu/talk-to-chatgpt)

语音交互ChatGPT工具，支持语音输入和语音播放回答。

- **Stars:** ⭐️ 1.9k
- **Tags:** `chatgpt` `voice-assistant` `speech-recognition` `tts`
- **最后活动时间:** 2024-05-19
...
### [biaxial-rnn-music-composition](https://github.com/danieldjohnson/biaxial-rnn-music-composition)

使用双向RNN生成古典音乐的神经网络项目，探索AI音乐创作。

- **Stars:** ⭐️ 1.9k
- **Tags:** `music-generation` `rnn` `lstm` `creative-ai`
- **最后活动时间:** 2023-12-12

### [denoiser](https://github.com/facebookresearch/denoiser)

Interspeech 2020论文实现，实时语音增强模型，可在CPU上实时运行去除背景噪声。

- **Stars:** ⭐️ 1.9k
- **Tags:** `speech-enhancement` `audio-processing` `pytorch` `real-time`
- **最后活动时间:** 2023-03-14

### [Qwen-Audio](https://github.com/QwenLM/Qwen-Audio)

阿里云通义千问音频模型，支持中英文音频理解与对话。

- **Stars:** ⭐️ 1.9k
- **Tags:** `audio-language-model` `qwen` `alibaba` `multimodal`
- **最后活动时间:** 2024-07-05

### [vad](https://github.com/ricky0123/vad)
...
开源多模态模型，具备视觉、语音和双工通信能力，对标GPT-4o。

- **Stars:** ⭐️ 1.9k
- **Tags:** `multimodal` `vision` `speech` `open-source` `gpt-4o`
- **最后活动时间:** 2025-01-16
...
Tacotron端到端文本转语音合成模型的TensorFlow实现。
...
跨平台 GPU 加速的 Whisper 语音识别工具，支持多平台高性能语音转文字。

- **Stars:** ⭐️ 1.8k
- **Tags:** `whisper` `speech-recognition` `webgpu` `rust`
- **最后活动时间:** 2024-02-27
...
使用动态规划加速WaveNet音频生成的优化实现。

- **Stars:** ⭐️ 1.8k
- **Tags:** `wavenet` `audio-generation` `deep-learning`
- **最后活动时间:** 2017-06-20
...
基于Rectified Flow Transformers的文本到音乐生成模型。

- **Stars:** ⭐️ 1.7k
- **Tags:** `text-to-music` `diffusion` `audio-generation`
- **最后活动时间:** 2024-12-10
...
无界交错状态循环神经网络，用于说话人分离和语音识别任务。

- **Stars:** ⭐️ 1.6k
- **Tags:** `speaker-diarization` `rnn` `speech-recognition` `supervised-learning`
- **最后活动时间:** 2024-09-25

### [polymath](https://github.com/samim23/polymath)

使用机器学习将任何音乐库转换为音乐制作样本库，支持音频分离和特征提取。

- **Stars:** ⭐️ 1.6k
- **Tags:** `audio` `machine-learning` `music` `python`
- **最后活动时间:** 2024-08-17
...
Google DeepMind SoundStorm音频生成模型的PyTorch实现，支持高效并行音频合成。

- **Stars:** ⭐️ 1.5k
- **Tags:** `audio-generation` `soundstorm` `pytorch`
- **最后活动时间:** 2025-04-24
...
基于机器学习的广播流和播客广告拦截器，结合音频识别技术。

- **Stars:** ⭐️ 1.5k
- **Tags:** `ai` `machine-learning` `signal-processing` `tensorflow`
- **最后活动时间:** 2021-04-10
...
### [Voice-Cloning-App](https://github.com/voice-cloning-app/Voice-Cloning-App)

基于PyTorch的语音克隆应用，轻松合成逼真的人声。

- **Stars:** ⭐️ 1.4k
- **Tags:** `voice-cloning` `text-to-speech` `pytorch` `deep-learning`
- **最后活动时间:** 2024-12-02

### [ast](https://github.com/YuanGongND/ast)

音频频谱Transformer模型，Interspeech 2021论文实现。用于音频分类和语音命令识别。

- **Stars:** ⭐️ 1.4k
- **Tags:** `audio-classification` `speech` `transformer`
- **最后活动时间:** 2023-05-21
...
基于 OpenAI Whisper 模型的 YouTube 字幕自动生成工具，支持多语言转录和字幕导出。

- **Stars:** ⭐️ 1.4k
- **Tags:** `whisper` `youtube` `subtitles` `transcribe` `speech-to-text`
- **最后活动时间:** 2024-01-16

### [obs-localvocal](https://github.com/royshil/obs-localvocal)
...
语音大语言模型系列，支持语音理解与生成能力。

- **Stars:** ⭐️ 1.4k
- **Tags:** `speech-llm` `multimodal` `audio-generation`
- **最后活动时间:** 2024-07-22
...
AI歌曲翻唱生成WebUI，可使用RVC v2训练的AI声音从视频或音频创建歌曲翻唱。

- **Stars:** ⭐️ 1.4k
- **Tags:** `rvc` `voice-cloning` `song-covers` `ai-music`
- **最后活动时间:** 2025-02-15
...
基于自然语言提示在本地生成音乐的AI工具，支持LLM本地运行。

- **Stars:** ⭐️ 1.4k
- **Tags:** `ai` `llm` `music-generation` `local`
- **最后活动时间:** 2025-02-09
...
音乐音源分离项目，将混合音频分离为独立音轨（人声、鼓点、贝斯等）。

- **Stars:** ⭐️ 1.4k
- **Tags:** `source-separation` `music-processing` `audio-separation` `deep-learning`
- **最后活动时间:** 2024-04-18
...
### [edge-TTS-record](https://github.com/LuckyHookin/edge-TTS-record)

Windows平台工具，可录制Microsoft Edge浏览器的TTS语音合成并输出为WAV音频文件。

- **Stars:** ⭐️ 1.4k
- **Tags:** `tts` `edge` `audio` `speech-synthesis`
- **最后活动时间:** 2024-11-27

### [crepe](https://github.com/marl/crepe)

ICASSP 2018发表的音高估计模型，基于卷积神经网络实现高精度音高检测，适用于音乐信息检索领域。

- **Stars:** ⭐️ 1.4k
- **Tags:** `pitch-estimation` `audio-processing` `music-information-retrieval` `keras`
- **最后活动时间:** 2024-08-19
...
Natural Speech 2零样本语音合成PyTorch实现，支持歌声与语音生成。

- **Stars:** ⭐️ 1.3k
- **Tags:** `speech-synthesis` `zero-shot` `latent-diffusion`
- **最后活动时间:** 2023-09-24
...
### [FunMusic](https://github.com/FunAudioLLM/FunMusic)

基于PyTorch的音乐与音频生成工具包，提供音频处理与生成的完整基础能力。

- **Stars:** ⭐️ 1.3k
- **Tags:** `audio-generation` `music-generation` `audio-processing` `pytorch`
- **最后活动时间:** 2025-05-20

### [merlin](https://github.com/CSTR-Edinburgh/merlin)

Merlin语音合成项目的官方仓库，支持深度学习TTS和声音转换。

- **Stars:** ⭐️ 1.3k
- **Tags:** `TTS` `Speech Synthesis` `Deep Learning`
- **最后活动时间:** 2020-03-03
...
基于PyTorch的语音分离系统，使用门控神经网络将混合音频中多个说话人的声音分离，支持未知数量的说话人分离。

- **Stars:** ⭐️ 1.3k
- **Tags:** `语音分离` `PyTorch` `音频处理` `神经网络`
- **最后活动时间:** 2023-11-16
...
基于神经网络建模的吉他电子管放大器模拟插件，实现真实音色仿真。

- **Stars:** ⭐️ 1.3k
- **Tags:** `Audio Processing` `Neural Networks` `Music AI`
- **最后活动时间:** 2023-04-11
...
### [dicio-android](https://github.com/Stypox/dicio-android)
...
基于Keras实现的语音情感识别系统，支持LSTM、CNN、SVM、MLP等多种模型架构。

- **Stars:** ⭐️ 1.3k
- **Tags:** `speech-emotion-recognition` `keras` `lstm` `cnn` `audio-processing`
- **最后活动时间:** 2023-03-25
...
一个功能强大的JavaScript语音识别与语音合成库，可在浏览器中实现类似Siri的语音交互体验。

- **Stars:** ⭐️ 1.3k
- **Tags:** `speech-recognition` `speech-synthesis` `voice-commands` `javascript`
- **最后活动时间:** 2023-01-24
...
### [audio-super-res](https://github.com/kuleshov/audio-super-res)

基于神经网络的音频超分辨率重建，提升低质量音频的采样率和清晰度。

- **Stars:** ⭐️ 1.3k
- **Tags:** `audio-super-resolution` `deep-learning` `audio-processing`
- **最后活动时间:** 2023-10-24

### [StreamSpeech](https://github.com/ictnlp/StreamSpeech)

一体化语音处理模型，支持离线和实时语音识别、翻译及语音合成。

- **Stars:** ⭐️ 1.3k
- **Tags:** `speech-recognition` `speech-translation` `tts` `streaming`
- **最后活动时间:** 2025-06-29

### [VoiceprintRecognition-Pytorch](https://github.com/yeyupiaoling/VoiceprintRecognition-Pytorch)
...
ChatTTS资源大全，包含免费体验地址和音色库等资源。

- **Stars:** ⭐️ 1.2k
- **Tags:** `tts` `speech-synthesis` `chatTTS` `awesome-list`
- **最后活动时间:** 2024-06-12

### [vosk-server](https://github.com/alphacep/vosk-server)

基于Vosk和Kaldi库的语音识别服务器，支持WebSocket、gRPC和WebRTC协议，可快速部署离线语音识别服务。

- **Stars:** ⭐️ 1.2k
- **Tags:** `Speech Recognition` `ASR` `Vosk` `Kaldi`
- **最后活动时间:** 2025-07-25

### [SincNet](https://github.com/mravanelli/SincNet)

高效原始音频处理神经网络架构，专为说话人识别与验证优化。

- **Stars:** ⭐️ 1.2k
- **Tags:** `speaker-recognition` `audio-processing` `cnn`
- **最后活动时间:** 2021-04-28

### [tango](https://github.com/declare-lab/tango)

基于扩散模型的文本转音频生成工具，支持高质量音频合成。适用于语音合成、音效生成等多模态应用场景。

- **Stars:** ⭐️ 1.2k
- **Tags:** `text-to-audio` `diffusion-models` `audio-generation`
- **最后活动时间:** 2025-07-29

### [vits_chinese](https://github.com/PlayVoice/vits_chinese)

基于BERT和VITS的中文TTS最佳实践，支持ONNX流式推理，集成微软Natural Speech特性。

- **Stars:** ⭐️ 1.2k
- **Tags:** `tts` `vits` `bert` `chinese`
- **最后活动时间:** 2024-02-05
...
基于 PyTorch 的端到端自动语音识别开源项目，实现 Listen, Attend and Spell 模型。

- **Stars:** ⭐️ 1.2k
- **Tags:** `asr` `speech-recognition` `pytorch` `deep-learning`
- **最后活动时间:** 2020-12-19
...
### [voicefilter](https://github.com/maum-ai/voicefilter)

Google AI VoiceFilter系统的PyTorch非官方实现，用于语音分离和目标说话人提取。

- **Stars:** ⭐️ 1.2k
- **Tags:** `voicefilter` `speech-separation` `audio-separation` `pytorch`
- **最后活动时间:** 2024-07-25
...
基于大语言模型训练范式的符号音乐生成模型，显著提升音乐生成的音乐性和表现力。

- **Stars:** ⭐️ 1.2k
- **Tags:** `music-generation` `llm` `symbolic-music`
- **最后活动时间:** 2025-04-21

### [dc_tts](https://github.com/Kyubyong/dc_tts)

DC-TTS的TensorFlow实现，一种高效的文本转语音模型，支持快速语音合成。
...
### [Composer](https://github.com/HackerPoet/Composer)

使用神经网络生成视频游戏音乐的AI作曲工具。

- **Stars:** ⭐️ 1.1k
- **Tags:** `music-generation` `neural-network` `game-music`
- **最后活动时间:** 2019-07-14
...
### [alan-sdk-cordova](https://github.com/alan-ai/alan-sdk-cordova)

Alan AI SDK for Cordova，为应用提供自编码的语音助手系统，支持语音识别、语音合成和对话式AI交互。

- **Stars:** ⭐️ 1.1k
- **Tags:** `voice-assistant` `speech-recognition` `conversational-ai` `cordova`
- **最后活动时间:** 2025-04-22
...
使用深度学习技术进行音乐流派分类的项目，通过神经网络自动识别歌曲的流派类型。

- **Stars:** ⭐️ 1.1k
- **Tags:** `deep-learning` `audio-classification` `music` `neural-networks`
- **最后活动时间:** 2021-07-26
...
- **Stars:** ⭐️ 1.1k
- **Tags:** `audio-generation` `generative-model` `audio-synthesis`
- **最后活动时间:** 2024-04-29
...
### [SoundMind](https://github.com/xid32/SoundMind)
...
### [A-Hackers-AI-Voice-Assistant](https://github.com/LearnedVector/A-Hackers-AI-Voice-Assistant)
...
零样本语音风格迁移模型，仅需自编码器损失实现声音转换。

- **Stars:** ⭐️ 1.1k
- **Tags:** `voice-conversion` `speech-synthesis` `zero-shot`
- **最后活动时间:** 2024-10-23

### [kaldi-gstreamer-server](https://github.com/alumae/kaldi-gstreamer-server)

基于Kaldi和GStreamer的实时全双工语音识别服务器。

- **Stars:** ⭐️ 1.1k
- **Tags:** `speech-recognition` `real-time` `kaldi` `gstreamer`
- **最后活动时间:** 2024-06-08
...
ACL 2024论文官方实现，自监督预训练模型用于语音情感表示学习，支持下游任务特征提取。

- **Stars:** ⭐️ 1.1k
- **Tags:** `speech-emotion-recognition` `self-supervised-learning` `pytorch` `audio-representation`
- **最后活动时间:** 2024-12-23

### [rapping-neural-network](https://github.com/robbiebarrat/rapping-neural-network)

基于Kanye West作品训练的Rap歌词生成神经网络，探索AI音乐创作。

- **Stars:** ⭐️ 1.1k
- **Tags:** `neural-network` `lyrics-generation` `rap` `generative-art`
- **最后活动时间:** 2023-07-23

### [wavenet](https://github.com/basveeling/wavenet)

Keras实现的WaveNet语音合成模型，用于高质量音频生成。

- **Stars:** ⭐️ 1.1k
- **Tags:** `wavenet` `audio-generation` `keras` `deep-learning`
- **最后活动时间:** 2023-03-24

### [YourTTS](https://github.com/Edresson/YourTTS)

面向大众的零样本多说话人 TTS 和零样本语音转换系统。

- **Stars:** ⭐️ 1.1k
- **Tags:** `zero-shot-tts` `voice-conversion` `multi-speaker`
- **最后活动时间:** 2024-11-04
...
基于GAN的梅尔频谱图反演网络，用于文本到语音合成的高质量声码器。

- **Stars:** ⭐️ 1.0k
- **Tags:** `melgan` `tts` `speech-synthesis` `gan`
- **最后活动时间:** 2023-08-28
...
### [ms-ra-forwarder](https://github.com/wxxxcxx/ms-ra-forwarder)
...
WaveNet的PyTorch实现，支持快速音频生成，适用于语音合成和音频建模任务。

- **Stars:** ⭐️ 1.0k
- **Tags:** `wavenet` `audio-generation` `speech-synthesis` `pytorch`
- **最后活动时间:** 2020-09-17
...
非自回归文本转语音框架，包含PortaSpeech和DiffSpeech的官方PyTorch实现，发表于NeurIPS 2021和AAAI 2022。

- **Stars:** ⭐️ 1.0k
- **Tags:** `TTS` `Diffusion Model` `PyTorch`
- **最后活动时间:** 2023-04-02

### [Cognitive-Speech-TTS](https://github.com/Azure-Samples/Cognitive-Speech-TTS)
...
基于Tacotron2、Hifigan、VITS和Diff-svc的语音合成模型，支持游戏角色语音生成。

- **Stars:** ⭐️ 996
- **Tags:** `TTS` `Speech Synthesis` `VITS`
- **最后活动时间:** 2023-03-03

### [odas](https://github.com/introlab/odas)

开源嵌入式听觉系统，支持实时声源定位、分离和跟踪。

- **Stars:** ⭐️ 988
- **Tags:** `audio-processing` `sound-localization` `beamformer`
- **最后活动时间:** 2024-12-05

### [MMSA](https://github.com/thuiar/MMSA)

多模态情感分析统一框架，支持多种模态融合和多任务学习，ACCV 2020论文。

- **Stars:** ⭐️ 982
- **Tags:** `multimodal-sentiment-analysis` `multimodal` `deep-learning`
- **最后活动时间:** 2025-01-15
...
端到端说话人嵌入系统，用于说话人识别和验证，基于深度学习实现高精度声纹特征提取。

- **Stars:** ⭐️ 939
- **Tags:** `speaker-recognition` `speaker-embedding` `voice-biometrics` `keras`
- **最后活动时间:** 2024-04-13
...
非侵入式语音质量评估与TTS自然度预测模型。

- **Stars:** ⭐️ 923
- **Tags:** `speech-quality` `tts-assessment` `deep-learning` `pytorch`
- **最后活动时间:** 2024-12-01

### [FaceFormer](https://github.com/EvelynFan/FaceFormer)

CVPR 2022论文实现，基于Transformer的语音驱动3D面部动画生成模型。

- **Stars:** ⭐️ 907
- **Tags:** `3D Animation` `Speech-Driven` `Transformer`
- **最后活动时间:** 2023-08-22

### [FireRedTTS](https://github.com/FireRedTeam/FireRedTTS)

开源的LLM驱动基础TTS系统，支持语音合成和声音克隆。

- **Stars:** ⭐️ 907
- **Tags:** `tts` `speech-synthesis` `llm` `voice-clone` `diffusion`
- **最后活动时间:** 2025-09-28
...
基于扩散模型的高质量神经声码器和波形合成器，可用于快速语音合成。

- **Stars:** ⭐️ 889
- **Tags:** `Vocoder` `Diffusion` `Speech Synthesis`
- **最后活动时间:** 2024-03-26
...
FastSpeech语音合成模型的PyTorch实现，支持快速高质量的文本转语音。

- **Stars:** ⭐️ 880
- **Tags:** `speech-synthesis` `tts` `fastspeech` `pytorch`
- **最后活动时间:** 2023-07-06
...
### [PPASR](https://github.com/yeyupiaoling/PPASR)
...
### [xtts-webui](https://github.com/daswer123/xtts-webui)

XTTS模型的Web界面工具，支持语音合成和模型微调功能。

- **Stars:** ⭐️ 876
- **Tags:** `xtts` `tts` `finetuning` `text-to-speech` `voice-cloning`
- **最后活动时间:** 2025-01-17
...
### [tuneflow-py](https://github.com/tuneflow/tuneflow-py)

下一代DAW音乐创作平台，支持构建音乐算法和AI模型，助力AI驱动的音乐生成与作曲。

- **Stars:** ⭐️ 870
- **Tags:** `ai-music` `music-generation` `daw` `music-ai` `python`
- **最后活动时间:** 2023-06-06
...
### [subvert](https://github.com/aschmelyun/subvert)
...
基于生成对抗网络的语音增强模型，可有效去除语音中的噪声，提升语音质量。

- **Stars:** ⭐️ 859
- **Tags:** `Speech Enhancement` `GAN` `TensorFlow`
- **最后活动时间:** 2023-03-24

### [mimic1](https://github.com/MycroftAI/mimic1)

Mycroft开源TTS引擎，基于CMU Flite构建，适用于语音助手项目。

- **Stars:** ⭐️ 858
- **Tags:** `tts` `text-to-speech` `voice-assistant` `open-source`
- **最后活动时间:** 2022-11-02
...
Suno Bark模型的C/C++高性能实现，支持快速文本转语音生成。

- **Stars:** ⭐️ 857
- **Tags:** `text-to-speech` `inference` `ggml` `tts`
- **最后活动时间:** 2024-11-16

### [openedai-speech](https://github.com/matatonic/openedai-speech)

兼容 OpenAI API 的文本转语音服务器，支持 Coqui AI 的 xtts_v2 和 piper tts 作为后端。

- **Stars:** ⭐️ 856
- **Tags:** `text-to-speech` `openai-api` `tts-server`
- **最后活动时间:** 2025-02-02

### [speech_recognition](https://github.com/xxbb1234021/speech_recognition)

面向中文语音识别的开源项目，基于TensorFlow实现。

- **Stars:** ⭐️ 848
- **Tags:** `speech-recognition` `chinese` `tensorflow`
- **最后活动时间:** 2018-05-16

### [VideoSubtitleGenerator](https://github.com/buxuku/VideoSubtitleGenerator)

批量为本地视频生成字幕文件并支持多语言翻译。跨平台支持Windows和Mac系统，基于Whisper实现高精度转录。
...
端到端语音识别项目，基于CTC损失和TensorFlow实现。

- **Stars:** ⭐️ 834
- **Tags:** `asr` `ctc` `speech-recognition` `tensorflow`
- **最后活动时间:** 2019-05-23

### [whisper-playground](https://github.com/saharmor/whisper-playground)

基于OpenAI Whisper的实时语音转文字Web应用开发工具，支持快速构建语音识别应用。

- **Stars:** ⭐️ 832
- **Tags:** `Speech-to-Text` `Whisper` `Real-time`
- **最后活动时间:** 2025-09-12

### [pdf-to-podcast](https://github.com/knowsuchagency/pdf-to-podcast)

将任意 PDF 文档转换为播客音频，支持多语言朗读和智能内容提取。

- **Stars:** ⭐️ 829
- **Tags:** `ai` `pdf` `podcast` `tts` `audio`
- **最后活动时间:** 2025-03-17
...
大规模俄语语音转文本数据集，适用于自动语音识别模型训练和评估。

- **Stars:** ⭐️ 820
- **Tags:** `asr` `speech-to-text` `dataset`
- **最后活动时间:** 2022-03-11
...
端到端语音识别Transformer模型，针对中文语音识别优化。

- **Stars:** ⭐️ 809
- **Tags:** `speech-recognition` `transformer` `asr` `end-to-end`
- **最后活动时间:** 2023-04-06

### [music-source-separation](https://github.com/andabi/music-source-separation)

基于TensorFlow的深度神经网络音乐源分离项目，实现人声与伴奏分离。

- **Stars:** ⭐️ 805
- **Tags:** `music-separation` `source-separation` `deep-learning` `tensorflow`
- **最后活动时间:** 2019-03-18

### [gitpodcast](https://github.com/BandarLabs/gitpodcast)
...
使用3D卷积神经网络进行说话人验证的深度学习项目，提升语音识别准确率。

- **Stars:** ⭐️ 792
- **Tags:** `speaker-recognition` `3d-cnn` `deep-learning` `voice-verification`
- **最后活动时间:** 2020-03-03
...
简单的麦克风集成工具，让用户能够通过麦克风实时使用OpenAI Whisper进行语音识别。

- **Stars:** ⭐️ 785
- **Tags:** `Microphone` `Speech-to-Text` `Whisper`
- **最后活动时间:** 2024-07-04

### [lobe-tts](https://github.com/lobehub/lobe-tts)
...
### [frogbase](https://github.com/hayabhay/frogbase)

将音视频内容转化为可导航的知识库，支持语义搜索和语音转文字功能。

- **Stars:** ⭐️ 777
- **Tags:** `embeddings` `semantic-search` `speech-to-text` `python`
- **最后活动时间:** 2023-10-25
...
### [Uni-TTS](https://github.com/X-T-E-R/Uni-TTS)

统一多种语音合成引擎的适配框架，支持模块化使用或后端服务部署。

- **Stars:** ⭐️ 772
- **Tags:** `tts` `speech-synthesis` `unified-api`
- **最后活动时间:** 2024-04-15

### [voicechat2](https://github.com/lhl/voicechat2)

本地语音聊天系统，集成语音识别、LLM对话和语音合成，实现完整的语音交互体验。

- **Stars:** ⭐️ 768
- **Tags:** `voice-chat` `tts` `stt` `local-llm`
- **最后活动时间:** 2024-10-12

### [SongBloom](https://github.com/tencent-ailab/SongBloom)
...
语音分离模型Conv-TasNet的PyTorch实现，支持置换不变训练(PIT)。

- **Stars:** ⭐️ 760
- **Tags:** `speech-separation` `conv-tasnet` `source-separation` `pytorch`
- **最后活动时间:** 2023-04-06
...
多尺度神经音频编解码器，支持低码率音频压缩。

- **Stars:** ⭐️ 757
- **Tags:** `audio-codec` `neural-audio` `deep-learning` `compression`
- **最后活动时间:** 2024-11-19

### [Speech-enhancement](https://github.com/vbelz/Speech-enhancement)

基于深度学习的音频降噪项目，使用CNN和UNet架构实现语音增强。

- **Stars:** ⭐️ 754
- **Tags:** `Speech Enhancement` `Deep Learning` `Denoising`
- **最后活动时间:** 2023-10-15
...
NVIDIA实时自回归WaveNet推理参考实现，用于语音合成。

- **Stars:** ⭐️ 746
- **Tags:** `wavenet` `audio-synthesis` `inference` `deep-learning`
- **最后活动时间:** 2021-01-19

### [nnsvs](https://github.com/nnsvs/nnsvs)

基于神经网络的歌声合成研究库，用于构建高质量的歌唱声音合成系统。

- **Stars:** ⭐️ 743
- **Tags:** `singing-voice-synthesis` `pytorch` `deep-learning` `tts`
- **最后活动时间:** 2023-10-09

### [DeepJ](https://github.com/calclavia/DeepJ)

基于深度学习的音乐风格生成模型，能够创作特定风格的音乐作品。使用Keras和TensorFlow构建，支持多种音乐风格的自动生成。

- **Stars:** ⭐️ 741
- **Tags:** `deep-learning` `music-generation` `tensorflow` `keras`
- **最后活动时间:** 2018-09-30
...
### [dla](https://github.com/markovka17/dla)
...
一体化音乐结构分析器，支持节拍追踪和音乐结构自动分析。

- **Stars:** ⭐️ 735
- **Tags:** `music-analysis` `beat-tracking` `audio` `pytorch`
- **最后活动时间:** 2024-05-09
...
大规模现代语音识别数据集，适用于ASR模型训练和评估。

- **Stars:** ⭐️ 721
- **Tags:** `speech-recognition` `asr` `dataset` `audio`
- **最后活动时间:** 2024-02-26

### [allosaurus](https://github.com/xinjli/allosaurus)

支持2000多种语言的预训练通用音素识别器，适用于多语言语音识别任务。

- **Stars:** ⭐️ 720
- **Tags:** `Speech Recognition` `Phonetics` `Multilingual`
- **最后活动时间:** 2024-04-26

### [ChatTTS_Speaker](https://github.com/6drf21e/ChatTTS_Speaker)

ChatTTS 2000 条音色稳定性评分数据集，按性别年龄分类并提供在线试听。

- **Stars:** ⭐️ 719
- **Tags:** `chattts` `speaker-embedding` `tts-dataset`
- **最后活动时间:** 2024-07-02

### [GenshinVoice](https://github.com/w4123/GenshinVoice)

原神游戏角色语音数据集，适用于语音合成和声音克隆研究。

- **Stars:** ⭐️ 718
- **Tags:** `dataset` `voice` `tts` `speech-synthesis` `gaming`
- **最后活动时间:** 2023-07-05
...
本地AI语音聊天系统，基于Zephyr 7B模型，使用Whisper转写和XTTS语音合成实现实时对话。

- **Stars:** ⭐️ 717
- **Tags:** `local-ai` `voice-chat` `whisper` `xtts`
- **最后活动时间:** 2025-06-17
...
CVPR 2020论文，学习个人说话风格实现准确的唇语到语音合成。

- **Stars:** ⭐️ 713
- **Tags:** `lip-to-speech` `speech-synthesis` `multimodal` `deep-learning`
- **最后活动时间:** 2023-07-06

### [ttsfm](https://github.com/dbccccccc/ttsfm)
...
### [speech-demo](https://github.com/Baidu-AIP/speech-demo)

语音识别API示例项目，提供语音转文字等功能的接口调用演示。

- **Stars:** ⭐️ 712
- **Tags:** `speech-recognition` `speech-to-text` `api-demo` `baidu`
- **最后活动时间:** 2024-07-25

### [bark-voice-cloning-HuBERT-quantizer](https://github.com/gitmylo/bark-voice-cloning-HuBERT-quantizer)

基于Bark的语音克隆模型，支持训练和推理，实现高质量的声音转换与克隆。

- **Stars:** ⭐️ 711
- **Tags:** `voice-cloning` `text-to-speech` `neural-networks`
- **最后活动时间:** 2023-09-13
...
### [Speech Denoising WaveNet](https://github.com/drethage/speech-denoising-wavenet)

基于WaveNet的端到端语音降噪神经网络模型。

- **Stars:** ⭐️ 709
- **Tags:** `WaveNet` `Speech Denoising` `End-to-End`
- **最后活动时间:** 2023-07-06

### [FreeVC](https://github.com/OlaWod/FreeVC)

高质量无文本单样本语音转换模型，实现声音风格迁移。

- **Stars:** ⭐️ 709
- **Tags:** `voice-conversion` `speech-synthesis` `pytorch` `one-shot`
- **最后活动时间:** 2025-01-19
...
实时语音降噪模型，支持TF-lite、ONNX和实时音频处理，适用于嵌入式设备。

- **Stars:** ⭐️ 700
- **Tags:** `speech-enhancement` `noise-reduction` `real-time-audio` `tensorflow` `onnx`
- **最后活动时间:** 2023-07-28

### [Mozart](https://github.com/aashrafh/Mozart)

基于神经网络的光学音乐识别(OMR)系统，能够将乐谱转换为机器可读格式。

- **Stars:** ⭐️ 697
- **Tags:** `optical-music-recognition` `neural-network` `computer-vision` `music-sheet`
- **最后活动时间:** 2022-08-24
...
### [whispering](https://github.com/shirayu/whispering)

基于Whisper的流式语音转录工具，支持实时语音识别和转录。

- **Stars:** ⭐️ 694
- **Tags:** `ASR` `Whisper` `Streaming`
- **最后活动时间:** 2023-05-01

### [Virtual-Human-for-Chatting](https://github.com/Navi-Studio/Virtual-Human-for-Chatting)

基于 Unity 和 Live2D 技术的虚拟数字人聊天系统，集成 Azure 语音服务实现沉浸式对话体验。

- **Stars:** ⭐️ 694
- **Tags:** `live2d` `virtual-human` `unity` `chatbot` `azure`
- **最后活动时间:** 2023-11-13

### [Transformer-TTS](https://github.com/soobinseo/Transformer-TTS)

基于Transformer的神经语音合成PyTorch实现，高质量文本转语音系统。

- **Stars:** ⭐️ 689
- **Tags:** `text-to-speech` `transformer` `pytorch` `speech-synthesis`
- **最后活动时间:** 2023-11-08

### [sagittarius](https://github.com/gregsadetsky/sagittarius)

GPT-4/Gemini语音视频探索工具，支持多模态交互体验。

- **Stars:** ⭐️ 686
- **Tags:** `voice-ai` `video-ai` `gpt4` `gemini` `multimodal`
- **最后活动时间:** 2024-01-26

### [musicnn](https://github.com/jordipons/musicnn)

预训练的深度卷积神经网络，用于音乐音频标签分类和特征提取。

- **Stars:** ⭐️ 685
- **Tags:** `music-tagging` `audio-classification` `cnn` `deep-learning`
- **最后活动时间:** 2023-12-11

### [tts](https://github.com/inworld-ai/tts)
...
Android端隐私优先的离线语音识别键盘，支持本地语音转文字输入。

- **Stars:** ⭐️ 684
- **Tags:** `android` `speech-recognition` `speech-to-text` `keyboard` `on-device`
- **最后活动时间:** 2025-08-29

### [voice-builder](https://github.com/google/voice-builder)

开源的TTS语音构建工具，帮助用户创建和定制文本转语音的语音模型。

- **Stars:** ⭐️ 683
- **Tags:** `TTS` `Voice Building` `Speech Synthesis`
- **最后活动时间:** 2024-07-22

### [Orpheus-FastAPI](https://github.com/Lex-au/Orpheus-FastAPI)

高性能文本转语音服务器，支持OpenAI兼容API、8种声音和情感标签。

- **Stars:** ⭐️ 682
- **Tags:** `text-to-speech` `tts` `fastapi` `voice-synthesis`
- **最后活动时间:** 2025-07-05

### [g2p-seq2seq](https://github.com/cmusphinx/g2p-seq2seq)

基于TensorFlow序列到序列模型的音素转换工具，用于语音合成前端。

- **Stars:** ⭐️ 681
- **Tags:** `g2p` `speech-synthesis` `seq2seq` `tensorflow`
- **最后活动时间:** 2024-07-29

### [voicebox-pytorch](https://github.com/lucidrains/voicebox-pytorch)

MetaAI Voicebox语音合成模型的PyTorch实现，新一代SOTA文本转语音网络。

- **Stars:** ⭐️ 679
- **Tags:** `text-to-speech` `voice-synthesis` `generative-audio` `pytorch`
- **最后活动时间:** 2024-10-01

### [VITA-Audio](https://github.com/VITA-MLLM/VITA-Audio)

NeurIPS 2025论文，高效大型语音语言模型，支持快速交错跨模态token生成。

- **Stars:** ⭐️ 677
- **Tags:** `speech-llm` `audio-language` `multimodal`
- **最后活动时间:** 2025-05-24
...
结合pyannote音频处理与Whisper语音识别的会议转录工具，支持说话人分离和会议摘要生成。

- **Stars:** ⭐️ 665
- **Tags:** `asr` `whisper` `speaker-diarization` `meeting-summarization`
- **最后活动时间:** 2025-09-24
...
### [LLaSA_training](https://github.com/zhenye234/LLaSA_training)
...
### [chatgpt-conversation](https://github.com/platelminto/chatgpt-conversation)

语音对话工具，支持与ChatGPT进行语音交互并获得语音回复。

- **Stars:** ⭐️ 658
- **Tags:** `chatgpt` `voice` `speech` `conversation`
- **最后活动时间:** 2022-12-06

### [SpecAugment](https://github.com/DemisEom/SpecAugment)

Google Brain提出的语音数据增强方法，支持TensorFlow和PyTorch实现，可提升语音识别模型的鲁棒性。

- **Stars:** ⭐️ 656
- **Tags:** `Data Augmentation` `Speech Recognition`
- **最后活动时间:** 2022-04-05
...
基于 GAN 的神经声码器，兼容 NVIDIA Tacotron2 的高质量语音合成。

- **Stars:** ⭐️ 650
- **Tags:** `neural-vocoder` `gan` `speech-synthesis`
- **最后活动时间:** 2020-10-03

### [lora-svc](https://github.com/PlayVoice/lora-svc)

基于Whisper和LoRA的歌声转换与克隆项目，支持语音到歌声的转换及个性化声音合成。

- **Stars:** ⭐️ 649
- **Tags:** `voice-conversion` `voice-cloning` `lora` `vits-svc` `whisper`
- **最后活动时间:** 2023-11-03
...
### [Speech-Translate](https://github.com/Dadangdut33/Speech-Translate)

基于Whisper的实时语音转录与翻译应用，支持多语言语音识别和即时翻译。

- **Stars:** ⭐️ 641
- **Tags:** `speech-recognition` `whisper` `translate` `python` `tkinter`
- **最后活动时间:** 2024-01-18
...
Node.js语音识别库，支持离线热词检测和语音转文字功能。

- **Stars:** ⭐️ 635
- **Tags:** `STT` `Speech Recognition` `Node.js`
- **最后活动时间:** 2024-07-02

### [VITS2](https://github.com/daniilrobnikov/vits2)

高质量单阶段文本转语音模型，通过对抗学习和架构设计提升合成质量与效率。

- **Stars:** ⭐️ 635
- **Tags:** `TTS` `VITS2` `Speech Synthesis`
- **最后活动时间:** 2023-09-11

### [xVA-Synth](https://github.com/DanRuta/xVA-Synth)

基于机器学习的语音合成桌面应用，支持游戏角色语音克隆与合成。

- **Stars:** ⭐️ 635
- **Tags:** `speech-synthesis` `voice-synthesis` `machine-learning` `electron`
- **最后活动时间:** 2024-04-28

### [OpenMusic](https://github.com/ivcylc/OpenMusic)

SOTA级文本转音乐生成模型，支持高质量AI音乐创作。

- **Stars:** ⭐️ 634
- **Tags:** `text-to-music` `diffusion-models` `music-generation`
- **最后活动时间:** 2025-06-26

### [TextyMcSpeechy](https://github.com/domesticatedviking/TextyMcSpeechy)

轻松创建任意语音的Piper文本转语音模型，支持使用自己的录音或RVC声音，可在树莓派上离线运行。

- **Stars:** ⭐️ 634
- **Tags:** `tts` `piper-tts` `voice-cloning` `speech-synthesis`
- **最后活动时间:** 2025-04-07
...
高性能 TTS 引擎，支持 xttsv2 模型的高效推理服务。

- **Stars:** ⭐️ 619
- **Tags:** `tts-engine` `xttsv2` `fast-inference`
- **最后活动时间:** 2025-01-23

### [Parakeet](https://github.com/PaddlePaddle/Parakeet)

飞桨并行文本转语音工具包，支持 Tacotron2、FastSpeech2、WaveFlow 等多种模型。

- **Stars:** ⭐️ 618
- **Tags:** `paddlepaddle` `tts-toolkit` `speech-synthesis`
- **最后活动时间:** 2021-11-19

### [speech-to-text](https://github.com/reriiasu/speech-to-text)

基于faster-whisper的实时语音转文字工具，提供高效的语音识别能力。

- **Stars:** ⭐️ 614
- **Tags:** `whisper` `speech-to-text` `real-time-transcription` `faster-whisper`
- **最后活动时间:** 2024-07-23

### [react-transcript-editor](https://github.com/bbc/react-transcript-editor)

BBC开源的React转录编辑组件，用于快速校正音频视频的自动转录文本。

- **Stars:** ⭐️ 613
- **Tags:** `transcript-editor` `speech-to-text` `react` `kaldi`
- **最后活动时间:** 2024-02-12
...
音乐自动标签系统，提供预训练模型进行音乐分类与标注。

- **Stars:** ⭐️ 612
- **Tags:** `music-tagging` `keras` `audio-processing` `deep-learning`
- **最后活动时间:** 2018-07-08

### [f5-tts-mlx](https://github.com/lucasnewman/f5-tts-mlx)

F5-TTS 在 Apple MLX 框架上的实现，支持 Apple Silicon 高效推理。

- **Stars:** ⭐️ 611
- **Tags:** `f5-tts` `mlx` `apple-silicon` `diffusion`
- **最后活动时间:** 2025-03-19
...
### [tts](https://github.com/zuoban/tts)
...
基于Transformer的流行音乐生成模型，可生成富有表现力的流行钢琴作品。ACM Multimedia 2020论文实现。

- **Stars:** ⭐️ 599
- **Tags:** `music-generation` `transformer` `tensorflow`
- **最后活动时间:** 2022-11-15

### [MusicGenreClassification](https://github.com/mlachmish/MusicGenreClassification)

使用神经网络对10秒音频片段进行音乐流派分类的深度学习项目。

- **Stars:** ⭐️ 599
- **Tags:** `music-classification` `audio-processing` `neural-network` `tensorflow`
- **最后活动时间:** 2020-01-11

### [FullSubNet](https://github.com/Audio-WestlakeU/FullSubNet)

全频带与子频带融合的实时单通道语音增强模型，提供预训练模型和可复现研究。

- **Stars:** ⭐️ 598
- **Tags:** `Speech Enhancement` `Real-time` `PyTorch`
- **最后活动时间:** 2023-08-19

### [FlashTTS](https://github.com/HuiResearch/FlashTTS)

基于SparkTTS和OrpheusTTS的高质量中文语音合成与声音克隆服务，支持多种TTS模型后端。

- **Stars:** ⭐️ 598
- **Tags:** `tts` `voice-cloning` `speech-synthesis` `spark-tts`
- **最后活动时间:** 2025-05-18

### [Neutone SDK](https://github.com/Neutone/neutone_sdk)
...
说话人验证系统的PyTorch实现，基于GE2E损失函数。

- **Stars:** ⭐️ 597
- **Tags:** `speaker-verification` `speaker-identification` `pytorch`
- **最后活动时间:** 2022-01-20
...
### [neural_sp](https://github.com/hirofumi0810/neural_sp)

基于PyTorch的端到端语音识别与语言模型实现，支持流式识别和多种解码器。

- **Stars:** ⭐️ 594
- **Tags:** `speech-recognition` `asr` `transformer`
- **最后活动时间:** 2021-08-30

### [Meta-voicebox](https://github.com/SpeechifyInc/Meta-voicebox)

Meta Voicebox的复现实现，首个跨任务泛化的生成式语音AI模型，达到SOTA性能。

- **Stars:** ⭐️ 592
- **Tags:** `speech-synthesis` `generative-ai` `voice-generation`
- **最后活动时间:** 2023-06-19

### [swift](https://github.com/ai-ng/swift)
...
免费开源的AI文本转语音服务，支持在线使用或自托管，兼容OpenAI API格式。

- **Stars:** ⭐️ 587
- **Tags:** `text-to-speech` `tts` `ai-voice` `openai-compatible`
- **最后活动时间:** 2025-03-16

### [fast-voice-assistant](https://github.com/dsa/fast-voice-assistant)

极速AI语音助手，响应时间低于500毫秒，实现流畅实时对话。

- **Stars:** ⭐️ 585
- **Tags:** `voice-assistant` `realtime` `speech-recognition`
- **最后活动时间:** 2024-12-03

### [so-vits-svc-4.0-v2](https://github.com/justinjohn0306/so-vits-svc-4.0-v2)

基于SoftVC VITS的歌声转换模型，支持高质量的声音克隆与变声，适用于虚拟歌手和语音合成场景。

- **Stars:** ⭐️ 583
- **Tags:** `Voice Conversion` `VITS` `Singing Voice`
- **最后活动时间:** 2023-04-04

### [MS-SNSD](https://github.com/microsoft/MS-SNSD)

微软可扩展噪声语音数据集，支持自定义说话人数量、噪声类型和信噪比，适用于语音增强和降噪研究。

- **Stars:** ⭐️ 582
- **Tags:** `speech-enhancement` `noisy-speech` `dataset` `microsoft`
- **最后活动时间:** 2024-07-01

### [CycleGAN-VC2](https://github.com/jackaduma/CycleGAN-VC2)

基于CycleGAN的语音转换模型，支持高质量语音克隆与转换。

- **Stars:** ⭐️ 571
- **Tags:** `voice-conversion` `voice-cloning` `cyclegan` `speech-synthesis`
- **最后活动时间:** 2023-06-10
...
使用LSTM神经网络训练生成钢琴或小提琴/钢琴音乐的深度学习项目，支持音乐创作自动化。

- **Stars:** ⭐️ 565
- **Tags:** `lstm` `music-generation` `deep-learning` `pytorch` `rnn`
- **最后活动时间:** 2020-12-03

### [ComfyUI-VibeVoice](https://github.com/wildminder/ComfyUI-VibeVoice)

ComfyUI 的 VibeVoice TTS 自定义节点，支持表达丰富的长文本多说话人对话音频生成。

- **Stars:** ⭐️ 565
- **Tags:** `comfyui` `text-to-speech` `voice-cloning`
- **最后活动时间:** 2025-09-25
...
### [room-impulse-responses](https://github.com/Graphi07/room-impulse-responses)
...
Google MusicLM的开源实现，支持文本到音乐生成。

- **Stars:** ⭐️ 562
- **Tags:** `text-to-music` `music-generation` `transformer` `audio-generation`
- **最后活动时间:** 2023-06-03
...
使用深度学习生成MIDI格式音乐的AI项目，支持音乐创作自动化。

- **Stars:** ⭐️ 554
- **Tags:** `music-generation` `deep-learning` `midi` `generative-ai`
- **最后活动时间:** 2021-02-08
...
### [vits2_pytorch](https://github.com/p0p4k/vits2_pytorch)

VITS2 文本转语音模型的 PyTorch 非官方实现，支持高质量语音合成。

- **Stars:** ⭐️ 548
- **Tags:** `VITS2` `TTS` `PyTorch` `Speech Synthesis`
- **最后活动时间:** 2024-03-28

### [decipher](https://github.com/dsymbol/decipher)

基于AI的视频转录字幕生成工具，轻松为视频添加自动生成的字幕和翻译。

- **Stars:** ⭐️ 548
- **Tags:** `whisper` `transcription` `video-subtitles` `translation`
- **最后活动时间:** 2024-11-13

### [FastASR](https://github.com/chenkui164/FastASR)

轻量级C++实现的自动语音识别推理引擎，支持ARM平台，依赖少、速度快、识别效果优异。

- **Stars:** ⭐️ 548
- **Tags:** `speech-recognition` `asr` `cpp` `arm`
- **最后活动时间:** 2023-03-19

### [Sayboard](https://github.com/ElishaAz/Sayboard)

Android开源离线语音输入法，基于Vosk实现本地语音转文字功能。

- **Stars:** ⭐️ 547
- **Tags:** `android` `speech-to-text` `keyboard` `vosk` `voice-input`
- **最后活动时间:** 2025-07-01

### [SpectralCluster](https://github.com/wq2012/SpectralCluster)

Google说话人分割论文中谱聚类算法的Python实现，支持约束聚类与自动调参。

- **Stars:** ⭐️ 546
- **Tags:** `Speaker Diarization` `Clustering` `Audio Processing`
- **最后活动时间:** 2024-09-25

### [tinydiarize](https://github.com/akashmjn/tinydiarize)

Whisper模型的轻量级扩展，通过特殊标记实现说话人分离功能，简洁高效。

- **Stars:** ⭐️ 543
- **Tags:** `whisper` `speaker-diarization` `speech-recognition` `audio`
- **最后活动时间:** 2023-11-06
...
基于Bert-VITS2的表情动画测试项目，支持音频驱动的动作生成。

- **Stars:** ⭐️ 539
- **Tags:** `bert-vits2` `tts` `audio2motion`
- **最后活动时间:** 2025-08-06

### [tacotron](https://github.com/google/tacotron)

Tacotron端到端语音合成模型的官方音频样本和研究资源。

- **Stars:** ⭐️ 539
- **Tags:** `tacotron` `speech-synthesis` `tts`
- **最后活动时间:** 2025-08-01
...
支持文本文件输入和零样本语音克隆的TTS工具，适合制作有声书。

- **Stars:** ⭐️ 535
- **Tags:** `text-to-speech` `voice-cloning` `audiobooks`
- **最后活动时间:** 2025-08-23

### [Voice-Converter-CycleGAN](https://github.com/leimao/Voice-Converter-CycleGAN)

使用CycleGAN和非平行数据进行语音转换的项目。

- **Stars:** ⭐️ 531
- **Tags:** `Voice Conversion` `CycleGAN` `Speech`
- **最后活动时间:** 2023-06-29

### [SwiftSpeech](https://github.com/Cay-Zhang/SwiftSpeech)

专为 SwiftUI 设计的语音识别框架，简化语音转文字功能的集成流程。

- **Stars:** ⭐️ 528
- **Tags:** `speech-recognition` `swiftui` `voice-recognition` `ios`
- **最后活动时间:** 2021-07-27

### [orpheus-tts-local](https://github.com/isaiahbjork/orpheus-tts-local)

使用 LM Studio 在本地运行 Orpheus 3B 文本转语音模型。

- **Stars:** ⭐️ 527
- **Tags:** `text-to-speech` `local-ai` `orpheus`
- **最后活动时间:** 2025-03-20
...
基于C++的独立中英文语音合成项目，无外部依赖，支持本地离线运行，一键编译即可使用。

- **Stars:** ⭐️ 525
- **Tags:** `tts` `speech-synthesis` `cplusplus` `standalone`
- **最后活动时间:** 2025-07-10

### [honk](https://github.com/castorini/honk)

PyTorch实现的关键词检测神经网络模型，用于语音唤醒词识别和音频事件检测。

- **Stars:** ⭐️ 525
- **Tags:** `keyword-spotting` `speech-recognition` `pytorch` `audio-processing`
- **最后活动时间:** 2023-05-22

### [StarGAN-Voice-Conversion](https://github.com/liusongxiang/StarGAN-Voice-Conversion)

StarGAN-VC的PyTorch实现，支持非并行多对多语音转换任务。

- **Stars:** ⭐️ 525
- **Tags:** `voice-conversion` `stargan` `speech-processing` `pytorch`
- **最后活动时间:** 2019-10-11

### [KAN-TTS](https://github.com/modelscope/KAN-TTS)

阿里达摩院开源的语音合成训练框架，提供完整的TTS模型训练流程。

- **Stars:** ⭐️ 524
- **Tags:** `TTS` `Training Framework` `Speech Synthesis`
- **最后活动时间:** 2023-12-28

### [DeepXi](https://github.com/anicolson/DeepXi)

深度学习语音增强框架，用于噪声抑制和语音识别前端处理。

- **Stars:** ⭐️ 523
- **Tags:** `speech-enhancement` `noise-reduction` `asr`
- **最后活动时间:** 2022-02-17

### [Urban-Sound-Classification](https://github.com/aqibsaeed/Urban-Sound-Classification)

使用深度学习进行城市声音分类的项目。可应用于环境监测和智能城市音频分析场景。

- **Stars:** ⭐️ 523
- **Tags:** `audio-classification` `deep-learning` `urban-sound` `neural-network`
- **最后活动时间:** 2022-09-12

### [libri-light](https://github.com/facebookresearch/libri-light)

基于LibriVox有声书录制的轻量级监督训练数据集，适用于语音识别和音频处理研究。

- **Stars:** ⭐️ 522
- **Tags:** `dataset` `speech-recognition` `audio` `asr`
- **最后活动时间:** 2023-07-11

### [rvc-webui](https://github.com/ddPn08/rvc-webui)

基于检索的语音转换WebUI项目，提供友好的界面进行实时语音变换和克隆。

- **Stars:** ⭐️ 519
- **Tags:** `rvc` `voice-conversion` `tts` `vits`
- **最后活动时间:** 2023-12-12

### [contentvec](https://github.com/auspicious3000/contentvec)

语音自监督学习表示模型，用于提取高质量的语音特征表示，适用于语音识别和语音合成等下游任务。

- **Stars:** ⭐️ 518
- **Tags:** `Speech` `Self-Supervised Learning`
- **最后活动时间:** 2023-04-27

### [StarGANv2-VC](https://github.com/yl4579/StarGANv2-VC)

基于StarGANv2的多样化非并行语音转换框架，实现自然语音风格迁移。

- **Stars:** ⭐️ 518
- **Tags:** `voice-conversion` `speech-synthesis` `gan` `deep-learning`
- **最后活动时间:** 2025-01-13

### [gantts](https://github.com/r9y9/gantts)

基于GAN的文本转语音合成和声音转换PyTorch实现。

- **Stars:** ⭐️ 518
- **Tags:** `gan` `tts` `speech-synthesis` `voice-conversion`
- **最后活动时间:** 2020-11-01
...
众包多模态情感表达演员数据集，用于语音情感识别与多模态情感分析研究。

- **Stars:** ⭐️ 515
- **Tags:** `emotion-recognition` `multimodal` `audio-dataset` `speech`
- **最后活动时间:** 2025-03-21
...
CREPE音高追踪器的PyTorch实现，用于音频音高检测。音频处理必备工具。

- **Stars:** ⭐️ 512
- **Tags:** `pitch-tracking` `audio` `pytorch`
- **最后活动时间:** 2025-05-16
...
Meta发布的图像分割基础模型，可实现任意物体的自动分割，支持提示词引导分割。

- **Stars:** ⭐️ 53.8k
- **Tags:** `segmentation` `computer-vision` `image-segmentation` `meta`
- **最后活动时间:** 2024-09-18
...
SIGGRAPH 2023官方代码，支持通过拖拽点精确控制GAN生成图像的姿态、形状和表情。

- **Stars:** ⭐️ 36.0k
- **Tags:** `generative-adversarial-network` `image-manipulation` `generative-models`
- **最后活动时间:** 2024-05-18

### [Real-ESRGAN](https://github.com/xinntao/Real-ESRGAN)

实用的图像/视频超分辨率恢复算法，支持去噪、去模糊等图像增强任务。

- **Stars:** ⭐️ 34.8k
- **Tags:** `Super Resolution` `Image Restoration` `ESRGAN`
- **最后活动时间:** 2024-08-06
...
为Stable Diffusion等扩散模型添加精确控制能力的革命性技术，支持姿态、边缘、深度等多种条件控制图像生成。

- **Stars:** ⭐️ 33.8k
- **Tags:** `diffusion-model` `image-generation` `stable-diffusion` `controlnet`
- **最后活动时间:** 2024-02-25
...
经典的动漫风格图像超分辨率放大工具，使用深度卷积神经网络实现高质量图像放大。

- **Stars:** ⭐️ 28.2k
- **Tags:** `super-resolution` `anime` `image-upscaling` `deep-learning`
- **最后活动时间:** 2023-05-04
...
基于Keras和TensorFlow的Mask R-CNN实现，用于目标检测和实例分割任务。

- **Stars:** ⭐️ 25.5k
- **Tags:** `Object Detection` `Instance Segmentation` `Computer Vision`
- **最后活动时间:** 2024-06-07

### [flux](https://github.com/black-forest-labs/flux)

FLUX.1图像生成模型的官方推理仓库，提供高质量文生图能力，是当前最先进的开源图像生成模型之一。
...
NeurIPS'23 Oral论文项目，视觉指令调优大模型，达到GPT-4V级别的多模态理解能力。

- **Stars:** ⭐️ 24.6k
- **Tags:** `multimodal` `vision-language` `llava` `gpt-4v` `instruction-tuning`
- **最后活动时间:** 2024-08-12
...
基于 TensorFlow.js 的人脸检测与识别 JavaScript API，支持浏览器和 Node.js 环境，可进行人脸检测、表情识别、年龄和性别估计。

- **Stars:** ⭐️ 17.8k
- **Tags:** `face-detection` `face-recognition` `tensorflow` `javascript`
- **最后活动时间:** 2024-01-24
...
CVPR 2020口头报告论文，使用GAN技术修复老照片的深度学习项目。

- **Stars:** ⭐️ 15.7k
- **Tags:** `photo-restoration` `gan` `image-restoration` `deep-learning`
- **最后活动时间:** 2023-10-26
...
图像动画领域的经典开源项目，通过运动重定向技术将静态图像转换为动态视频，只需一张图片即可生成逼真的动画效果。

- **Stars:** ⭐️ 15.0k
- **Tags:** `deep-learning` `image-animation` `motion-retargeting` `generative-model`
- **最后活动时间:** 2024-11-14
...
NVIDIA官方StyleGAN的TensorFlow实现，用于生成高质量逼真人脸图像的生成对抗网络。

- **Stars:** ⭐️ 14.4k
- **Tags:** `stylegan` `gan` `image-generation` `tensorflow`
- **最后活动时间:** 2024-04-10

### [latent-diffusion](https://github.com/CompVis/latent-diffusion)

高分辨率图像合成潜在扩散模型，Stable Diffusion的核心技术基础。

- **Stars:** ⭐️ 13.9k
- **Tags:** `Diffusion Model` `Image Generation` `Research`
- **最后活动时间:** 2024-02-29
...
经典图像到图像翻译框架，支持风格迁移、马变斑马等无配对转换。

- **Stars:** ⭐️ 12.8k
- **Tags:** `cyclegan` `image-translation` `style-transfer` `gan`
- **最后活动时间:** 2023-09-12
...
利用深度学习从GUI截图自动生成前端代码的AI模型，实现从图像到代码的智能转换。

- **Stars:** ⭐️ 12.0k
- **Tags:** `deep-learning` `code-generation` `gui` `image-to-code` `neural-network`
- **最后活动时间:** 2024-05-29
...
AI绘画资源合集，包含Stable Diffusion等主流平台的使用教程、参数指南、部署方法和业界动态。

- **Stars:** ⭐️ 11.8k
- **Tags:** `stable-diffusion` `ai-art` `image-generation` `diffusion-models`
- **最后活动时间:** 2024-08-14

### [nerfstudio](https://github.com/nerfstudio-project/nerfstudio)

协作友好的NeRF开发工作室，支持3D场景重建、高斯溅射和深度学习视觉任务。

- **Stars:** ⭐️ 11.4k
- **Tags:** `nerf` `3d-reconstruction` `computer-vision` `deep-learning` `pytorch`
- **最后活动时间:** 2025-07-29

### [DALLE2-pytorch](https://github.com/lucidrains/DALLE2-pytorch)

OpenAI DALL-E 2文本生成图像模型的PyTorch实现。探索文本到图像合成的前沿技术。

- **Stars:** ⭐️ 11.3k
- **Tags:** `text-to-image` `dalle2` `generative-ai`
- **最后活动时间:** 2024-05-11
...
StyleGAN2官方TensorFlow实现，相比一代在图像质量和训练稳定性上有显著提升。

- **Stars:** ⭐️ 11.2k
- **Tags:** `stylegan2` `gan` `image-generation` `tensorflow`
- **最后活动时间:** 2024-05-18

### [FastPhotoStyle](https://github.com/NVIDIA/FastPhotoStyle)

NVIDIA开源的快速风格迁移项目，实现照片级别的风格转换效果。

- **Stars:** ⭐️ 11.2k
- **Tags:** `style-transfer` `deep-learning` `image-processing` `nvidia`
- **最后活动时间:** 2023-06-07

### [faceai](https://github.com/vipstone/faceai)

入门级人脸检测、视频分析和文字识别项目，适合初学者学习计算机视觉应用。

- **Stars:** ⭐️ 11.1k
- **Tags:** `Face Detection` `OCR` `Computer Vision`
- **最后活动时间:** 2020-04-16

### [fast-style-transfer](https://github.com/lengstrom/fast-style-transfer)

基于TensorFlow的快速风格迁移实现，可将艺术风格实时应用到图像和视频中。

- **Stars:** ⭐️ 11.0k
- **Tags:** `style-transfer` `neural-style` `deep-learning` `tensorflow`
- **最后活动时间:** 2023-07-16

### [DALL-E](https://github.com/openai/DALL-E)

OpenAI DALL·E官方PyTorch实现，离散VAE用于文本到图像生成。

- **Stars:** ⭐️ 10.9k
- **Tags:** `dall-e` `image-generation` `vae`
- **最后活动时间:** 2024-01-31

### [pix2pix](https://github.com/phillipi/pix2pix)

经典的图像到图像翻译框架，使用条件对抗网络实现多种图像转换任务，如草图转照片、黑白转彩色等。

- **Stars:** ⭐️ 10.6k
- **Tags:** `gan` `image-to-image-translation` `computer-vision`
- **最后活动时间:** 2021-06-06

### [caire](https://github.com/esimov/caire)

基于机器学习的智能图像缩放库，支持内容感知缩放和人脸检测，可实现无缝的图像尺寸调整。

- **Stars:** ⭐️ 10.5k
- **Tags:** `computer-vision` `image-processing` `machine-learning` `face-detection`
- **最后活动时间:** 2025-05-02
...
基于深度神经网络的风格迁移工具，将简笔画转换为艺术作品。

- **Stars:** ⭐️ 9.9k
- **Tags:** `style-transfer` `neural-art` `image-generation` `deep-learning`
- **最后活动时间:** 2020-10-01

### [lama](https://github.com/advimman/lama)

WACV'2022基于傅里叶卷积的大掩码图像修复方法，支持高分辨率图像修复。

- **Stars:** ⭐️ 9.8k
- **Tags:** `image-inpainting` `fourier-convolutions` `pytorch` `computer-vision`
- **最后活动时间:** 2025-02-05

### [U-2-Net](https://github.com/xuebinqin/U-2-Net)

嵌套U型结构的显著性目标检测模型，适用于图像背景移除和分割任务。

- **Stars:** ⭐️ 9.7k
- **Tags:** `图像分割` `显著性检测` `深度学习`
- **最后活动时间:** 2024-06-26
...
一个用于生成数字分身的深度学习工具链，支持个性化人脸生成与定制。

- **Stars:** ⭐️ 9.5k
- **Tags:** `digital-twin` `image-generation` `stable-diffusion` `face-swap`
- **最后活动时间:** 2025-06-06

### [StableStudio](https://github.com/Stability-AI/StableStudio)

Stability AI官方开源的生成式AI社区界面，支持Stable Diffusion图像生成的直观交互体验。

- **Stars:** ⭐️ 9.1k
- **Tags:** `stable-diffusion` `generative-ai` `frontend`
- **最后活动时间:** 2024-04-30

### [stable-dreamfusion](https://github.com/ashawkey/stable-dreamfusion)

结合NeRF与扩散模型的文本/图像到3D生成工具，支持网格导出。

- **Stars:** ⭐️ 8.8k
- **Tags:** `dreamfusion` `nerf` `stable-diffusion` `text-to-3d`
- **最后活动时间:** 2023-12-10
...
Facebook官方的扩散模型Transformer实现，将Transformer架构应用于扩散模型的开创性工作。
...
Google Imagen文本生成图像神经网络的PyTorch实现。高质量文本到图像生成模型的开源复现。

- **Stars:** ⭐️ 8.4k
- **Tags:** `text-to-image` `imagen` `generative-ai`
- **最后活动时间:** 2024-10-07
...
开源图像和视频复原工具箱，支持EDSR、SRGAN、ESRGAN、SwinIR等多种超分辨率和去噪去模糊算法。

- **Stars:** ⭐️ 8.2k
- **Tags:** `super-resolution` `image-restoration` `pytorch` `esrgan`
- **最后活动时间:** 2024-07-21
...
无需预训练数据的图像恢复技术，仅利用神经网络结构本身即可完成去噪、超分辨率等任务。

- **Stars:** ⭐️ 8.1k
- **Tags:** `image-restoration` `deep-learning` `computer-vision` `unsupervised`
- **最后活动时间:** 2023-04-27

### [PaddleGAN](https://github.com/PaddlePaddle/PaddleGAN)

百度飞桨GAN库，包含人脸动画、Wav2Lip唇形同步、图像修复、风格迁移等多种生成对抗网络应用。

- **Stars:** ⭐️ 8.1k
- **Tags:** `gan` `image-generation` `style-transfer` `motion-transfer`
- **最后活动时间:** 2024-07-03

### [pulse](https://github.com/alex-damian/pulse)

通过潜在空间探索实现自监督照片超分辨率上采样，可将低分辨率人脸图像转换为高分辨率。

- **Stars:** ⭐️ 8.0k
- **Tags:** `super-resolution` `generative-models` `image-upsampling`
- **最后活动时间:** 2021-04-30
...
领先的开源人脸识别系统，提供REST API接口，支持人脸检测、识别、验证和口罩检测等功能。

- **Stars:** ⭐️ 7.9k
- **Tags:** `face-recognition` `computer-vision` `face-detection` `docker`
- **最后活动时间:** 2024-10-05
...
OpenMMLab姿态估计工具箱，支持人体、手部、面部关键点检测及动物姿态估计。

- **Stars:** ⭐️ 7.5k
- **Tags:** `pose-estimation` `computer-vision` `deep-learning` `pytorch` `openmmlab`
- **最后活动时间:** 2025-08-04

### [tessdata](https://github.com/tesseract-ocr/tessdata)

Tesseract OCR官方训练模型库，包含快速版和最佳版LSTM模型及传统模型。

- **Stars:** ⭐️ 7.5k
- **Tags:** `ocr` `tesseract` `lstm`
- **最后活动时间:** 2024-03-09
...
CVPR 2025收录的高效视觉语言模型，专注于视觉编码效率优化。

- **Stars:** ⭐️ 7.3k
- **Tags:** `视觉语言模型` `多模态` `CVPR2025`
- **最后活动时间:** 2025-05-05
...
深度卷积生成对抗网络(DCGAN)的TensorFlow实现，用于生成逼真的图像。

- **Stars:** ⭐️ 7.2k
- **Tags:** `dcgan` `gan` `image-generation` `tensorflow`
- **最后活动时间:** 2021-01-06

### [BackgroundMattingV2](https://github.com/PeterL1n/BackgroundMattingV2)

实时高分辨率背景抠图模型，支持视频和图像处理。

- **Stars:** ⭐️ 7.1k
- **Tags:** `computer-vision` `matting` `real-time` `image-processing`
- **最后活动时间:** 2024-06-19
...
统一的3D内容生成框架，支持文本到3D、图像到3D等多种AI生成方式，集成多种先进生成算法。

- **Stars:** ⭐️ 7.0k
- **Tags:** `3d-generation` `text-to-3d` `image-to-3d` `ai-generation`
- **最后活动时间:** 2024-12-16

### [pix2pixHD](https://github.com/NVIDIA/pix2pixHD)

NVIDIA高分辨率图像到图像翻译模型，支持2048x1024图像合成与编辑。

- **Stars:** ⭐️ 7.0k
- **Tags:** `image-to-image-translation` `gan` `high-resolution`
- **最后活动时间:** 2024-11-04

### [background-removal-js](https://github.com/imgly/background-removal-js)

浏览器端AI图像背景移除工具，基于ONNX实现图像分割，无需服务器即可在本地处理图片，保护隐私且零成本。

- **Stars:** ⭐️ 7.0k
- **Tags:** `background-removal` `image-segmentation` `onnx` `javascript` `typescript`
- **最后活动时间:** 2025-07-18

### [stylegan3](https://github.com/NVlabs/stylegan3)

NVIDIA官方StyleGAN3实现，解决了生成图像中的纹理粘连问题。

- **Stars:** ⭐️ 6.9k
- **Tags:** `stylegan` `generative-model` `image-synthesis`
- **最后活动时间:** 2023-09-12
...
增强型超分辨率生成对抗网络，PIRM感知超分辨率挑战赛冠军方案。提供高质量图像超分辨率重建能力。

- **Stars:** ⭐️ 6.5k
- **Tags:** `esrgan` `super-resolution` `gan` `image-enhancement`
- **最后活动时间:** 2022-10-19
...
开创性的高分辨率图像合成研究项目，将Transformer架构应用于图像生成领域，对后续扩散模型发展影响深远。

- **Stars:** ⭐️ 6.5k
- **Tags:** `image-generation` `transformers` `vqgan` `deep-learning`
- **最后活动时间:** 2024-07-30
...
NVIDIA官方实现的渐进式GAN训练方法，可生成高质量图像，是GAN领域里程碑式的研究成果。

- **Stars:** ⭐️ 6.2k
- **Tags:** `gan` `image-generation` `nvidia` `deep-learning`
- **最后活动时间:** 2022-02-17

### [UGATIT](https://github.com/taki0112/UGATIT)

ICLR 2020论文官方实现，无监督图像到图像翻译，支持自适应归一化的注意力机制。

- **Stars:** ⭐️ 6.1k
- **Tags:** `ugatit` `image-translation` `gan` `unsupervised`
- **最后活动时间:** 2021-05-20

### [chineseocr](https://github.com/chineseocr/chineseocr)

基于YOLO3的中文OCR识别系统，支持身份证、火车票等多种场景文字识别。

- **Stars:** ⭐️ 6.1k
- **Tags:** `ocr` `yolo` `chinese` `opencv`
- **最后活动时间:** 2022-08-29

### [open_nsfw](https://github.com/yahoo/open_nsfw)

基于深度神经网络的NSFW内容分类模型，使用Caffe框架实现图像安全检测。

- **Stars:** ⭐️ 6.0k
- **Tags:** `nsfw-detection` `image-classification` `deep-learning` `caffe`
- **最后活动时间:** 2018-11-21
...
OpenAI DALL-E文本生成图像模型的PyTorch实现，支持多模态文本到图像转换。

- **Stars:** ⭐️ 5.6k
- **Tags:** `text-to-image` `transformers` `pytorch` `generative-ai`
- **最后活动时间:** 2024-02-17
...
基于Torch的高效图像描述生成系统，支持GPU加速，能够自动为图像生成自然语言描述。

- **Stars:** ⭐️ 5.6k
- **Tags:** `image-captioning` `deep-learning` `neural-network` `torch` `computer-vision`
- **最后活动时间:** 2017-11-07
...
基于Python和numpy的多模态RNN项目，实现图像描述生成功能，将图片转换为自然语言描述。

- **Stars:** ⭐️ 5.5k
- **Tags:** `image-captioning` `multimodal` `rnn` `computer-vision`
- **最后活动时间:** 2020-12-22

### [SwinIR](https://github.com/JingyunLiang/SwinIR)

基于Swin Transformer的图像修复模型，支持超分辨率、去噪、去压缩伪影等任务。

- **Stars:** ⭐️ 5.4k
- **Tags:** `图像修复` `超分辨率` `Transformer`
- **最后活动时间:** 2024-05-14

### [ml-depth-pro](https://github.com/apple/ml-depth-pro)

快速单目深度估计模型，可在不到一秒内生成清晰的度量深度图。

- **Stars:** ⭐️ 5.4k
- **Tags:** `depth-estimation` `computer-vision` `monocular` `deep-learning`
- **最后活动时间:** 2025-04-21

### [pointnet](https://github.com/charlesq34/pointnet)

PointNet深度学习模型实现，用于3D点云数据的分类和语义分割任务。

- **Stars:** ⭐️ 5.4k
- **Tags:** `pointnet` `point-cloud` `3d-deep-learning` `tensorflow`
- **最后活动时间:** 2023-11-30

### [AnimeGANv2](https://github.com/TachibanaYoshino/AnimeGANv2)

将风景照片和视频转换为动漫风格的生成模型，支持TensorFlow GPU训练，效果出色的风格迁移工具。

- **Stars:** ⭐️ 5.4k
- **Tags:** `animegan` `style-transfer` `image-generation` `tensorflow`
- **最后活动时间:** 2024-08-27

### [MiDaS](https://github.com/isl-org/MiDaS)

Intel开源的单目深度估计模型，支持跨数据集零样本迁移，适用于3D场景理解和增强现实应用。

- **Stars:** ⭐️ 5.4k
- **Tags:** `depth-estimation` `computer-vision` `deep-learning` `monocular`
- **最后活动时间:** 2024-08-23

### [stargan](https://github.com/yunjey/stargan)

CVPR 2018论文官方实现，支持多域图像到图像翻译的统一生成对抗网络。

- **Stars:** ⭐️ 5.3k
- **Tags:** `image-to-image-translation` `generative-adversarial-network` `pytorch`
- **最后活动时间:** 2021-01-23

### [srez](https://github.com/david-gpu/srez)

基于深度学习的图像超分辨率项目，通过神经网络实现图像质量增强和放大。

- **Stars:** ⭐️ 5.3k
- **Tags:** `super-resolution` `deep-learning` `image-processing` `neural-networks` `computer-vision`
- **最后活动时间:** 2017-08-16

### [DeepSeek-VL2](https://github.com/deepseek-ai/DeepSeek-VL2)

DeepSeek开源的混合专家视觉语言模型，支持高级多模态理解任务，包括图像描述、视觉问答等。
...
基于 Stable Diffusion WebUI 的智能 AI 照片生成器，轻松创建个性化照片。

- **Stars:** ⭐️ 5.2k
- **Tags:** `stable-diffusion` `photo-generation` `ai-portrait` `webui`
- **最后活动时间:** 2024-07-10

### [SimSwap](https://github.com/neuralchen/SimSwap)

高效的人脸替换框架，仅需单一训练模型即可实现图像和视频中的人脸替换，效果自然逼真。

- **Stars:** ⭐️ 5.1k
- **Tags:** `face-swap` `gan` `deepfakes`
- **最后活动时间:** 2024-08-06

### [Realtime_Multi-Person_Pose_Estimation](https://github.com/ZheC/Realtime_Multi-Person_Pose_Estimation)

CVPR 2017发表的实时多人姿态估计代码库，基于深度学习实现高效人体姿态检测。

- **Stars:** ⭐️ 5.1k
- **Tags:** `pose-estimation` `deep-learning` `computer-vision` `realtime`
- **最后活动时间:** 2020-03-21

### [pix2pix-tensorflow](https://github.com/affinelayer/pix2pix-tensorflow)

条件生成对抗网络的图像翻译实现，可实现草图转照片、黑白转彩色等任务。

- **Stars:** ⭐️ 5.1k
- **Tags:** `pix2pix` `gan` `image-translation` `tensorflow`
- **最后活动时间:** 2021-02-02
...
ECCV 2018论文，基于位置图回归网络实现3D人脸重建与密集对齐的端到端深度学习方案。

- **Stars:** ⭐️ 5.0k
- **Tags:** `3d-face` `face-reconstruction` `deep-learning`
- **最后活动时间:** 2022-07-25
...
DragGAN交互式图像编辑工具，通过拖拽点实现精确的图像变形控制，支持多平台部署。

- **Stars:** ⭐️ 5.0k
- **Tags:** `draggan` `image-editing` `generative-model` `gradio`
- **最后活动时间:** 2023-07-17
...
图像分割模型库，提供多种预训练骨干网络，支持U-Net、FPN、PSPNet等架构。

- **Stars:** ⭐️ 4.9k
- **Tags:** `image-segmentation` `unet` `keras` `pretrained-models`
- **最后活动时间:** 2024-08-21
...
图像超分辨率工具，使用残差密集网络和对抗网络实现图像放大增强。

- **Stars:** ⭐️ 4.8k
- **Tags:** `超分辨率` `图像增强` `计算机视觉`
- **最后活动时间:** 2024-12-18
...
潜在一致性模型，实现少步推理生成高分辨率图像。

- **Stars:** ⭐️ 4.6k
- **Tags:** `latent-consistency` `image-generation` `diffusion-models`
- **最后活动时间:** 2024-06-14

### [AnimeGAN](https://github.com/TachibanaYoshino/AnimeGAN)

基于TensorFlow的轻量级GAN模型，可将真实照片快速转换为动漫风格图像，支持多种动漫风格。

- **Stars:** ⭐️ 4.6k
- **Tags:** `gan` `image-generation` `anime` `tensorflow` `style-transfer`
- **最后活动时间:** 2022-08-03

### [neuralangelo](https://github.com/NVlabs/neuralangelo)

CVPR 2023论文官方实现，高保真神经表面重建技术，可从图像重建精细3D模型。

- **Stars:** ⭐️ 4.6k
- **Tags:** `3d-reconstruction` `neural-rendering` `computer-vision` `computer-graphics`
- **最后活动时间:** 2024-04-14
...
CVPR2019论文官方实现，用于人体姿态估计的高分辨率表示学习网络。

- **Stars:** ⭐️ 4.5k
- **Tags:** `pose-estimation` `deep-learning` `pytorch` `computer-vision`
- **最后活动时间:** 2024-08-30
...
AnimeGANv2的PyTorch实现，将真实照片转换为动漫风格图像，支持多种动漫风格。

- **Stars:** ⭐️ 4.5k
- **Tags:** `gan` `style-transfer` `anime`
- **最后活动时间:** 2023-01-06
...
### [restorePhotos](https://github.com/Nutlope/restorePhotos)

使用AI技术修复老旧模糊的人脸照片，让珍贵回忆焕发新生。

- **Stars:** ⭐️ 4.4k
- **Tags:** `ai` `photo-restoration` `image-enhancement` `face-restoration`
- **最后活动时间:** 2024-06-20

### [deep-daze](https://github.com/lucidrains/deep-daze)

基于CLIP和Siren的文本生成图像工具，支持命令行快速生成高质量图像。

- **Stars:** ⭐️ 4.3k
- **Tags:** `text-to-image` `clip` `generative-ai` `pytorch`
- **最后活动时间:** 2022-03-13
...
从单张图像高效生成3D网格模型，结合稀疏视图大重建模型实现高质量重建。

- **Stars:** ⭐️ 4.3k
- **Tags:** `3d-mesh` `text-to-3d` `image-to-3d`
- **最后活动时间:** 2025-01-03

### [dreamgaussian](https://github.com/dreamgaussian/dreamgaussian)

ICLR 2024 Oral论文，生成式高斯溅射实现高效3D内容创作。

- **Stars:** ⭐️ 4.3k
- **Tags:** `gaussian-splatting` `image-to-3d` `text-to-3d` `iclr`
- **最后活动时间:** 2024-01-02
...
Segment Anything高质量版本，NeurIPS 2023发表，显著提升分割边缘精度。

- **Stars:** ⭐️ 4.2k
- **Tags:** `segment-anything` `segmentation` `zero-shot`
- **最后活动时间:** 2025-09-12

### [StyleCLIP](https://github.com/orpatashnik/StyleCLIP)

ICCV 2021 Oral论文官方实现，基于CLIP实现文本驱动的StyleGAN图像编辑，支持用自然语言描述来操控和修改生成图像。

- **Stars:** ⭐️ 4.1k
- **Tags:** `StyleGAN` `CLIP` `Text-to-Image` `Image-Manipulation`
- **最后活动时间:** 2023-05-30

### [DeepSeek-VL](https://github.com/deepseek-ai/DeepSeek-VL)

DeepSeek推出的视觉语言模型，专注于真实世界的视觉语言理解任务，支持图像理解和多模态推理。

- **Stars:** ⭐️ 4.1k
- **Tags:** `vision-language-model` `multimodal` `deepseek`
- **最后活动时间:** 2024-04-24

### [open_flamingo](https://github.com/mlfoundations/open_flamingo)

开源多模态大模型训练框架，复现Flamingo架构。

- **Stars:** ⭐️ 4.1k
- **Tags:** `multimodal-models` `flamingo` `vision-language`
- **最后活动时间:** 2024-08-31

### [imaginaire](https://github.com/NVlabs/imaginaire)

NVIDIA深度想象团队的PyTorch图像视频生成库。

- **Stars:** ⭐️ 4.1k
- **Tags:** `image-generation` `video-generation` `nvidia` `pytorch`
- **最后活动时间:** 2022-11-29
...
人像卡通化探索项目，将真实人脸照片转换为卡通风格头像，效果精美。

- **Stars:** ⭐️ 4.0k
- **Tags:** `cartoon` `gan` `computer-vision`
- **最后活动时间:** 2022-06-12

### [iGAN](https://github.com/junyanz/iGAN)

基于GAN的交互式图像生成工具，用户可通过简单手绘快速生成逼真图像。

- **Stars:** ⭐️ 4.0k
- **Tags:** `gan` `interactive` `image-generation`
- **最后活动时间:** 2020-08-05
...
ICCV 2019深度学习文本识别基准项目，包含多种先进文本识别算法实现。

- **Stars:** ⭐️ 3.9k
- **Tags:** `ocr` `deep-learning` `crnn` `scene-text`
- **最后活动时间:** 2024-03-04
...
基于扩散概率模型的图像超分辨率PyTorch实现，通过迭代优化生成高质量图像。

- **Stars:** ⭐️ 3.9k
- **Tags:** `diffusion-model` `super-resolution` `image-generation` `pytorch`
- **最后活动时间:** 2023-11-04

### [photoshot](https://github.com/premieroctet/photoshot)

开源AI头像生成Web应用，基于Dreambooth和Stable Diffusion技术。

- **Stars:** ⭐️ 3.9k
- **Tags:** `avatar-generator` `stable-diffusion` `dreambooth` `webapp`
- **最后活动时间:** 2024-12-07

### [stablediffusion-infinity](https://github.com/lkwq007/stablediffusion-infinity)

基于Stable Diffusion的无限画布图像外绘工具，支持在无限画布上进行AI图像扩展和创作。

- **Stars:** ⭐️ 3.9k
- **Tags:** `Stable Diffusion` `Outpainting` `Image Generation` `GUI`
- **最后活动时间:** 2023-05-16
...
StyleGAN2的PyTorch简洁实现，支持高分辨率图像生成和风格解耦控制。

- **Stars:** ⭐️ 3.8k
- **Tags:** `stylegan` `generative-model` `gan` `image-generation`
- **最后活动时间:** 2025-01-12

### [PaintsChainer](https://github.com/pfnet/PaintsChainer)

基于深度学习的线稿自动上色工具，使用Chainer框架实现，能够自动为黑白线稿添加颜色。

- **Stars:** ⭐️ 3.8k
- **Tags:** `image-colorization` `deep-learning` `chainer` `line-art`
- **最后活动时间:** 2019-01-06

### [web-stable-diffusion](https://github.com/mlc-ai/web-stable-diffusion)

将 Stable Diffusion 模型带入浏览器，完全本地运行无需服务器支持。基于 WebGPU 和 WebAssembly 实现高性能图像生成。

- **Stars:** ⭐️ 3.7k
- **Tags:** `stable-diffusion` `webgpu` `deep-learning` `image-generation`
- **最后活动时间:** 2024-03-12
...
3D人脸对齐PyTorch实现，支持全姿态范围的人脸3D建模与重建。

- **Stars:** ⭐️ 3.7k
- **Tags:** `3d-face` `face-alignment` `computer-vision` `pytorch`
- **最后活动时间:** 2022-05-14
...
基于深度学习的线稿肖像生成项目，可将照片转换为艺术线稿风格。

- **Stars:** ⭐️ 3.6k
- **Tags:** `deep-learning` `generative-art` `image-processing` `portraits`
- **最后活动时间:** 2023-03-03

### [tensorflow-yolov3](https://github.com/YunYang1994/tensorflow-yolov3)

YOLOv3目标检测算法的TensorFlow实现，支持实时物体检测与识别。

- **Stars:** ⭐️ 3.6k
- **Tags:** `yolov3` `object-detection` `tensorflow` `computer-vision`
- **最后活动时间:** 2024-07-04

### [stargan-v2](https://github.com/clovaai/stargan-v2)

CVPR 2020官方PyTorch实现，多域图像到图像翻译的生成模型，支持多样化风格转换。

- **Stars:** ⭐️ 3.6k
- **Tags:** `generative-models` `image-translation` `pytorch` `cvpr2020`
- **最后活动时间:** 2023-04-27

### [colornet](https://github.com/pavelgonchar/colornet)

使用神经网络自动为灰度图像上色的深度学习项目，实现黑白照片彩色化。

- **Stars:** ⭐️ 3.6k
- **Tags:** `image-colorization` `neural-network` `deep-learning` `computer-vision`
- **最后活动时间:** 2020-04-21

### [Unique3D](https://github.com/AiuniAI/Unique3D)

NeurIPS 2024 论文，从单张图像高效生成高质量 3D 网格模型，推动 AIGC 三维内容创作发展。

- **Stars:** ⭐️ 3.5k
- **Tags:** `NeurIPS2024` `3D-Generation` `Image-to-3D`
- **最后活动时间:** 2025-07-17

### [min-dalle](https://github.com/kuprel/min-dalle)

DALL-E Mini的轻量级PyTorch移植版本，快速实现文本到图像生成。

- **Stars:** ⭐️ 3.5k
- **Tags:** `text-to-image` `dalle` `pytorch` `generative-ai`
- **最后活动时间:** 2025-04-28

### [Hunyuan3D-1](https://github.com/Tencent-Hunyuan/Hunyuan3D-1)
...
基于生成对抗网络的超分辨率图像重建，实现照片级单图超分辨率。

- **Stars:** ⭐️ 3.5k
- **Tags:** `super-resolution` `gan` `tensorflow`
- **最后活动时间:** 2024-02-22

### [colorization](https://github.com/richzhang/colorization)

基于深度学习的自动图像着色项目，ECCV 2016论文实现，可将黑白照片自动上色。

- **Stars:** ⭐️ 3.5k
- **Tags:** `colorization` `computer-vision` `deep-learning` `caffe`
- **最后活动时间:** 2023-11-27

### [generative_inpainting](https://github.com/JiahuiYu/generative_inpainting)

CVPR 2018/ICCV 2019论文实现，基于上下文注意力和门控卷积的图像修复技术。

- **Stars:** ⭐️ 3.5k
- **Tags:** `image-inpainting` `generative-adversarial-network` `tensorflow`
- **最后活动时间:** 2024-06-27

### [KAIR](https://github.com/cszn/KAIR)

基于PyTorch的图像修复工具箱，包含DnCNN、SwinIR、BSRGAN等多种深度学习模型的训练与测试代码。

- **Stars:** ⭐️ 3.5k
- **Tags:** `image-restoration` `deep-learning` `pytorch` `super-resolution` `denoising`
- **最后活动时间:** 2024-10-02

### [faceswap-GAN](https://github.com/shaoanlu/faceswap-GAN)

结合去噪自编码器与对抗损失的人脸替换项目，引入注意力机制提升换脸效果。

- **Stars:** ⭐️ 3.4k
- **Tags:** `face-swap` `gan` `autoencoder`
- **最后活动时间:** 2022-04-17
...
从单张自然图像学习生成模型，支持图像编辑、动画生成和超分辨率等任务。

- **Stars:** ⭐️ 3.3k
- **Tags:** `single-image-generation` `gan` `image-editing`
- **最后活动时间:** 2023-05-26

### [PixArt-alpha](https://github.com/PixArt-alpha/PixArt-alpha)

快速训练的Diffusion Transformer，用于逼真文本到图像合成。

- **Stars:** ⭐️ 3.3k
- **Tags:** `text-to-image` `diffusion-transformer` `image-generation`
- **最后活动时间:** 2024-10-31

### [efficientvit](https://github.com/mit-han-lab/efficientvit)

高效视觉基础模型，支持高分辨率图像生成与感知，优化Transformer架构实现实时推理。

- **Stars:** ⭐️ 3.3k
- **Tags:** `vision-transformer` `segment-anything` `efficient-model`
- **最后活动时间:** 2025-09-05

### [SuGaR](https://github.com/Anttwo/SuGaR)

CVPR2024论文，表面对齐高斯泼溅技术，实现高效3D网格重建和高质量渲染。

- **Stars:** ⭐️ 3.3k
- **Tags:** `3d-gaussian-splatting` `mesh-reconstruction` `neural-rendering`
- **最后活动时间:** 2024-09-24

### [Real_Time_Image_Animation](https://github.com/anandpawara/Real_Time_Image_Animation)

基于一阶运动模型的实时图像动画项目，能够将静态图像转换为动态视频，实现人脸和物体的自然动画效果。

- **Stars:** ⭐️ 3.3k
- **Tags:** `deep-learning` `image-animation` `first-order-model` `computer-vision`
- **最后活动时间:** 2021-10-27
...
ECCV 2020 论文官方实现，快速准确稳定的3D密集人脸对齐与重建工具。

- **Stars:** ⭐️ 3.1k
- **Tags:** `3d-face-alignment` `face-reconstruction` `pytorch` `computer-vision`
- **最后活动时间:** 2024-02-02

### [neural-style-tf](https://github.com/cysmith/neural-style-tf)

TensorFlow实现的神经风格迁移算法，将艺术风格应用于图像。

- **Stars:** ⭐️ 3.1k
- **Tags:** `style-transfer` `tensorflow` `deep-learning`
- **最后活动时间:** 2020-12-24
...
OCR光学字符识别项目精选列表，涵盖文字检测、识别和文档理解技术。

- **Stars:** ⭐️ 3.1k
- **Tags:** `ocr` `text-recognition` `computer-vision` `document-ai`
- **最后活动时间:** 2024-07-06
...
EAST文本检测算法的TensorFlow实现，用于自然场景中的高效文本定位。

- **Stars:** ⭐️ 3.1k
- **Tags:** `text-detection` `ocr` `tensorflow` `computer-vision`
- **最后活动时间:** 2022-11-22
...
ICCV 2023论文，零样本单图像到3D物体生成模型。

- **Stars:** ⭐️ 3.0k
- **Tags:** `image-to-3d` `zero-shot` `novel-view-synthesis` `iccv`
- **最后活动时间:** 2023-12-05
...
AI草图转图像工具，将简单涂鸦转化为精美图像。

- **Stars:** ⭐️ 3.0k
- **Tags:** `ai` `image-generation` `sketch-to-image` `diffusion` `creative`
- **最后活动时间:** 2025-08-28
...
Retinaface人脸检测模型PyTorch实现，在Widerface数据集上达到80.99%准确率。

- **Stars:** ⭐️ 2.9k
- **Tags:** `face-detection` `retinaface` `computer-vision`
- **最后活动时间:** 2023-06-28

### [NAFNet](https://github.com/megvii-research/NAFNet)

ECCV2022图像复原模型，无需非线性激活函数即可实现SOTA去模糊去噪效果。

- **Stars:** ⭐️ 2.9k
- **Tags:** `image-restoration` `deblur` `denoise` `pytorch`
- **最后活动时间:** 2024-07-03

### [BigGAN-PyTorch](https://github.com/ajbrock/BigGAN-PyTorch)

BigGAN官方PyTorch实现，高质量图像生成模型，支持ImageNet规模训练。

- **Stars:** ⭐️ 2.9k
- **Tags:** `biggan` `gan` `image-generation` `pytorch`
- **最后活动时间:** 2023-07-19
...
Plenoxels：无需神经网络的辐射场渲染技术，CVPR 2022论文实现，用于3D场景重建。

- **Stars:** ⭐️ 2.9k
- **Tags:** `radiance-fields` `3d-reconstruction` `computer-vision` `neural-rendering`
- **最后活动时间:** 2023-06-29

### [dalle-flow](https://github.com/jina-ai/dalle-flow)

基于人机协作的文本生成高清图像工作流，支持DALL-E、GLID-3等多种生成模型，可通过Jina实现神经搜索和图像优化。

- **Stars:** ⭐️ 2.8k
- **Tags:** `dalle` `generative-art` `image-generation` `openai` `neural-search`
- **最后活动时间:** 2023-05-16

### [stylegan2-pytorch](https://github.com/rosinality/stylegan2-pytorch)

StyleGAN 2 的 PyTorch 实现，用于高质量图像生成和风格迁移。

- **Stars:** ⭐️ 2.8k
- **Tags:** `stylegan2` `image-generation` `gan` `pytorch` `generative-model`
- **最后活动时间:** 2023-11-06

### [Kandinsky-2](https://github.com/ai-forever/Kandinsky-2)

多语言文本到图像的潜在扩散模型，支持图像生成、编辑、修复等多种功能。

- **Stars:** ⭐️ 2.8k
- **Tags:** `Text-to-Image` `Diffusion` `Multilingual` `Inpainting`
- **最后活动时间:** 2024-05-01

### [swift-coreml-diffusers](https://github.com/tensorflow/tflite-micro)
...
单图像度量深度估计模型，基于Transformer架构实现零样本迁移能力。

- **Stars:** ⭐️ 2.8k
- **Tags:** `depth-estimation` `computer-vision` `transformers`
- **最后活动时间:** 2025-05-05

### [nerf_pl](https://github.com/kwea123/nerf_pl)

基于PyTorch Lightning的NeRF实现，支持NeRF in the Wild场景重建。

- **Stars:** ⭐️ 2.8k
- **Tags:** `nerf` `neural-radiance-fields` `3d-reconstruction` `pytorch`
- **最后活动时间:** 2023-08-03
...
### [chinese-ocr](https://github.com/YCG09/chinese_ocr)

端到端中文OCR系统，结合CTPN、DenseNet和CTC实现高精度文字识别。

- **Stars:** ⭐️ 2.8k
- **Tags:** `ocr` `chinese` `text-recognition` `tensorflow`
- **最后活动时间:** 2019-10-08
...
文本生成图像在线演示平台，支持Stable Diffusion模型，可快速体验AI图像生成。

- **Stars:** ⭐️ 2.7k
- **Tags:** `Image Generation` `Stable Diffusion` `Playground`
- **最后活动时间:** 2024-06-03

### [SimpleCV](https://github.com/sightmachine/SimpleCV)

开源机器视觉框架，简化计算机视觉开发流程，支持图像处理、特征检测等功能。
...
使用条件GAN学习汉字风格迁移，实现中文字体的风格转换与生成。

- **Stars:** ⭐️ 2.7k
- **Tags:** `gan` `style-transfer` `chinese-characters` `deep-learning`
- **最后活动时间:** 2019-08-09

### [MUNIT](https://github.com/NVlabs/MUNIT)

多模态无监督图像到图像翻译框架，基于GAN实现不同域之间的风格迁移，无需成对训练数据。

- **Stars:** ⭐️ 2.7k
- **Tags:** `deep-learning` `gan` `image-translation`
- **最后活动时间:** 2022-09-20

### [interactive-deep-colorization](https://github.com/junyanz/interactive-deep-colorization)

交互式深度学习黑白图像上色工具，用户可通过点击引导上色效果。

- **Stars:** ⭐️ 2.7k
- **Tags:** `colorization` `deep-learning` `computer-vision`
- **最后活动时间:** 2022-07-29

### [DWPose](https://github.com/IDEA-Research/DWPose)

基于两阶段蒸馏的高效全身姿态估计方法，ICCV 2023论文。支持ControlNet和Stable Diffusion WebUI集成。

- **Stars:** ⭐️ 2.7k
- **Tags:** `pose-estimation` `controlnet` `stable-diffusion` `knowledge-distillation`
- **最后活动时间:** 2023-12-12
...
ICCV 2025 Highlight 论文，实现灵活的照片重制同时保持人物身份特征，支持个性化图像编辑。

- **Stars:** ⭐️ 2.7k
- **Tags:** `ICCV2025` `Identity-Preserving` `Image-Editing`
- **最后活动时间:** 2025-08-22
...
### [Stable-Diffusion](https://github.com/FurkanGozukara/Stable-Diffusion)
...
基于TensorFlow.js的Web端增强现实框架，支持图像追踪和人脸追踪。

- **Stars:** ⭐️ 2.7k
- **Tags:** `augmented-reality` `webar` `tensorflowjs`
- **最后活动时间:** 2024-06-11

### [StableSR](https://github.com/IceClear/StableSR)

IJCV 2024论文实现，利用Stable Diffusion先验进行真实世界图像超分辨率。

- **Stars:** ⭐️ 2.6k
- **Tags:** `stable-diffusion` `super-resolution` `diffusion-model` `ijcv`
- **最后活动时间:** 2024-07-12

### [DeblurGAN](https://github.com/KupynOrest/DeblurGAN)

基于生成对抗网络的图像去模糊模型，ICCV 2017论文实现。

- **Stars:** ⭐️ 2.6k
- **Tags:** `gan` `image-deblurring` `computer-vision`
- **最后活动时间:** 2019-12-25
...
### [UNetPlusPlus](https://github.com/MrGiovanni/UNetPlusPlus)
...
基于边缘预测的结构引导图像修复模型，ICCV 2019论文实现。

- **Stars:** ⭐️ 2.6k
- **Tags:** `image-inpainting` `gan` `computer-vision`
- **最后活动时间:** 2024-02-03

### [EDSR-PyTorch](https://github.com/sanghyun-son/EDSR-PyTorch)

CVPRW 2017论文PyTorch实现，单图像超分辨率增强。

- **Stars:** ⭐️ 2.6k
- **Tags:** `super-resolution` `image-enhancement` `pytorch`
- **最后活动时间:** 2023-01-03

### [LISA](https://github.com/JIA-Lab-research/LISA)

通过大语言模型实现推理分割的多模态项目，结合视觉与语言理解。

- **Stars:** ⭐️ 2.6k
- **Tags:** `multimodal` `segmentation` `llm` `vision-language`
- **最后活动时间:** 2025-02-16

### [Self-Attention-GAN](https://github.com/heykeetae/Self-Attention-GAN)

自注意力生成对抗网络PyTorch实现，提升图像生成质量。

- **Stars:** ⭐️ 2.6k
- **Tags:** `gan` `self-attention` `image-generation`
- **最后活动时间:** 2024-04-22

### [DeepLabV3Plus-Pytorch](https://github.com/VainF/DeepLabV3Plus-Pytorch)

DeepLabv3+预训练模型，支持Pascal VOC和Cityscapes语义分割。

- **Stars:** ⭐️ 2.6k
- **Tags:** `semantic-segmentation` `deeplabv3` `pytorch`
- **最后活动时间:** 2022-11-15
...
基于CLIP和BigGAN的文本到图像生成命令行工具，简单易用。

- **Stars:** ⭐️ 2.6k
- **Tags:** `text-to-image` `clip` `gan` `generative-art`
- **最后活动时间:** 2022-02-06
...
基于PULSE的人脸去像素化工具，可将模糊低分辨率人脸图像转换为清晰高分辨率图像。

- **Stars:** ⭐️ 2.6k
- **Tags:** `face-restoration` `super-resolution` `generative-models`
- **最后活动时间:** 2025-01-06

### [DeepMosaics](https://github.com/HypoX64/DeepMosaics)

基于深度学习的图像/视频马赛克处理工具，支持自动去除或添加马赛克效果。

- **Stars:** ⭐️ 2.6k
- **Tags:** `deep-learning` `video-inpainting` `computer-vision`
- **最后活动时间:** 2024-08-30

### [face-parsing.PyTorch](https://github.com/zllrunning/face-parsing.PyTorch)

基于BiSeNet的人脸解析PyTorch实现，支持人脸语义分割。

- **Stars:** ⭐️ 2.6k
- **Tags:** `face-parsing` `semantic-segmentation` `bisenet`
- **最后活动时间:** 2023-05-21

### [UGATIT-pytorch](https://github.com/znxlwm/UGATIT-pytorch)

U-GAT-IT官方PyTorch实现，无监督图像到图像翻译。

- **Stars:** ⭐️ 2.5k
- **Tags:** `image-translation` `gan` `unsupervised`
- **最后活动时间:** 2023-03-16
...
高精度二分图像分割项目，可实现高质量背景移除效果。

- **Stars:** ⭐️ 2.5k
- **Tags:** `image-segmentation` `background-removal` `computer-vision` `deep-learning`
- **最后活动时间:** 2024-09-23

### [contrastive-unpaired-translation](https://github.com/taesungp/contrastive-unpaired-translation)

ECCV 2020论文，基于对比学习的无配对图像到图像翻译方法，比CycleGAN更快更轻量。

- **Stars:** ⭐️ 2.5k
- **Tags:** `image-translation` `contrastive-learning` `gan` `unpaired-translation`
- **最后活动时间:** 2023-09-05

### [crnn.pytorch](https://github.com/meijieru/crnn.pytorch)

卷积循环神经网络PyTorch实现，用于场景文本识别。

- **Stars:** ⭐️ 2.5k
- **Tags:** `ocr` `scene-text-recognition` `crnn`
- **最后活动时间:** 2024-09-19
...
携程自研的OCR识别系统，支持身份证、护照、火车票、签证等多种证件材料的智能识别，包含拒识、检测、识别、后处理四大模块。

- **Stars:** ⭐️ 2.5k
- **Tags:** `ocr` `chinese` `document-recognition` `deep-learning`
- **最后活动时间:** 2024-02-14

### [DECA](https://github.com/yfeng95/DECA)

SIGGRAPH 2021 论文，从单张图片重建详细3D人脸表情并支持动画生成。

- **Stars:** ⭐️ 2.5k
- **Tags:** `face-reconstruction` `3d-face` `animation` `flame`
- **最后活动时间:** 2023-07-23

### [AIGODLIKE-ComfyUI-Translation](https://github.com/AIGODLIKE/AIGODLIKE-ComfyUI-Translation)

ComfyUI多语言翻译插件，实现菜单栏、搜索栏、右键菜单、节点等的完整中文翻译支持。

- **Stars:** ⭐️ 2.4k
- **Tags:** `comfyui` `translation` `ai-image-generation`
- **最后活动时间:** 2025-03-24
...
### [iPERCore](https://github.com/iPERDance/iPERCore)

基于注意力机制的Liquid Warping GAN，实现人体图像合成的统一框架。

- **Stars:** ⭐️ 2.4k
- **Tags:** `human-synthesis` `gan` `pose-transfer` `image-generation`
- **最后活动时间:** 2023-05-12

### [img2img-turbo](https://github.com/GaParmar/img2img-turbo)

基于Stable Diffusion的单步图像转换工具，支持草图转图像、日夜转换等。

- **Stars:** ⭐️ 2.4k
- **Tags:** `stable-diffusion` `image-to-image` `generative-art`
- **最后活动时间:** 2025-08-01

### [Sophus](https://github.com/strasdat/Sophus)

基于Eigen的C++李群库，广泛用于机器人、计算机视觉和SLAM领域。

- **Stars:** ⭐️ 2.4k
- **Tags:** `lie-groups` `computer-vision` `robotics` `geometry`
- **最后活动时间:** 2024-07-06
...
基于YOLOv5的高性能人脸检测器，ECCV Workshops 2022论文。支持TensorRT加速和多种骨干网络。

- **Stars:** ⭐️ 2.4k
- **Tags:** `yolo` `face-detection` `pytorch` `tensorrt` `object-detection`
- **最后活动时间:** 2024-07-22
...
模块化多模态大语言模型，专为文档理解设计，支持图表和表格理解任务。

- **Stars:** ⭐️ 2.4k
- **Tags:** `multimodal-llm` `document-understanding` `vision-language-model` `ocr`
- **最后活动时间:** 2025-05-30

### [Swin-Unet](https://github.com/HuCaoFighting/Swin-Unet)

ECCVW 2022，纯Transformer架构的U-Net医学图像分割模型。

- **Stars:** ⭐️ 2.4k
- **Tags:** `medical-imaging` `image-segmentation` `swin-transformer`
- **最后活动时间:** 2025-05-09

### [Deep3DFaceReconstruction](https://github.com/microsoft/Deep3DFaceReconstruction)

CVPRW 2019论文，利用弱监督学习实现高精度3D人脸重建，支持单图到图像集输入。

- **Stars:** ⭐️ 2.3k
- **Tags:** `3d-face` `face-reconstruction` `tensorflow`
- **最后活动时间:** 2024-01-04

### [DPT](https://github.com/isl-org/DPT)

Dense Prediction Transformers，用于密集预测任务的视觉Transformer架构。

- **Stars:** ⭐️ 2.3k
- **Tags:** `dense-prediction` `vision-transformer` `depth-estimation`
- **最后活动时间:** 2024-12-18

### [pytorch-openpose](https://github.com/Hzzone/pytorch-openpose)

OpenPose PyTorch实现，支持人体和手部姿态估计。

- **Stars:** ⭐️ 2.3k
- **Tags:** `pose-estimation` `openpose` `keypoint-detection`
- **最后活动时间:** 2024-07-09

### [Semantic-Segment-Anything](https://github.com/fudan-zvg/Semantic-Segment-Anything)

自动化密集类别标注引擎，为Segment Anything数据集提供初始语义标注。

- **Stars:** ⭐️ 2.3k
- **Tags:** `semantic-segmentation` `segment-anything` `computer-vision` `annotation`
- **最后活动时间:** 2023-06-07

### [Neural-Style-Transfer](https://github.com/titu1994/Neural-Style-Transfer)

Keras实现的神经风格迁移，将艺术风格应用到普通图像上。

- **Stars:** ⭐️ 2.3k
- **Tags:** `neural-style-transfer` `style-transfer` `keras` `deep-learning`
- **最后活动时间:** 2023-02-13
...
### [DreamOmni2](https://github.com/JIA-Lab-research/DreamOmni2)
...
YOLOv4/v3目标检测的TensorFlow 2.0实现，支持TFLite移动端部署和TensorRT加速。

- **Stars:** ⭐️ 2.3k
- **Tags:** `yolov4` `object-detection` `tflite` `tensorflow`
- **最后活动时间:** 2024-05-12
...
CVPR 2021 Oral论文，从单目视频实时重建连贯3D场景的神经重建方法。

- **Stars:** ⭐️ 2.3k
- **Tags:** `3d-reconstruction` `neural-network` `monocular`
- **最后活动时间:** 2023-10-04
...
CVPR 2022论文官方实现，使用去噪扩散概率模型进行图像修复。

- **Stars:** ⭐️ 2.2k
- **Tags:** `inpainting` `diffusion-models` `cvpr2022`
- **最后活动时间:** 2022-08-20

### [lightweight-human-pose-estimation.pytorch](https://github.com/Daniil-Osokin/lightweight-human-pose-estimation.pytorch)

基于PyTorch的轻量级实时人体姿态估计模型，可在CPU上实现快速准确的多人2D姿态检测。

- **Stars:** ⭐️ 2.2k
- **Tags:** `Pose Estimation` `PyTorch` `Computer Vision` `Deep Learning`
- **最后活动时间:** 2024-04-30

### [image-quality-assessment](https://github.com/idealo/image-quality-assessment)

基于CNN的图像美学与技术质量评估模型，可预测图片的审美评分和技术质量。

- **Stars:** ⭐️ 2.2k
- **Tags:** `image-quality-assessment` `deep-learning` `computer-vision`
- **最后活动时间:** 2024-07-12

### [torch-ngp](https://github.com/ashawkey/torch-ngp)

Instant-NGP的PyTorch CUDA实现，支持NeRF和SDF，提供实时神经辐射场渲染与交互式GUI界面。

- **Stars:** ⭐️ 2.2k
- **Tags:** `NeRF` `3D Reconstruction` `PyTorch` `Neural Graphics`
- **最后活动时间:** 2023-11-10
...
Facebook Research开发的图像分类研究代码库，基于PyTorch构建。

- **Stars:** ⭐️ 2.2k
- **Tags:** `image-classification` `pytorch` `computer-vision` `research`
- **最后活动时间:** 2024-03-20

### [text-to-image](https://github.com/paarthneekhara/text-to-image)

基于思维向量的文本到图像合成项目，结合GAN实现跨模态生成。

- **Stars:** ⭐️ 2.2k
- **Tags:** `text-to-image` `gan` `generative-model` `tensorflow`
- **最后活动时间:** 2018-01-30
...
### [DenoisingDiffusionProbabilityModel-ddpm-](https://github.com/zoubohao/DenoisingDiffusionProbabilityModel-ddpm-)

DDPM扩散模型的简洁实现，可在CIFAR-10上训练UNet并观察去噪过程。

- **Stars:** ⭐️ 2.2k
- **Tags:** `ddpm` `diffusion-model` `denoising` `generative-model`
- **最后活动时间:** 2023-04-24
...
### [DragGAN](https://github.com/JiauZhang/DragGAN)

DragGAN全功能实现，支持交互式点控图像编辑，提供在线Demo和本地部署。

- **Stars:** ⭐️ 2.1k
- **Tags:** `draggan` `image-editing` `interactive-manipulation` `gan`
- **最后活动时间:** 2023-07-11
...
### [subpixel](https://github.com/atriumlts/subpixel)

基于TensorFlow实现的亚像素卷积神经网络，用于图像超分辨率重建。

- **Stars:** ⭐️ 2.1k
- **Tags:** `super-resolution` `tensorflow` `cnn`
- **最后活动时间:** 2022-05-18
...
实用的手部追踪引擎，支持JavaScript和TypeScript的Web端手势识别。

- **Stars:** ⭐️ 2.1k
- **Tags:** `hand-tracking` `gesture-recognition` `computer-vision`
- **最后活动时间:** 2024-03-30

### [sdfstudio](https://github.com/autonomousvision/sdfstudio)

统一的表面重建框架，支持NeRF和SDF等多种隐式表示方法。

- **Stars:** ⭐️ 2.1k
- **Tags:** `3d-reconstruction` `nerf` `sdf` `pytorch`
- **最后活动时间:** 2024-07-11
...
OpenAI发布的图像生成预训练模型，将GPT架构应用于图像生成任务。

- **Stars:** ⭐️ 2.1k
- **Tags:** `image-gpt` `openai` `image-generation` `transformer`
- **最后活动时间:** 2022-04-29

### [Neural-Photo-Editor](https://github.com/ajbrock/Neural-Photo-Editor)

基于生成神经网络的图像编辑工具，支持自然照片的智能编辑。

- **Stars:** ⭐️ 2.1k
- **Tags:** `image-editing` `generative-networks` `computer-vision` `gans`
- **最后活动时间:** 2017-03-22
...
Diffusion Transformer的上下文LoRA官方实现，支持灵活的条件生成。

- **Stars:** ⭐️ 2.1k
- **Tags:** `lora` `diffusion-transformer` `in-context-learning`
- **最后活动时间:** 2024-12-20

### [PI-REC](https://github.com/youyuge34/PI-REC)

基于条件GAN的渐进式图像重建网络，支持边缘和色彩域的AI绘画与图像翻译。

- **Stars:** ⭐️ 2.1k
- **Tags:** `GAN` `Image Reconstruction` `AI Painting`
- **最后活动时间:** 2022-11-22

### [LGM](https://github.com/3DTopia/LGM)

ECCV 2024 Oral论文，大规模多视角高斯模型用于高分辨率3D内容创作。

- **Stars:** ⭐️ 2.1k
- **Tags:** `gaussian-splatting` `image-to-3d` `text-to-3d` `eccv`
- **最后活动时间:** 2024-08-20
...
### [StableDiffusion-CheatSheet](https://github.com/SupaGruen/StableDiffusion-CheatSheet)

Stable Diffusion 风格提示词速查表，包含多种艺术风格和提示词笔记，支持离线使用。

- **Stars:** ⭐️ 2.0k
- **Tags:** `stable-diffusion` `ai-art` `prompt-engineering` `image-generation`
- **最后活动时间:** 2024-08-29

### [Real-ESRGAN-ncnn-vulkan](https://github.com/xinntao/Real-ESRGAN-ncnn-vulkan)

基于NCNN的Real-ESRGAN图像超分辨率重建实现，支持AMD/Intel/NVIDIA GPU，适用于图像修复和增强。

- **Stars:** ⭐️ 2.0k
- **Tags:** `super-resolution` `image-restoration` `esrgan` `ncnn` `vulkan`
- **最后活动时间:** 2024-05-10
...
无监督图像到图像翻译框架，支持域间风格转换。

- **Stars:** ⭐️ 2.0k
- **Tags:** `image-translation` `gan` `unsupervised-learning` `computer-vision`
- **最后活动时间:** 2021-09-02

### [ScaledYOLOv4](https://github.com/WongKinYiu/ScaledYOLOv4)

可扩展YOLOv4目标检测模型，支持多种规模的高效检测。

- **Stars:** ⭐️ 2.0k
- **Tags:** `object-detection` `yolo` `pytorch` `deep-learning`
- **最后活动时间:** 2024-11-03

### [Zero123++](https://github.com/SUDO-AI-3D/zero123plus)

从单张图片生成一致多视角图像的扩散模型，为3D重建提供高质量多视图输入。

- **Stars:** ⭐️ 2.0k
- **Tags:** `diffusion-models` `image-to-3d` `text-to-3d` `aigc`
- **最后活动时间:** 2024-02-23

### [talking-head-anime-demo](https://github.com/pkhungurn/talking-head-anime-demo)

从单张图片生成会说话的动漫角色动画，支持VTuber应用场景。

- **Stars:** ⭐️ 2.0k
- **Tags:** `talking-head` `anime` `deep-learning` `vtuber`
- **最后活动时间:** 2022-06-29

### [mmgeneration](https://github.com/open-mmlab/mmgeneration)

OpenMMLab推出的生成式模型工具包，支持GAN、扩散模型等多种生成架构。

- **Stars:** ⭐️ 2.0k
- **Tags:** `Generative Models` `GAN` `Diffusion`
- **最后活动时间:** 2023-09-05

### [AnimeGANv3](https://github.com/TachibanaYoshino/AnimeGANv3)

动漫风格迁移工具，支持将照片和视频转换为动漫风格，提供多种预训练模型。

- **Stars:** ⭐️ 2.0k
- **Tags:** `Anime` `Style Transfer` `Image Generation`
- **最后活动时间:** 2025-08-23

### [art-DCGAN](https://github.com/robbiebarrat/art-DCGAN)

专注于生成艺术的DCGAN改进实现，包含风景、肖像等预训练模型。

- **Stars:** ⭐️ 2.0k
- **Tags:** `generative-art` `gan` `dcgan`
- **最后活动时间:** 2022-02-17

### [ml-fastvit](https://github.com/apple/ml-fastvit)

ICCV 2023论文FastViT官方实现，一种使用结构重参数化的快速混合视觉Transformer。

- **Stars:** ⭐️ 2.0k
- **Tags:** `vision-transformer` `deep-learning` `computer-vision` `iccv2023`
- **最后活动时间:** 2023-11-30

### [GANimation](https://github.com/albertpumarola/GANimation)

ECCV 2018论文，从单张图像生成解剖学感知的面部动画。

- **Stars:** ⭐️ 2.0k
- **Tags:** `face-animation` `gan` `facial-expressions` `image-generation`
- **最后活动时间:** 2019-12-23

### [ml-hypersim](https://github.com/apple/ml-hypersim)
...
利用监督学习解析GAN潜在空间，实现可控图像生成与编辑的创新框架。

- **Stars:** ⭐️ 2.0k
- **Tags:** `gan` `generative-adversarial-network` `image-generation` `latent-space` `tensorflow`
- **最后活动时间:** 2020-12-28
...
基于OpenCV的动漫/漫画人脸检测器，专为二次元角色设计。

- **Stars:** ⭐️ 2.0k
- **Tags:** `face-detector` `anime` `opencv` `computer-vision`
- **最后活动时间:** 2018-11-23

### [eos](https://github.com/patrikhuber/eos)

轻量级现代C++ 3D可变形人脸模型库，支持跨平台人脸重建。

- **Stars:** ⭐️ 2.0k
- **Tags:** `3d-face` `3dmm` `face-reconstruction` `computer-vision`
- **最后活动时间:** 2025-05-01
...
基于计算机视觉的全身手势键盘，通过摄像头捕捉手势实现无接触打字输入。

- **Stars:** ⭐️ 1.9k
- **Tags:** `computer-vision` `gesture-recognition` `mediapipe` `opencv` `keyboard`
- **最后活动时间:** 2023-06-29

### [nerfies](https://github.com/google/nerfies)

可变形神经辐射场实现，支持动态场景的3D重建与渲染。

- **Stars:** ⭐️ 1.9k
- **Tags:** `3d` `nerf` `neural-rendering` `deformable`
- **最后活动时间:** 2024-04-22

### [gigagan-pytorch](https://github.com/lucidrains/gigagan-pytorch)

Adobe GigaGAN的PyTorch实现，新一代大规模生成对抗网络架构。

- **Stars:** ⭐️ 1.9k
- **Tags:** `gan` `image-generation` `adobe` `pytorch`
- **最后活动时间:** 2025-01-12
...
基于TensorFlow的通用U-Net图像分割实现，支持多种分割任务。

- **Stars:** ⭐️ 1.9k
- **Tags:** `TensorFlow` `U-Net` `Image Segmentation`
- **最后活动时间:** 2020-05-05

### [PixArt-sigma](https://github.com/PixArt-alpha/PixArt-sigma)

弱到强训练的Diffusion Transformer，支持4K文本到图像生成。

- **Stars:** ⭐️ 1.9k
- **Tags:** `text-to-image` `4k-generation` `diffusion-transformer`
- **最后活动时间:** 2024-10-31

### [MedicalZooPytorch](https://github.com/black0017/MedicalZooPytorch)

基于PyTorch的多模态医学图像分割深度学习框架，支持2D/3D分割任务。

- **Stars:** ⭐️ 1.9k
- **Tags:** `PyTorch` `Medical Imaging` `Segmentation` `3D CNN`
- **最后活动时间:** 2024-07-25
...
Deep3DFaceReconstruction的PyTorch实现，利用弱监督学习实现高精度3D人脸重建。

- **Stars:** ⭐️ 1.9k
- **Tags:** `3d-face` `face-reconstruction` `pytorch`
- **最后活动时间:** 2024-11-26

### [FreeU](https://github.com/ChenyangSi/FreeU)

CVPR2024 Oral论文，提出扩散U-Net中的免费午餐优化方法，无需额外训练即可提升生成质量。

- **Stars:** ⭐️ 1.9k
- **Tags:** `diffusion` `u-net` `image-generation`
- **最后活动时间:** 2024-12-24
...
ICCV 2023论文，利用扩散先验从单张图像生成高保真3D内容。

- **Stars:** ⭐️ 1.9k
- **Tags:** `3d-generation` `diffusion-models` `nerf` `single-image-3d`
- **最后活动时间:** 2024-07-05
...
SSD单次多框检测器的Keras实现，用于实时目标检测。

- **Stars:** ⭐️ 1.9k
- **Tags:** `object-detection` `ssd` `keras` `computer-vision`
- **最后活动时间:** 2022-04-21
...
StackGAN文本到图像生成模型，通过两阶段生成实现高分辨率图像合成。

- **Stars:** ⭐️ 1.9k
- **Tags:** `stackgan` `text-to-image` `gan` `image-generation`
- **最后活动时间:** 2020-05-15

### [Atlas](https://github.com/magicleap/Atlas)

端到端3D场景重建系统，从已定位图像集合直接重建完整3D场景。

- **Stars:** ⭐️ 1.9k
- **Tags:** `3d-reconstruction` `scene-reconstruction` `deep-learning`
- **最后活动时间:** 2022-04-06

### [RPG-DiffusionMaster](https://github.com/YangLing0818/RPG-DiffusionMaster)

ICML 2024论文，使用多模态LLM实现文本到图像扩散模型的重新描述、规划与生成。

- **Stars:** ⭐️ 1.8k
- **Tags:** `text-to-image` `diffusion` `multimodal-llm` `image-generation`
- **最后活动时间:** 2025-02-01

### [stylegan2-ada](https://github.com/NVlabs/stylegan2-ada)

NVIDIA官方StyleGAN2自适应判别器增强实现，高质量图像生成模型。

- **Stars:** ⭐️ 1.8k
- **Tags:** `stylegan` `image-generation` `gan`
- **最后活动时间:** 2024-07-02
...
NeurIPS 2022 Oral论文官方实现，扩散模型快速采样求解器。

- **Stars:** ⭐️ 1.8k
- **Tags:** `diffusion-models` `stable-diffusion` `neurips2022`
- **最后活动时间:** 2024-02-06
...
像素对齐隐式函数，用于高分辨率穿衣人体三维数字化重建。

- **Stars:** ⭐️ 1.8k
- **Tags:** `3d-reconstruction` `human-digitization` `implicit-function` `pytorch`
- **最后活动时间:** 2023-11-24

### [Anime-InPainting](https://github.com/joelibaceta/video-to-ascii)

基于GAN的动漫图像修复工具，支持去马赛克、瑕疵修复和图像补全，采用edge-connect深度学习模型。

- **Stars:** ⭐️ 1.8k
- **Tags:** `inpainting` `gan` `deep-learning` `anime` `pytorch`
- **最后活动时间:** 2025-09-27

### [aicover](https://github.com/all-in-aigc/aicover)

基于 DALL-E 3 的 AI 封面生成器，可自动生成各类封面图片。

- **Stars:** ⭐️ 1.8k
- **Tags:** `ai` `dalle-3` `cover-generator` `image-generation`
- **最后活动时间:** 2025-01-24

### [Palette-Image-to-Image-Diffusion-Models](https://github.com/Janspiry/Palette-Image-to-Image-Diffusion-Models)

Palette图像到图像扩散模型PyTorch实现，支持图像修复、着色等任务。

- **Stars:** ⭐️ 1.8k
- **Tags:** `diffusion-model` `image-restoration` `pytorch`
- **最后活动时间:** 2023-07-07
...
基于示例的纹理合成工具，使用Rust编写。支持图像修复和纹理生成，适用于游戏开发和图形设计场景。

- **Stars:** ⭐️ 1.8k
- **Tags:** `texture-synthesis` `image-generation` `rust` `inpainting`
- **最后活动时间:** 2023-01-22
...
NeurIPS 2021论文实现，基于Transformer的文本到图像生成模型。

- **Stars:** ⭐️ 1.8k
- **Tags:** `text-to-image` `transformers` `pytorch` `generative-model`
- **最后活动时间:** 2023-09-25

### [ganspace](https://github.com/harskish/ganspace)

NeurIPS 2020论文实现，发现GAN的可解释控制方法，支持交互式图像编辑。

- **Stars:** ⭐️ 1.8k
- **Tags:** `gan` `generative-models` `pytorch` `interactive`
- **最后活动时间:** 2023-01-20

### [ml-4m](https://github.com/apple/ml-4m)

大规模多模态掩码建模框架，支持多种模态的统一预训练方法。

- **Stars:** ⭐️ 1.8k
- **Tags:** `multimodal` `masked-modeling` `pretraining` `vision-language`
- **最后活动时间:** 2025-06-02

### [flowty-realtime-lcm-canvas](https://github.com/flowtyone/flowty-realtime-lcm-canvas)

基于LCM的实时草图转图像演示，支持快速交互式图像生成。

- **Stars:** ⭐️ 1.8k
- **Tags:** `lcm` `image-generation` `realtime` `gradio`
- **最后活动时间:** 2023-12-02

### [Caption-Anything](https://github.com/ttengwang/Caption-Anything)

结合图像分割、视觉描述和ChatGPT的多功能图像描述生成工具。

- **Stars:** ⭐️ 1.8k
- **Tags:** `ChatGPT` `Image Captioning` `Segment Anything`
- **最后活动时间:** 2023-08-29
...
ECCV 2018论文，从单张RGB图像生成3D网格模型的深度学习方法。

- **Stars:** ⭐️ 1.8k
- **Tags:** `3d-mesh` `image-to-3d` `deep-learning`
- **最后活动时间:** 2021-12-15

### [SOLO](https://github.com/WXinlong/SOLO)

ECCV2020和NeurIPS2020论文实现，SOLO和SOLOv2实例分割算法。无需检测框，直接将实例分割转化为分类问题。

- **Stars:** ⭐️ 1.7k
- **Tags:** `instance-segmentation` `object-detection` `solo` `solov2`
- **最后活动时间:** 2023-12-26

### [pytorch-semantic-segmentation](https://github.com/zijundeng/pytorch-semantic-segmentation)

PyTorch语义分割框架，支持多种分割网络架构。

- **Stars:** ⭐️ 1.7k
- **Tags:** `semantic-segmentation` `computer-vision` `pytorch`
- **最后活动时间:** 2019-10-25

### [keras-yolo2](https://github.com/experiencor/keras-yolo2)

易于训练的YOLO2目标检测实现，支持MobileNet和SqueezeNet后端。

- **Stars:** ⭐️ 1.7k
- **Tags:** `yolo` `object-detection` `keras` `realtime`
- **最后活动时间:** 2023-03-24
...
ICCV 2019论文实现，基于Liquid Warping GAN实现人体动作模仿、外观迁移和新视角合成。

- **Stars:** ⭐️ 1.7k
- **Tags:** `gan` `pose-transfer` `pytorch` `human-motion`
- **最后活动时间:** 2022-06-21

### [MeshCNN](https://github.com/ranahanocka/MeshCNN)

PyTorch实现的3D网格卷积神经网络，专为3D网格分析和分割任务设计。

- **Stars:** ⭐️ 1.7k
- **Tags:** `geometric-deep-learning` `mesh` `pytorch` `3d-segmentation`
- **最后活动时间:** 2024-02-07
...
NVIDIA开源的图像和视频神经分词器套件，支持扩散模型和Transformer架构。

- **Stars:** ⭐️ 1.7k
- **Tags:** `neural-tokenizer` `diffusion` `video-compression` `image-tokenization`
- **最后活动时间:** 2025-02-11

### [One-2-3-45](https://github.com/One-2-3-45/One-2-3-45)

NeurIPS 2023 论文官方实现，可在45秒内从单张图片生成3D网格模型，无需逐形状优化。

- **Stars:** ⭐️ 1.7k
- **Tags:** `3d-generation` `nerf` `mesh-generation` `aigc`
- **最后活动时间:** 2024-04-20

### [DPED](https://github.com/aiff22/DPED)

基于深度卷积网络的自动照片质量增强工具，包含软件和预训练模型。

- **Stars:** ⭐️ 1.7k
- **Tags:** `image-enhancement` `deep-learning` `cnn` `gan`
- **最后活动时间:** 2025-08-23

### [HyperLandmark](https://github.com/szad670401/HyperLandmark)

基于深度学习的移动端实时人脸关键点检测器，支持106点检测和追踪。

- **Stars:** ⭐️ 1.7k
- **Tags:** `face-landmark` `deep-learning` `mobile` `real-time` `cnn`
- **最后活动时间:** 2024-10-15

### [OneFormer](https://github.com/SHI-Labs/OneFormer)

CVPR 2023论文实现，统一Transformer架构处理语义、实例和全景分割任务。

- **Stars:** ⭐️ 1.7k
- **Tags:** `Transformer` `Segmentation` `CVPR 2023`
- **最后活动时间:** 2024-10-03

### [stable-diffusion-tutorial](https://github.com/ai-vip/stable-diffusion-tutorial)

全网最全的Stable Diffusion教程，从入门到进阶全覆盖，适合想要学习AI图像生成的开发者。

- **Stars:** ⭐️ 1.7k
- **Tags:** `stable-diffusion` `aigc` `image-generation` `tutorial`
- **最后活动时间:** 2023-05-26

### [ComfyUI-Prompt-Assistant](https://github.com/yawiii/ComfyUI-Prompt-Assistant)
...
TIP 2017论文实现，使用残差学习的深度CNN图像去噪方法，支持高斯去噪和超分辨率任务。

- **Stars:** ⭐️ 1.7k
- **Tags:** `image-denoising` `deep-learning` `cnn` `pytorch`
- **最后活动时间:** 2021-10-09

### [TransGAN](https://github.com/VITA-Group/TransGAN)

NeurIPS 2021论文，证明两个纯Transformer可以构建强大的GAN生成模型。

- **Stars:** ⭐️ 1.7k
- **Tags:** `transformer` `gan` `image-generation` `pytorch`
- **最后活动时间:** 2022-11-03

### [DualStyleGAN](https://github.com/williamyang1991/DualStyleGAN)

CVPR 2022论文，基于示例的高分辨率人像风格迁移方法。

- **Stars:** ⭐️ 1.7k
- **Tags:** `style-transfer` `stylegan2` `portrait` `face-stylization`
- **最后活动时间:** 2023-03-06

### [AI-Lossless-Zoomer](https://github.com/X-Lucifer/AI-Lossless-Zoomer)
...
视频和单图像超分辨率架构集合，包含SRCNN、VDSR、EDSR、SRGAN等多种经典模型实现。

- **Stars:** ⭐️ 1.7k
- **Tags:** `video-super-resolution` `tensorflow` `pytorch` `deep-learning`
- **最后活动时间:** 2020-09-11

### [lightweight-gan](https://github.com/datawhalechina/key-book)
...
可扩展、易用的Stable Diffusion Web UI工具，支持图像生成与编辑。

- **Stars:** ⭐️ 1.7k
- **Tags:** `ai` `stable-diffusion` `image-generation` `diffusion`
- **最后活动时间:** 2023-08-18

### [handtracking](https://github.com/victordibia/handtracking)

基于SSD神经网络实现的实时手势检测器，适用于人机交互应用场景。

- **Stars:** ⭐️ 1.7k
- **Tags:** `hand-detection` `ssd` `computer-vision` `tensorflow`
- **最后活动时间:** 2021-09-30

### [SOTA-MedSeg](https://github.com/JunMa11/SOTA-MedSeg)

汇总多个医学图像分割挑战赛的SOTA方法，提供最新分割算法参考实现。
...
CVPR 2022 论文项目，基于隐式函数从单张图像重建穿衣人体3D模型，支持SMPL身体模型和高质量网格生成。

- **Stars:** ⭐️ 1.7k
- **Tags:** `3d-reconstruction` `computer-vision` `human-pose-estimation` `implicit-functions` `pytorch` `smpl`
- **最后活动时间:** 2023-11-23

### [MobileNet](https://github.com/Zehaos/MobileNet)

TensorFlow实现的轻量级MobileNet模型，专为移动端和嵌入式设备优化的高效CNN架构。

- **Stars:** ⭐️ 1.7k
- **Tags:** `mobilenets` `detection` `tensorflow` `slim`
- **最后活动时间:** 2017-11-06

### [Leffa](https://github.com/franciszzj/Leffa)

CVPR 2025 论文实现，通过注意力机制学习流场，实现可控的人物图像生成，支持姿态和外观的精确控制。

- **Stars:** ⭐️ 1.7k
- **Tags:** `CVPR2025` `Person-Generation` `Flow-Fields`
- **最后活动时间:** 2025-09-12

### [occupancy_networks](https://github.com/autonomousvision/occupancy_networks)

开创性论文，通过学习函数空间中的占用表示实现3D重建，支持复杂拓扑结构。

- **Stars:** ⭐️ 1.7k
- **Tags:** `3d-reconstruction` `occupancy-network` `deep-learning`
- **最后活动时间:** 2023-06-27

### [stable-fast-3d](https://github.com/Stability-AI/stable-fast-3d)

快速稳定的3D网格重建方法，支持UV展开与光照解耦，生成高质量3D资产。

- **Stars:** ⭐️ 1.7k
- **Tags:** `3d-reconstruction` `text-to-3d` `mesh-generation`
- **最后活动时间:** 2025-01-22

### [ru-dalle](https://github.com/ai-forever/ru-dalle)

俄语文本生成图像模型，基于 DALL-E 架构实现的文本到图像生成工具。

- **Stars:** ⭐️ 1.6k
- **Tags:** `dalle` `image-generation` `text-to-image` `pytorch`
- **最后活动时间:** 2023-01-10

### [stable-diffusion-webui-localization-zh_CN](https://github.com/dtlnor/stable-diffusion-webui-localization-zh_CN)

Stable Diffusion WebUI简体中文翻译扩展，帮助中文用户更便捷地使用AI图像生成工具。

- **Stars:** ⭐️ 1.6k
- **Tags:** `Stable Diffusion` `中文` `图像生成`
- **最后活动时间:** 2025-04-28

### [pytorch_GAN_zoo](https://github.com/facebookresearch/pytorch_GAN_zoo)

PyTorch GAN实现集合，包含渐进式生成等多种GAN架构。

- **Stars:** ⭐️ 1.6k
- **Tags:** `gan` `pytorch` `progressive-growing` `image-generation`
- **最后活动时间:** 2021-10-12
...
多模态LaTeX OCR工具，支持中英文、表格识别，可在Windows本地CPU高效推理。

- **Stars:** ⭐️ 1.6k
- **Tags:** `ocr` `latex` `onnx` `multimodal` `computer-vision`
- **最后活动时间:** 2025-04-24

### [stable-diffusion-tensorflow](https://github.com/divamgupta/stable-diffusion-tensorflow)

Stable Diffusion的TensorFlow/Keras实现，支持文本到图像生成。

- **Stars:** ⭐️ 1.6k
- **Tags:** `stable-diffusion` `text-to-image` `tensorflow` `keras`
- **最后活动时间:** 2023-08-08

### [Anything-3D](https://github.com/Anything-of-anything/Anything-3D)

结合Segment-Anything模型实现3D重建，将任意物体提升到三维空间。

- **Stars:** ⭐️ 1.6k
- **Tags:** `segment-anything` `3d-reconstruction` `computer-vision`
- **最后活动时间:** 2023-06-12

### [stylized-neural-painting](https://github.com/jiupinjia/stylized-neural-painting)

CVPR 2021论文官方实现，基于神经网络的风格化绘画生成方法。

- **Stars:** ⭐️ 1.6k
- **Tags:** `neural-painting` `style-transfer` `neural-rendering` `cvpr2021`
- **最后活动时间:** 2021-08-26

### [Macaw-LLM](https://github.com/lyuchenyang/Macaw-LLM)

多模态大语言模型，支持图像、视频、音频和文本的统一理解与生成。

- **Stars:** ⭐️ 1.6k
- **Tags:** `multimodal` `llm` `deep-learning` `vision-language`
- **最后活动时间:** 2025-01-01
...
高质量、快速的SSD目标检测PyTorch实现，采用模块化设计，适合计算机视觉研究和应用开发。

- **Stars:** ⭐️ 1.6k
- **Tags:** `object-detection` `pytorch` `computer-vision` `deep-learning`
- **最后活动时间:** 2024-01-26

### [REPA](https://github.com/sihyun-yu/REPA)

ICLR2025 Oral，通过表示对齐简化Diffusion Transformer训练的方法。

- **Stars:** ⭐️ 1.6k
- **Tags:** `diffusion-transformer` `representation-alignment` `image-generation`
- **最后活动时间:** 2025-03-16

### [bundler_sfm](https://github.com/snavely/bundler_sfm)

经典的结构运动恢复工具包，用于从图像序列重建3D场景结构。
...
解释GAN潜在空间实现语义化人脸编辑。CVPR 2020论文实现。

- **Stars:** ⭐️ 1.6k
- **Tags:** `gan` `face-editing` `latent-space`
- **最后活动时间:** 2022-02-09

### [TripoSG](https://github.com/VAST-AI-Research/TripoSG)

基于大规模修正流模型的高保真3D形状合成。

- **Stars:** ⭐️ 1.6k
- **Tags:** `3d-generation` `3d-reconstruction` `image-to-3d` `shape-synthesis`
- **最后活动时间:** 2025-04-18

### [ghost](https://github.com/ai-forever/ghost)

新型单样本人脸替换方法，支持图像和视频领域的深度换脸应用。

- **Stars:** ⭐️ 1.6k
- **Tags:** `face-swap` `deepfake` `computer-vision` `pytorch`
- **最后活动时间:** 2025-02-25
...
学习连续符号距离函数用于3D形状表示，实现高质量三维几何建模与生成。

- **Stars:** ⭐️ 1.5k
- **Tags:** `deep-learning` `3d-reconstruction` `sdf` `shape-representation`
- **最后活动时间:** 2022-06-20

### [noise2noise](https://github.com/NVlabs/noise2noise)

ICML 2018官方实现，无需干净数据即可学习图像修复的深度学习模型。

- **Stars:** ⭐️ 1.5k
- **Tags:** `image-restoration` `denoising` `deep-learning` `research`
- **最后活动时间:** 2021-11-12

### [wgan-gp](https://github.com/caogang/wgan-gp)

论文《Improved Training of Wasserstein GANs》的PyTorch实现。

- **Stars:** ⭐️ 1.5k
- **Tags:** `wgan-gp` `gan` `pytorch` `wasserstein`
- **最后活动时间:** 2023-07-18

### [fast3r](https://github.com/facebookresearch/fast3r)

CVPR 2025 论文，单次前向传播即可完成1000+张图像的3D重建，效率极高。

- **Stars:** ⭐️ 1.5k
- **Tags:** `3d-reconstruction` `multi-view` `efficient` `cvpr2025`
- **最后活动时间:** 2025-05-07

### [RandLA-Net](https://github.com/QingyongHu/RandLA-Net)

CVPR 2020口头报告论文，高效的大规模点云语义分割神经网络。

- **Stars:** ⭐️ 1.5k
- **Tags:** `point-cloud` `semantic-segmentation` `3d-vision` `deep-learning`
- **最后活动时间:** 2023-07-11
...
- **Stars:** ⭐️ 1.5k
- **Tags:** `bicyclegan` `image-translation` `gan` `pytorch`
- **最后活动时间:** 2020-08-05

### [deep_ocr](https://github.com/JinpengLI/deep_ocr)

基于深度学习的中文OCR识别引擎，专注于中文字符识别，性能优于Tesseract。

- **Stars:** ⭐️ 1.5k
- **Tags:** `ocr` `chinese` `deep-learning` `character-recognition`
- **最后活动时间:** 2017-11-12

### [super-resolution](https://github.com/krasserm/super-resolution)

基于TensorFlow 2.x的单图像超分辨率实现，包含EDSR、WDSR和SRGAN模型。支持高分辨率图像重建和增强。

- **Stars:** ⭐️ 1.5k
- **Tags:** `super-resolution` `srgan` `edsr` `tensorflow2`
- **最后活动时间:** 2022-05-13

### [MTCNN-Tensorflow](https://github.com/AITTSMD/MTCNN-Tensorflow)

TensorFlow复现的MTCNN人脸检测算法，支持人脸检测和对齐。

- **Stars:** ⭐️ 1.5k
- **Tags:** `mtcnn` `face-detection` `tensorflow` `computer-vision`
- **最后活动时间:** 2019-12-16
...
ECCV 2018论文PyTorch实现，深度残差通道注意力图像超分辨率网络。经典超分辨率方法。

- **Stars:** ⭐️ 1.5k
- **Tags:** `super-resolution` `channel-attention` `image-enhancement`
- **最后活动时间:** 2025-04-01

### [ImageCaptioning.pytorch](https://github.com/ruotianluo/ImageCaptioning.pytorch)

图像描述生成PyTorch实现，包含自临界训练方法。

- **Stars:** ⭐️ 1.5k
- **Tags:** `image-captioning` `attention` `vision-language`
- **最后活动时间:** 2023-10-05
...
基于pix2pix的人脸生成演示，从面部关键点学习并生成真实人脸图像。

- **Stars:** ⭐️ 1.5k
- **Tags:** `pix2pix` `face-generation` `tensorflow`
- **最后活动时间:** 2023-10-10

### [nerfacc](https://github.com/nerfstudio-project/nerfacc)

通用NeRF加速工具箱，高效神经辐射场渲染。

- **Stars:** ⭐️ 1.5k
- **Tags:** `nerf` `3d-rendering` `pytorch`
- **最后活动时间:** 2024-10-02

### [3d-pose-baseline](https://github.com/una-dinosauria/3d-pose-baseline)

ICCV 2017发表的3D人体姿态估计基准模型，TensorFlow实现的简单高效方案。

- **Stars:** ⭐️ 1.5k
- **Tags:** `3d-pose` `human-pose` `computer-vision` `tensorflow`
- **最后活动时间:** 2020-09-26

### [DLTK](https://github.com/DLTK/DLTK)

医学图像分析深度学习工具包，提供预训练模型与完整处理流程。

- **Stars:** ⭐️ 1.5k
- **Tags:** `medical-imaging` `deep-learning` `dltk` `tensorflow`
- **最后活动时间:** 2023-03-24
...
单样本人脸风格化的官方PyTorch实现，支持动漫等多种风格。

- **Stars:** ⭐️ 1.4k
- **Tags:** `face-stylization` `gan` `one-shot` `pytorch`
- **最后活动时间:** 2022-09-29

### [Diffusion-Models-pytorch](https://github.com/dome272/Diffusion-Models-pytorch)

扩散模型的 PyTorch 实现，涵盖 DDPM 等核心生成模型算法。

- **Stars:** ⭐️ 1.4k
- **Tags:** `diffusion-models` `ddpm` `image-generation` `pytorch` `generative-model`
- **最后活动时间:** 2023-09-07

### [redner](https://github.com/BachiLi/redner)

可微分渲染器，支持梯度优化的光线追踪渲染。

- **Stars:** ⭐️ 1.4k
- **Tags:** `differentiable-rendering` `computer-graphics` `ray-tracing`
- **最后活动时间:** 2022-08-19

### [Barbershop](https://github.com/ZPdesu/Barbershop)

SIGGRAPH Asia 2021论文，基于GAN和分割掩码的图像合成工具。

- **Stars:** ⭐️ 1.4k
- **Tags:** `GAN` `Image Compositing` `Segmentation`
- **最后活动时间:** 2023-06-25

### [simplerecon](https://github.com/nianticlabs/simplerecon)

ECCV 2022论文，无需3D卷积的高效3D重建方法，简化多视图立体匹配流程。

- **Stars:** ⭐️ 1.4k
- **Tags:** `3d-reconstruction` `mvs` `depth-estimation`
- **最后活动时间:** 2025-05-09

### [CLIP_prefix_caption](https://github.com/rmokady/CLIP_prefix_caption)

基于CLIP的简单图像描述生成模型，利用预训练视觉编码器生成高质量图像标题。

- **Stars:** ⭐️ 1.4k
- **Tags:** `image-captioning` `clip` `vision-language` `deep-learning`
- **最后活动时间:** 2024-06-09

### [yolov4-deepsort](https://github.com/theAIGuysCode/yolov4-deepsort)

结合YOLOv4和DeepSort实现的目标检测与跟踪系统，支持实时多目标追踪应用。

- **Stars:** ⭐️ 1.4k
- **Tags:** `object-tracking` `yolov4` `deepsort` `computer-vision`
- **最后活动时间:** 2024-05-22

### [3D-R2N2](https://github.com/chrischoy/3D-R2N2)

使用循环神经网络从单/多视图图像重建3D体素模型的开创性工作。

- **Stars:** ⭐️ 1.4k
- **Tags:** `3d-reconstruction` `voxel` `rnn`
- **最后活动时间:** 2021-07-16

### [GaussianEditor](https://github.com/buaacyw/GaussianEditor)

CVPR 2024 论文，基于高斯溅射的快速可控3D编辑工具，支持精确的3D场景修改。

- **Stars:** ⭐️ 1.4k
- **Tags:** `gaussian-splatting` `3d-editing` `generative-ai` `cvpr2024`
- **最后活动时间:** 2024-02-27

### [hierarchical-3d-gaussians](https://github.com/graphdeco-inria/hierarchical-3d-gaussians)

SIGGRAPH 2024论文官方实现，用于大规模数据集实时渲染的分层3D高斯表示方法。

- **Stars:** ⭐️ 1.4k
- **Tags:** `3d-gaussian-splatting` `rendering` `computer-graphics`
- **最后活动时间:** 2025-06-10

### [NiftyNet](https://github.com/NifTK/NiftyNet)

医学图像分析和图像引导治疗的开源卷积神经网络平台（已停止维护）。

- **Stars:** ⭐️ 1.4k
- **Tags:** `medical-imaging` `deep-learning` `cnn` `segmentation`
- **最后活动时间:** 2020-04-21

### [semseg](https://github.com/hszhao/semseg)

PyTorch语义分割工具库，提供多种分割网络的高效实现。

- **Stars:** ⭐️ 1.4k
- **Tags:** `semantic-segmentation` `pytorch` `deep-learning` `computer-vision`
- **最后活动时间:** 2022-08-28

### [keras-deeplab-v3-plus](https://github.com/bonlime/keras-deeplab-v3-plus)

DeepLab v3+语义分割网络的Keras实现，附带预训练权重。支持高精度图像语义分割任务。

- **Stars:** ⭐️ 1.4k
- **Tags:** `deeplabv3` `semantic-segmentation` `keras` `pretrained-model`
- **最后活动时间:** 2024-11-13

### [liif](https://github.com/yinboc/liif)

CVPR 2021 Oral论文，使用局部隐式图像函数学习连续图像表示，实现任意尺度超分辨率。

- **Stars:** ⭐️ 1.4k
- **Tags:** `implicit-neural-representation` `super-resolution` `continuous-image` `cvpr`
- **最后活动时间:** 2021-08-21

### [cog-face-to-many](https://github.com/fofr/cog-face-to-many)

将人脸转换为游戏角色、像素艺术、粘土动画、3D或玩具风格的生成式AI工具。

- **Stars:** ⭐️ 1.4k
- **Tags:** `generative-ai` `text-to-image` `comfyui` `face-transform`
- **最后活动时间:** 2024-04-09

### [CUT3R](https://github.com/CUT3R/CUT3R)

连续3D感知模型的官方实现，通过持久化状态实现连续的3D场景理解和重建。

- **Stars:** ⭐️ 1.4k
- **Tags:** `3d-perception` `computer-vision` `deep-learning` `3d-reconstruction`
- **最后活动时间:** 2025-08-27

### [AttnGAN](https://github.com/taoxugit/AttnGAN)

基于注意力机制的文本到图像生成模型，实现细粒度文本描述生成图像。

- **Stars:** ⭐️ 1.4k
- **Tags:** `attngan` `text-to-image` `gan` `attention`
- **最后活动时间:** 2024-07-25
...
ICCV 2021论文实现，设计实用的退化模型用于深度盲图像超分辨率。

- **Stars:** ⭐️ 1.4k
- **Tags:** `blind-super-resolution` `gan` `iccv` `pytorch`
- **最后活动时间:** 2024-04-12
...
ICCV 2025 论文，提出通用定制化方法，支持单主体和多主体条件控制的高质量图像生成。

- **Stars:** ⭐️ 1.4k
- **Tags:** `ICCV2025` `Subject-Driven` `Flux`
- **最后活动时间:** 2025-09-12

### [SDT](https://github.com/dailenson/SDT)

CVPR 2023论文官方实现，解耦书写者和字符风格的手写生成模型。

- **Stars:** ⭐️ 1.4k
- **Tags:** `handwriting-generation` `style-disentanglement` `generative-model`
- **最后活动时间:** 2025-06-26

### [head-pose-estimation](https://github.com/yinguobing/head-pose-estimation)

基于ONNXRuntime和OpenCV的实时人头姿态估计系统，支持面部关键点检测。

- **Stars:** ⭐️ 1.3k
- **Tags:** `head-pose` `onnxruntime` `opencv` `deep-learning`
- **最后活动时间:** 2024-09-02

### [gansformer](https://github.com/dorarad/gansformer)

结合Transformer与GAN的生成模型，用于图像和场景生成。

- **Stars:** ⭐️ 1.3k
- **Tags:** `transformer` `gan` `image-generation` `attention`
- **最后活动时间:** 2022-06-14
...
PyTorch实现的人脸检测与识别系统，基于MTCNN等经典方法。

- **Stars:** ⭐️ 1.3k
- **Tags:** `face-detection` `face-recognition` `mtcnn` `pytorch`
- **最后活动时间:** 2024-02-21
...
AAAI 2025虚拟试衣生成模型，支持服装、姿态和场景的灵活控制，实现高保真虚拟穿搭效果。

- **Stars:** ⭐️ 1.3k
- **Tags:** `virtual-try-on` `diffusion-models` `image-generation` `text-to-image`
- **最后活动时间:** 2025-09-30
...
ICCV'23论文项目，将Segment Anything模型扩展到3D场景分割，支持在三维环境中进行通用物体分割。

- **Stars:** ⭐️ 1.3k
- **Tags:** `3d-segmentation` `segment-anything` `computer-vision`
- **最后活动时间:** 2024-04-21

### [PyTorch-CycleGAN](https://github.com/aitorzip/PyTorch-CycleGAN)

CycleGAN的清晰易读PyTorch实现，用于无配对图像到图像翻译。

- **Stars:** ⭐️ 1.3k
- **Tags:** `cyclegan` `image-translation` `pytorch` `gan`
- **最后活动时间:** 2022-04-20

### [dcgan-completion.tensorflow](https://github.com/bamos/dcgan-completion.tensorflow)

基于DCGAN的图像补全深度学习模型，使用生成对抗网络实现图像缺失区域的智能填充。

- **Stars:** ⭐️ 1.3k
- **Tags:** `image-inpainting` `dcgan` `image-completion` `generative-model`
- **最后活动时间:** 2017-07-18
...
多任务专家视觉语言模型Prismer的官方实现，支持图像描述生成和视觉问答等任务。

- **Stars:** ⭐️ 1.3k
- **Tags:** `Vision-Language` `Multi-task` `VQA`
- **最后活动时间:** 2024-01-17

### [MimicBrush](https://github.com/ali-vilab/MimicBrush)

零样本图像编辑工具，通过参考图像模仿实现纹理迁移和图像合成，支持AIGC创作流程。

- **Stars:** ⭐️ 1.3k
- **Tags:** `image-editing` `zero-shot` `texture-transfer` `aigc`
- **最后活动时间:** 2024-06-15
...
Stable Diffusion重绘扩展，结合Segment Anything实现智能图像修复。

- **Stars:** ⭐️ 1.3k
- **Tags:** `stable-diffusion` `inpainting` `segment-anything` `gradio`
- **最后活动时间:** 2024-12-28

### [alias-free-gan](https://github.com/NVlabs/alias-free-gan)

无别名GAN项目，提供高质量图像生成代码和项目网站，解决GAN生成中的别名问题。

- **Stars:** ⭐️ 1.3k
- **Tags:** `gan` `image-generation` `pytorch`
- **最后活动时间:** 2021-10-11

### [ngp_pl](https://github.com/kwea123/ngp_pl)

基于PyTorch和CUDA实现的Instant-NGP，结合PyTorch Lightning训练，代码简洁高效，支持NeRF 3D重建和新视角合成。

- **Stars:** ⭐️ 1.3k
- **Tags:** `NeRF` `3D重建` `PyTorch` `CUDA`
- **最后活动时间:** 2023-06-16

### [animeGAN](https://github.com/jayleicn/animeGAN)

基于PyTorch实现的生成对抗网络，专注于动漫人脸绘制，适合学习GAN原理。

- **Stars:** ⭐️ 1.3k
- **Tags:** `gan` `anime` `pytorch` `generative-adversarial-network`
- **最后活动时间:** 2022-08-24
...
DeepMind Flamingo视觉问答模型PyTorch实现，支持少样本多模态推理。

- **Stars:** ⭐️ 1.3k
- **Tags:** `flamingo` `visual-question-answering` `few-shot`
- **最后活动时间:** 2022-10-18

### [cnn-watermark-removal](https://github.com/marcbelmont/cnn-watermark-removal)

基于全卷积神经网络的图像水印去除模型，使用膨胀卷积实现透明水印的自动消除。

- **Stars:** ⭐️ 1.3k
- **Tags:** `image-inpainting` `watermark-removal` `cnn` `image-restoration`
- **最后活动时间:** 2021-03-29

### [HyperPose](https://github.com/tensorlayer/HyperPose)

快速灵活的人体姿态估计库，支持分布式训练和TensorRT加速，适用于实时应用场景。

- **Stars:** ⭐️ 1.3k
- **Tags:** `pose-estimation` `computer-vision` `tensorflow` `tensorrt`
- **最后活动时间:** 2023-03-25

### [tensorflow-deeplab-resnet](https://github.com/DrSleep/tensorflow-deeplab-resnet)

TensorFlow实现的DeepLab-ResNet语义分割模型，适用于高精度场景理解。

- **Stars:** ⭐️ 1.3k
- **Tags:** `deeplab` `semantic-segmentation` `resnet` `tensorflow`
- **最后活动时间:** 2021-10-11

### [StableVITON](https://github.com/rlawjdghek/StableVITON)

CVPR2024论文，基于潜在扩散模型的虚拟试穿技术，学习语义对应关系实现高质量服装试穿效果。

- **Stars:** ⭐️ 1.3k
- **Tags:** `virtual-try-on` `diffusion-model` `cvpr2024`
- **最后活动时间:** 2025-10-12
...
基于示例的扩散模型图像编辑工具，支持通过参考图像进行语义引导的图像生成与编辑。

- **Stars:** ⭐️ 1.3k
- **Tags:** `diffusion-models` `image-editing` `stable-diffusion` `pytorch`
- **最后活动时间:** 2023-11-28

### [MV-Adapter](https://github.com/huanngzh/MV-Adapter)

ICCV 2025 官方实现，轻松实现多视角一致的图像生成，支持纹理生成和多视图同步创作。

- **Stars:** ⭐️ 1.3k
- **Tags:** `ICCV2025` `Multi-view` `Texture-Generation`
- **最后活动时间:** 2025-06-26

### [FCN.tensorflow](https://github.com/shekkizh/FCN.tensorflow)

TensorFlow实现的Fully Convolutional Networks语义分割网络，用于图像像素级分类任务。

- **Stars:** ⭐️ 1.3k
- **Tags:** `fcn` `segmentation` `tensorflow`
- **最后活动时间:** 2022-03-17

### [PhotographicImageSynthesis](https://github.com/CQFIO/PhotographicImageSynthesis)

基于级联细化网络的逼真图像合成模型，可从语义布局生成高质量照片级图像。

- **Stars:** ⭐️ 1.3k
- **Tags:** `image-synthesis` `semantic-layout` `generative-model` `deep-learning`
- **最后活动时间:** 2022-02-07

### [SRGAN](https://github.com/leftthomas/SRGAN)

CVPR 2017论文官方实现，首次将GAN应用于单图像超分辨率，生成逼真高分辨率图像。

- **Stars:** ⭐️ 1.2k
- **Tags:** `srgan` `super-resolution` `gan` `tensorflow`
- **最后活动时间:** 2024-07-21
...
SIGGRAPH 2020论文，从点云重建水密网格的深度学习方法。

- **Stars:** ⭐️ 1.2k
- **Tags:** `3d-reconstruction` `point-cloud` `mesh-generation` `deep-learning`
- **最后活动时间:** 2023-11-03

### [Emotion-recognition](https://github.com/otaha178/Emotion-recognition)

基于卷积神经网络的实时面部表情识别系统，可检测多种情绪状态。

- **Stars:** ⭐️ 1.2k
- **Tags:** `emotion-recognition` `computer-vision` `cnn` `deep-learning`
- **最后活动时间:** 2024-08-30

### [AdvancedEAST](https://github.com/huoyijie/AdvancedEAST)

基于EAST改进的场景文本检测算法，优化长文本预测精度。适用于自然场景中的文字检测任务。

- **Stars:** ⭐️ 1.2k
- **Tags:** `text-detection` `scene-text` `east` `deep-learning`
- **最后活动时间:** 2022-09-09

### [pixelsplat](https://github.com/dcharatan/pixelsplat)

CVPR 2024 Oral & Best Paper Runner-Up，从图像对生成3D高斯泼溅，实现可扩展的泛化3D重建。

- **Stars:** ⭐️ 1.2k
- **Tags:** `gaussian-splatting` `3d-reconstruction` `generalizable` `cvpr2024`
- **最后活动时间:** 2025-01-13

### [OpenLRM](https://github.com/3DTopia/OpenLRM)

大型重建模型的开源实现，支持从图像到3D的高质量重建。

- **Stars:** ⭐️ 1.2k
- **Tags:** `3d` `reconstruction` `computer-vision` `large-model`
- **最后活动时间:** 2024-05-06

### [Direct3D-S2](https://github.com/DreamTechAI/Direct3D-S2)

NeurIPS 2025论文，基于空间稀疏注意力机制的十亿级3D生成模型。

- **Stars:** ⭐️ 1.2k
- **Tags:** `3d-generation` `image-to-3d` `neurips` `large-scale`
- **最后活动时间:** 2025-09-26

### [FastMOT](https://github.com/GeekAlexis/FastMOT)

基于YOLO、DeepSORT和KLT的高性能多目标跟踪系统，支持TensorRT加速和边缘设备实时部署。

- **Stars:** ⭐️ 1.2k
- **Tags:** `multi-object-tracking` `real-time` `tensorrt` `edge-computing`
- **最后活动时间:** 2024-07-25

### [arbitrary-image-stylization-tfjs](https://github.com/reiinakano/arbitrary-image-stylization-tfjs)

基于TensorFlow.js的任意风格迁移工具，可在浏览器中实时运行。

- **Stars:** ⭐️ 1.2k
- **Tags:** `style-transfer` `tensorflow-js` `browser` `image-generation`
- **最后活动时间:** 2022-12-03

### [Scaffold-GS](https://github.com/city-super/Scaffold-GS)

CVPR 2024 Highlight论文，提出结构化3D高斯泼溅方法，实现自适应视角的高质量渲染。

- **Stars:** ⭐️ 1.2k
- **Tags:** `3d` `gaussian-splatting` `neural-rendering` `reconstruction`
- **最后活动时间:** 2024-09-26

### [ComfyUI_Comfyroll_CustomNodes](https://github.com/Suzie1/ComfyUI_Comfyroll_CustomNodes)

ComfyUI 的强大自定义节点集合，支持 SDXL 和 SD1.5，包含 Multi-ControlNet、LoRA、宽高比调整等丰富功能。

- **Stars:** ⭐️ 1.2k
- **Tags:** `ComfyUI` `Stable Diffusion` `Custom Nodes`
- **最后活动时间:** 2024-07-24

### [stylegan-t](https://github.com/autonomousvision/stylegan-t)

ICML'23论文实现，解锁GAN在快速大规模文本到图像合成中的强大能力。

- **Stars:** ⭐️ 1.2k
- **Tags:** `stylegan` `text-to-image` `gan` `icml`
- **最后活动时间:** 2023-04-07

### [CoCa-pytorch](https://github.com/lucidrains/CoCa-pytorch)

CoCa对比字幕模型PyTorch实现，图像-文本基础模型架构。

- **Stars:** ⭐️ 1.2k
- **Tags:** `contrastive-learning` `image-text` `multimodal`
- **最后活动时间:** 2023-12-12

### [realsr-ncnn-vulkan](https://github.com/nihui/realsr-ncnn-vulkan)

基于 ncnn 的 RealSR 超分辨率实现，支持 Intel/AMD/NVIDIA GPU 的 Vulkan 加速图像放大。

- **Stars:** ⭐️ 1.2k
- **Tags:** `super-resolution` `ncnn` `vulkan` `image-upscaling`
- **最后活动时间:** 2023-03-12

### [DreamClear](https://github.com/shallowdream204/DreamClear)

NeurIPS 2024论文，基于Diffusion Transformer的高容量真实世界图像修复方法，注重隐私安全的数据集构建。

- **Stars:** ⭐️ 1.2k
- **Tags:** `diffusion-transformer` `image-restoration` `super-resolution` `neurips2024`
- **最后活动时间:** 2025-03-21

### [StyleGAN-nada](https://github.com/rinongal/StyleGAN-nada)

无需目标域训练数据的StyleGAN域自适应方法，实现风格迁移。

- **Stars:** ⭐️ 1.2k
- **Tags:** `stylegan` `domain-adaptation` `gan`
- **最后活动时间:** 2022-09-29
...
TensorFlow实现的CycleGAN，支持无配对数据的图像到图像翻译。

- **Stars:** ⭐️ 1.2k
- **Tags:** `cyclegan` `tensorflow` `image-translation` `gan`
- **最后活动时间:** 2021-07-29

### [awesome-3D-generation](https://github.com/justimyhxu/awesome-3D-generation)

3D生成领域论文精选列表，涵盖NeRF、3D Gaussian Splatting、文本到3D等前沿技术。

- **Stars:** ⭐️ 1.2k
- **Tags:** `3d-generation` `nerf` `text-to-3d` `generative-ai`
- **最后活动时间:** 2023-03-09

### [StyleGAN-Human](https://github.com/stylegan-human/StyleGAN-Human)

以数据为中心的人类图像生成研究，高质量人物图像生成模型。

- **Stars:** ⭐️ 1.2k
- **Tags:** `stylegan` `human-generation` `gan`
- **最后活动时间:** 2025-01-26
...
CVPR2024 Highlight论文，大规模图像视频通用目标基础模型，支持检测、分割、跟踪等任务。

- **Stars:** ⭐️ 1.2k
- **Tags:** `foundation-model` `object-detection` `segment-anything`
- **最后活动时间:** 2024-10-21

### [DeblurGANv2](https://github.com/VITA-Group/DeblurGANv2)

ICCV 2019论文实现，快速高效的图像去模糊GAN模型，性能优异。

- **Stars:** ⭐️ 1.2k
- **Tags:** `deblurgan` `image-restoration` `gan` `iccv`
- **最后活动时间:** 2022-07-14
...
ICCV2017论文的PyTorch非官方实现，实现实时任意风格迁移。基于自适应实例归一化技术，可快速将艺术风格应用到任意图像。

- **Stars:** ⭐️ 1.2k
- **Tags:** `style-transfer` `cnn` `instance-normalization` `pytorch`
- **最后活动时间:** 2024-01-23

### [GaussianObject](https://github.com/chensjtu/GaussianObject)

SIGGRAPH Asia 2024 论文，仅需四视角即可通过高斯泼溅实现高质量3D物体重建。

- **Stars:** ⭐️ 1.2k
- **Tags:** `gaussian-splatting` `3d-object` `few-view` `siggraph2024`
- **最后活动时间:** 2024-09-29

### [SDEdit](https://github.com/ermongroup/SDEdit)

基于随机微分方程的图像合成与编辑方法，支持文本引导的图像生成与修改。

- **Stars:** ⭐️ 1.2k
- **Tags:** `image-generation` `image-editing` `diffusion-models` `pytorch`
- **最后活动时间:** 2023-02-12
...
### [GANsNRoses](https://github.com/mchong6/GANsNRoses)

官方PyTorch实现，支持多样化的图像到图像和视频翻译，如自拍转动漫。

- **Stars:** ⭐️ 1.2k
- **Tags:** `gan` `image-translation` `anime` `pytorch`
- **最后活动时间:** 2022-05-27

### [UniDepth](https://github.com/lpiccinelli-eth/UniDepth)

通用单目度量深度估计模型，可从单张图像预测精确的深度信息。

- **Stars:** ⭐️ 1.2k
- **Tags:** `depth-estimation` `computer-vision` `3d-reconstruction` `monocular`
- **最后活动时间:** 2025-05-18

### [Point-NeRF](https://github.com/Xharlie/pointnerf)

CVPR 2022 论文，基于点云的神经辐射场实现，用于高效3D场景重建与渲染。

- **Stars:** ⭐️ 1.2k
- **Tags:** `nerf` `neural-rendering` `3d-reconstruction` `point-cloud`
- **最后活动时间:** 2024-03-08

### [LLaMA-Mesh](https://github.com/nv-tlabs/LLaMA-Mesh)

将3D网格生成与大语言模型统一，实现文本到3D模型的生成能力。

- **Stars:** ⭐️ 1.1k
- **Tags:** `3d-generation` `mesh-generation` `multimodal` `llm`
- **最后活动时间:** 2025-03-28

### [Image-OutPainting](https://github.com/bendangnuksung/Image-OutPainting)

基于GAN的图像外延生成，使用Keras实现图像边界扩展。

- **Stars:** ⭐️ 1.1k
- **Tags:** `image-outpainting` `gan` `computer-vision` `keras`
- **最后活动时间:** 2022-11-22

### [TBCF](https://github.com/Escheee/TBCF)

相关滤波器的视觉跟踪基准测试，用于计算机视觉目标跟踪研究。

- **Stars:** ⭐️ 1.1k
- **Tags:** `visual-tracking` `computer-vision` `benchmark`
- **最后活动时间:** 2017-11-30
...
CVPR 2021论文官方实现，高分辨率虚拟试穿技术。

- **Stars:** ⭐️ 1.1k
- **Tags:** `Virtual Try-On` `Fashion AI` `Image Generation`
- **最后活动时间:** 2025-04-27
...
### [Anime-InPainting](https://github.com/youyuge34/Anime-InPainting)

动漫图像修复与绘制工具，支持去马赛克、填补和瑕疵修复功能。

- **Stars:** ⭐️ 1.1k
- **Tags:** `inpainting` `anime` `gan` `image-restoration`
- **最后活动时间:** 2019-03-27

### [spann3r](https://github.com/HengyiWang/spann3r)

3DV 2025 论文，基于空间记忆的3D重建方法，实现高效的场景级重建。

- **Stars:** ⭐️ 1.1k
- **Tags:** `3d-reconstruction` `spatial-memory` `scene-understanding` `3dv2025`
- **最后活动时间:** 2025-02-25

### [MST](https://github.com/caiyuanhao1998/MST)

光谱压缩成像重建工具箱，包含MST、CST、DAUHST等多项顶会论文实现。

- **Stars:** ⭐️ 1.1k
- **Tags:** `hyperspectral-images` `image-restoration` `transformer` `compressive-imaging`
- **最后活动时间:** 2025-10-10

### [FCRN-DepthPrediction](https://github.com/irolaina/FCRN-DepthPrediction)

使用全卷积残差网络进行单目图像深度预测的研究实现。

- **Stars:** ⭐️ 1.1k
- **Tags:** `depth-prediction` `computer-vision` `cnn` `tensorflow`
- **最后活动时间:** 2019-08-26
...
CVPR 2020论文，高效压缩条件GAN架构，实现交互式图像生成。

- **Stars:** ⭐️ 1.1k
- **Tags:** `gan-compression` `cyclegan` `pix2pix` `cvpr`
- **最后活动时间:** 2024-06-05
...
### [Awesome-Controllable-T2I-Diffusion-Models](https://github.com/PRIV-Creation/Awesome-Controllable-T2I-Diffusion-Models)

文本到图像扩散模型可控生成资源的精选合集，涵盖空间控制、个性化定制和多概念生成等技术方向。

- **Stars:** ⭐️ 1.1k
- **Tags:** `diffusion-models` `text-to-image` `controllable-generation` `image-generation`
- **最后活动时间:** 2024-12-31

### [style-based-gan-pytorch](https://github.com/rosinality/style-based-gan-pytorch)

PyTorch实现的StyleGAN，基于风格的生成器架构，高质量图像生成。

- **Stars:** ⭐️ 1.1k
- **Tags:** `stylegan` `pytorch` `gan` `image-generation`
- **最后活动时间:** 2021-08-26
...
单目深度估计与3D场景重建项目集合，包含Virtual Normal、DiverseDepth等方法。

- **Stars:** ⭐️ 1.1k
- **Tags:** `depth-estimation` `3d-scene` `monocular`
- **最后活动时间:** 2023-11-10

### [T3Bench](https://github.com/THU-LYJ-Lab/T3Bench)

文本到3D生成领域的基准测试工具，用于评估和比较各类Text-to-3D模型性能。

- **Stars:** ⭐️ 1.1k
- **Tags:** `text-to-3d` `benchmark` `diffusion` `nerf`
- **最后活动时间:** 2023-10-24

### [sngan_projection](https://github.com/pfnet-research/sngan_projection)

带谱归一化和投影判别器的GAN实现，提升生成稳定性和质量。

- **Stars:** ⭐️ 1.1k
- **Tags:** `gan` `spectral-normalization` `pytorch`
- **最后活动时间:** 2019-11-12

### [DiscoGAN-pytorch](https://github.com/carpedm20/DiscoGAN-pytorch)

PyTorch实现的DiscoGAN，学习发现跨域关系的生成对抗网络。

- **Stars:** ⭐️ 1.1k
- **Tags:** `discogan` `gan` `cross-domain` `pytorch`
- **最后活动时间:** 2018-03-26

### [tensorflow-fcn](https://github.com/MarvinTeichmann/tensorflow-fcn)

TensorFlow全卷积网络实现，用于语义图像分割任务。

- **Stars:** ⭐️ 1.1k
- **Tags:** `segmentation` `fcn` `tensorflow` `vgg`
- **最后活动时间:** 2017-12-15
...
即梦3.0逆向API，专注于图像生成领域，支持零配置部署和多路token，适合测试和开发使用。

- **Stars:** ⭐️ 1.1k
- **Tags:** `image-generation` `jimeng` `bytedance` `ai-art`
- **最后活动时间:** 2025-04-09

### [AnomalyGPT](https://github.com/CASIA-LMC-Lab/AnomalyGPT)

基于大视觉语言模型的工业异常检测方法，AAAI 2024 Oral论文。

- **Stars:** ⭐️ 1.1k
- **Tags:** `vision-language-model` `anomaly-detection` `multimodal`
- **最后活动时间:** 2023-12-20

### [noise2noise](https://github.com/yu4u/noise2noise)

无需干净数据的图像恢复方法实现，使用噪声图像训练去噪模型。

- **Stars:** ⭐️ 1.1k
- **Tags:** `denoising` `image-restoration` `keras` `deep-learning`
- **最后活动时间:** 2021-08-12

### [NVAE](https://github.com/NVlabs/NVAE)

NeurIPS 2020 Spotlight论文官方实现，深度层次化变分自编码器，高质量图像生成。

- **Stars:** ⭐️ 1.1k
- **Tags:** `vae` `generative-models` `pytorch` `neurips2020`
- **最后活动时间:** 2022-12-06

### [splatter-image](https://github.com/szymanowiczs/splatter-image)

CVPR 2024 论文，超快速单视角3D重建方法，实现实时高质量重建。

- **Stars:** ⭐️ 1.1k
- **Tags:** `single-view` `3d-reconstruction` `gaussian-splatting` `cvpr2024`
- **最后活动时间:** 2024-08-17

### [maxim](https://github.com/google-research/maxim)

CVPR 2022 Oral论文，多轴MLP图像处理模型，在去噪、去模糊、去雨等任务达SOTA。

- **Stars:** ⭐️ 1.1k
- **Tags:** `image-restoration` `mlp` `denoising` `deblurring`
- **最后活动时间:** 2023-06-09
...
IEEE TIP论文实现，无需配对监督的深度低光照图像增强GAN模型。

- **Stars:** ⭐️ 1.1k
- **Tags:** `low-light-enhancement` `gan` `image-enhancement` `pytorch`
- **最后活动时间:** 2024-04-25
...
基于VGG11编码器的UNet图像分割模型，在Kaggle Carvana数据集上预训练。适用于图像分割任务。

- **Stars:** ⭐️ 1.1k
- **Tags:** `image-segmentation` `unet` `pytorch`
- **最后活动时间:** 2022-10-26

### [Coloring-greyscale-images](https://github.com/emilwallner/Coloring-greyscale-images)

使用深度学习技术为黑白图像自动上色的教程项目，基于TensorFlow和Keras实现。

- **Stars:** ⭐️ 1.1k
- **Tags:** `deep-learning` `image-colorization` `tensorflow` `keras` `computer-vision`
- **最后活动时间:** 2024-01-22

### [SReC](https://github.com/caoscott/SReC)

基于PyTorch实现的无损图像压缩方案，利用超分辨率神经网络技术实现高质量图像压缩。

- **Stars:** ⭐️ 1.1k
- **Tags:** `Image Compression` `Neural Network` `PyTorch`
- **最后活动时间:** 2023-10-03

### [pytorch-pretrained-BigGAN](https://github.com/huggingface/pytorch-pretrained-BigGAN)

PyTorch实现的BigGAN，提供预训练权重和转换脚本，开箱即用。

- **Stars:** ⭐️ 1.0k
- **Tags:** `biggan` `pytorch` `pretrained` `image-generation`
- **最后活动时间:** 2021-02-12
...
基于深度学习的图像超分辨率工具，可将图像放大4倍并生成逼真细节。

- **Stars:** ⭐️ 1.0k
- **Tags:** `image-enhancement` `super-resolution` `computer-vision`
- **最后活动时间:** 2025-09-17

### [pytorch-stable-diffusion](https://github.com/hkproj/pytorch-stable-diffusion)

从零开始实现的Stable Diffusion，适合学习扩散模型原理。

- **Stars:** ⭐️ 1.0k
- **Tags:** `stable-diffusion` `diffusion-models` `pytorch`
- **最后活动时间:** 2024-10-22

### [CRNN_Tensorflow](https://github.com/MaybeShewill-CV/CRNN_Tensorflow)

基于TensorFlow的卷积循环神经网络，用于场景文本识别和OCR任务。

- **Stars:** ⭐️ 1.0k
- **Tags:** `ocr` `crnn` `text-recognition` `tensorflow`
- **最后活动时间:** 2023-05-09

### [HashNeRF-pytorch](https://github.com/yashbhalgat/HashNeRF-pytorch)

NVIDIA Instant NGP论文的纯PyTorch实现，支持实时神经辐射场渲染。

- **Stars:** ⭐️ 1.0k
- **Tags:** `nerf` `3d-reconstruction` `neural-graphics` `pytorch`
- **最后活动时间:** 2024-08-07

### [face-api](https://github.com/vladmandic/face-api)

基于TensorFlow.js的人脸检测与识别库，支持人脸检测、年龄性别情绪预测，可在浏览器和Node.js环境中运行。

- **Stars:** ⭐️ 1.0k
- **Tags:** `face-detection` `face-recognition` `tensorflowjs` `emotion-detection`
- **最后活动时间:** 2025-02-05

### [deeplab2](https://github.com/google-research/deeplab2)

Google开源的深度像素标注库，提供语义分割和实例分割的统一代码库。

- **Stars:** ⭐️ 1.0k
- **Tags:** `semantic-segmentation` `deep-learning` `computer-vision` `tensorflow`
- **最后活动时间:** 2023-04-17

### [minimal-hand](https://github.com/CalciferZh/minimal-hand)

单目摄像头实现100+FPS的实时手部姿态估计，即插即用的轻量级解决方案。

- **Stars:** ⭐️ 1.0k
- **Tags:** `hand-pose-estimation` `real-time` `3d-tracking`
- **最后活动时间:** 2022-01-12

### [3DTopia-XL](https://github.com/3DTopia/3DTopia-XL)

CVPR 2025 Highlight论文，基于基元扩散的高质量3D PBR资产生成。
...
UNet++（嵌套U-Net）的PyTorch实现，用于医学和自然图像分割任务。

- **Stars:** ⭐️ 1.0k
- **Tags:** `image-segmentation` `unet` `medical-imaging` `pytorch`
- **最后活动时间:** 2020-04-10
...
自注意力GAN实现，通过注意力机制提升图像生成的全局一致性。

- **Stars:** ⭐️ 1.0k
- **Tags:** `self-attention` `gan` `image-generation`
- **最后活动时间:** 2019-08-19

### [SegmentAnythingin3D](https://github.com/Jumpat/SegmentAnythingin3D)

结合NeRF实现3D场景分割，NeurIPS 2023和IJCV 2025发表。支持开放词汇的3D物体分割。

- **Stars:** ⭐️ 1.0k
- **Tags:** `3d-segmentation` `nerf` `segment-anything` `deep-learning`
- **最后活动时间:** 2025-05-19

### [PyTorch-Multi-Style-Transfer](https://github.com/zhanghang1989/PyTorch-Multi-Style-Transfer)

神经风格迁移PyTorch实现，支持实时多风格图像转换。

- **Stars:** ⭐️ 1.0k
- **Tags:** `style-transfer` `pytorch` `image-generation` `deep-learning`
- **最后活动时间:** 2022-05-12

### [PythonSIFT](https://github.com/rmislam/PythonSIFT)

SIFT特征提取算法的简洁Python实现，用于图像特征匹配和识别。

- **Stars:** ⭐️ 1.0k
- **Tags:** `sift` `feature-matching` `opencv` `computer-vision`
- **最后活动时间:** 2025-08-13

### [FaceTracker](https://github.com/kylemcdonald/FaceTracker)

基于OpenCV的C++实时可变形人脸追踪库，支持高精度面部特征点检测与跟踪。

- **Stars:** ⭐️ 1.0k
- **Tags:** `computer-vision` `face-tracking` `opencv` `realtime`
- **最后活动时间:** 2020-07-24

### [rq-vae-transformer](https://github.com/kakaobrain/rq-vae-transformer)

CVPR 2022官方实现，基于残差量化的自回归图像生成模型，结合VAE与Transformer架构实现高质量图像生成。

- **Stars:** ⭐️ 1.0k
- **Tags:** `image-generation` `transformer` `vae` `autoregressive` `cvpr`
- **最后活动时间:** 2024-01-03

### [LangSplat](https://github.com/minghanqin/LangSplat)

CVPR2024 Highlight论文，实现3D语言高斯泼溅技术，将语言理解与3D重建相结合。

- **Stars:** ⭐️ 1.0k
- **Tags:** `3d-gaussian-splatting` `3d-reconstruction` `language-model`
- **最后活动时间:** 2025-10-10

### [stable-point-aware-3d](https://github.com/Stability-AI/stable-point-aware-3d)

SPAR3D：从单张图像稳定重建3D物体，具有点感知能力的高质量重建方法。

- **Stars:** ⭐️ 1.0k
- **Tags:** `3d-reconstruction` `single-view` `point-cloud` `deep-learning`
- **最后活动时间:** 2025-05-05

### [Efficient-Segmentation-Networks](https://github.com/xiaoyufenfei/Efficient-Segmentation-Networks)

轻量级实时语义分割模型集合，包含UNet、ENet、Fast-SCNN等多种架构。

- **Stars:** ⭐️ 1.0k
- **Tags:** `semantic-segmentation` `real-time` `lightweight`
- **最后活动时间:** 2024-07-25

### [tiny-diffusion](https://github.com/tanelp/tiny-diffusion)

极简PyTorch扩散模型实现，适合学习扩散模型核心原理。

- **Stars:** ⭐️ 995
- **Tags:** `diffusion-models` `pytorch` `generative-ai` `image-generation`
- **最后活动时间:** 2024-05-07

### [stylegan-xl](https://github.com/autonomousvision/stylegan-xl)

SIGGRAPH'22论文代码，将StyleGAN扩展到大规模多样化数据集的高质量图像生成模型。

- **Stars:** ⭐️ 994
- **Tags:** `stylegan` `image-generation` `generative-model` `gan`
- **最后活动时间:** 2024-06-24
...
ICCV 2021论文，基于Transformer的目标重识别模型，用于视觉检索任务。

- **Stars:** ⭐️ 981
- **Tags:** `object-reidentification` `transformer` `computer-vision` `iccv2021`
- **最后活动时间:** 2024-06-12
...
多视角扩散模型用于3D生成，从文本或图像生成一致的多视角3D内容。

- **Stars:** ⭐️ 978
- **Tags:** `3d-generation` `diffusion-models` `multiview` `text-to-3d`
- **最后活动时间:** 2023-10-07

### [text2mesh](https://github.com/threedle/text2mesh)

基于文本驱动的3D网格风格化工具，使用PyTorch实现文本到3D的生成。

- **Stars:** ⭐️ 974
- **Tags:** `3d` `text-to-3d` `neural-style` `mesh-generation`
- **最后活动时间:** 2024-05-19
...
ICCV 2025 论文官方实现，基于相邻网格标记化技术实现艺术家级别的3D网格生成，支持从任意输入生成高质量网格模型。

- **Stars:** ⭐️ 973
- **Tags:** `3d-generation` `mesh` `transformers` `generative-model`
- **最后活动时间:** 2025-04-28

### [OpenCLAY](https://github.com/CLAY-3D/OpenCLAY)

可控大规模3D资产生成模型，用于创建高质量3D内容。

- **Stars:** ⭐️ 971
- **Tags:** `3d-generation` `generative-model` `3d-assets`
- **最后活动时间:** 2024-06-21

### [facexlib](https://github.com/xinntao/facexlib)

人脸相关功能工具库，提供检测、识别、对齐、解析等SOTA开源方法。

- **Stars:** ⭐️ 971
- **Tags:** `face-detection` `face-recognition` `face-parsing` `pytorch`
- **最后活动时间:** 2024-02-29

### [MAT](https://github.com/fenglinglwb/MAT)

掩码感知Transformer用于大面积图像修复，实现高质量图像inpainting。

- **Stars:** ⭐️ 970
- **Tags:** `image-inpainting` `mask-aware` `transformer` `image-restoration`
- **最后活动时间:** 2024-07-02

### [Monocular-Depth-Estimation-Toolbox](https://github.com/zhyever/Monocular-Depth-Estimation-Toolbox)

基于MMSegmentation的单目深度估计工具箱，提供多种深度估计模型。

- **Stars:** ⭐️ 968
- **Tags:** `depth-estimation` `computer-vision` `toolbox`
- **最后活动时间:** 2025-07-21
...
基于深度神经网络的面部表情识别工具包，用于情感分析和情绪识别。

- **Stars:** ⭐️ 967
- **Tags:** `facial-expression-recognition` `emotion-recognition` `deep-learning` `computer-vision`
- **最后活动时间:** 2022-05-26
...
### [gan](https://github.com/tensorflow/gan)

TensorFlow 生成对抗网络工具库，提供 GAN 模型的训练与评估工具。

- **Stars:** ⭐️ 966
- **Tags:** `gan` `tensorflow` `generative-models` `image-generation`
- **最后活动时间:** 2025-01-16

### [visual_anagrams](https://github.com/dangeng/visual_anagrams)
...
### [diffae](https://github.com/konpatp/diffae)

CVPR 2022论文官方实现，提出扩散自编码器，实现高质量图像生成与语义操控。

- **Stars:** ⭐️ 959
- **Tags:** `Diffusion Models` `Autoencoder` `Image Generation` `CVPR`
- **最后活动时间:** 2024-09-12

### [hypernerf](https://github.com/google/hypernerf)

高维神经辐射场表示方法，支持拓扑变化的场景建模与新视角合成。

- **Stars:** ⭐️ 958
- **Tags:** `3d` `nerf` `neural-rendering` `novel-view-synthesis`
- **最后活动时间:** 2024-05-03

### [CogView2](https://github.com/zai-org/CogView2)

智源研究院官方文本到图像生成模型，采用分层Transformer架构实现更快更好的图像生成。

- **Stars:** ⭐️ 955
- **Tags:** `text-to-image` `transformer` `pytorch` `pretrained-models`
- **最后活动时间:** 2022-08-03

### [keras-vggface](https://github.com/rcmalli/keras-vggface)

基于Keras框架实现的VGGFace人脸识别模型，用于人脸特征提取与验证。

- **Stars:** ⭐️ 952
- **Tags:** `keras` `vggface` `face-recognition` `tensorflow`
- **最后活动时间:** 2024-07-09
...
ECCV 2020论文实现，基于深度多尺度组件字典的盲人脸修复技术。

- **Stars:** ⭐️ 948
- **Tags:** `face-restoration` `image-enhancement` `pytorch`
- **最后活动时间:** 2022-12-05

### [SMPL](https://github.com/CalciferZh/SMPL)

人体SMPL模型的多框架实现，支持人体姿态估计和3D人体建模。

- **Stars:** ⭐️ 945
- **Tags:** `smpl` `3d-body` `pose-estimation` `tensorflow` `pytorch`
- **最后活动时间:** 2022-03-21

### [YOLO-CoreML-MPSNNGraph](https://github.com/hollance/YOLO-CoreML-MPSNNGraph)

iOS端Tiny YOLO实现，使用CoreML和MPS图API进行实时目标检测。

- **Stars:** ⭐️ 944
- **Tags:** `yolo` `coreml` `ios` `object-detection` `metal`
- **最后活动时间:** 2019-11-19
...
开源多视图几何与运动恢复结构库，用于3D重建和相机位姿估计。

- **Stars:** ⭐️ 944
- **Tags:** `computer-vision` `structure-from-motion` `3d-reconstruction` `geometry`
- **最后活动时间:** 2023-04-03

### [pix2seq](https://github.com/google-research/pix2seq)

基于生成建模的多任务代码库，支持自回归和扩散模型。

- **Stars:** ⭐️ 939
- **Tags:** `pix2seq` `object-detection` `generative-model`
- **最后活动时间:** 2023-11-07

### [semantic-segmentation](https://github.com/sithu31296/semantic-segmentation)

PyTorch实现的SOTA语义分割模型集合，支持Transformer和多种数据集。

- **Stars:** ⭐️ 939
- **Tags:** `semantic-segmentation` `vision-transformer` `deep-learning` `pytorch`
- **最后活动时间:** 2024-03-20
...
经典的Pix2Pix图像到图像翻译模型的TensorFlow实现。

- **Stars:** ⭐️ 938
- **Tags:** `image-translation` `gan` `tensorflow`
- **最后活动时间:** 2019-09-04

### [GFM](https://github.com/JizhiziLi/GFM)

IJCV 2022发表的端到端深度图像抠图方法，桥接合成与真实数据域。

- **Stars:** ⭐️ 938
- **Tags:** `image-matting` `alpha-matting` `deep-learning`
- **最后活动时间:** 2023-04-13

### [Eagle](https://github.com/NVlabs/Eagle)
...
开源表格识别模型集合，包含ONNX转换与完善的前后处理流程。

- **Stars:** ⭐️ 937
- **Tags:** `ocr` `table-recognition` `onnx` `structure`
- **最后活动时间:** 2025-08-03

### [GSCNN](https://github.com/nv-tlabs/GSCNN)

ICCV 2019论文实现，用于语义分割的门控形状CNN。
...
基于TensorFlow 2.0的CartoonGAN实现，可将照片转换为卡通风格图像。

- **Stars:** ⭐️ 935
- **Tags:** `cartoongan` `image-style-transfer` `gan` `tensorflow` `deep-learning`
- **最后活动时间:** 2021-10-17
...
基于Transformer的快速扩散模型实现，专注于高效图像生成。

- **Stars:** ⭐️ 934
- **Tags:** `diffusion-models` `transformer` `image-generation`
- **最后活动时间:** 2025-08-17

### [renderformer](https://github.com/microsoft/renderformer)

SIGGRAPH 2025论文项目，基于Transformer的三角网格神经渲染框架，支持全局光照效果。

- **Stars:** ⭐️ 933
- **Tags:** `neural-rendering` `transformer` `3d-graphics` `pytorch` `global-illumination`
- **最后活动时间:** 2025-09-25

### [GeoTransformer](https://github.com/qinzheng93/GeoTransformer)

CVPR 2022论文实现，用于快速鲁棒的点云配准的几何Transformer。

- **Stars:** ⭐️ 933
- **Tags:** `point-cloud` `transformer` `registration` `deep-learning`
- **最后活动时间:** 2023-11-22

### [SegAnyGAussians](https://github.com/Jumpat/SegAnyGAussians)
...
TensorFlow实现的快速神经风格迁移算法，可将艺术风格应用到任意图像上。

- **Stars:** ⭐️ 928
- **Tags:** `neural-style` `style-transfer` `image-generation` `tensorflow`
- **最后活动时间:** 2018-06-20
...
基于Instant-NGP的神经表面重建框架，支持快速训练NeuS模型进行3D重建。

- **Stars:** ⭐️ 922
- **Tags:** `neural-rendering` `3d-reconstruction` `nerf` `instant-ngp`
- **最后活动时间:** 2023-11-22

### [TriplaneGaussian](https://github.com/VAST-AI-Research/TriplaneGaussian)

新型混合表示方法，用于单视角3D重建，结合三平面和高斯表示的优势。

- **Stars:** ⭐️ 920
- **Tags:** `triplane` `gaussian` `single-view` `hybrid-representation`
- **最后活动时间:** 2024-03-05

### [muse-maskgit-pytorch](https://github.com/lucidrains/muse-maskgit-pytorch)

Muse文本到图像生成模型的PyTorch实现，基于掩码生成Transformer。

- **Stars:** ⭐️ 919
- **Tags:** `text-to-image` `masked-transformer` `generative-ai` `pytorch`
- **最后活动时间:** 2024-02-29

### [FernRPExample](https://github.com/FernRP/FernRPExample)
...
ECCV 2022论文实现，高分辨率虚拟试穿系统，处理错位和遮挡问题。

- **Stars:** ⭐️ 913
- **Tags:** `virtual-try-on` `image-synthesis` `fashion-ai` `pytorch`
- **最后活动时间:** 2024-12-31

### [Medical-SAM2](https://github.com/ImprintLab/Medical-SAM2)

基于SAM2的3D医学图像分割模型，支持多种医学影像模态。

- **Stars:** ⭐️ 912
- **Tags:** `medical-imaging` `segment-anything` `deep-learning` `segmentation`
- **最后活动时间:** 2025-01-06

### [PConv-Keras](https://github.com/MathiasGruber/PConv-Keras)

基于部分卷积的不规则图像修复实现，支持AI驱动的图像填充。

- **Stars:** ⭐️ 909
- **Tags:** `image-inpainting` `deep-learning` `keras` `tensorflow`
- **最后活动时间:** 2023-03-24

### [USRNet](https://github.com/cszn/USRNet)

CVPR 2020论文实现，深度展开网络用于图像超分辨率，支持多种退化模型。

- **Stars:** ⭐️ 907
- **Tags:** `deep-unfolding` `super-resolution` `deblurring` `cvpr`
- **最后活动时间:** 2025-09-03

### [FacePoke](https://github.com/jbilcke-hf/FacePoke)

AI驱动的肖像面部表情编辑工具，支持实时交互式头部姿态调整。

- **Stars:** ⭐️ 905
- **Tags:** `face-manipulation` `portrait-editing` `ai` `computer-vision`
- **最后活动时间:** 2025-08-18
...
CVPR 2025论文，从单张图像生成3D场景的多实例扩散模型。

- **Stars:** ⭐️ 903
- **Tags:** `3D Generation` `Scene Generation` `CVPR2025`
- **最后活动时间:** 2025-06-12

### [face_morpher](https://github.com/alyssaq/face_morpher)

基于Python的人脸变形工具，使用Numpy和Scipy实现平滑的人脸渐变和变形效果。

- **Stars:** ⭐️ 901
- **Tags:** `face-morphing` `computer-vision` `python` `opencv`
- **最后活动时间:** 2021-12-31

### [DSINE](https://github.com/baegwangbin/DSINE)

CVPR2024 Oral论文，重新思考表面法线估计的归纳偏置，实现高质量3D表面重建。

- **Stars:** ⭐️ 896
- **Tags:** `surface-normal` `3d-reconstruction` `deep-learning`
- **最后活动时间:** 2024-07-10

### [deconvfaces](https://github.com/flynnmd/deconvfaces)

使用反卷积神经网络生成人脸图像的深度学习项目，基于Keras实现。

- **Stars:** ⭐️ 891
- **Tags:** `deep-learning` `keras` `image-generation` `face-generation` `neural-network`
- **最后活动时间:** 2021-06-08

### [api-llm-ocr](https://github.com/yigitkonur/api-llm-ocr)
...
苹果ARKit场景数据集，提供多样化的室内3D场景RGB-D数据，用于移动端3D场景理解研究。

- **Stars:** ⭐️ 890
- **Tags:** `3d-scene` `rgb-d` `dataset` `computer-vision` `indoor-scene`
- **最后活动时间:** 2024-09-21

### [SEED-Story](https://github.com/TencentARC/SEED-Story)

基于大语言模型的多模态长故事生成系统，实现图文交织的叙事创作。

- **Stars:** ⭐️ 887
- **Tags:** `multimodal-generation` `story-generation` `image-text`
- **最后活动时间:** 2024-10-11

### [realcugan-ncnn-vulkan](https://github.com/nihui/realcugan-ncnn-vulkan)

基于 ncnn 的 real-cugan 视频超分辨率工具，支持 Intel/AMD/NVIDIA/Apple Silicon GPU 加速。

- **Stars:** ⭐️ 884
- **Tags:** `super-resolution` `ncnn` `vulkan` `video-upscaling`
- **最后活动时间:** 2023-03-12
...
TensorFlow实现的YOLO v3目标检测器，支持实时高精度物体检测。

- **Stars:** ⭐️ 878
- **Tags:** `yolo` `object-detection` `tensorflow` `real-time`
- **最后活动时间:** 2023-05-15

### [RingNet](https://github.com/soubhiksanyal/RingNet)

CVPR论文实现，从单张图像重建3D人脸形状和表情，无需3D监督。

- **Stars:** ⭐️ 877
- **Tags:** `3d-face-reconstruction` `computer-vision` `deep-learning` `tensorflow`
- **最后活动时间:** 2023-03-24
...
TensorFlow实现的Faster RCNN目标检测框架，支持行人检测等应用场景。

- **Stars:** ⭐️ 872
- **Tags:** `faster-rcnn` `detection` `pedestrian` `tensorflow`
- **最后活动时间:** 2018-06-07

### [Poisson_flow](https://github.com/Newbeeer/Poisson_flow)

NeurIPS 2022论文，泊松流生成模型(PFGM)官方实现。

- **Stars:** ⭐️ 871
- **Tags:** `pfgm` `generative-model` `diffusion-alternative`
- **最后活动时间:** 2023-06-06

### [Human-detection-and-Tracking](https://github.com/ITCoders/Human-detection-and-Tracking)

基于OpenCV的人体检测与追踪系统，支持视频中的人脸识别和追踪功能。

- **Stars:** ⭐️ 871
- **Tags:** `face-detection` `face-recognition` `opencv` `computer-vision`
- **最后活动时间:** 2022-12-30

### [CVPR2023-3D-Occupancy-Prediction](https://github.com/CVPR2023-3D-Occupancy-Prediction/CVPR2023-3D-Occupancy-Prediction)

CVPR 2023自动驾驶3D占用预测挑战赛项目。

- **Stars:** ⭐️ 869
- **Tags:** `3d-occupancy` `autonomous-driving` `computer-vision`
- **最后活动时间:** 2023-07-31

### [3dmm_cnn](https://github.com/anhttran/3dmm_cnn)

使用深度神经网络回归3D可变形人脸模型，实现鲁棒的人脸形状重建。

- **Stars:** ⭐️ 869
- **Tags:** `3d-face` `cnn` `face-modeling` `computer-vision`
- **最后活动时间:** 2021-01-09

### [PFLD-pytorch](https://github.com/polarisZhao/PFLD-pytorch)

轻量级人脸关键点检测模型PFLD的PyTorch实现，支持移动端部署。

- **Stars:** ⭐️ 869
- **Tags:** `face-landmark` `face-detection` `pfld` `pytorch`
- **最后活动时间:** 2022-06-21

### [hdrnet](https://github.com/google/hdrnet)

SIGGRAPH 2017论文实现，基于深度双边学习的实时图像增强技术。

- **Stars:** ⭐️ 865
- **Tags:** `image-enhancement` `deep-learning` `siggraph` `real-time`
- **最后活动时间:** 2023-04-09
...
神经风格迁移算法的PyTorch实现，将艺术风格应用到图像上。

- **Stars:** ⭐️ 863
- **Tags:** `neural-style-transfer` `style-transfer` `pytorch` `deep-learning`
- **最后活动时间:** 2022-10-15

### [neurecon](https://github.com/ventusff/neurecon)

多视角3D重建神经渲染实现，包含UNISURF、VolSDF、NeuS等方法的非官方实现。

- **Stars:** ⭐️ 862
- **Tags:** `nerf` `neural-rendering` `implicit-surfaces` `sdf`
- **最后活动时间:** 2021-09-14

### [domain-transfer-network](https://github.com/yunjey/domain-transfer-network)

无监督跨域图像生成的TensorFlow实现，实现不同风格域之间的图像转换。

- **Stars:** ⭐️ 862
- **Tags:** `domain-transfer` `image-generation` `tensorflow` `unsupervised-learning`
- **最后活动时间:** 2018-06-06
...
ECCV 2024论文实现，将图像编码为2个token的高效视觉语言模型。

- **Stars:** ⭐️ 860
- **Tags:** `vision-language-model` `multimodal` `llama`
- **最后活动时间:** 2024-07-29

### [meshgpt-pytorch](https://github.com/lucidrains/meshgpt-pytorch)

基于注意力机制的SOTA网格生成模型PyTorch实现。

- **Stars:** ⭐️ 858
- **Tags:** `mesh-generation` `transformers` `deep-learning` `3d-generation`
- **最后活动时间:** 2024-12-24

### [SRGAN-tensorflow](https://github.com/brade31919/SRGAN-tensorflow)

SRGAN算法的TensorFlow实现，用于单图像超分辨率重建。

- **Stars:** ⭐️ 858
- **Tags:** `srgan` `super-resolution` `gan`
- **最后活动时间:** 2023-05-12

### [3DMPPE_POSENET_RELEASE](https://github.com/mks0601/3DMPPE_POSENET_RELEASE)

ICCV 2019官方实现，单张RGB图像进行3D多人姿态估计。

- **Stars:** ⭐️ 858
- **Tags:** `3d-pose-estimation` `multi-person` `rgb`
- **最后活动时间:** 2024-07-10
...
### [JarvisArt](https://github.com/LYL1015/JarvisArt)
...
使用归一化流的超分辨率方法官方训练代码，提供多样化超分辨率结果。

- **Stars:** ⭐️ 854
- **Tags:** `normalizing-flow` `super-resolution` `image-manipulation` `pytorch`
- **最后活动时间:** 2022-12-08

### [FaceBoxes.PyTorch](https://github.com/zisianw/FaceBoxes.PyTorch)

FaceBoxes人脸检测器PyTorch实现，高效实时人脸检测。

- **Stars:** ⭐️ 853
- **Tags:** `face-detection` `computer-vision` `pytorch`
- **最后活动时间:** 2024-12-11

### [zipnerf-pytorch](https://github.com/SuLvXiangXin/zipnerf-pytorch)

ZipNeRF非官方PyTorch实现，高效神经辐射场渲染技术。

- **Stars:** ⭐️ 852
- **Tags:** `nerf` `3d-reconstruction` `pytorch`
- **最后活动时间:** 2024-09-24

### [d2-net](https://github.com/mihaidusmanu/d2-net)

CVPR 2019论文，可训练的CNN局部特征检测与描述联合学习模型，用于视觉定位。

- **Stars:** ⭐️ 847
- **Tags:** `local-features` `visual-localization` `cnn` `pytorch`
- **最后活动时间:** 2024-04-08

### [instagan](https://github.com/sangwoomo/instagan)

ICLR 2019论文，实例感知的图像翻译生成对抗网络。

- **Stars:** ⭐️ 845
- **Tags:** `image-translation` `gan` `instance-aware`
- **最后活动时间:** 2024-07-25

### [DPSR](https://github.com/cszn/DPSR)

CVPR 2019论文实现，针对任意模糊核的深度即插即用超分辨率方法。

- **Stars:** ⭐️ 844
- **Tags:** `blind-super-resolution` `deblurring` `pytorch` `cvpr`
- **最后活动时间:** 2020-09-03

### [StackGAN-v2](https://github.com/hanzhanggit/StackGAN-v2)

StackGAN第二版，通过堆叠生成对抗网络实现高分辨率文本到图像生成。

- **Stars:** ⭐️ 844
- **Tags:** `stackgan` `text-to-image` `gan` `high-resolution`
- **最后活动时间:** 2020-01-13

### [tensorflow-deeplab-v3-plus](https://github.com/rishizek/tensorflow-deeplab-v3-plus)

TensorFlow实现的DeepLabv3+语义分割模型，支持Pascal VOC数据集。

- **Stars:** ⭐️ 840
- **Tags:** `deeplab` `semantic-segmentation` `tensorflow` `computer-vision`
- **最后活动时间:** 2023-03-24

### [Image-Super-Resolution](https://github.com/titu1994/Image-Super-Resolution)

Keras实现的超分辨率卷积神经网络，提升图像质量，探索图像处理技术。

- **Stars:** ⭐️ 840
- **Tags:** `super-resolution` `image-processing` `keras` `cnn`
- **最后活动时间:** 2024-08-11

### [SSH](https://github.com/mahyarnajibi/SSH)
...
基于注意力机制的场景文本识别模型，用于自然场景中的文字检测与识别。

- **Stars:** ⭐️ 839
- **Tags:** `ocr` `attention-mechanism` `scene-text-recognition` `computer-vision`
- **最后活动时间:** 2019-12-11

### [Osprey](https://github.com/CircleRadon/Osprey)

CVPR2024论文，通过视觉指令调优实现像素级理解的多模态大模型。

- **Stars:** ⭐️ 837
- **Tags:** `mllm` `visual-instruction-tuning` `pixel-understanding`
- **最后活动时间:** 2025-08-19
...
端到端自动人脸替换管线，集成3D重建与表情迁移技术。

- **Stars:** ⭐️ 834
- **Tags:** `face-swap` `3d-reconstruction` `deep-learning`
- **最后活动时间:** 2018-12-05
...
### [MeshDiffusion](https://github.com/lzzcd001/MeshDiffusion)
...
### [Anole](https://github.com/GAIR-NLP/anole)

开源自回归原生多模态模型，支持交错的图文生成任务。

- **Stars:** ⭐️ 829
- **Tags:** `Multimodal` `Image Generation` `Autoregressive`
- **最后活动时间:** 2025-06-16

### [handwriting-ocr](https://github.com/Breta01/handwriting-ocr)

手写文字OCR识别系统，基于TensorFlow和OpenCV实现。

- **Stars:** ⭐️ 829
- **Tags:** `handwriting-ocr` `tensorflow` `opencv` `recognition`
- **最后活动时间:** 2022-12-23

### [emoca](https://github.com/radekd91/emoca)

CVPR 2022 论文，情感驱动的单目人脸捕捉与动画系统，在野外情感图像重建方面达到领先水平。

- **Stars:** ⭐️ 829
- **Tags:** `3d-face-reconstruction` `emotion-recognition` `deep-learning` `cvpr2022`
- **最后活动时间:** 2024-12-06

### [StegaStamp](https://github.com/tancik/StegaStamp)

利用深度学习在物理照片中嵌入隐形超链接和水印，实现图像隐写术。

- **Stars:** ⭐️ 829
- **Tags:** `steganography` `watermark` `tensorflow` `image-processing`
- **最后活动时间:** 2023-12-08

### [pggan-pytorch](https://github.com/nashory/pggan-pytorch)

Progressive Growing of GANs的PyTorch实现，支持TensorBoard可视化。

- **Stars:** ⭐️ 828
- **Tags:** `progressive-gan` `pggan` `high-quality-generation` `pytorch`
- **最后活动时间:** 2022-11-22

### [LION](https://github.com/nv-tlabs/LION)

基于潜在点扩散模型的3D形状生成框架，支持高质量三维内容创作。

- **Stars:** ⭐️ 826
- **Tags:** `3d` `diffusion` `pointcloud` `generative-model`
- **最后活动时间:** 2024-09-09

### [edm2](https://github.com/NVlabs/edm2)

NVIDIA官方PyTorch实现，EDM2和Autoguidance扩散模型，用于高质量图像生成。

- **Stars:** ⭐️ 826
- **Tags:** `diffusion-models` `image-generation` `pytorch` `generative-ai`
- **最后活动时间:** 2024-12-09
...
### [Open-DiffusionGS](https://github.com/caiyuanhao1998/Open-DiffusionGS)
...
基于Taichi和PyTorch的NeRF变体实现集合，支持实时3D重建与渲染。

- **Stars:** ⭐️ 824
- **Tags:** `nerf` `3d-reconstruction` `computer-vision` `taichi` `neural-radiance-field`
- **最后活动时间:** 2024-05-27

### [DCT-Net](https://github.com/menyifang/DCT-Net)

SIGGRAPH 2022官方实现，用于人像风格化的域校准翻译网络，支持多风格卡通化。

- **Stars:** ⭐️ 824
- **Tags:** `style-transfer` `cartoonization` `portrait` `gan`
- **最后活动时间:** 2023-10-24

### [Image2Paragraph](https://github.com/showlab/Image2Paragraph)

将图像转换为独特段落的AI工具，集成ChatGPT、BLIP2、Segment Anything、ControlNet等多种模型。

- **Stars:** ⭐️ 823
- **Tags:** `chatgpt` `gpt4` `segment-anything` `controlnet` `image-to-text`
- **最后活动时间:** 2023-04-28

### [neural-image-assessment](https://github.com/titu1994/neural-image-assessment)

NIMA神经图像评估的Keras实现，自动评估图像美学质量。

- **Stars:** ⭐️ 822
- **Tags:** `image-quality` `nima` `keras` `aesthetic-assessment`
- **最后活动时间:** 2019-07-05
...
### [maple-diffusion](https://github.com/madebyollin/maple-diffusion)

在iOS/macOS上使用MPSGraph运行Stable Diffusion推理。苹果设备原生图像生成方案。

- **Stars:** ⭐️ 819
- **Tags:** `stable-diffusion` `ios` `macos` `mps`
- **最后活动时间:** 2022-12-22

### [RealSR](https://github.com/jixiaozhong/RealSR)

基于核估计和噪声注入的真实世界超分辨率方法，解决真实场景下的图像增强问题。

- **Stars:** ⭐️ 816
- **Tags:** `super-resolution` `kernel-estimation` `real-world`
- **最后活动时间:** 2020-09-02
...
### [tennis_analysis](https://github.com/abdullahtarek/tennis_analysis)

使用YOLO和CNN分析网球比赛视频，检测球员和球并测量速度等指标的计算机视觉项目。

- **Stars:** ⭐️ 815
- **Tags:** `computer-vision` `yolo` `object-detection` `sports-analytics`
- **最后活动时间:** 2024-08-12

### [NextFace](https://github.com/abdallahdib/NextFace)

高保真3D人脸重建库，从单目RGB图像重建3D人脸，支持可微渲染和优化。

- **Stars:** ⭐️ 814
- **Tags:** `3d-face-reconstruction` `differentiable-rendering` `pytorch` `face-capture`
- **最后活动时间:** 2023-10-18

### [panic3d-anime-reconstruction](https://github.com/ShuhongChen/panic3d-anime-reconstruction)

CVPR 2023 论文，从动漫角色肖像进行风格化单视角3D重建。

- **Stars:** ⭐️ 813
- **Tags:** `anime` `stylized-3d` `single-view` `cvpr2023`
- **最后活动时间:** 2023-06-04

### [deocclusion](https://github.com/XiaohangZhan/deocclusion)

CVPR 2020论文，图像去遮挡的深度学习方法。

- **Stars:** ⭐️ 811
- **Tags:** `deocclusion` `image-inpainting` `computer-vision` `cvpr2020`
- **最后活动时间:** 2023-10-03

### [daclip-uir](https://github.com/Algolzw/daclip-uir)
...
### [4dface](https://github.com/patrikhuber/4dface)

从2D视频实时进行3D人脸跟踪与重建系统，支持动态人脸建模。

- **Stars:** ⭐️ 810
- **Tags:** `3d-face` `face-tracking` `real-time`
- **最后活动时间:** 2018-12-10

### [Deep-Photo-Enhancer](https://github.com/nothinglo/Deep-Photo-Enhancer)

CVPR 2018 论文实现，使用GAN进行无配对学习的图像增强工具。

- **Stars:** ⭐️ 809
- **Tags:** `Image Enhancement` `GAN` `TensorFlow`
- **最后活动时间:** 2019-09-11

### [APDrawingGAN](https://github.com/yiranran/APDrawingGAN)

CVPR 2019口头报告论文，从人脸照片生成艺术肖像素描画。

- **Stars:** ⭐️ 809
- **Tags:** `gan` `artistic-generation` `portrait`
- **最后活动时间:** 2022-08-01

### [deep-photo-styletransfer-tf](https://github.com/LouieYang/deep-photo-styletransfer-tf)

深度照片风格迁移的TensorFlow实现，实现照片级别的艺术风格转换。

- **Stars:** ⭐️ 808
- **Tags:** `style-transfer` `tensorflow` `image-processing` `deep-learning`
- **最后活动时间:** 2022-05-09

### [yolo_tensorflow](https://github.com/hizhangp/yolo_tensorflow)

TensorFlow实现的YOLO目标检测算法，包含完整的训练与测试流程。

- **Stars:** ⭐️ 806
- **Tags:** `yolo` `detection` `tensorflow` `object-detection`
- **最后活动时间:** 2019-05-22

### [extreme_3d_faces](https://github.com/anhttran/extreme_3d_faces)

处理遮挡情况的极端3D人脸重建方法，通过形状着色技术恢复面部细节。

- **Stars:** ⭐️ 805
- **Tags:** `3d-face` `face-reconstruction` `occlusion`
- **最后活动时间:** 2020-10-26

### [deeplab_v3](https://github.com/sthalles/deeplab_v3)

DeepLab V3语义分割CNN的TensorFlow实现。
...
通过双体积打包实现高效的部件级3D对象生成。

- **Stars:** ⭐️ 803
- **Tags:** `3d-generation` `image-to-3d` `part-level`
- **最后活动时间:** 2025-06-26

### [rich-text-to-image](https://github.com/songweige/rich-text-to-image)

富文本到图像生成，支持复杂文本排版和样式的文生图模型。

- **Stars:** ⭐️ 801
- **Tags:** `text-to-image` `diffusion-models` `rich-text`
- **最后活动时间:** 2023-10-09
...
图像驱动的3D生成项目，支持从单张图像生成多视角一致的3D内容。

- **Stars:** ⭐️ 799
- **Tags:** `image-to-3d` `diffusion-models` `3d-generation`
- **最后活动时间:** 2024-01-27

### [fewshot-face-translation-GAN](https://github.com/shaoanlu/fewshot-face-translation-GAN)

集成FUNIT和SPADE模块的GAN，用于高质量人脸替换和图像翻译。

- **Stars:** ⭐️ 799
- **Tags:** `face-swap` `gan` `image-translation` `pytorch`
- **最后活动时间:** 2021-07-02

### [deep-fonts](https://github.com/erikbern/deep-fonts)

使用深度学习生成字体的项目，探索AI在字体设计领域的创意应用。

- **Stars:** ⭐️ 797
- **Tags:** `deep-learning` `font-generation` `generative-model`
- **最后活动时间:** 2016-02-09

### [image_captioning](https://github.com/DeepRNN/image_captioning)

TensorFlow实现的图像描述生成模型，结合视觉注意力机制生成图像文本描述。

- **Stars:** ⭐️ 796
- **Tags:** `image-captioning` `attention-mechanism` `visual-attention` `tensorflow`
- **最后活动时间:** 2022-05-24

### [anime-segmentation](https://github.com/SkyTNT/anime-segmentation)

高精度动漫角色图像分割模型，可实现动漫人物的自动抠图与背景分离。

- **Stars:** ⭐️ 795
- **Tags:** `anime` `segmentation` `image-segmentation` `computer-vision`
- **最后活动时间:** 2025-05-21

### [FLAME_PyTorch](https://github.com/soubhiksanyal/FLAME_PyTorch)

3D人脸模型PyTorch实现，支持人脸重建、表情捕捉等计算机视觉任务。

- **Stars:** ⭐️ 793
- **Tags:** `3d-face-model` `computer-vision` `pytorch`
- **最后活动时间:** 2023-05-23

### [Paint3D](https://github.com/OpenTexture/Paint3D)

CVPR 2024论文，使用无光照纹理扩散模型为任意3D物体生成纹理贴图。

- **Stars:** ⭐️ 792
- **Tags:** `3d-texture-generation` `diffusion-models` `stable-diffusion`
- **最后活动时间:** 2024-11-05

### [TTSR](https://github.com/researchmm/TTSR)

CVPR'20 论文实现，基于纹理 Transformer 的图像超分辨率网络。

- **Stars:** ⭐️ 791
- **Tags:** `image-super-resolution` `texture-transformer` `cvpr`
- **最后活动时间:** 2022-07-24

### [daam](https://github.com/castorini/daam)

Stable Diffusion扩散模型的注意力归因图解释工具，用于理解生成过程。

- **Stars:** ⭐️ 789
- **Tags:** `stable-diffusion` `explainable-ai` `diffusion-models` `pytorch`
- **最后活动时间:** 2024-04-05

### [BCDU-Net](https://github.com/rezazad68/BCDU-Net)

基于深度学习的医学图像分割模型，结合U-Net与双向ConvLSTM实现高精度分割，适用于癌症检测、肺部分割、视网膜血管分割等医学影像应用。

- **Stars:** ⭐️ 785
- **Tags:** `Medical AI` `Image Segmentation` `Deep Learning` `U-Net`
- **最后活动时间:** 2023-01-30
...
CVPR 2021论文，支持交互式图像合成与编辑的可变成本GAN。

- **Stars:** ⭐️ 783
- **Tags:** `gan` `image-editing` `stylegan2` `pytorch`
- **最后活动时间:** 2023-10-03
...
TensorFlow实现的RetinexNet低光照图像增强网络，用于图像恢复和增强。

- **Stars:** ⭐️ 782
- **Tags:** `image-enhancement` `lowlight` `computer-vision` `tensorflow`
- **最后活动时间:** 2020-12-02

### [PSGAN](https://github.com/wtjiang98/PSGAN)

CVPR 2020 Oral论文，姿态和表情鲁棒的空间感知GAN，用于可定制妆容迁移。

- **Stars:** ⭐️ 782
- **Tags:** `makeup-transfer` `gan` `image-editing` `pytorch`
- **最后活动时间:** 2024-03-13

### [CharacterGen](https://github.com/zjp-shadow/CharacterGen)

SIGGRAPH 2024论文，从单张图像高效生成3D角色。

- **Stars:** ⭐️ 781
- **Tags:** `3D Character` `Avatar Generation` `SIGGRAPH2024`
- **最后活动时间:** 2025-04-11
...
### [exposure](https://github.com/yuanming-hu/exposure)

结合GAN与强化学习从非配对图像数据学习无限分辨率图像处理，支持可微分照片编辑。

- **Stars:** ⭐️ 780
- **Tags:** `gan` `image-processing` `reinforcement-learning` `computational-photography`
- **最后活动时间:** 2021-08-27

### [OSX](https://github.com/IDEA-Research/OSX)

CVPR 2023论文官方实现，基于组件感知Transformer的单阶段3D全身网格重建方法，支持人体姿态估计和SMPL模型。

- **Stars:** ⭐️ 780
- **Tags:** `3d-mesh` `transformer` `pose-estimation` `cvpr2023`
- **最后活动时间:** 2024-08-26

### [DiscoGAN](https://github.com/SKTBrain/DiscoGAN)

DiscoGAN官方实现，用于学习跨域关系发现，实现图像到图像的域转换。

- **Stars:** ⭐️ 780
- **Tags:** `gan` `domain-transfer` `image-translation` `deep-learning`
- **最后活动时间:** 2021-03-11
...
### [text2art](https://github.com/mfrashad/text2art)

AI驱动的文本转艺术生成器，输入文字描述即可生成多种风格的艺术作品。

- **Stars:** ⭐️ 777
- **Tags:** `text-to-image` `generative-art` `gan`
- **最后活动时间:** 2023-07-22

### [Awesome-Face-Forgery-Generation-and-Detection](https://github.com/clpeng/Awesome-Face-Forgery-Generation-and-Detection)

人脸伪造生成与检测技术的精选资源合集，涵盖深度伪造、人脸替换、人脸重演等前沿方向。

- **Stars:** ⭐️ 777
- **Tags:** `deepfake-detection` `face-forgery` `face-swap` `image-manipulation`
- **最后活动时间:** 2022-11-18

### [ocean](https://github.com/facebookresearch/ocean)
...
### [HVI-CIDNet](https://github.com/Fediory/HVI-CIDNet)
...
NeurIPS 2019口头报告论文，噪声条件分数网络的生成模型。

- **Stars:** ⭐️ 772
- **Tags:** `score-based-model` `generative-model` `diffusion`
- **最后活动时间:** 2024-02-14

### [GPT4Tools](https://github.com/AILab-CVC/GPT4Tools)

智能系统，可自动决策、控制和使用多种视觉基础模型，支持对话中与图像交互。

- **Stars:** ⭐️ 772
- **Tags:** `multimodal` `visual-models` `image-understanding` `agent`
- **最后活动时间:** 2023-12-19

### [scribeocr](https://github.com/scribeocr/scribeocr)
...
TOG 2022论文，支持动态风格的人像图像生成器。

- **Stars:** ⭐️ 770
- **Tags:** `gan` `portrait-generation` `style-mixing`
- **最后活动时间:** 2025-06-19

### [brain-segmentation-pytorch](https://github.com/mateuszbuda/brain-segmentation-pytorch)

PyTorch实现的U-Net脑部MRI FLAIR异常分割，医学影像深度学习应用。

- **Stars:** ⭐️ 769
- **Tags:** `brain-segmentation` `unet` `medical-imaging` `mri` `pytorch`
- **最后活动时间:** 2023-03-24

### [Attend-and-Excite](https://github.com/yuval-alaluf/Attend-and-Excite)

SIGGRAPH 2023论文，基于注意力的语义引导方法提升文生图模型的生成质量。

- **Stars:** ⭐️ 768
- **Tags:** `stable-diffusion` `text-to-image` `attention-guidance`
- **最后活动时间:** 2024-01-26
...
### [Skyfall-GS](https://github.com/jayin92/Skyfall-GS)
...
### [midjourney-proxy](https://github.com/trueai-org/midjourney-proxy)
...
2017 VQA Challenge冠军方案的高效PyTorch实现，基于自底向上注意力机制。

- **Stars:** ⭐️ 766
- **Tags:** `vqa` `visual-question-answering` `attention` `pytorch`
- **最后活动时间:** 2024-03-10

### [FaderNetworks](https://github.com/facebookresearch/FaderNetworks)

NIPS 2017论文实现，通过滑动属性来操控图像的生成模型。支持对图像属性进行连续、平滑的调整。

- **Stars:** ⭐️ 763
- **Tags:** `image-manipulation` `generative-model` `neural-network` `computer-vision`
- **最后活动时间:** 2021-09-01

### [SRN-Deblur](https://github.com/jiangsutx/SRN-Deblur)

基于尺度循环网络的深度图像去模糊模型，恢复清晰图像细节。

- **Stars:** ⭐️ 763
- **Tags:** `deblurring` `image-processing` `deep-learning`
- **最后活动时间:** 2021-09-05
...
### [app.enfugue.ai](https://github.com/painebenjamin/app.enfugue.ai)

开源的AI图像和视频生成Web应用，支持Stable Diffusion，可自托管部署。

- **Stars:** ⭐️ 759
- **Tags:** `Stable Diffusion` `Image Generation` `Self-hosted`
- **最后活动时间:** 2024-10-29
...
### [face_segmentation](https://github.com/YuvalNirkin/face_segmentation)

极端条件下的人脸分割深度学习模型，处理遮挡、光照等复杂场景。

- **Stars:** ⭐️ 759
- **Tags:** `face-segmentation` `computer-vision` `deep-learning`
- **最后活动时间:** 2023-05-09

### [InSPyReNet](https://github.com/plemeri/InSPyReNet)

ACCV 2022论文官方实现，高分辨率显著目标检测。支持背景移除和图像抠图。

- **Stars:** ⭐️ 758
- **Tags:** `salient-object-detection` `image-matting` `background-removal`
- **最后活动时间:** 2025-05-14

### [DPIR](https://github.com/cszn/DPIR)

IEEE TPAMI 2021论文实现，基于深度去噪先验的即插即用图像修复框架，支持去噪、超分辨率和去马赛克等任务。

- **Stars:** ⭐️ 757
- **Tags:** `image-restoration` `denoising` `super-resolution` `deep-learning`
- **最后活动时间:** 2022-11-21

### [Generative-AI](https://github.com/fnzhan/Generative-AI)

TPAMI 2023发表的 multimodal 图像合成与编辑研究，涵盖扩散模型、GANs、NeRFs 等生成AI技术。

- **Stars:** ⭐️ 757
- **Tags:** `aigc` `diffusion-model` `gans` `multimodality` `nerfs`
- **最后活动时间:** 2023-11-21

### [FaceSwap](https://github.com/MarekKowalski/FaceSwap)

Python实现的3D人脸替换技术，支持高质量面部融合。

- **Stars:** ⭐️ 756
- **Tags:** `face-swap` `3d-face` `computer-vision` `deep-learning`
- **最后活动时间:** 2023-04-23

### [vietocr](https://github.com/pbcquoc/vietocr)

基于Transformer的OCR文字识别模型。

- **Stars:** ⭐️ 756
- **Tags:** `ocr` `transformer` `text-recognition`
- **最后活动时间:** 2025-01-19
...
结合去噪扩散与GAN解决生成学习三难问题的高效生成模型。

- **Stars:** ⭐️ 754
- **Tags:** `diffusion-gan` `denoising` `generative-model`
- **最后活动时间:** 2022-12-02

### [sketch_simplification](https://github.com/bobbens/sketch_simplification)

SIGGRAPH论文实现，使用深度学习将粗糙草图简化为清晰线条，适用于数字艺术创作。

- **Stars:** ⭐️ 752
- **Tags:** `sketch` `image-processing` `pytorch` `deep-learning` `siggraph`
- **最后活动时间:** 2022-01-13

### [vnet.pytorch](https://github.com/mattmacy/vnet.pytorch)

V-Net全卷积网络的PyTorch实现，用于3D医学图像体积分割。

- **Stars:** ⭐️ 751
- **Tags:** `vnet` `medical-segmentation` `3d-segmentation` `pytorch`
- **最后活动时间:** 2018-07-06

### [OpenSeeD](https://github.com/IDEA-Research/OpenSeeD)

ICCV 2023论文官方实现，开放词汇分割与检测的统一框架。

- **Stars:** ⭐️ 749
- **Tags:** `open-vocabulary` `segmentation` `object-detection` `iccv2023`
- **最后活动时间:** 2024-01-22

### [Paella](https://github.com/dome272/Paella)

高效图像生成模型的官方实现，提供新型扩散架构。

- **Stars:** ⭐️ 748
- **Tags:** `diffusion-models` `generative-model` `image-generation`
- **最后活动时间:** 2023-10-04

### [GenerativeModels](https://github.com/Project-MONAI/GenerativeModels)
...
ICLR 2020论文官方实现，视觉-语言预训练模型，用于通用视觉语言表示学习。

- **Stars:** ⭐️ 746
- **Tags:** `bert` `vision-language` `pre-training` `pytorch`
- **最后活动时间:** 2023-05-22

### [texturize](https://github.com/texturedesign/texturize)

基于深度学习的纹理合成工具，可从源图像生成逼真纹理变体，支持PBR材质生成。

- **Stars:** ⭐️ 745
- **Tags:** `deep-learning` `texture-generation` `image-processing` `generative-model`
- **最后活动时间:** 2023-04-09

### [taichi_3d_gaussian_splatting](https://github.com/wanmeihuali/taichi_3d_gaussian_splatting)

使用Taichi语言实现的3D高斯泼溅非官方版本，用于实时辐射场渲染。

- **Stars:** ⭐️ 744
- **Tags:** `3d-gaussian-splatting` `nerf` `3d-reconstruction` `real-time-rendering`
- **最后活动时间:** 2024-03-12
...
TensorFlow实现的SqueezeDet目标检测网络，专为自动驾驶场景设计的轻量级CNN。

- **Stars:** ⭐️ 743
- **Tags:** `object-detection` `autonomous-driving` `cnn` `tensorflow`
- **最后活动时间:** 2022-11-22

### [aster](https://github.com/bgshih/aster)

场景文本识别模型，专注于自然图像中裁剪文本的识别任务。

- **Stars:** ⭐️ 743
- **Tags:** `ocr` `scene-text` `computer-vision` `text-recognition`
- **最后活动时间:** 2023-03-25

### [PMRF](https://github.com/ohayonguy/PMRF)

ICLR 2025论文，基于后验均值校正流的图像修复方法，支持去噪、上色、修复等任务。

- **Stars:** ⭐️ 742
- **Tags:** `image-restoration` `flow-matching` `diffusion-models`
- **最后活动时间:** 2025-02-05

### [stable-diffusion-aesthetic-gradients](https://github.com/vicgalle/stable-diffusion-aesthetic-gradients)
...
### [RelativisticGAN](https://github.com/AlexiaJM/RelativisticGAN)

相对判别器GAN论文复现代码，改进标准GAN的判别器设计以提升生成质量。

- **Stars:** ⭐️ 741
- **Tags:** `gan` `relativistic-discriminator` `generative-model` `deep-learning`
- **最后活动时间:** 2020-03-12

### [InterHand2.6M](https://github.com/facebookresearch/InterHand2.6M)

ECCV 2020论文官方实现，提供大规模3D交互手部姿态估计数据集和基线模型，支持单张RGB图像的手部姿态预测。

- **Stars:** ⭐️ 741
- **Tags:** `pose-estimation` `computer-vision` `3d-hand` `pytorch`
- **最后活动时间:** 2024-07-10

### [OpenCV-Playing-Card-Detector](https://github.com/EdjeElectronics/OpenCV-Playing-Card-Detector)

基于树莓派和OpenCV的扑克牌识别系统，支持实时视频流检测。

- **Stars:** ⭐️ 738
- **Tags:** `card-detection` `opencv` `raspberry-pi` `computer-vision`
- **最后活动时间:** 2018-01-13

### [ClipBERT](https://github.com/jayleicn/ClipBERT)

CVPR 2021最佳学生论文提名，端到端图像文本和视频文本任务的高效学习框架。

- **Stars:** ⭐️ 730
- **Tags:** `Vision-Language` `Video QA` `Pre-training`
- **最后活动时间:** 2023-08-08

### [C-3-Framework](https://github.com/gjy3035/C-3-Framework)

开源人群计数PyTorch框架，支持密集场景分析与统计。

- **Stars:** ⭐️ 730
- **Tags:** `crowd-counting` `deep-learning` `computer-vision`
- **最后活动时间:** 2024-03-30
...
SparseFlex高分辨率任意拓扑3D形状建模方法。

- **Stars:** ⭐️ 728
- **Tags:** `3d-generation` `3d-reconstruction` `image-to-3d` `flexicubes`
- **最后活动时间:** 2025-04-07

### [DeepDeblur_release](https://github.com/SeungjunNah/DeepDeblur_release)

深度多尺度CNN动态场景去模糊模型，有效处理运动模糊和场景模糊问题。

- **Stars:** ⭐️ 726
- **Tags:** `deblurring` `image-restoration` `cnn` `computer-vision`
- **最后活动时间:** 2020-09-08

### [AtlasNet](https://github.com/ThibaultGROUEIX/AtlasNet)

CVPR 2018 论文实现，通过神经网络学习3D表面生成，可从低分辨率点云或图像合成网格模型。

- **Stars:** ⭐️ 724
- **Tags:** `3d-deep-learning` `computer-vision` `geometry-processing` `pytorch`
- **最后活动时间:** 2022-10-26
...
简洁完整的CLIP实现，集成多篇论文的实验性改进，支持零样本学习与多模态理解。

- **Stars:** ⭐️ 722
- **Tags:** `clip` `contrastive-learning` `zero-shot` `multi-modal`
- **最后活动时间:** 2023-10-16

### [OpenAI-CLIP](https://github.com/moein-shariatnia/OpenAI-CLIP)
...
### [PaddleMIX](https://github.com/PaddlePaddle/PaddleMIX)
...
ECCV 2020论文，从2D人体姿态恢复3D人体姿态和网格的图卷积网络。

- **Stars:** ⭐️ 719
- **Tags:** `3d-human-pose` `3d-mesh` `graph-convolution` `pose-estimation`
- **最后活动时间:** 2023-06-09

### [v-diffusion-pytorch](https://github.com/crowsonkb/v-diffusion-pytorch)

PyTorch实现的v目标扩散模型推理代码，用于图像生成。

- **Stars:** ⭐️ 719
- **Tags:** `diffusion` `pytorch` `image-generation`
- **最后活动时间:** 2022-11-29

### [Mask3D](https://github.com/JonasSchult/Mask3D)

在ScanNet、S3DIS等数据集上达到SOTA的3D语义实例分割模型。

- **Stars:** ⭐️ 718
- **Tags:** `3d-segmentation` `instance-segmentation` `pytorch`
- **最后活动时间:** 2023-10-29

### [TwinGAN](https://github.com/jerryli27/TwinGAN)

基于权重共享GAN的无配对跨域图像翻译模型。

- **Stars:** ⭐️ 718
- **Tags:** `image-translation` `gan` `cross-domain` `unsupervised`
- **最后活动时间:** 2022-11-22
...
ECCV 2024论文，基于人类指令的高质量图像修复模型，支持去噪、去模糊、去雾等多任务。

- **Stars:** ⭐️ 716
- **Tags:** `instruction-based` `image-restoration` `multimodal` `llm`
- **最后活动时间:** 2024-09-26

### [CycleGAN-tensorflow](https://github.com/xiaowei-hu/CycleGAN-tensorflow)

CycleGAN的TensorFlow实现，用于无配对数据的图像风格转换。

- **Stars:** ⭐️ 716
- **Tags:** `cyclegan` `image-translation` `tensorflow`
- **最后活动时间:** 2019-06-12

### [MIRNet](https://github.com/swz30/MIRNet)

ECCV 2020论文实现，通过多分辨率流和注意力机制实现图像去噪、超分辨率和增强的SOTA方法。

- **Stars:** ⭐️ 714
- **Tags:** `image-restoration` `denoising` `super-resolution` `attention-mechanism`
- **最后活动时间:** 2024-04-18

### [dcscn-super-resolution](https://github.com/jiny2001/dcscn-super-resolution)

基于深度CNN的快速精准单图像超分辨率重建模型TensorFlow实现。

- **Stars:** ⭐️ 714
- **Tags:** `super-resolution` `image-enhancement` `cnn`
- **最后活动时间:** 2023-04-06

### [StarGAN-Tensorflow](https://github.com/taki0112/StarGAN-Tensorflow)

StarGAN的TensorFlow实现，支持多域图像到图像转换，单一模型处理多种转换任务。

- **Stars:** ⭐️ 712
- **Tags:** `stargan` `image-translation` `tensorflow` `multi-domain`
- **最后活动时间:** 2019-07-16

### [UniK3D](https://github.com/lpiccinelli-eth/UniK3D)

CVPR 2025论文，通用相机单目3D估计与深度预测模型。

- **Stars:** ⭐️ 710
- **Tags:** `3d-estimation` `depth-estimation` `computer-vision`
- **最后活动时间:** 2025-09-14

### [DeepCAD](https://github.com/rundiwu/DeepCAD)

ICCV 2021 论文实现，深度生成网络用于计算机辅助设计模型的自动生成。

- **Stars:** ⭐️ 709
- **Tags:** `3d-generation` `cad` `deep-learning` `iccv2021`
- **最后活动时间:** 2024-04-12

### [GANSketching](https://github.com/PeterWang512/GANSketching)

通过手绘草图自定义GAN模型，实现个性化的图像生成。

- **Stars:** ⭐️ 709
- **Tags:** `gan` `sketch-to-image` `image-generation`
- **最后活动时间:** 2023-10-29

### [License-Plate-Recognition](https://github.com/wzh191920/License-Plate-Recognition)

基于Python和OpenCV的车牌识别系统，适用于智能交通场景。

- **Stars:** ⭐️ 706
- **Tags:** `license-plate-recognition` `opencv` `computer-vision`
- **最后活动时间:** 2021-01-18

### [DifFace](https://github.com/zsyOAOA/DifFace)

基于扩散模型的盲人脸修复技术，通过误差收缩机制实现高质量人脸图像恢复，发表于 TPAMI 2024。

- **Stars:** ⭐️ 706
- **Tags:** `face-restoration` `diffusion-model` `image-enhancement` `computer-vision`
- **最后活动时间:** 2025-01-25

### [stereo-transformer](https://github.com/mli0603/stereo-transformer)

ICCV 2021 Oral论文，从序列到序列视角重新审视立体深度估计问题。

- **Stars:** ⭐️ 706
- **Tags:** `stereo-depth` `depth-estimation` `transformer` `iccv`
- **最后活动时间:** 2023-08-17

### [image-restoration-sde](https://github.com/Algolzw/image-restoration-sde)
...
SSD目标检测PyTorch实现，包含RFBSSD、FSSD、RefineDet等变体。

- **Stars:** ⭐️ 704
- **Tags:** `ssd` `object-detection` `refinedet`
- **最后活动时间:** 2020-03-27

### [polyrnn-pp-pytorch](https://github.com/fidler-lab/polyrnn-pp-pytorch)

CVPR 2018 论文 Polygon-RNN++ 的 PyTorch 实现，用于图像实例分割和多边形标注。

- **Stars:** ⭐️ 702
- **Tags:** `Instance Segmentation` `Annotation` `PyTorch`
- **最后活动时间:** 2019-07-24
...
CVPR2024论文，通过绘制铬球实现免费的光照估计，为场景重建提供高质量光探针。

- **Stars:** ⭐️ 702
- **Tags:** `light-estimation` `image-relighting` `diffusion`
- **最后活动时间:** 2024-12-18
...
### [FMA-Net](https://github.com/KAIST-VICLab/FMA-Net)
...
CVPR 2023论文，轻量级CNN与Transformer架构用于自监督单目深度估计，适合资源受限场景。

- **Stars:** ⭐️ 700
- **Tags:** `depth-estimation` `self-supervised` `transformer` `cvpr2023`
- **最后活动时间:** 2023-12-11

### [ComfyUI-IF_AI_tools](https://github.com/if-ai/ComfyUI-IF_AI_tools)

ComfyUI自定义节点集，通过Ollama等本地LLM生成图像提示词，增强Stable Diffusion工作流。

- **Stars:** ⭐️ 699
- **Tags:** `ComfyUI` `Image Generation` `LLM`
- **最后活动时间:** 2025-09-15

### [MidJourney-Wrapper](https://github.com/Wildric-Auric/MidJourney-Wrapper)

MidJourney的Discord封装API，允许通过Python代码调用MidJourney进行AI图像生成。

- **Stars:** ⭐️ 699
- **Tags:** `MidJourney` `Image Generation` `API` `Discord`
- **最后活动时间:** 2023-06-16

### [vstar](https://github.com/penghao-wu/vstar)

V* 论文的 PyTorch 实现，探索引导式视觉搜索作为多模态大语言模型的核心机制。

- **Stars:** ⭐️ 699
- **Tags:** `visual-search` `multimodal-llm` `pytorch`
- **最后活动时间:** 2024-01-07

### [BeautyGAN](https://github.com/Honlan/BeautyGAN)

BeautyGAN实现，可将参考图像的妆容风格迁移到素颜人脸上。

- **Stars:** ⭐️ 698
- **Tags:** `makeup-transfer` `gan` `face-editing` `style-transfer`
- **最后活动时间:** 2019-07-15

### [MobileStyleGAN.pytorch](https://github.com/bes-dev/MobileStyleGAN.pytorch)

MobileStyleGAN官方PyTorch实现，支持移动端高效图像合成。

- **Stars:** ⭐️ 697
- **Tags:** `stylegan` `mobile` `image-synthesis` `pytorch`
- **最后活动时间:** 2022-04-27
...
结合扩散模型与GAN的训练方法，官方PyTorch实现。

- **Stars:** ⭐️ 696
- **Tags:** `diffusion-model` `gan` `generative-model` `pytorch`
- **最后活动时间:** 2023-03-27
...
### [Regional-Prompting-FLUX](https://github.com/instantX-research/Regional-Prompting-FLUX)

Diffusion Transformer的无训练区域提示方法，支持局部精确控制。

- **Stars:** ⭐️ 693
- **Tags:** `regional-prompting` `diffusion-transformer` `flux`
- **最后活动时间:** 2024-11-28

### [Pluralistic-Inpainting](https://github.com/lyndonzheng/Pluralistic-Inpainting)

CVPR 2019论文项目，实现多样化图像补全技术。基于GAN的方法，能够为图像缺失区域生成多种合理的补全结果。

- **Stars:** ⭐️ 693
- **Tags:** `image-inpainting` `generative-adversarial-networks` `computer-vision` `image-completion`
- **最后活动时间:** 2022-07-29

### [FaceSwap](https://github.com/hrastnik/FaceSwap)

基于OpenCV和dlib的实时人脸替换应用，支持视频流处理。

- **Stars:** ⭐️ 692
- **Tags:** `face-swap` `computer-vision` `opencv` `dlib` `real-time`
- **最后活动时间:** 2017-08-22

### [CartoonGAN-Test-Pytorch-Torch](https://github.com/Yijunmaverick/CartoonGAN-Test-Pytorch-Torch)

CartoonGAN的PyTorch测试实现，可将真实照片转换为卡通风格图像，支持多种艺术风格迁移。

- **Stars:** ⭐️ 691
- **Tags:** `gan` `cartoon-style` `style-transfer` `pytorch`
- **最后活动时间:** 2024-08-10

### [long_stable_diffusion](https://github.com/sharonzhou/long_stable_diffusion)

结合 GPT-3 与 Stable Diffusion 的长文本图像生成流水线，实现复杂场景的文本到图像转换。

- **Stars:** ⭐️ 689
- **Tags:** `stable-diffusion` `text-to-image` `gpt-3` `image-generation`
- **最后活动时间:** 2022-10-30

### [AttentionGAN](https://github.com/Ha0Tang/AttentionGAN)

基于注意力机制的GAN，用于非配对和多域图像到图像翻译。

- **Stars:** ⭐️ 688
- **Tags:** `attention-gan` `image-translation` `pytorch`
- **最后活动时间:** 2023-07-06

### [lightweight-human-pose-estimation-3d](https://github.com/Daniil-Osokin/lightweight-human-pose-estimation-3d-demo.pytorch)

轻量级实时3D多人姿态估计PyTorch实现，支持OpenVINO加速CPU推理。

- **Stars:** ⭐️ 685
- **Tags:** `pose-estimation` `3d-human-pose` `pytorch` `real-time`
- **最后活动时间:** 2023-11-25
...
ASTER场景文本识别的PyTorch实现，支持文本矫正与识别。

- **Stars:** ⭐️ 684
- **Tags:** `ocr` `scene-text` `pytorch` `text-recognition`
- **最后活动时间:** 2021-12-09

### [videoavatars](https://github.com/thmoa/videoavatars)

从视频重建3D人体模型的研究项目，支持动态人体建模与动画。

- **Stars:** ⭐️ 683
- **Tags:** `3d-human` `video-reconstruction` `avatar`
- **最后活动时间:** 2022-07-06

### [Facial-Expression-Recognition](https://github.com/xionghc/Facial-Expression-Recognition)

基于TensorFlow的面部表情识别系统，可在视频中检测人脸并识别情绪表情。

- **Stars:** ⭐️ 683
- **Tags:** `facial-expression` `emotion-recognition` `computer-vision` `tensorflow`
- **最后活动时间:** 2020-11-30

### [deep-image-retrieval](https://github.com/naver/deep-image-retrieval)

端到端深度视觉表示学习框架，用于图像检索任务。

- **Stars:** ⭐️ 680
- **Tags:** `image-retrieval` `computer-vision` `deep-learning`
- **最后活动时间:** 2021-05-19

### [swin2sr](https://github.com/mv-lab/swin2sr)

ECCV 2022论文，基于SwinV2 Transformer的压缩图像超分辨率与修复模型，支持去噪、去块效应等任务。

- **Stars:** ⭐️ 676
- **Tags:** `transformer` `super-resolution` `image-restoration` `swin`
- **最后活动时间:** 2024-08-19

### [photomosaic](https://github.com/worldveil/photomosaic)

使用机器学习和相似性搜索技术，从家庭照片创建有趣的马赛克图像、GIF和壁画。

- **Stars:** ⭐️ 676
- **Tags:** `photomosaic` `machine-learning` `similarity-search` `image-processing`
- **最后活动时间:** 2022-12-08

### [ComfyTextures](https://github.com/AlexanderDzhoganov/ComfyTextures)

Unreal Engine 与 ComfyUI 的集成工具，利用扩散模型实现游戏资产的自动纹理生成。

- **Stars:** ⭐️ 675
- **Tags:** `unreal-engine` `comfyui` `stable-diffusion` `texturing`
- **最后活动时间:** 2024-07-26

### [illustration2vec](https://github.com/rezoo/illustration2vec)

从插画中提取语义特征向量和标签估计的深度学习库。

- **Stars:** ⭐️ 675
- **Tags:** `feature-extraction` `illustration` `deep-learning`
- **最后活动时间:** 2019-01-18
...
YOLOv1目标检测实验性实现，包含训练和测试。

- **Stars:** ⭐️ 670
- **Tags:** `yolo` `object-detection` `yolov1`
- **最后活动时间:** 2019-04-19

### [mtcnn-pytorch](https://github.com/TropComplique/mtcnn-pytorch)

使用多任务级联卷积网络实现联合人脸检测与对齐的PyTorch实现，广泛应用于人脸识别系统。

- **Stars:** ⭐️ 669
- **Tags:** `face-detection` `pytorch` `cnn` `computer-vision`
- **最后活动时间:** 2021-06-27

### [cloth-segmentation](https://github.com/levindabhi/cloth-segmentation)

服装分割预训练模型与代码，基于U2Net实现时尚服饰图像解析。

- **Stars:** ⭐️ 669
- **Tags:** `cloth-segmentation` `fashion` `u2net` `image-parsing`
- **最后活动时间:** 2023-04-17

### [nowatermark](https://github.com/SixQuant/nowatermark)

基于图像修复技术的图片水印去除工具，使用OpenCV实现。

- **Stars:** ⭐️ 668
- **Tags:** `inpainting` `watermark-removal` `opencv` `image-processing`
- **最后活动时间:** 2017-11-01

### [facial-expression-recognition-using-cnn](https://github.com/ov2slam/ov2slam)

基于CNN的深度面部表情识别系统，支持从图像和摄像头实时识别多种面部表情。

- **Stars:** ⭐️ 667
- **Tags:** `cnn` `facial-expression-recognition` `deep-learning` `tensorflow` `opencv`
- **最后活动时间:** 2024-04-08
...
CVPR 2025论文官方实现，支持图像翻译、新视角合成与单视图重建。

- **Stars:** ⭐️ 665
- **Tags:** `diffusion-models` `novel-view-synthesis` `image-translation`
- **最后活动时间:** 2024-12-14

### [ddrm](https://github.com/bahjat-kawar/ddrm)

NeurIPS 2022官方代码，基于扩散模型实现去模糊、修复和超分辨率。

- **Stars:** ⭐️ 663
- **Tags:** `diffusion-models` `inpainting` `super-resolution`
- **最后活动时间:** 2022-10-10

### [neuralsim](https://github.com/PJLab-ADG/neuralsim)

基于3D神经渲染的表面重建与仿真框架，支持高质量三维场景重建。

- **Stars:** ⭐️ 662
- **Tags:** `3d-reconstruction` `neural-rendering` `computer-vision`
- **最后活动时间:** 2024-03-14
...
### [DerainZoo](https://github.com/abisee/cnn-dailymail)

图像去雨方法集合，包含论文、代码和数据集的完整资源。

- **Stars:** ⭐️ 662
- **Tags:** `deraining` `image-restoration` `computer-vision`
- **最后活动时间:** 2022-06-16
...
### [ml-projects](https://github.com/zaidalyafeai/ml-projects)

基于TensorFlow.js的网页友好型ML模型集合，包含pix2pix、人脸分割、快速风格迁移等多种实用模型。

- **Stars:** ⭐️ 660
- **Tags:** `tensorflowjs` `machine-learning` `image-processing` `style-transfer`
- **最后活动时间:** 2020-05-12

### [Cartoon-StyleGAN](https://github.com/happy-jihye/Cartoon-StyleGAN)

基于StyleGAN2的卡通人脸生成模型微调实现，适用于动漫角色创作。

- **Stars:** ⭐️ 660
- **Tags:** `stylegan2` `cartoon-generation` `gan` `anime`
- **最后活动时间:** 2021-10-16

### [FastGAN-pytorch](https://github.com/bingchenlll/FastGAN-pytorch)

ICLR 2021官方实现，专注于少样本高保真图像合成的快速稳定GAN训练方法。

- **Stars:** ⭐️ 659
- **Tags:** `gan` `few-shot` `image-synthesis` `pytorch`
- **最后活动时间:** 2024-03-11

### [ArcaneGAN](https://github.com/Sxela/ArcaneGAN)

将真人面部图像转换为《英雄联盟：双城之战》动画风格的GAN模型，实现高质量的艺术风格迁移。

- **Stars:** ⭐️ 659
- **Tags:** `gan` `style-transfer` `image-generation` `arcane`
- **最后活动时间:** 2024-08-30
...
多视角压缩编码方法，用于高效的3D重建与表示学习。

- **Stars:** ⭐️ 658
- **Tags:** `multiview` `compressive-coding` `3d-reconstruction` `representation-learning`
- **最后活动时间:** 2023-01-20

### [SEAN](https://github.com/ZPdesu/SEAN)

CVPR 2020 Oral论文，语义区域自适应归一化的图像合成方法。

- **Stars:** ⭐️ 658
- **Tags:** `sean` `gan` `semantic-synthesis` `image-generation`
- **最后活动时间:** 2021-06-02

### [flash-diffusion](https://github.com/gojasper/flash-diffusion)

AAAI 2025 Oral论文，加速任意条件扩散模型的少步图像生成。

- **Stars:** ⭐️ 657
- **Tags:** `diffusion-models` `distillation` `text-to-image`
- **最后活动时间:** 2025-03-11

### [unet.cu](https://github.com/clu0/unet.cu)

纯CUDA实现的UNet扩散模型，展示高性能图像生成的底层优化技术。

- **Stars:** ⭐️ 656
- **Tags:** `unet` `diffusion-model` `cuda` `image-generation`
- **最后活动时间:** 2024-06-28

### [SceneDreamer](https://github.com/FrozenBurning/SceneDreamer)

TPAMI 2023论文，从2D图像集合生成无界3D场景的生成模型。

- **Stars:** ⭐️ 655
- **Tags:** `3d` `generative-model` `neural-rendering` `scene-generation`
- **最后活动时间:** 2024-08-14
...
CVPR 2019 论文，使用生成对抗网络实现高保真3D人脸重建与纹理生成。

- **Stars:** ⭐️ 654
- **Tags:** `3d-face-reconstruction` `gan` `differentiable-rendering` `cvpr2019`
- **最后活动时间:** 2021-11-09
...
ICCV 2023论文，为随机扩散模型构建潜在空间，支持零样本学习。

- **Stars:** ⭐️ 652
- **Tags:** `diffusion-models` `image-synthesis` `zero-shot-learning`
- **最后活动时间:** 2023-12-31

### [DynamicViT](https://github.com/raoyongming/DynamicViT)

NeurIPS 2021/T-PAMI论文，通过动态Token稀疏化实现高效Vision Transformer。

- **Stars:** ⭐️ 652
- **Tags:** `vision-transformer` `efficient-inference` `deep-learning`
- **最后活动时间:** 2023-07-11

### [HiDT](https://github.com/advimman/HiDT)

CVPR2020口头论文，无监督高分辨率日间图像风格转换，无需域标签。

- **Stars:** ⭐️ 652
- **Tags:** `image-translation` `style-transfer` `gan` `unsupervised`
- **最后活动时间:** 2023-02-15

### [Invertible-Image-Rescaling](https://github.com/pkuxmq/Invertible-Image-Rescaling)

ECCV 2020/IJCV 2022论文实现，可逆图像缩放技术，实现高质量图像降采样与重建。

- **Stars:** ⭐️ 651
- **Tags:** `image-rescaling` `invertible-network` `pytorch`
- **最后活动时间:** 2023-04-06

### [3DMM-Fitting-Pytorch](https://github.com/ascust/3DMM-Fitting-Pytorch)

基于PyTorch的3D可变形人脸模型拟合框架。支持从单目视频进行3D人脸重建，集成Basel人脸模型。

- **Stars:** ⭐️ 651
- **Tags:** `3d-face-reconstruction` `3dmm` `face-alignment` `pytorch`
- **最后活动时间:** 2024-01-12

### [hart](https://github.com/mit-han-lab/hart)

混合自回归Transformer，实现高效的视觉生成。

- **Stars:** ⭐️ 651
- **Tags:** `autoregressive` `visual-generation` `hybrid-transformer`
- **最后活动时间:** 2024-10-16
...
### [SkyPaint-AI-Diffusion](https://github.com/SkyWorkAIGC/SkyPaint-AI-Diffusion)

基于Stable Diffusion优化的中文AI绘画模型，支持多种现代艺术风格生成。

- **Stars:** ⭐️ 649
- **Tags:** `stable-diffusion` `text-to-image` `chinese-model`
- **最后活动时间:** 2023-03-09

### [Woodpecker](https://github.com/VITA-MLLM/Woodpecker)

多模态大语言模型幻觉纠正框架，提升视觉语言模型可靠性。

- **Stars:** ⭐️ 649
- **Tags:** `hallucination` `multimodal` `mllm` `correction`
- **最后活动时间:** 2024-12-23

### [ComfyUI-Janus-Pro](https://github.com/CY-CHENYUE/ComfyUI-Janus-Pro)

ComfyUI节点扩展，集成Janus-Pro统一多模态理解与生成框架，支持图像生成和理解任务。

- **Stars:** ⭐️ 649
- **Tags:** `comfyui` `multimodal` `image-generation` `janus-pro`
- **最后活动时间:** 2025-01-30
...
### [MobilePose](https://github.com/YuliangXiu/MobilePose)

轻量级单人姿态估计模型，专为移动设备优化，支持实时推理。

- **Stars:** ⭐️ 646
- **Tags:** `Pose Estimation` `Deep Learning` `Mobile`
- **最后活动时间:** 2024-05-03

### [dress-code](https://github.com/aimagelab/dress-code)

ECCV 2022论文实现，高分辨率多类别虚拟试穿系统，支持服装图像生成与替换。

- **Stars:** ⭐️ 646
- **Tags:** `virtual-try-on` `computer-vision` `deep-learning` `generative-model`
- **最后活动时间:** 2024-12-12

### [Relightable3DGaussian](https://github.com/NJU-3DV/Relightable3DGaussian)

ECCV 2024论文，实现可重光照的3D高斯点云渲染，支持BRDF分解和光线追踪。

- **Stars:** ⭐️ 645
- **Tags:** `3d` `gaussian-splatting` `inverse-rendering` `neural-rendering`
- **最后活动时间:** 2024-08-14
...
### [paint-with-words-sd](https://github.com/cloneofsimo/paint-with-words-sd)

基于eDiff-I方法的文本标注分割图图像生成工具，实现精准区域控制。

- **Stars:** ⭐️ 644
- **Tags:** `stable-diffusion` `segmentation` `generative-ai`
- **最后活动时间:** 2023-03-24

### [FOTS.PyTorch](https://github.com/jiangxiluning/FOTS.PyTorch)

CVPR 2018论文FOTS的PyTorch实现，实现端到端场景文本检测与识别。

- **Stars:** ⭐️ 644
- **Tags:** `ocr` `scene-text` `pytorch` `cvpr2018`
- **最后活动时间:** 2023-02-14
...
ICLR 2024官方实现，SEED-LLaMA视觉语言基础模型。

- **Stars:** ⭐️ 642
- **Tags:** `foundation-model` `multimodal` `vision-language`
- **最后活动时间:** 2024-09-21

### [MeshTransformer](https://github.com/microsoft/MeshTransformer)

CVPR 2021论文研究代码，端到端人体姿态与网格重建Transformer，用于3D人体建模。

- **Stars:** ⭐️ 642
- **Tags:** `human-pose` `mesh-reconstruction` `transformer` `cvpr2021`
- **最后活动时间:** 2023-07-06

### [DiscoFaceGAN](https://github.com/microsoft/DiscoFaceGAN)

通过3D模仿对比学习实现解耦可控的人脸图像生成。CVPR 2020 Oral论文实现。

- **Stars:** ⭐️ 640
- **Tags:** `face-generation` `gan` `3d-learning`
- **最后活动时间:** 2022-07-04

### [EditGAN](https://github.com/nv-tlabs/editGAN_release)

基于GAN的高质量图像编辑模型，支持语义级别的图像操控，可精确修改图像属性同时保持真实感。

- **Stars:** ⭐️ 639
- **Tags:** `gan` `image-editing` `semantic-manipulation` `computer-vision`
- **最后活动时间:** 2024-11-11

### [CVPR2020-HAttMatting](https://github.com/yuhaoliu7456/CVPR2020-HAttMatting)

CVPR 2020论文，基于注意力引导的层次结构聚合图像抠图方法。

- **Stars:** ⭐️ 638
- **Tags:** `image-matting` `attention` `cvpr2020` `deep-learning`
- **最后活动时间:** 2023-12-09

### [Paddle3D](https://github.com/PaddlePaddle/Paddle3D)

基于飞桨的3D计算机视觉开发套件，支持点云目标检测、分割和单目3D检测，覆盖主流自动驾驶数据集。

- **Stars:** ⭐️ 638
- **Tags:** `3d-object-detection` `point-cloud` `autonomous-driving`
- **最后活动时间:** 2025-04-22

### [minRF](https://github.com/cloneofsimo/minRF)

基于SD3方法的可扩展整流流Transformer最小实现，用于生成式模型研究和学习。

- **Stars:** ⭐️ 636
- **Tags:** `rectified-flow` `diffusion` `transformer` `generative-model`
- **最后活动时间:** 2024-07-01

### [Real-ESRGAN](https://github.com/ai-forever/Real-ESRGAN)

实用真实世界图像超分辨率模型，广泛用于图像增强和放大，支持多种退化场景。

- **Stars:** ⭐️ 634
- **Tags:** `real-esrgan` `super-resolution` `image-enhancement` `pytorch`
- **最后活动时间:** 2024-04-15
...
### [deeplabv3plus-pytorch](https://github.com/YudeWang/deeplabv3plus-pytorch)

DeepLabV3+的PyTorch实现，支持ResNet和Xception骨干网络的语义分割模型。

- **Stars:** ⭐️ 632
- **Tags:** `semantic-segmentation` `deeplabv3` `pytorch` `computer-vision`
- **最后活动时间:** 2021-03-21

### [MICA](https://github.com/Zielon/MICA)

ECCV2022论文实现，用于人脸3D重建的度量学习方法，基于FLAME模型。

- **Stars:** ⭐️ 631
- **Tags:** `3D Reconstruction` `Computer Vision` `Face`
- **最后活动时间:** 2025-03-17

### [GRM](https://github.com/justimyhxu/GRM)

大型高斯重建模型，实现高效的3D重建与生成。

- **Stars:** ⭐️ 631
- **Tags:** `gaussian-reconstruction` `large-model` `3d-generation` `efficient`
- **最后活动时间:** 2024-04-04

### [we-drawing](https://github.com/liruifengv/we-drawing)
...
### [FSA-Net](https://github.com/shamangary/FSA-Net)

CVPR 2019论文实现，从单张图像进行精细头部姿态估计。

- **Stars:** ⭐️ 630
- **Tags:** `head-pose-estimation` `cvpr` `computer-vision` `keras`
- **最后活动时间:** 2022-12-08
...
### [blended-latent-diffusion](https://github.com/omriav/blended-latent-diffusion)

SIGGRAPH 2023官方实现，支持文本驱动的图像编辑与合成。

- **Stars:** ⭐️ 629
- **Tags:** `diffusion-models` `text-to-image` `image-editing`
- **最后活动时间:** 2024-06-04

### [mesh-gpt](https://github.com/nihalsid/mesh-gpt)

使用Decoder-Only Transformer生成三角网格模型，开创性的3D生成技术研究。

- **Stars:** ⭐️ 629
- **Tags:** `3d-generation` `transformer` `mesh` `deep-learning`
- **最后活动时间:** 2024-10-31

### [LiteFlowNet](https://github.com/twhui/LiteFlowNet)

CVPR 2018 Spotlight 论文，轻量级卷积神经网络用于光流估计。
...
高稳定性的GAN架构实现，无需复杂超参数调优即可生成高质量图像，PyTorch版本。

- **Stars:** ⭐️ 627
- **Tags:** `gan` `image-synthesis` `deep-learning` `generative-models`
- **最后活动时间:** 2022-06-17

### [magic-avatar](https://github.com/magic-research/magic-avatar)

MagicAvatar 多模态虚拟人生成与动画系统，支持多种输入模态驱动的角色生成。

- **Stars:** ⭐️ 626
- **Tags:** `avatar-generation` `multimodal` `animation`
- **最后活动时间:** 2023-08-29

### [Faster-RCNN-TensorFlow-Python3](https://github.com/dBeker/Faster-RCNN-TensorFlow-Python3)

TensorFlow实现的Faster R-CNN目标检测模型，支持Windows/Linux和Python 3。

- **Stars:** ⭐️ 625
- **Tags:** `faster-rcnn` `object-detection` `tensorflow` `python3`
- **最后活动时间:** 2025-09-15

### [Text2Light](https://github.com/FrozenBurning/Text2Light)

SIGGRAPH Asia 2022论文项目，零样本文本驱动的HDR全景图生成模型。

- **Stars:** ⭐️ 624
- **Tags:** `text-to-image` `hdr` `panorama` `generative-ai` `siggraph`
- **最后活动时间:** 2023-05-05

### [Deep-Image-Matting](https://github.com/Joker316701882/Deep-Image-Matting)

论文《Deep Image Matting》的TensorFlow实现，用于高质量图像抠图和前景提取。

- **Stars:** ⭐️ 624
- **Tags:** `computer-vision` `deep-learning` `image-matting`
- **最后活动时间:** 2018-09-21
...
### [cartoonize](https://github.com/experience-ml/cartoonize)

基于深度学习和GAN的图像视频卡通化Web应用，可将照片和视频转换为卡通风格。

- **Stars:** ⭐️ 623
- **Tags:** `deeplearning` `gans` `image-processing` `cartoonization` `webapp`
- **最后活动时间:** 2023-09-12

### [Glyph-ByT5](https://github.com/AIGText/Glyph-ByT5)

ECCV2024论文推理代码，实现精确的视觉文本渲染与多语言支持。

- **Stars:** ⭐️ 622
- **Tags:** `text-rendering` `multimodal` `eccv` `image-generation`
- **最后活动时间:** 2025-09-05

### [ControlLoRA](https://github.com/HighCWu/ControlLoRA)

轻量级神经网络模块，用于控制Stable Diffusion的空间信息生成。

- **Stars:** ⭐️ 621
- **Tags:** `stable-diffusion` `lora` `controlnet` `image-generation`
- **最后活动时间:** 2024-07-31

### [medpy](https://github.com/loli/medpy)

Python医学图像处理库，支持分割、分类、特征提取等机器学习任务。

- **Stars:** ⭐️ 620
- **Tags:** `medical-imaging` `image-segmentation` `machine-learning` `python`
- **最后活动时间:** 2024-09-03
...
### [RAG-Diffusion](https://github.com/NJU-PCALab/RAG-Diffusion)
...
深度学习超分辨率开山之作SRCNN的TensorFlow实现，首次将CNN应用于图像超分辨率。

- **Stars:** ⭐️ 617
- **Tags:** `srcnn` `super-resolution` `cnn` `tensorflow`
- **最后活动时间:** 2023-07-12

### [HIPT](https://github.com/mahmoodlab/HIPT)

CVPR 2022 Oral论文，层次化图像金字塔Transformer，用于计算病理学的高分辨率图像分析。

- **Stars:** ⭐️ 617
- **Tags:** `vision-transformer` `histopathology` `self-supervised-learning` `pytorch`
- **最后活动时间:** 2024-03-19

### [efficientdet](https://github.com/signatrix/efficientdet)

EfficientDet目标检测模型实现，提供预训练权重，高效且可扩展。

- **Stars:** ⭐️ 617
- **Tags:** `object-detection` `efficientdet` `computer-vision` `pytorch`
- **最后活动时间:** 2023-10-06

### [AttGAN-Tensorflow](https://github.com/LynnHo/AttGAN-Tensorflow)

面部属性编辑GAN，支持只修改想要改变的面部特征，发表于TIP 2019。

- **Stars:** ⭐️ 616
- **Tags:** `attgan` `face-editing` `gan` `tensorflow`
- **最后活动时间:** 2025-02-21

### [MIGC](https://github.com/limuloo/MIGC)

CVPR 2024 Highlight论文官方实现，专注于多实例图像生成控制，基于Stable Diffusion的高级生成技术。

- **Stars:** ⭐️ 615
- **Tags:** `aigc` `stable-diffusion` `text-to-image` `computer-vision`
- **最后活动时间:** 2025-05-15

### [panoptic-deeplab](https://github.com/bowenc0221/panoptic-deeplab)

CVPR 2020论文，简单高效的底部向上全景分割基线方法，基于PyTorch实现。

- **Stars:** ⭐️ 613
- **Tags:** `panoptic-segmentation` `semantic-segmentation` `deeplab` `pytorch`
- **最后活动时间:** 2023-06-23

### [TensorFlow-2.x-YOLOv3](https://github.com/pythonlessons/TensorFlow-2.x-YOLOv3)

TensorFlow 2.x实现的YOLOv3/v4目标检测框架，支持TensorRT加速和模型训练。

- **Stars:** ⭐️ 613
- **Tags:** `yolo` `object-detection` `tensorflow2` `tensorrt`
- **最后活动时间:** 2024-05-03

### [FUnIE-GAN](https://github.com/xahidbuffon/FUnIE-GAN)

RAL2020发表的水下图像增强GAN模型，专为水下机器人视觉感知优化设计。

- **Stars:** ⭐️ 612
- **Tags:** `image-enhancement` `underwater-images` `gan`
- **最后活动时间:** 2024-04-08

### [CIPS-3D](https://github.com/PeterouZh/CIPS-3D)

基于NeRF的3D感知GAN模型，实现高质量3D场景生成与渲染。

- **Stars:** ⭐️ 611
- **Tags:** `nerf` `3d-gan` `generative-model` `pytorch`
- **最后活动时间:** 2023-10-14

### [IRCNN](https://github.com/cszn/IRCNN)

CVPR 2017论文实现，基于深度CNN去噪先验的图像恢复方法。

- **Stars:** ⭐️ 611
- **Tags:** `image-restoration` `cnn` `computer-vision`
- **最后活动时间:** 2021-10-09

### [TransMorph_Transformer_for_Medical_Image_Registration](https://github.com/junyuchen245/TransMorph_Transformer_for_Medical_Image_Registration)

基于Transformer的无监督医学图像配准方法。适用于医学影像分析和处理。

- **Stars:** ⭐️ 610
- **Tags:** `image-registration` `medical-imaging` `transformer`
- **最后活动时间:** 2025-05-22

### [Deep_White_Balance](https://github.com/mahmoudnafifi/Deep_White_Balance)

CVPR 2020论文参考代码，基于深度学习的多任务白平衡编辑框架，实现高质量色彩校正。

- **Stars:** ⭐️ 609
- **Tags:** `White Balance` `Image Enhancement` `Deep Learning` `CVPR`
- **最后活动时间:** 2023-07-05
...
YOLOv4/v3目标检测扩展实现，支持TensorFlow、TFLite和TensorRT部署。

- **Stars:** ⭐️ 608
- **Tags:** `yolo` `object-detection` `tensorflow` `tensorrt` `tflite`
- **最后活动时间:** 2023-01-30

### [pytorch-inpainting-with-partial-conv](https://github.com/naoto0804/pytorch-inpainting-with-partial-conv)

ECCV2018论文的PyTorch实现，使用部分卷积进行不规则孔洞图像修复。有效处理图像中的缺失区域，生成自然连贯的填充结果。

- **Stars:** ⭐️ 608
- **Tags:** `inpainting` `partial-convolution` `image-restoration` `pytorch`
- **最后活动时间:** 2024-01-22

### [InstanceDiffusion](https://github.com/frank-xwang/InstanceDiffusion)

CVPR 2024论文实现，提供图像生成中的实例级控制能力。

- **Stars:** ⭐️ 607
- **Tags:** `Diffusion` `Instance Control` `CVPR2024`
- **最后活动时间:** 2025-06-17
...
赋能大语言模型理解和生成视觉内容的多模态框架，实现跨模态内容创作。

- **Stars:** ⭐️ 606
- **Tags:** `multimodal` `llm` `visual-generation` `vision-language`
- **最后活动时间:** 2024-10-06

### [mlsd](https://github.com/navervision/mlsd)

AAAI 2022论文官方实现，轻量级实时线段检测模型，适用于边缘设备。

- **Stars:** ⭐️ 606
- **Tags:** `line-segment-detection` `computer-vision` `tensorflow`
- **最后活动时间:** 2023-07-11

### [UnityMLStableDiffusion](https://github.com/keijiro/UnityMLStableDiffusion)

在Unity中运行Core ML Stable Diffusion，实现跨平台图像生成。

- **Stars:** ⭐️ 606
- **Tags:** `stable-diffusion` `unity` `coreml` `image-generation`
- **最后活动时间:** 2024-09-21

### [colorization-pytorch](https://github.com/richzhang/colorization-pytorch)

交互式深度图像着色方法的PyTorch复现，支持用户引导的黑白图像上色。

- **Stars:** ⭐️ 604
- **Tags:** `image-colorization` `deep-learning` `pytorch`
- **最后活动时间:** 2020-06-04

### [cosine_metric_learning](https://github.com/nwojke/cosine_metric_learning)

基于深度余弦度量学习的人员重识别方法实现。

- **Stars:** ⭐️ 604
- **Tags:** `metric-learning` `person-reid` `computer-vision`
- **最后活动时间:** 2022-06-15

### [pytorch-deeplab-resnet](https://github.com/isht7/pytorch-deeplab-resnet)

DeepLab ResNet v2语义分割模型的PyTorch实现。

- **Stars:** ⭐️ 603
- **Tags:** `deeplab` `semantic-segmentation` `pytorch`
- **最后活动时间:** 2023-09-05

### [wdsr_ntire2018](https://github.com/JiahuiYu/wdsr_ntire2018)

NTIRE 2018超分辨率挑战赛冠军方案，CVPR 2018，基于PyTorch的高效图像超分辨率网络。

- **Stars:** ⭐️ 602
- **Tags:** `Super Resolution` `Computer Vision` `PyTorch`
- **最后活动时间:** 2020-04-27

### [InsightFace-REST](https://github.com/SthPhoenix/InsightFace-REST)

基于TensorRT的人脸识别REST API服务，支持多种人脸检测和识别模型，提供Docker快速部署方案。

- **Stars:** ⭐️ 602
- **Tags:** `face-recognition` `tensorrt` `insightface` `onnx` `docker`
- **最后活动时间:** 2025-06-01

### [tokenize-anything](https://github.com/baaivision/tokenize-anything)

ECCV 2024论文实现，通过提示实现任意内容的统一标记化。

- **Stars:** ⭐️ 602
- **Tags:** `foundation-models` `multimodal` `promptable`
- **最后活动时间:** 2024-12-11

### [DeepFAS](https://github.com/ZitongYu/DeepFAS)

专注于人脸反欺骗的深度学习项目，用于检测人脸识别系统中的伪造攻击。

- **Stars:** ⭐️ 601
- **Tags:** `face-anti-spoofing` `deep-learning` `computer-vision` `face-recognition`
- **最后活动时间:** 2023-07-11

### [DiffIR](https://github.com/Zj-BinXia/DiffIR)

ICCV 2023论文，基于高效扩散模型的图像修复方法，支持去模糊、修复和超分辨率任务。

- **Stars:** ⭐️ 600
- **Tags:** `diffusion-model` `image-restoration` `super-resolution` `iccv2023`
- **最后活动时间:** 2024-08-25

### [deblur-gan](https://github.com/RaphaelMeudec/deblur-gan)

Keras实现的DeblurGAN，利用生成对抗网络实现盲运动去模糊，恢复清晰图像。

- **Stars:** ⭐️ 600
- **Tags:** `gan` `image-deblurring` `image-restoration` `keras`
- **最后活动时间:** 2022-11-22
...
- **Stars:** ⭐️ 599
- **Tags:** `text-to-image` `gan` `tensorflow` `generative-models`
- **最后活动时间:** 2021-01-22

### [tessdata_fast](https://github.com/tesseract-ocr/tessdata_fast)

Tesseract OCR的快速整数版LSTM训练模型，适用于生产环境的文字识别。

- **Stars:** ⭐️ 599
- **Tags:** `ocr` `tesseract` `lstm` `models`
- **最后活动时间:** 2024-08-01

### [gaussian_splatting_notes](https://github.com/kwea123/gaussian_splatting_notes)

3D高斯泼溅技术的详细公式解析文档，适合深入理解该前沿渲染技术。

- **Stars:** ⭐️ 598
- **Tags:** `gaussian-splatting` `cuda` `3d-rendering`
- **最后活动时间:** 2023-11-12

### [peinture](https://github.com/Amery2010/peinture)
...
紧凑的软阶段回归神经网络，用于年龄估计，发表于IJCAI 2018。

- **Stars:** ⭐️ 596
- **Tags:** `Age Estimation` `CNN` `Keras`
- **最后活动时间:** 2019-11-22

### [stable-diffusion-pytorch](https://github.com/kjsman/stable-diffusion-pytorch)

易于阅读的Stable Diffusion PyTorch实现，适合学习和理解扩散模型原理。

- **Stars:** ⭐️ 596
- **Tags:** `stable-diffusion` `diffusion-model` `image-generation` `pytorch`
- **最后活动时间:** 2024-03-04

### [SingleHDR](https://github.com/alex04072000/SingleHDR)

通过学习逆向相机管道实现单图像HDR重建。CVPR 2020论文实现。

- **Stars:** ⭐️ 595
- **Tags:** `hdr` `image-enhancement` `deep-learning`
- **最后活动时间:** 2021-12-11

### [MDT](https://github.com/sail-sg/MDT)

ICCV 2023 论文实现，掩码扩散Transformer在图像合成任务中达到SOTA性能。

- **Stars:** ⭐️ 594
- **Tags:** `diffusion-model` `image-synthesis` `transformer`
- **最后活动时间:** 2024-04-23

### [oneformer3d](https://github.com/filaPro/oneformer3d)

CVPR2024论文，统一点云分割的单一Transformer模型，支持多种3D分割任务。

- **Stars:** ⭐️ 593
- **Tags:** `3d-segmentation` `point-cloud` `transformer`
- **最后活动时间:** 2024-10-23

### [SAMed](https://github.com/hitachinsk/SAMed)

基于Segment Anything Model的医学图像分割定制化实现，适配医学影像场景。

- **Stars:** ⭐️ 593
- **Tags:** `segment-anything` `medical-imaging` `image-segmentation`
- **最后活动时间:** 2023-09-02

### [waifu2x-ios](https://github.com/imxieyi/waifu2x-ios)

基于 Core ML 的 iOS 端 waifu2x 图像超分辨率放大工具，专为动漫风格图片优化。

- **Stars:** ⭐️ 591
- **Tags:** `coreml` `ios` `image-upscaling` `waifu2x` `neural-network`
- **最后活动时间:** 2022-12-14

### [real-time-demo-app](https://github.com/fal-ai/real-time-demo-app)

基于fal.realtime和SDXL API的实时图像生成演示应用，展示低延迟AI图像生成能力。

- **Stars:** ⭐️ 590
- **Tags:** `ai` `sdxl` `real-time` `image-generation`
- **最后活动时间:** 2024-09-24

### [BrushEdit](https://github.com/TencentARC/BrushEdit)

一体化图像修复与编辑的官方实现，基于扩散模型。

- **Stars:** ⭐️ 589
- **Tags:** `diffusion-models` `image-editing` `image-inpainting`
- **最后活动时间:** 2025-09-03

### [semantic-draw](https://github.com/ironjr/semantic-draw)
...
### [R2CNN_Faster-RCNN_Tensorflow](https://github.com/DetectionTeamUCAS/R2CNN_Faster-RCNN_Tensorflow)

基于Faster-RCNN的旋转区域检测实现，适用于遥感图像、OCR等场景。

- **Stars:** ⭐️ 587
- **Tags:** `faster-rcnn` `object-detection` `remote-sensing` `tensorflow`
- **最后活动时间:** 2020-11-20

### [ChangeFormer](https://github.com/wgcban/ChangeFormer)

IGARSS 2022论文，基于Transformer的孪生网络用于遥感图像变化检测。

- **Stars:** ⭐️ 587
- **Tags:** `change-detection` `remote-sensing` `transformer` `siamese-network`
- **最后活动时间:** 2024-01-31

### [ml-matrix3d](https://github.com/apple/ml-matrix3d)

CVPR 2025 Highlight 论文项目，大型摄影测量一体化模型，支持3D重建与渲染。

- **Stars:** ⭐️ 587
- **Tags:** `3d-reconstruction` `photogrammetry` `computer-vision` `deep-learning`
- **最后活动时间:** 2025-07-15

### [aot-benchmark](https://github.com/yoxu515/aot-benchmark)
...
CVPR论文实现，深度与运动网络用于从视频中估计深度和相机运动。

- **Stars:** ⭐️ 586
- **Tags:** `depth-estimation` `structure-from-motion` `computer-vision` `research`
- **最后活动时间:** 2022-04-02

### [OCR-SAM](https://github.com/yeungchenwa/OCR-SAM)

结合MMOCR与Segment Anything、Stable Diffusion的开源项目，实现文本检测、识别、分割及文本擦除修复等功能。

- **Stars:** ⭐️ 586
- **Tags:** `ocr` `segment-anything` `stable-diffusion` `text-inpainting` `mmocr`
- **最后活动时间:** 2024-01-30

### [blended-diffusion](https://github.com/omriav/blended-diffusion)

CVPR 2022论文官方实现，基于文本驱动的自然图像编辑扩散模型，支持精准的图像局部修改。

- **Stars:** ⭐️ 585
- **Tags:** `diffusion` `text-to-image` `image-editing` `clip`
- **最后活动时间:** 2024-06-04

### [CCTV_YOLO](https://github.com/SanshruthR/CCTV_YOLO)

基于YOLO的实时目标检测系统，支持高分辨率输出和Gradio界面。

- **Stars:** ⭐️ 584
- **Tags:** `yolo` `object-detection` `realtime`
- **最后活动时间:** 2025-03-20
...
### [Groma](https://github.com/FoundationVision/Groma)

ECCV 2024论文，具备局部视觉定位能力的多模态大语言模型。

- **Stars:** ⭐️ 584
- **Tags:** `multimodal` `visual-grounding` `vision-language` `llm`
- **最后活动时间:** 2024-06-07

### [PyTorch-progressive_growing_of_gans](https://github.com/gapeng000/PyTorch-progressive_growing_of_gans)

渐进式GAN的PyTorch实现，提升生成质量和训练稳定性。

- **Stars:** ⭐️ 584
- **Tags:** `pggan` `gan` `progressive-training` `pytorch`
- **最后活动时间:** 2018-02-04

### [UniverSeg](https://github.com/JJGO/UniverSeg)

通用医学图像分割框架，支持跨任务的医学影像分割解决方案。

- **Stars:** ⭐️ 584
- **Tags:** `medical-imaging` `segmentation` `universal` `deep-learning`
- **最后活动时间:** 2023-07-15

### [Stable-Texturify](https://github.com/PrAYtele/Stable-Texturify)
...
基于神经网络的图像质量评估PyTorch实现，自动评分照片美学。
...
多尺度照片曝光校正项目，CVPR 2021论文，解决过曝和欠曝图像增强问题。

- **Stars:** ⭐️ 582
- **Tags:** `image-enhancement` `deep-learning` `computational-photography` `cvpr2021`
- **最后活动时间:** 2023-12-24

### [VITON](https://github.com/xthan/VITON)

基于图像的虚拟试穿网络，实现服装在人物图像上的逼真合成与替换。

- **Stars:** ⭐️ 582
- **Tags:** `virtual-try-on` `image-synthesis` `computer-vision`
- **最后活动时间:** 2023-04-26
...
EAST场景文本检测器的PyTorch实现，高效准确的任意方向文本检测。

- **Stars:** ⭐️ 580
- **Tags:** `ocr` `scene-text` `text-detection` `pytorch`
- **最后活动时间:** 2019-04-06

### [SCAN](https://github.com/kuanghuei/SCAN)

ECCV 2018论文实现：堆叠交叉注意力机制用于图文匹配，跨模态检索经典方法。

- **Stars:** ⭐️ 579
- **Tags:** `Cross Modal` `Image Text Matching` `PyTorch`
- **最后活动时间:** 2023-05-18

### [GenerativeImage2Text](https://github.com/microsoft/GenerativeImage2Text)

微软GIT模型，生成式图像到文本Transformer，实现视觉语言理解与生成。

- **Stars:** ⭐️ 579
- **Tags:** `image-to-text` `vision-language` `transformer`
- **最后活动时间:** 2023-12-02

### [GazeML](https://github.com/swook/GazeML)

基于TensorFlow的深度学习视线估计框架，用于眼部追踪和注意力检测应用。

- **Stars:** ⭐️ 579
- **Tags:** `gaze-estimation` `deep-learning` `tensorflow` `computer-vision`
- **最后活动时间:** 2024-10-26

### [Vitron](https://github.com/SkyworkAI/Vitron)

NeurIPS 2024论文实现，统一像素级视觉大模型，支持理解、生成、分割和编辑。

- **Stars:** ⭐️ 579
- **Tags:** `mllm` `vision-llm` `segmentation` `multimodal`
- **最后活动时间:** 2024-10-20

### [refacer](https://github.com/xaviviro/refacer)

一键深度伪造多换脸工具，基于ONNX Runtime实现。

- **Stars:** ⭐️ 578
- **Tags:** `ai` `deepfake` `face-swap` `onnx` `image-generation`
- **最后活动时间:** 2023-06-27

### [keras-facenet](https://github.com/nyoki-mtl/keras-facenet)

基于Keras的FaceNet人脸识别实现，支持人脸特征提取与相似度比对。

- **Stars:** ⭐️ 578
- **Tags:** `facenet` `face-recognition` `keras` `deep-learning`
- **最后活动时间:** 2018-11-28

### [ACG2vec](https://github.com/OysterQAQ/ACG2vec)

结合ACG与深度学习的综合平台，支持文本语义检索、以图搜图、图像超分辨率等功能。

- **Stars:** ⭐️ 576
- **Tags:** `deep-learning` `image-search` `embedding` `super-resolution`
- **最后活动时间:** 2024-02-20

### [GAN2Shape](https://github.com/XingangPan/GAN2Shape)

ICLR2021口头论文，利用GAN进行3D形状重建与逆图形学。

- **Stars:** ⭐️ 576
- **Tags:** `3d-reconstruction` `gan` `inverse-graphics` `shape-from-image`
- **最后活动时间:** 2023-07-04
...
CVPR 2018论文官方实现，深度反向投影网络，NTIRE2018和PIRM2018冠军方案。

- **Stars:** ⭐️ 575
- **Tags:** `super-resolution` `back-projection` `cvpr` `pytorch`
- **最后活动时间:** 2020-07-06

### [multiview-human-pose-estimation-pytorch](https://github.com/microsoft/multiview-human-pose-estimation-pytorch)

ICCV 2019官方PyTorch实现，跨视角融合的3D人体姿态估计。

- **Stars:** ⭐️ 575
- **Tags:** `3d-pose-estimation` `multi-view` `human-pose` `iccv2019`
- **最后活动时间:** 2024-08-30

### [PointSetGeneration](https://github.com/fanhqme/PointSetGeneration)

从单张图像生成3D点集的神经网络方法，开创点云生成重建方向。

- **Stars:** ⭐️ 571
- **Tags:** `point-cloud` `3d-reconstruction` `deep-learning`
- **最后活动时间:** 2017-10-17

### [metrabs](https://github.com/isarandi/metrabs)

从RGB图像估计绝对3D人体姿态的深度学习模型，支持多人场景。

- **Stars:** ⭐️ 570
- **Tags:** `3d-pose-estimation` `human-pose` `computer-vision` `tensorflow`
- **最后活动时间:** 2024-04-22
...
### [Awesome-Deep-Stereo-Matching](https://github.com/fabiotosi92/Awesome-Deep-Stereo-Matching)
...
BMVC 2022论文，仅需90K参数的轻量级Transformer，用于低光照图像增强和曝光校正。

- **Stars:** ⭐️ 568
- **Tags:** `low-light-enhancement` `image-enhancement` `transformer` `pytorch`
- **最后活动时间:** 2024-02-27

### [disco-diffusion-wrapper](https://github.com/mazzzystar/disco-diffusion-wrapper)

Disco Diffusion 的 GPU 本地运行封装工具，支持批量文本输入生成 AI 艺术图像。

- **Stars:** ⭐️ 567
- **Tags:** `disco-diffusion` `ai-art` `image-generation` `gpu`
- **最后活动时间:** 2024-03-02

### [Social-STGCNN](https://github.com/abduallahmohamed/Social-STGCNN)

基于社会时空图卷积神经网络的人体轨迹预测模型，发表于CVPR 2020。

- **Stars:** ⭐️ 566
- **Tags:** `Trajectory Prediction` `Graph CNN` `Computer Vision`
- **最后活动时间:** 2023-01-27

### [ESPCN](https://github.com/leftthomas/ESPCN)

实时图像和视频超分辨率重建的高效亚像素卷积神经网络PyTorch实现。

- **Stars:** ⭐️ 566
- **Tags:** `superresolution` `cnn` `pytorch` `image-processing`
- **最后活动时间:** 2019-11-04
...
CVPR 2018 论文《Residual Dense Network for Image Super-Resolution》的官方实现，用于图像超分辨率重建。

- **Stars:** ⭐️ 564
- **Tags:** `Super-Resolution` `Computer Vision` `Deep Learning`
- **最后活动时间:** 2022-08-29

### [3D-Box-Segment-Anything](https://github.com/JIA-Lab-research/3D-Box-Segment-Anything)

将Segment-Anything扩展到3D感知，结合VoxelNeXt实现自动驾驶场景的3D分割。

- **Stars:** ⭐️ 563
- **Tags:** `segment-anything` `3d-perception` `autonomous-driving`
- **最后活动时间:** 2023-04-18

### [GANet](https://github.com/feihuzhang/GANet)

GA-Net端到端立体匹配网络，使用引导聚合机制实现高精度深度估计。

- **Stars:** ⭐️ 562
- **Tags:** `stereo-matching` `depth-estimation` `computer-vision` `deep-learning`
- **最后活动时间:** 2020-04-15

### [Low-light-Image-Enhancement](https://github.com/pvnieo/Low-light-Image-Enhancement)

基于光照图估计的低光照图像增强技术Python实现，包含LIME和Retinex两种经典算法。

- **Stars:** ⭐️ 562
- **Tags:** `low-light-enhancement` `image-processing` `computer-vision` `retinex` `python`
- **最后活动时间:** 2022-08-18
...
PyTorch实现的3D UNet医学图像分割网络，适用于 volumetric 数据处理。

- **Stars:** ⭐️ 560
- **Tags:** `3d-unet` `medical-imaging` `segmentation` `pytorch`
- **最后活动时间:** 2021-05-26

### [Multi-Modality-Arena](https://github.com/OpenGVLab/Multi-Modality-Arena)

多模态模型竞技场，支持视觉语言模型并排对比评测，可输入图像进行基准测试，支持MiniGPT-4、LLaVA、BLIP-2等主流模型。

- **Stars:** ⭐️ 559
- **Tags:** `Multi-Modal` `VLM` `Benchmark` `Gradio`
- **最后活动时间:** 2024-04-21

### [DehazeFormer](https://github.com/IDKiro/DehazeFormer)

基于视觉Transformer的单图像去雾方法，有效恢复雾霾场景图像清晰度。

- **Stars:** ⭐️ 558
- **Tags:** `image-dehazing` `vision-transformer` `image-restoration`
- **最后活动时间:** 2024-08-18

### [deepcolor](https://github.com/kvfrans/deepcolor)

基于TensorFlow和cGAN的漫画线稿自动上色工具，实现智能填色与阴影渲染。

- **Stars:** ⭐️ 558
- **Tags:** `image-colorization` `gan` `manga` `tensorflow` `image-generation`
- **最后活动时间:** 2018-05-25

### [ComfyUI-ArtGallery](https://github.com/ZHO-ZHO-ZHO/ComfyUI-ArtGallery)

ComfyUI的提示词可视化艺术画廊插件，帮助用户浏览和管理Stable Diffusion生成的艺术作品。

- **Stars:** ⭐️ 558
- **Tags:** `comfyui` `stable-diffusion` `art` `prompt-visualization`
- **最后活动时间:** 2024-06-12
...
面向真实世界应用的多模态大模型，支持图像理解与生成。

- **Stars:** ⭐️ 557
- **Tags:** `multimodal` `foundation-model` `image-generation`
- **最后活动时间:** 2025-02-24

### [2txt](https://github.com/ai-ng/2txt)
...
高效的文本到图像模型预训练方案，优化扩散模型训练成本。

- **Stars:** ⭐️ 556
- **Tags:** `diffusion-models` `text-to-image` `efficiency`
- **最后活动时间:** 2024-04-06

### [Vehicle-Detection-and-Tracking](https://github.com/kcg2015/Vehicle-Detection-and-Tracking)

基于TensorFlow目标检测API和卡尔曼滤波的车辆检测与跟踪系统。

- **Stars:** ⭐️ 556
- **Tags:** `vehicle-detection` `object-tracking` `kalman-filter` `tensorflow`
- **最后活动时间:** 2020-05-23
...
MICCAI 2022发表的MLP架构医学图像分割网络，高效且轻量。

- **Stars:** ⭐️ 556
- **Tags:** `unext` `medical-segmentation` `mlp` `miccai`
- **最后活动时间:** 2023-09-09

### [Self-Attention-GAN-Tensorflow](https://github.com/taki0112/Self-Attention-GAN-Tensorflow)

自注意力GAN的TensorFlow实现，通过注意力机制捕捉图像长距离依赖关系。

- **Stars:** ⭐️ 554
- **Tags:** `self-attention` `gan` `tensorflow` `image-generation`
- **最后活动时间:** 2019-07-17

### [EfficientPS](https://github.com/DeepSceneSeg/EfficientPS)

高效全景分割PyTorch训练代码，实现语义分割与实例分割的统一框架。

- **Stars:** ⭐️ 554
- **Tags:** `panoptic-segmentation` `efficientps` `pytorch` `autonomous-driving`
- **最后活动时间:** 2022-11-09
...
轻量级实时人脸检测库，支持CPU端近实时推理。

- **Stars:** ⭐️ 552
- **Tags:** `face-detection` `computer-vision` `real-time`
- **最后活动时间:** 2019-12-22

### [SEAM](https://github.com/YudeWang/SEAM)

CVPR 2020口头报告论文，基于自监督等变注意力机制的弱监督语义分割方法。

- **Stars:** ⭐️ 551
- **Tags:** `semantic-segmentation` `weakly-supervised` `attention` `self-supervised`
- **最后活动时间:** 2023-07-06

### [StyleGAN_PyTorch](https://github.com/tomguluson92/StyleGAN_PyTorch)

StyleGAN的PyTorch实现版本，用于高质量图像生成。支持生成逼真的人脸、物体等图像。

- **Stars:** ⭐️ 551
- **Tags:** `stylegan` `generative-adversarial-network` `pytorch` `image-generation`
- **最后活动时间:** 2020-06-28

### [MVDream-threestudio](https://github.com/bytedance/MVDream-threestudio)

MVDream的3D生成代码实现，支持多视角扩散模型生成高质量3D内容。

- **Stars:** ⭐️ 550
- **Tags:** `3d-generation` `diffusion-models` `multiview`
- **最后活动时间:** 2024-05-13

### [OpenCV-Marker-less-AR](https://github.com/takmin/OpenCV-Marker-less-AR)

基于OpenCV的无标记增强现实应用，实现实时3D物体渲染和跟踪。

- **Stars:** ⭐️ 550
- **Tags:** `augmented-reality` `computer-vision` `opencv` `markerless-ar`
- **最后活动时间:** 2015-05-21

### [LaTeX_OCR](https://github.com/LinXueyuanStdio/LaTeX_OCR)

数学公式OCR识别工具，可将数学公式图像转换为LaTeX代码。

- **Stars:** ⭐️ 550
- **Tags:** `ocr` `latex` `deep-learning` `formula-recognition`
- **最后活动时间:** 2023-03-24

### [DeRaindrop](https://github.com/rui1996/DeRaindrop)

CVPR 2018论文实现：基于注意力GAN的单图像雨滴去除，低层视觉恢复任务。

- **Stars:** ⭐️ 547
- **Tags:** `Image Restoration` `GAN` `Computer Vision`
- **最后活动时间:** 2018-06-29

### [T2F](https://github.com/akanimax/T2F)

文本到人脸生成的深度学习项目，使用GAN技术实现从文本描述生成人脸图像。

- **Stars:** ⭐️ 547
- **Tags:** `text-to-image` `gan` `face-generation` `generative-adversarial-network`
- **最后活动时间:** 2022-05-14

### [meshed-memory-transformer](https://github.com/aimagelab/meshed-memory-transformer)

CVPR 2020论文实现，基于网格记忆Transformer的图像描述生成模型。

- **Stars:** ⭐️ 546
- **Tags:** `image-captioning` `transformer` `pytorch` `cvpr2020`
- **最后活动时间:** 2022-12-21
...
CVPR 2022论文，Mask Transfiner用于高质量实例分割，结合Transformer实现精细化分割效果。

- **Stars:** ⭐️ 546
- **Tags:** `instance-segmentation` `transformer` `computer-vision`
- **最后活动时间:** 2022-09-22

### [VQGAN-pytorch](https://github.com/dome272/VQGAN-pytorch)

VQGAN的PyTorch实现，结合Transformer实现高分辨率图像合成，广泛应用于图像生成领域。

- **Stars:** ⭐️ 545
- **Tags:** `vqgan` `image-synthesis` `transformer` `pytorch`
- **最后活动时间:** 2024-07-17

### [One-DM](https://github.com/dailenson/One-DM)
...
CVPR 2020口头报告论文，基于可微分框架的3D点云配准方法。

- **Stars:** ⭐️ 543
- **Tags:** `3d-registration` `point-cloud` `sparse-tensor` `deep-learning`
- **最后活动时间:** 2023-10-25
...
基于细胞神经网络的Python图像处理库，支持边缘检测、角点检测等图像处理任务。

- **Stars:** ⭐️ 542
- **Tags:** `neural-network` `image-processing` `computer-vision` `python`
- **最后活动时间:** 2018-11-01

### [neural-art-tf](https://github.com/woodrush/neural-art-tf)

基于TensorFlow的神经风格迁移实现，将艺术风格应用于图像创作。

- **Stars:** ⭐️ 542
- **Tags:** `neural-style-transfer` `tensorflow` `image-generation` `artistic-style`
- **最后活动时间:** 2015-12-05

### [TinySAM](https://github.com/xinghaochen/TinySAM)

AAAI 2025论文实现，高效轻量化的Segment Anything Model，显著降低计算成本。

- **Stars:** ⭐️ 542
- **Tags:** `sam` `segment-anything` `efficient-model` `image-segmentation`
- **最后活动时间:** 2025-01-19

### [hdrcnn](https://github.com/gabrieleilertsen/hdrcnn)

使用深度卷积神经网络从单次曝光重建HDR图像，实现高质量的高动态范围图像生成。

- **Stars:** ⭐️ 542
- **Tags:** `hdr` `cnn` `image-reconstruction` `deep-learning` `computer-vision`
- **最后活动时间:** 2022-10-28

### [SfM-Toy-Library](https://github.com/royshil/SfM-Toy-Library)

基于OpenCV的运动恢复结构(SfM)库，实现3D场景重建和相机位姿估计。

- **Stars:** ⭐️ 541
- **Tags:** `structure-from-motion` `3d-reconstruction` `computer-vision` `opencv`
- **最后活动时间:** 2017-12-23

### [StyleSwin](https://github.com/microsoft/StyleSwin)

CVPR 2022论文，基于Transformer的GAN模型，用于高分辨率图像生成。

- **Stars:** ⭐️ 540
- **Tags:** `image-generation` `transformer` `gans` `pytorch`
- **最后活动时间:** 2024-07-30
...
Progressive Growing of GANs的PyTorch非官方实现，用于高质量图像生成。

- **Stars:** ⭐️ 540
- **Tags:** `progressive-gan` `gan` `image-generation` `pytorch`
- **最后活动时间:** 2023-10-03

### [ResUnet](https://github.com/rishikksh20/ResUnet)

ResUnet和ResUnet++的PyTorch实现，用于医学图像和卫星图像的语义分割任务。

- **Stars:** ⭐️ 540
- **Tags:** `image-segmentation` `unet` `pytorch` `medical-imaging`
- **最后活动时间:** 2024-09-07
...
### [parti-pytorch](https://github.com/lucidrains/parti-pytorch)

Google Parti文本生成图像模型的PyTorch实现，基于纯注意力机制的Transformer架构。

- **Stars:** ⭐️ 537
- **Tags:** `text-to-image` `transformers` `attention-mechanism` `pytorch`
- **最后活动时间:** 2023-12-08

### [PVN3D](https://github.com/ethnhe/PVN3D)

CVPR 2020论文实现，基于深度点云关键点的6DoF姿态估计网络。

- **Stars:** ⭐️ 536
- **Tags:** `3d-vision` `pose-estimation` `point-cloud` `pytorch`
- **最后活动时间:** 2022-12-27
...
### [ic_gan](https://github.com/facebookresearch/ic_gan)

Instance-Conditioned GAN官方实现，用于生成多样化图像实例，支持条件生成任务。

- **Stars:** ⭐️ 536
- **Tags:** `gan` `image-generation` `conditional-gan` `deep-learning`
- **最后活动时间:** 2022-02-07
...
CVPR 2024 论文项目，利用大语言模型引导生成3D具身智能环境，支持文本到3D场景的自动化构建。

- **Stars:** ⭐️ 533
- **Tags:** `generative-ai` `text-to-3d` `embodied-ai` `unity`
- **最后活动时间:** 2025-04-02

### [CBDNet](https://github.com/GuoShi28/CBDNet)

CVPR 2019论文实现，真实照片卷积盲去噪网络。

- **Stars:** ⭐️ 532
- **Tags:** `image-denoising` `blind-denoising` `deep-learning` `cvpr2019`
- **最后活动时间:** 2021-12-13

### [mvpose](https://github.com/zju3dv/mvpose)

CVPR 2019/T-PAMI 2021论文，快速鲁棒的多视角多人3D姿态估计。

- **Stars:** ⭐️ 532
- **Tags:** `3d-pose-estimation` `multi-person` `multi-view` `cvpr2019`
- **最后活动时间:** 2021-07-30

### [VON](https://github.com/junyanz/VON)

NeurIPS 2018 论文实现，视觉对象网络通过解耦3D表示实现高质量图像生成，结合GAN技术生成逼真物体图像。

- **Stars:** ⭐️ 532
- **Tags:** `gans` `3d` `generative-adversarial-network` `shape-generation` `pytorch`
- **最后活动时间:** 2020-08-05
...
Keras实现的OCR系统，支持文字定位与识别，端到端光学字符识别。

- **Stars:** ⭐️ 532
- **Tags:** `ocr` `text-recognition` `keras` `deep-learning`
- **最后活动时间:** 2019-04-21

### [Stable-Hair](https://github.com/Xiaojiu-z/Stable-Hair)

AAAI 2025论文，基于扩散模型的真实世界发型迁移技术。

- **Stars:** ⭐️ 531
- **Tags:** `hair-transfer` `diffusion-model` `image-editing`
- **最后活动时间:** 2025-03-14

### [pytorch-MNIST-CelebA-cGAN-cDCGAN](https://github.com/znxlwm/pytorch-MNIST-CelebA-cGAN-cDCGAN)

PyTorch实现的条件生成对抗网络，支持MNIST和CelebA数据集的图像生成。

- **Stars:** ⭐️ 531
- **Tags:** `gan` `pytorch` `image-generation` `deep-learning`
- **最后活动时间:** 2017-08-22

### [FasterSeg](https://github.com/VITA-Group/FasterSeg)

ICLR 2020论文实现，神经架构搜索优化实时语义分割，兼顾速度与精度。

- **Stars:** ⭐️ 530
- **Tags:** `semantic-segmentation` `neural-architecture-search` `pytorch`
- **最后活动时间:** 2023-01-27

### [DeepPATH](https://github.com/ncoudray/DeepPATH)

基于深度学习的肺癌病理切片图像分类项目，应用于医学影像诊断领域。

- **Stars:** ⭐️ 530
- **Tags:** `deep-learning` `medical-imaging` `lung-cancer` `pathology` `classification`
- **最后活动时间:** 2024-09-24
...
AdvancedLivePortrait的Gradio Web界面，实现AI驱动的面部动画生成。

- **Stars:** ⭐️ 529
- **Tags:** `liveportrait` `facial-animation` `gradio` `deep-learning`
- **最后活动时间:** 2025-03-13
...
ICCV2023，双聚合Transformer用于图像超分辨率重建。

- **Stars:** ⭐️ 528
- **Tags:** `image-super-resolution` `transformer` `image-restoration`
- **最后活动时间:** 2024-11-26

### [StyleGANEX](https://github.com/williamyang1991/StyleGANEX)

ICCV 2023发表，基于StyleGAN的人脸编辑模型，支持非裁剪对齐人脸的操控。

- **Stars:** ⭐️ 528
- **Tags:** `stylegan` `face-editing` `image-manipulation`
- **最后活动时间:** 2023-09-19

### [FaceLift](https://github.com/weijielyu/FaceLift)
...
DRAW论文的TensorFlow实现，一种用于图像生成的循环神经网络。

- **Stars:** ⭐️ 527
- **Tags:** `tensorflow` `image-generation` `rnn` `generative-model`
- **最后活动时间:** 2018-08-07

### [FaceVerse](https://github.com/LizhenWangT/FaceVerse)

CVPR2022收录的精细可控3D人脸形变模型，支持高质量人脸重建与追踪。

- **Stars:** ⭐️ 527
- **Tags:** `3d-face` `face-reconstruction` `computer-vision` `cvpr`
- **最后活动时间:** 2024-12-19

### [swapping-autoencoder-pytorch](https://github.com/taesungp/swapping-autoencoder-pytorch)

用于深度图像编辑的交换自编码器，支持图像风格迁移与内容操控。NeurIPS 2020论文实现。

- **Stars:** ⭐️ 526
- **Tags:** `autoencoder` `image-manipulation` `pytorch`
- **最后活动时间:** 2022-06-14

### [break-a-scene](https://github.com/google/break-a-scene)

SIGGRAPH Asia 2023官方实现，从单张图像提取多个概念。

- **Stars:** ⭐️ 526
- **Tags:** `diffusion-models` `text-to-image` `concept-extraction`
- **最后活动时间:** 2024-01-14

### [OpenCE](https://github.com/baidut/OpenCE)

低光照图像增强技术集合，提升暗光环境下的图像质量。

- **Stars:** ⭐️ 525
- **Tags:** `low-light-enhancement` `image-processing` `contrast`
- **最后活动时间:** 2018-06-28
...
基于YOLOv5的安全帽与反光衣检测系统，适用于施工人员穿戴合规检测场景。

- **Stars:** ⭐️ 524
- **Tags:** `yolov5` `object-detection` `safety` `computer-vision`
- **最后活动时间:** 2021-07-02

### [handwritten-text-recognition-for-apache-mxnet](https://github.com/awslabs/handwritten-text-recognition-for-apache-mxnet)
...
AAAI 2025论文实现，提出U-KAN架构作为医学图像分割和生成的强大骨干网络。

- **Stars:** ⭐️ 523
- **Tags:** `Medical Imaging` `Segmentation` `AAAI2025`
- **最后活动时间:** 2025-06-23

### [sjc](https://github.com/pals-ttic/sjc)

CVPR 2023论文，利用预训练2D扩散模型实现3D生成。

- **Stars:** ⭐️ 523
- **Tags:** `diffusion-models` `3d-generation` `score-jacobian`
- **最后活动时间:** 2024-03-13

### [PaintTransformer](https://github.com/Huage001/PaintTransformer)

ICCV 2021论文非官方实现，基于笔画预测的前馈神经绘画方法。

- **Stars:** ⭐️ 523
- **Tags:** `neural-painting` `stroke-prediction` `image-generation`
- **最后活动时间:** 2023-04-11
...
### [PAIR-Diffusion](https://github.com/Picsart-AI-Research/PAIR-Diffusion)

CVPR 2024 论文，全面的多模态对象级图像编辑器，支持精细的图像操控。

- **Stars:** ⭐️ 522
- **Tags:** `image-editing` `diffusion` `multimodal` `cvpr2024`
- **最后活动时间:** 2024-04-02

### [AOT-GAN-for-Inpainting](https://github.com/researchmm/AOT-GAN-for-Inpainting)

TVCG'2023发表的高分辨率图像修复GAN模型，支持多尺度处理，适用于图像编辑和修复任务。

- **Stars:** ⭐️ 522
- **Tags:** `image-inpainting` `gan` `high-resolution`
- **最后活动时间:** 2024-05-08

### [SCube](https://github.com/nv-tlabs/SCube)
...
### [pacnet](https://github.com/NVlabs/pacnet)

CVPR 2019论文实现，像素自适应卷积神经网络用于图像处理和计算机视觉任务。

- **Stars:** ⭐️ 518
- **Tags:** `pixel-adaptive-convolution` `computer-vision` `cvpr` `deep-learning`
- **最后活动时间:** 2022-12-12
...
### [deep-generative-prior](https://github.com/XingangPan/deep-generative-prior)

ECCV2020口头论文，深度生成先验用于图像修复与操控。

- **Stars:** ⭐️ 517
- **Tags:** `generative-prior` `image-restoration` `gan` `deep-learning`
- **最后活动时间:** 2023-07-04

### [SSGAN-Tensorflow](https://github.com/clvrai/SSGAN-Tensorflow)

半监督学习生成对抗网络的TensorFlow实现，基于NIPS 2016论文改进的GAN训练技术。

- **Stars:** ⭐️ 517
- **Tags:** `gan` `semi-supervised-learning` `tensorflow`
- **最后活动时间:** 2019-03-05

### [Segmentation-Pytorch](https://github.com/Deeachain/Segmentation-Pytorch)

PyTorch语义分割框架，集成FCN、UNet、DeepLab、PSPNet等多种主流网络架构。

- **Stars:** ⭐️ 517
- **Tags:** `semantic-segmentation` `pytorch` `deep-learning` `unet` `deeplab`
- **最后活动时间:** 2023-07-23
...
Information Fusion期刊论文实现，利用预训练视觉Transformer提升图像抠图性能。

- **Stars:** ⭐️ 516
- **Tags:** `image-matting` `vision-transformer` `computer-vision` `deep-learning`
- **最后活动时间:** 2025-08-13
...
### [DiffiT](https://github.com/NVlabs/DiffiT)
...
### [Phased-Consistency-Model](https://github.com/G-U-N/Phased-Consistency-Model)

NeurIPS 2024论文，提升一致性模型性能的高效采样方案。

- **Stars:** ⭐️ 514
- **Tags:** `consistency-models` `diffusion-models` `few-step-generation`
- **最后活动时间:** 2024-12-11
...
ICCV 2021论文，灵活的盲JPEG伪影去除模型，支持图像修复与增强。

- **Stars:** ⭐️ 514
- **Tags:** `image-restoration` `jpeg-artifacts-removal` `image-denoising` `pytorch`
- **最后活动时间:** 2024-04-19

### [INSTA](https://github.com/Zielon/INSTA)

CVPR2023论文实现，实时体积化头部头像生成系统。

- **Stars:** ⭐️ 514
- **Tags:** `avatars` `nerf` `3dmm` `volumetric-rendering` `cuda`
- **最后活动时间:** 2025-08-03

### [aura-sr](https://github.com/fal-ai/aura-sr)

基于 GAN 的真实世界图像超分辨率模型。适用于图像增强和修复场景。

- **Stars:** ⭐️ 514
- **Tags:** `super-resolution` `gan` `image-enhancement`
- **最后活动时间:** 2024-11-13

### [YOLOMagic](https://github.com/WangQvQ/YOLOMagic)

基于YOLOv5的视觉任务扩展工具，提供更强大的功能和简化的操作界面。

- **Stars:** ⭐️ 513
- **Tags:** `yolo` `object-detection` `computer-vision` `gradio`
- **最后活动时间:** 2024-04-25

### [glow-pytorch](https://github.com/chaiyujin/glow-pytorch)

OpenAI Glow论文的PyTorch实现，用于可逆1×1卷积的生成流模型。

- **Stars:** ⭐️ 513
- **Tags:** `pytorch` `generative-model` `glow` `flow-based`
- **最后活动时间:** 2019-04-25

### [TP-GAN](https://github.com/HRLTY/TP-GAN)

人脸正面视图合成GAN模型，保持身份特征的同时生成逼真的正面人脸图像。

- **Stars:** ⭐️ 512
- **Tags:** `face-synthesis` `generative-adversarial-network` `face-recognition`
- **最后活动时间:** 2022-04-22

### [DeepAlignmentNetwork](https://github.com/MarekKowalski/DeepAlignmentNetwork)

CVPR 2017论文实现，用于人脸关键点检测和对齐的深度神经网络。

- **Stars:** ⭐️ 511
- **Tags:** `face-alignment` `computer-vision` `deep-learning` `cvpr`
- **最后活动时间:** 2023-04-23

### [XPretrain](https://github.com/microsoft/XPretrain)
...
基于VGGFace2数据集的PyTorch人脸识别模型，支持跨姿态和年龄的人脸识别。

- **Stars:** ⭐️ 510
- **Tags:** `face-recognition` `pytorch` `vggface2` `computer-vision`
- **最后活动时间:** 2018-06-17

### [BigGAN-pytorch](https://github.com/sxhxliang/BigGAN-pytorch)

大规模GAN训练的PyTorch实现，用于高保真自然图像合成。

- **Stars:** ⭐️ 508
- **Tags:** `biggan` `gan` `high-fidelity` `pytorch`
- **最后活动时间:** 2019-02-23

### [DiffMorpher](https://github.com/Kevin-thu/DiffMorpher)

CVPR 2024官方代码，利用扩散模型实现高质量图像变形。

- **Stars:** ⭐️ 506
- **Tags:** `diffusion-models` `image-morphing` `image-editing`
- **最后活动时间:** 2024-04-24

### [all-seeing](https://github.com/OpenGVLab/all-seeing)

ICLR 2024 & ECCV 2024论文，实现开放世界全景视觉识别与通用关系理解。

- **Stars:** ⭐️ 506
- **Tags:** `vision-language` `panoptic-segmentation` `multimodal`
- **最后活动时间:** 2024-08-09

### [posenet-python](https://github.com/rwightman/posenet-python)

Google TensorFlow.js PoseNet的Python移植版，实现实时人体姿态估计。

- **Stars:** ⭐️ 506
- **Tags:** `pose-estimation` `computer-vision` `tensorflow` `real-time`
- **最后活动时间:** 2022-09-02

### [RSN](https://github.com/caiyuanhao1998/RSN)

ECCV 2020 Spotlight，COCO 2019人体关键点检测冠军，多人姿态估计模型。

- **Stars:** ⭐️ 505
- **Tags:** `pose-estimation` `keypoint-detection` `coco-winner` `eccv2020`
- **最后活动时间:** 2025-10-10
...
### [MultiModal-DeepFake](https://github.com/rshaojimmy/MultiModal-DeepFake)

TPAMI 2024 & CVPR 2023 论文代码，用于检测和定位多模态媒体篡改的 DGM4 框架。

- **Stars:** ⭐️ 505
- **Tags:** `deepfake-detection` `multimodal` `media-manipulation`
- **最后活动时间:** 2024-04-23

### [BlendGAN](https://github.com/onion-liu/BlendGAN)

NeurIPS 2021官方实现，隐式GAN混合实现任意风格化人脸生成。

- **Stars:** ⭐️ 505
- **Tags:** `style-transfer` `face-generation` `gan` `neurips2021`
- **最后活动时间:** 2022-09-29

### [ReVersion](https://github.com/ziqihuangg/ReVersion)

SIGGRAPH Asia 2024论文，基于扩散模型的关系反转技术，从图像学习并生成特定关系。

- **Stars:** ⭐️ 504
- **Tags:** `aigc` `diffusion-model` `stable-diffusion` `image-generation`
- **最后活动时间:** 2025-10-07

### [alias-free-gan-pytorch](https://github.com/rosinality/alias-free-gan-pytorch)

Alias-Free GAN 的 PyTorch 非官方实现，解决生成对抗网络中的混叠问题。提升生成图像质量和训练稳定性。

- **Stars:** ⭐️ 504
- **Tags:** `alias-free-gan` `gan` `stylegan2` `pytorch`
- **最后活动时间:** 2022-01-20

### [PITI](https://github.com/PITI-Synthesis/PITI)

图像到图像翻译的预训练模型，实现高质量的风格转换与图像生成。

- **Stars:** ⭐️ 502
- **Tags:** `image-to-image-translation` `pretraining` `image-synthesis`
- **最后活动时间:** 2024-06-02

### [face-nn](https://github.com/huailiang/face-nn)

基于神经风格迁移的游戏捏脸系统，生成逼真的游戏角色人脸。

- **Stars:** ⭐️ 502
- **Tags:** `neural-style-transfer` `face-generation` `game-engine` `unity` `cnn`
- **最后活动时间:** 2019-11-28

### [PIDM](https://github.com/ankanbhunia/PIDM)
...
实时AI换脸工具，支持PC直播和视频通话中的实时人脸替换。

- **Stars:** ⭐️ 30.7k
- **Tags:** `Deepfake` `Face Swap` `Real-time`
- **最后活动时间:** 2024-11-08
...
高质量实时动漫视频超分辨率放大器，基于卷积神经网络实现视频画质增强与降噪。

- **Stars:** ⭐️ 20.8k
- **Tags:** `super-resolution` `neural-networks` `video-upscaling` `anime`
- **最后活动时间:** 2024-08-17
...
高性能视频抠图模型，支持PyTorch、TensorFlow、ONNX、CoreML等多框架部署，适用于实时视频背景替换。

- **Stars:** ⭐️ 9.3k
- **Tags:** `Video-Matting` `Computer-Vision` `Deep-Learning`
- **最后活动时间:** 2024-04-02

### [vid2vid](https://github.com/NVIDIA/vid2vid)

NVIDIA高分辨率视频到视频翻译框架，支持逼真视频生成。

- **Stars:** ⭐️ 8.7k
- **Tags:** `video-generation` `gan` `pytorch`
- **最后活动时间:** 2022-05-17
...
实时高精度多人姿态估计与跟踪系统，支持全身关键点检测。

- **Stars:** ⭐️ 8.5k
- **Tags:** `pose-estimation` `pytorch` `realtime`
- **最后活动时间:** 2024-05-13
...
大型世界模型，支持百万级上下文的文本与视频建模。

- **Stars:** ⭐️ 7.4k
- **Tags:** `world-model` `video-understanding` `long-context`
- **最后活动时间:** 2024-10-19
...
SIGGRAPH项目，时序一致性GAN用于视频超分辨率增强。

- **Stars:** ⭐️ 6.1k
- **Tags:** `video-super-resolution` `gan` `temporal-coherence`
- **最后活动时间:** 2023-08-17

### [MoneyPrinterPlus](https://github.com/ddean2009/MoneyPrinterPlus)

AI驱动的短视频一键批量生成工具，支持ChatTTS、Stable Diffusion等多种AI模型，可自动发布到抖音、快手等平台。

- **Stars:** ⭐️ 5.9k
- **Tags:** `Video Generation` `AI Automation` `Content Creation`
- **最后活动时间:** 2025-03-07
...
基于Stable Diffusion的唇形同步项目，实现高质量视频人物口型与音频精准对齐。

- **Stars:** ⭐️ 5.5k
- **Tags:** `diffusion-models` `lipsync` `video-generation` `virtual-avatars`
- **最后活动时间:** 2025-06-20
...
ECCV2022论文实现，实时视频帧插值算法，可生成高质量慢动作效果。

- **Stars:** ⭐️ 5.4k
- **Tags:** `video-interpolation` `computer-vision` `deep-learning`
- **最后活动时间:** 2025-09-10
...
CVPR'24 Highlight项目，基于内容变形场实现时间一致的视频处理，支持视频编辑与特效迁移。

- **Stars:** ⭐️ 4.9k
- **Tags:** `video-processing` `neural-fields` `computer-vision` `deep-learning`
- **最后活动时间:** 2024-04-07
...
ICCV 2023论文，实现图像扩散模型的一次性微调用于文本到视频生成。

- **Stars:** ⭐️ 4.4k
- **Tags:** `text-to-video` `diffusion-models` `video-generation` `iccv2023`
- **最后活动时间:** 2023-10-25

### [Text2Video-Zero](https://github.com/Picsart-AI-Research/Text2Video-Zero)

ICCV 2023 Oral论文，证明文本到图像扩散模型可作为零样本视频生成器。

- **Stars:** ⭐️ 4.2k
- **Tags:** `text-to-video` `zero-shot` `video-generation` `diffusion`
- **最后活动时间:** 2023-05-06

### [motion-diffusion-model](https://github.com/GuyTevet/motion-diffusion-model)

人体运动扩散模型的官方PyTorch实现，用于生成人体动作序列。

- **Stars:** ⭐️ 3.9k
- **Tags:** `motion-generation` `diffusion-model` `pytorch` `human-motion`
- **最后活动时间:** 2025-10-01
...
CVPR 2022论文实现，基于薄板样条运动模型的图像动画生成工具。

- **Stars:** ⭐️ 3.6k
- **Tags:** `image-animation` `deepfake` `face-animation` `motion-transfer`
- **最后活动时间:** 2024-02-10
...
### [agentheroes](https://github.com/agentheroes/agentheroes)
...
万代南梦宫研究所发布的高质量动作捕捉数据集，适用于动画和机器人研究。

- **Stars:** ⭐️ 3.3k
- **Tags:** `dataset` `motion-capture` `animation` `robotics`
- **最后活动时间:** 2023-07-04
...
NeurIPS 2025 Spotlight论文官方代码，实现自回归视频扩散模型的训练与推理统一。

- **Stars:** ⭐️ 3.3k
- **Tags:** `video-diffusion` `autoregressive` `video-generation`
- **最后活动时间:** 2025-09-12
...
ICLR 2025论文实现，通过金字塔流匹配实现高效视频生成建模。

- **Stars:** ⭐️ 3.2k
- **Tags:** `video-generation` `diffusion-models` `flow-matching`
- **最后活动时间:** 2024-12-21

### [VIBE](https://github.com/mkocabas/VIBE)

CVPR2020论文实现，从视频推断人体姿态和形状估计，支持SMPL模型。

- **Stars:** ⭐️ 3.2k
- **Tags:** `3d-human-pose` `human-pose-estimation` `smpl` `pytorch`
- **最后活动时间:** 2023-03-24
...
OpenMMLab人体姿态估计与骨架动作识别工具箱，支持动作合成。

- **Stars:** ⭐️ 3.1k
- **Tags:** `action-recognition` `pose-estimation` `skeleton-based` `pytorch`
- **最后活动时间:** 2022-11-25

### [Super-SloMo](https://github.com/avinashpaliwal/Super-SloMo)

PyTorch实现的视频帧插值模型，可将普通视频转换为高帧率慢动作效果。

- **Stars:** ⭐️ 3.0k
- **Tags:** `video-interpolation` `slow-motion` `deep-learning` `pytorch`
- **最后活动时间:** 2023-03-09

### [deep_sort_pytorch](https://github.com/ZQPei/deep_sort_pytorch)

基于DeepSort和YOLOv3的多目标跟踪PyTorch实现，支持实时跟踪。

- **Stars:** ⭐️ 3.0k
- **Tags:** `deep-sort` `object-tracking` `mot` `yolov3` `pytorch`
- **最后活动时间:** 2024-07-16

### [Rerender_A_Video](https://github.com/williamyang1991/Rerender_A_Video)

SIGGRAPH Asia 2023论文，实现零样本文本引导的视频到视频翻译与风格转换。

- **Stars:** ⭐️ 3.0k
- **Tags:** `video-processing` `controlnet` `diffusion`
- **最后活动时间:** 2024-03-09

### [InternLM-XComposer](https://github.com/InternLM/InternLM-XComposer)

支持长时流媒体视频音频交互的综合多模态系统，视觉语言大模型。

- **Stars:** ⭐️ 2.9k
- **Tags:** `Multimodal` `Vision-Language` `Video` `LLM`
- **最后活动时间:** 2025-05-26

### [goku](https://github.com/Saiyan-World/goku)

CVPR 2025 Highlight，高质量视频生成基础模型。

- **Stars:** ⭐️ 2.9k
- **Tags:** `video-generation` `foundation-model` `diffusion`
- **最后活动时间:** 2025-02-19

### [MuseV](https://github.com/TMElyralab/MuseV)

无限长度高保真虚拟人视频生成模型，采用视觉条件并行去噪技术实现高质量视频合成。

- **Stars:** ⭐️ 2.8k
- **Tags:** `Video Generation` `Diffusion` `Virtual Human`
- **最后活动时间:** 2024-06-28
...
基于边界框的视频物体移除工具，支持自动视频修复。

- **Stars:** ⭐️ 2.7k
- **Tags:** `video-inpainting` `object-removal` `pytorch`
- **最后活动时间:** 2019-09-27

### [GeneFace](https://github.com/yerfor/GeneFace)

ICLR 2023官方代码，实现高保真3D说话人脸合成。

- **Stars:** ⭐️ 2.7k
- **Tags:** `talking-face` `nerf` `3d-synthesis` `pytorch`
- **最后活动时间:** 2024-10-18
...
开源的Sora网页客户端，让用户能够轻松使用OpenAI的Sora模型从文本生成视频。

- **Stars:** ⭐️ 2.4k
- **Tags:** `openai` `sora` `text-to-video` `webui`
- **最后活动时间:** 2024-08-04
...
### [Deep-Flow-Guided-Video-Inpainting](https://github.com/nbei/Deep-Flow-Guided-Video-Inpainting)

CVPR 2019论文PyTorch实现，基于光流的深度视频修复。

- **Stars:** ⭐️ 2.4k
- **Tags:** `video-inpainting` `optical-flow` `cvpr`
- **最后活动时间:** 2022-12-08

### [V-Express](https://github.com/tencent-ailab/V-Express)

基于参考图像、音频和V-Kps序列生成说话人头像视频的AI模型，支持可控的表情同步。

- **Stars:** ⭐️ 2.4k
- **Tags:** `talking-head` `video-generation` `deep-learning` `face-animation`
- **最后活动时间:** 2025-01-24

### [EasyAnimate](https://github.com/aigc-apps/EasyAnimate)

基于Transformer Diffusion的高分辨率长视频生成端到端解决方案。

- **Stars:** ⭐️ 2.3k
- **Tags:** `video-generation` `diffusion-transformer` `high-resolution`
- **最后活动时间:** 2025-03-06
...
### [story-flicks](https://github.com/alecm20/story-flicks)

使用AI大模型一键生成高清故事短视频，支持自动化视频创作流程。

- **Stars:** ⭐️ 2.2k
- **Tags:** `ai-video` `video-generation` `story-generation` `python`
- **最后活动时间:** 2025-03-12
...
视频天空替换与和谐化的神经网络方法，实现动态天空背景生成。

- **Stars:** ⭐️ 2.0k
- **Tags:** `sky-replacement` `video-editing` `neural-rendering` `pytorch`
- **最后活动时间:** 2022-08-04

### [make-a-video-pytorch](https://github.com/lucidrains/make-a-video-pytorch)

Meta AI文本生成视频模型的PyTorch实现，支持高质量视频生成。

- **Stars:** ⭐️ 2.0k
- **Tags:** `text-to-video` `diffusion-models` `video-generation` `pytorch`
- **最后活动时间:** 2024-05-03
...
ECCV 2022论文，基于记忆模型的长时视频目标分割方法。

- **Stars:** ⭐️ 2.0k
- **Tags:** `video-segmentation` `object-segmentation` `memory-model` `computer-vision`
- **最后活动时间:** 2024-11-15
...
基于3D架构的跨音频-视觉唇语识别深度学习项目。

- **Stars:** ⭐️ 1.9k
- **Tags:** `lip-reading` `audio-visual` `speech-recognition` `3d-cnn`
- **最后活动时间:** 2022-11-07

### [MotionGPT](https://github.com/OpenMotionLab/MotionGPT)

NeurIPS 2023论文，将人体运动视为外语的统一运动-语言生成模型。

- **Stars:** ⭐️ 1.9k
- **Tags:** `motion-generation` `multimodal` `llm` `text-to-motion`
- **最后活动时间:** 2025-07-01
...
基于PyTorch的视频动作理解工具箱，支持动作识别、检测和定位任务。

- **Stars:** ⭐️ 1.9k
- **Tags:** `action-recognition` `video-understanding` `pytorch` `computer-vision`
- **最后活动时间:** 2022-04-08

### [TimeSformer](https://github.com/facebookresearch/TimeSformer)

Facebook官方视频理解Transformer模型，通过时空注意力机制实现视频理解，CVPR 2021论文官方实现。

- **Stars:** ⭐️ 1.8k
- **Tags:** `video-understanding` `transformer` `attention` `pytorch`
- **最后活动时间:** 2024-04-09

### [kinetics-i3d](https://github.com/google-deepmind/kinetics-i3d)

基于Kinetics数据集训练的视频分类卷积神经网络模型，用于动作识别和视频理解任务。

- **Stars:** ⭐️ 1.8k
- **Tags:** `video-classification` `i3d` `action-recognition` `cnn` `kinetics`
- **最后活动时间:** 2019-09-12
...
CVPR 2025 Highlight，为超长视频提供一致的深度估计，支持单目视频深度预测。

- **Stars:** ⭐️ 1.8k
- **Tags:** `depth-estimation` `video-depth` `transformer` `cvpr2025`
- **最后活动时间:** 2025-10-07

### [GeneFacePlusPlus](https://github.com/yerfor/GeneFacePlusPlus)

 generalized and stable real-time 3D talking face generation system using NeRF technology, capable of producing high-quality lip-synced facial animations.

- **Stars:** ⭐️ 1.8k
- **Tags:** `NeRF` `Talking Face` `3D Generation`
- **最后活动时间:** 2024-10-18
...
NVIDIA研究的少样本逼真视频到视频翻译PyTorch实现，支持高质量视频生成。

- **Stars:** ⭐️ 1.8k
- **Tags:** `video-translation` `few-shot` `generative-model` `nvidia`
- **最后活动时间:** 2021-10-27
...
ICCV2025论文实现，为Diffusion Transformer提供高效灵活的控制方案，支持多种条件生成。

- **Stars:** ⭐️ 1.7k
- **Tags:** `diffusion-transformer` `controllable-generation` `video-generation`
- **最后活动时间:** 2025-07-25
...
SIGGRAPH 2020论文库，用于3D角色运动的深度学习编辑和渲染。

- **Stars:** ⭐️ 1.7k
- **Tags:** `motion-editing` `deep-learning` `computer-graphics` `animation`
- **最后活动时间:** 2024-07-12
...
CVPR2024论文，专注于说话人头像合成中的同步问题，实现高质量的音频驱动人脸生成。

- **Stars:** ⭐️ 1.6k
- **Tags:** `talking-head` `audio-driven` `face-generation`
- **最后活动时间:** 2025-09-18

### [SiamTrackers](https://github.com/HonglinChu/SiamTrackers)

基于深度学习的视觉目标跟踪算法集合，包含SiamFC、SiamRPN、SiamMask等多种Siamese跟踪器。

- **Stars:** ⭐️ 1.6k
- **Tags:** `object-tracking` `siamese-network` `visual-tracking` `deep-learning`
- **最后活动时间:** 2023-10-26
...
CVPR2021官方代码，混合分析-神经逆运动学方案用于3D人体姿态估计。

- **Stars:** ⭐️ 1.6k
- **Tags:** `3d-pose-estimation` `human-pose` `pytorch`
- **最后活动时间:** 2025-01-08

### [EDVR](https://github.com/xinntao/EDVR)

CVPR19获奖视频修复方案，基于增强可变形卷积网络的视频恢复与增强技术。

- **Stars:** ⭐️ 1.6k
- **Tags:** `video-restoration` `deep-learning` `pytorch` `computer-vision` `deformable-convolution`
- **最后活动时间:** 2021-08-09

### [FGVC](https://github.com/vt-vl-lab/FGVC)

流边缘引导的视频补全方法，支持视频物体移除和帧插值。ECCV 2020论文实现。

- **Stars:** ⭐️ 1.6k
- **Tags:** `video-completion` `video-inpainting` `optical-flow`
- **最后活动时间:** 2021-12-14
...
文本到视频合成的Colab笔记本集合，方便快速体验T2V模型。

- **Stars:** ⭐️ 1.5k
- **Tags:** `text-to-video` `colab` `video-synthesis` `t2v`
- **最后活动时间:** 2024-03-28

### [ROMP](https://github.com/Arthur151/ROMP)

单阶段多人3D姿态估计系统，支持相机和全局坐标系下的3D人体网格恢复。ICCV/CVPR论文实现。

- **Stars:** ⭐️ 1.5k
- **Tags:** `pose-estimation` `3d-mesh-recovery` `smpl`
- **最后活动时间:** 2024-11-14

### [Phantom](https://github.com/Phantom-video/Phantom)

通过跨模态对齐实现主体一致性的视频生成模型。

- **Stars:** ⭐️ 1.5k
- **Tags:** `text-to-video` `video-generation` `aigc`
- **最后活动时间:** 2025-09-11

### [Tracking-Anything-with-DEVA](https://github.com/hkchengrex/Tracking-Anything-with-DEVA)

ICCV 2023发表的解耦视频分割方法，支持任意物体追踪。适用于视频编辑和目标分割场景。

- **Stars:** ⭐️ 1.5k
- **Tags:** `video-segmentation` `object-tracking` `deep-learning` `iccv2023`
- **最后活动时间:** 2025-04-26
...
### [STAR](https://github.com/NJU-PCALab/STAR)

利用文本到视频模型进行现实世界视频超分辨率增强的算法。

- **Stars:** ⭐️ 1.5k
- **Tags:** `video-super-resolution` `text-to-video` `enhancement`
- **最后活动时间:** 2025-07-02
...
CVPR 2024论文，面向真实世界视频超分辨率的时序一致性扩散模型。

- **Stars:** ⭐️ 1.5k
- **Tags:** `video-super-resolution` `diffusion-model` `aigc-enhancement`
- **最后活动时间:** 2024-09-27
...
ICCV 2023论文，基于扩散模型的文本驱动视频编辑方法，实现一致性感知的视频生成与编辑。

- **Stars:** ⭐️ 1.4k
- **Tags:** `video-editing` `diffusion-model` `controlnet` `aigc`
- **最后活动时间:** 2023-09-07
...
Jonathan Ho视频扩散模型PyTorch实现，将DDPM扩展至视频生成领域。

- **Stars:** ⭐️ 1.4k
- **Tags:** `video-diffusion` `video-generation` `ddpm`
- **最后活动时间:** 2024-05-03

### [hallo3](https://github.com/fudan-generative-vision/hallo3)

CVPR2025，基于视频Diffusion Transformer的高动态真实人像动画生成。

- **Stars:** ⭐️ 1.4k
- **Tags:** `portrait-animation` `video-diffusion` `image-animation`
- **最后活动时间:** 2025-03-13
...
AAAI 2024论文官方实现，基于无姿态视频进行姿态引导的文本到视频生成。

- **Stars:** ⭐️ 1.4k
- **Tags:** `text-to-video` `pose-guided` `video-generation` `aaai2024`
- **最后活动时间:** 2024-03-20

### [MagicTime](https://github.com/PKU-YuanGroup/MagicTime)
...
### [sd-webui-text2video](https://github.com/kabachuha/sd-webui-text2video)

Stable Diffusion WebUI扩展，支持ModelScope和VideoCrafter等文本生成视频扩散模型，无需额外依赖即可运行。

- **Stars:** ⭐️ 1.3k
- **Tags:** `Text2Video` `Stable Diffusion` `Extension`
- **最后活动时间:** 2024-07-14
...
基于CNN的自动2D转3D视频转换工具，可将普通2D视频自动生成为3D立体视频。

- **Stars:** ⭐️ 1.3k
- **Tags:** `cnn` `3d-video` `video-conversion` `deep-learning`
- **最后活动时间:** 2016-05-04

### [minisora](https://github.com/mini-sora/minisora)

探索Sora实现路径与未来发展方向的开源社区项目，专注于视频生成技术。

- **Stars:** ⭐️ 1.3k
- **Tags:** `sora` `video-generation` `diffusion`
- **最后活动时间:** 2025-02-18

### [ml-neuman](https://github.com/apple/ml-neuman)

从单视频重建神经人体辐射场，ECCV 2022论文官方实现。

- **Stars:** ⭐️ 1.3k
- **Tags:** `neural-radiance-field` `human-rendering` `computer-vision`
- **最后活动时间:** 2023-05-23

### [articulated-animation](https://github.com/snap-research/articulated-animation)

基于运动表示的关节动画生成论文实现，可从单张图片生成动画视频。支持人体运动迁移和视频合成。

- **Stars:** ⭐️ 1.3k
- **Tags:** `image-animation` `video-generation` `deep-learning` `motion-transfer`
- **最后活动时间:** 2025-06-01
...
### [momask-codes](https://github.com/EricGuo5513/momask-codes)

CVPR 2024论文官方实现，基于掩码建模的3D人体动作生成模型。

- **Stars:** ⭐️ 1.3k
- **Tags:** `motion-generation` `text-to-motion` `3d-generation`
- **最后活动时间:** 2024-09-13

### [voca](https://github.com/TimoBolkart/voca)

根据语音信号合成逼真的3D角色面部动画模型。

- **Stars:** ⭐️ 1.3k
- **Tags:** `3d-animation` `speech-driven` `tensorflow`
- **最后活动时间:** 2024-08-20
...
CVPR 2024 论文，使用可变形3D高斯实现高保真单目动态场景重建。

- **Stars:** ⭐️ 1.2k
- **Tags:** `dynamic-scene` `gaussian-splatting` `monocular` `cvpr2024`
- **最后活动时间:** 2024-06-25
...
CVPR 2022最佳学生论文，端到端概率PnP单目物体姿态估计。6DoF姿态估计突破性工作。

- **Stars:** ⭐️ 1.2k
- **Tags:** `pose-estimation` `6dof` `monocular`
- **最后活动时间:** 2025-05-01

### [WLASL](https://github.com/dxli94/WLASL)

WACV 2020论文，大规模手语识别数据集与方法对比，支持词级视频手语识别。

- **Stars:** ⭐️ 1.2k
- **Tags:** `sign-language` `video-recognition` `dataset`
- **最后活动时间:** 2023-03-18

### [Yolov5-Deepsort](https://github.com/Sharpiless/Yolov5-Deepsort)

YOLOv5结合DeepSORT实现目标检测与追踪，支持自定义数据集训练。

- **Stars:** ⭐️ 1.2k
- **Tags:** `object-detection` `object-tracking` `yolov5`
- **最后活动时间:** 2022-10-06

### [Show-1](https://github.com/showlab/Show-1)

结合像素与潜在扩散模型的文本到视频生成研究项目。
...
基于YOLOv8和DeepSORT的目标追踪系统，支持目标计数和速度估计。

- **Stars:** ⭐️ 1.1k
- **Tags:** `yolov8` `deep-sort` `object-tracking` `opencv`
- **最后活动时间:** 2023-03-04

### [pose-tensorflow](https://github.com/eldar/pose-tensorflow)

基于TensorFlow框架的人体姿态估计系统，用于人体关键点检测。

- **Stars:** ⭐️ 1.1k
- **Tags:** `pose-estimation` `tensorflow` `computer-vision` `deep-learning`
- **最后活动时间:** 2019-12-07

### [video-classification-3d-cnn-pytorch](https://github.com/kenshohara/video-classification-3d-cnn-pytorch)

使用3D ResNet进行视频分类和动作识别的工具集。

- **Stars:** ⭐️ 1.1k
- **Tags:** `video-classification` `action-recognition` `3d-cnn`
- **最后活动时间:** 2018-11-23

### [Allegro](https://github.com/rhymes-ai/Allegro)

强大的文本到视频生成模型，支持生成分辨率达720p的高质量视频。

- **Stars:** ⭐️ 1.1k
- **Tags:** `text-to-video` `video-generation` `diffusion`
- **最后活动时间:** 2025-02-07

### [VideoLLaMA3](https://github.com/DAMO-NLP-SG/VideoLLaMA3)

前沿多模态基础模型，专注于图像和视频理解任务，支持多种视觉输入的高效处理。

- **Stars:** ⭐️ 1.1k
- **Tags:** `Multimodal` `Video Understanding` `Foundation Model`
- **最后活动时间:** 2025-08-14
...
多摄像头实时目标追踪系统，集成YOLO v4、Deep SORT和Flask，支持人流和车流统计。

- **Stars:** ⭐️ 1.1k
- **Tags:** `object-tracking` `yolo` `deep-sort` `opencv` `real-time`
- **最后活动时间:** 2021-12-19

### [DisCo](https://github.com/Wangt-CN/DisCo)

CVPR2024论文，真实场景下的参考人体舞蹈生成，基于ControlNet实现高质量动作迁移。

- **Stars:** ⭐️ 1.1k
- **Tags:** `human-generation` `dance-generation` `controlnet`
- **最后活动时间:** 2024-07-22
...
基于MCP协议的短视频自动生成工具，支持TikTok、Instagram Reels和YouTube Shorts平台的内容创作。

- **Stars:** ⭐️ 1.0k
- **Tags:** `video-generation` `mcp` `tiktok` `shorts` `automation`
- **最后活动时间:** 2025-06-21

### [sam-pt](https://github.com/SysCV/sam-pt)

扩展SAM至零样本视频分割，结合点追踪技术实现视频目标分割。

- **Stars:** ⭐️ 1.0k
- **Tags:** `segment-anything` `video-segmentation` `zero-shot` `point-tracking`
- **最后活动时间:** 2024-01-27

### [talking-head-anime-3-demo](https://github.com/pkhungurn/talking-head-anime-3-demo)

从单张图像生成会说话的动漫角色动画，支持头部和身体动作的AI驱动动画生成。

- **Stars:** ⭐️ 1.0k
- **Tags:** `computer-vision` `machine-learning` `pytorch` `animation`
- **最后活动时间:** 2023-08-29

### [Cutie](https://github.com/hkchengrex/Cutie)

CVPR2024 Highlight论文，将目标重新引入视频目标分割，实现高质量视频分割效果。

- **Stars:** ⭐️ 1.0k
- **Tags:** `video-object-segmentation` `video-editing` `segmentation`
- **最后活动时间:** 2024-11-08

### [CLIP4Clip](https://github.com/ArrowLuo/CLIP4Clip)

基于CLIP的端到端视频片段检索官方实现，支持多数据集。

- **Stars:** ⭐️ 1.0k
- **Tags:** `clip` `video-retrieval` `multimodal`
- **最后活动时间:** 2024-04-12

### [sepconv-slomo](https://github.com/sniklaus/sepconv-slomo)

基于PyTorch的视频帧插值实现，使用自适应可分离卷积实现视频慢动作效果。

- **Stars:** ⭐️ 1.0k
- **Tags:** `video-interpolation` `pytorch` `deep-learning` `cuda`
- **最后活动时间:** 2025-05-26

### [handcrafted-persona-engine](https://github.com/fagenorn/handcrafted-persona-engine)
...
基于RIFE神经网络的实时视频插帧工具，使用ncnn推理框架实现GPU加速的视频帧插值。

- **Stars:** ⭐️ 1.0k
- **Tags:** `video-interpolation` `rife` `ncnn` `vulkan` `gpu`
- **最后活动时间:** 2024-01-02

### [WarpFusion](https://github.com/Sxela/WarpFusion)

基于Stable Diffusion的AI视频生成工具，支持图生图、文生视频、视频转视频等功能。

- **Stars:** ⭐️ 1.0k
- **Tags:** `Stable Diffusion` `Video Generation` `Img2Img` `AI Art`
- **最后活动时间:** 2025-04-27

### [Min_Max_Similarity](https://github.com/AngeLouCN/Min_Max_Similarity)

基于对比学习的半监督医学图像分割网络，适用于手术工具视频分割。

- **Stars:** ⭐️ 1.0k
- **Tags:** `contrastive-learning` `semi-supervised` `medical-segmentation` `video-segmentation`
- **最后活动时间:** 2023-06-23

### [CVPR2022-DaGAN](https://github.com/harlanhong/CVPR2022-DaGAN)

CVPR2022论文官方实现：基于深度感知GAN的说话人头像视频生成，实现高质量面部重演与动作迁移。

- **Stars:** ⭐️ 997
- **Tags:** `GAN` `Video Generation` `Face Reenactment` `Talking Head`
- **最后活动时间:** 2023-12-04

### [magvit](https://github.com/google-research/magvit)

MAGVIT官方JAX实现，基于掩码生成视频Transformer的视频生成模型。

- **Stars:** ⭐️ 995
- **Tags:** `video-generation` `masked-transformer` `jax` `generative-model`
- **最后活动时间:** 2024-01-17
...
ICLR 2024论文，短视频到长视频扩散模型，支持生成过渡和预测。

- **Stars:** ⭐️ 969
- **Tags:** `video-generation` `diffusion-model` `stable-diffusion`
- **最后活动时间:** 2024-11-13
...
### [Talking-Face_PC-AVS](https://github.com/Hangz-nju-cuhk/Talking-Face_PC-AVS)

CVPR 2021论文实现，通过隐式模块化音视频表示实现姿态可控的说话人脸生成。

- **Stars:** ⭐️ 960
- **Tags:** `talking-face` `audio-visual` `video-generation` `deepfake`
- **最后活动时间:** 2024-01-06

### [brainrot.js](https://github.com/noahgsolomon/brainrot.js)
...
### [autoclip_mvp](https://github.com/zhouxiaoka/autoclip_mvp)

AI驱动的智能视频剪辑工具，自动提取高光片段，适合二创内容制作。

- **Stars:** ⭐️ 945
- **Tags:** `ai-video-editing` `auto-highlight` `video-editing`
- **最后活动时间:** 2025-09-15

### [Zooming-Slow-Mo-CVPR-2020](https://github.com/Mukosame/Zooming-Slow-Mo-CVPR-2020)

CVPR 2020论文，实现快速准确的单阶段时空视频超分辨率。

- **Stars:** ⭐️ 934
- **Tags:** `video-super-resolution` `cvpr2020` `pytorch` `video-processing`
- **最后活动时间:** 2021-09-05

### [Vchitect-2.0](https://github.com/Vchitect/Vchitect-2.0)

并行Transformer架构的视频扩散模型，支持大规模视频生成任务。

- **Stars:** ⭐️ 925
- **Tags:** `video-diffusion` `transformer` `video-generation`
- **最后活动时间:** 2025-03-17
...
### [FancyVideo](https://github.com/360CVGroup/FancyVideo)
...
工业级视频基础模型，统一支持文本生成视频（T2V）和图像生成视频（I2V），适用于专业内容创作场景。

- **Stars:** ⭐️ 911
- **Tags:** `Video-Generation` `T2V` `I2V`
- **最后活动时间:** 2025-08-27

### [YOWO](https://github.com/wei-tim/YOWO)

实时时空动作定位统一CNN架构，用于视频中的人体动作检测与识别。

- **Stars:** ⭐️ 905
- **Tags:** `action-localization` `video-understanding` `cnn` `real-time`
- **最后活动时间:** 2024-10-28

### [TransNetV2](https://github.com/soCzech/TransNetV2)

基于神经网络的镜头边界检测模型，用于视频分割和场景识别任务。

- **Stars:** ⭐️ 897
- **Tags:** `shot-boundary-detection` `video-processing` `neural-network`
- **最后活动时间:** 2023-12-04

### [two-stream-action-recognition](https://github.com/jeffreyyihuang/two-stream-action-recognition)

双流架构视频动作识别实现，在UCF101数据集上实现经典动作识别方法。适用于视频理解研究。

- **Stars:** ⭐️ 876
- **Tags:** `action-recognition` `video` `pytorch`
- **最后活动时间:** 2019-10-14
...
### [video_analyst](https://github.com/megvii-research/video_analyst)

视频理解算法集合，包含单目标跟踪(SOT)、视频目标分割(VOS)等核心算法。

- **Stars:** ⭐️ 854
- **Tags:** `video-understanding` `object-tracking` `vos`
- **最后活动时间:** 2023-08-03
...
开源计算机视觉框架，支持快速构建和部署视频处理应用。集成YOLO目标检测、FFmpeg和GStreamer，实现高效的实时推理。

- **Stars:** ⭐️ 846
- **Tags:** `Computer Vision` `Video Processing` `Object Detection` `Inference`
- **最后活动时间:** 2024-05-08

### [UniAnimate-DiT](https://github.com/ali-vilab/UniAnimate-DiT)

基于大规模视频扩散Transformer的人体图像动画生成模型。

- **Stars:** ⭐️ 844
- **Tags:** `video-diffusion` `human-animation` `transformer` `video-generation`
- **最后活动时间:** 2025-04-27
...
### [clipturbo](https://github.com/clipturbo/clipturbo)

AI驱动的视频生成工具，一键创建高质量营销视频。

- **Stars:** ⭐️ 823
- **Tags:** `ai` `video` `generator` `marketing`
- **最后活动时间:** 2025-02-23

### [Efficient-3DCNNs](https://github.com/okankop/Efficient-3DCNNs)

资源高效的3D卷积神经网络PyTorch实现，用于视频理解和动作识别任务。

- **Stars:** ⭐️ 818
- **Tags:** `3d-cnn` `video-understanding` `pytorch` `efficient-networks`
- **最后活动时间:** 2022-12-21
...
### [IJCAI2023-CoNR](https://github.com/megvii-research/IJCAI2023-CoNR)

IJCAI2023论文项目，利用动漫角色设定图进行协作神经渲染，生成高质量角色动画。

- **Stars:** ⭐️ 805
- **Tags:** `neural-rendering` `deep-learning` `computer-vision` `pytorch`
- **最后活动时间:** 2023-08-24

### [DiT-Extrapolation](https://github.com/thu-ml/DiT-Extrapolation)
...
Phenaki视频生成模型PyTorch实现，支持生成长达2分钟的文本引导视频。

- **Stars:** ⭐️ 794
- **Tags:** `text-to-video` `masked-git` `video-generation` `pytorch`
- **最后活动时间:** 2024-07-29

### [MOTR](https://github.com/megvii-research/MOTR)

ECCV2022论文实现，基于Transformer的端到端多目标跟踪框架。将目标检测与跟踪统一为Transformer解码过程，实现高性能跟踪。

- **Stars:** ⭐️ 792
- **Tags:** `multi-object-tracking` `transformer` `object-detection` `pytorch`
- **最后活动时间:** 2024-01-15

### [aphantasia](https://github.com/eps696/aphantasia)

结合CLIP与信号处理技术实现的文本到图像及视频生成实验项目。

- **Stars:** ⭐️ 789
- **Tags:** `text-to-video` `clip` `image-generation`
- **最后活动时间:** 2025-02-13

### [Cosmos-Transfer1-DiffusionRenderer](https://github.com/nv-tlabs/cosmos-transfer1-diffusion-renderer)

基于Cosmos视频扩散框架的高质量视频去光与重光照工具。

- **Stars:** ⭐️ 788
- **Tags:** `Video Diffusion` `Relighting` `GenAI`
- **最后活动时间:** 2025-10-02

### [MagicDance](https://github.com/Boese0601/MagicDance)

ICML 2024论文，基于身份感知扩散模型实现真实人体姿态和面部表情迁移。

- **Stars:** ⭐️ 777
- **Tags:** `pose-transfer` `diffusion-models` `video-editing`
- **最后活动时间:** 2024-07-03

### [Audio-driven-TalkingFace-HeadPose](https://github.com/yiranran/Audio-driven-TalkingFace-HeadPose)

基于音频驱动的说话人脸视频生成项目，支持个性化头部姿态预测，发表于Arxiv 2020和TMM 2022。

- **Stars:** ⭐️ 776
- **Tags:** `talking-face` `audio-driven` `video-generation` `deep-learning`
- **最后活动时间:** 2023-12-15

### [python_video_stab](https://github.com/AdamSpannbauer/python_video_stab)

基于OpenCV的Python视频稳定工具包，可有效消除视频抖动。

- **Stars:** ⭐️ 768
- **Tags:** `video-stabilization` `opencv` `computer-vision`
- **最后活动时间:** 2023-07-19
...
### [VisTR](https://github.com/YuqingWang1029/VisTR)

CVPR2021 Oral论文，基于Transformer的端到端视频实例分割模型。

- **Stars:** ⭐️ 757
- **Tags:** `video-segmentation` `transformers` `computer-vision` `instance-segmentation`
- **最后活动时间:** 2021-07-15
...
CVPR 2023 论文实现，基于离散表示从文本描述生成人体动作，支持文本到动作的转换。

- **Stars:** ⭐️ 754
- **Tags:** `motion-generation` `text-to-motion` `vq-vae` `transformer`
- **最后活动时间:** 2024-09-17
...
### [AI-Shorts-Creator](https://github.com/NisaarAgharia/AI-Shorts-Creator)

利用GPT-4自动分析视频并提取精彩片段的AI工具。结合FFmpeg和OpenCV实现智能视频裁剪。

- **Stars:** ⭐️ 747
- **Tags:** `Video Processing` `GPT-4` `Content Creation`
- **最后活动时间:** 2024-02-14

### [Adversarial_Video_Generation](https://github.com/dyelax/Adversarial_Video_Generation)

基于TensorFlow实现的深度多尺度视频预测模型，使用生成对抗网络(GAN)进行视频帧预测，超越传统均方误差方法。

- **Stars:** ⭐️ 746
- **Tags:** `adversarial-networks` `deep-learning` `gan` `video-prediction` `tensorflow`
- **最后活动时间:** 2021-10-23

### [SC-SfMLearner-Release](https://github.com/JiawangBian/SC-SfMLearner-Release)

从单目视频进行无监督尺度一致深度估计与视觉里程计研究。

- **Stars:** ⭐️ 745
- **Tags:** `depth-estimation` `computer-vision` `unsupervised-learning`
- **最后活动时间:** 2022-09-05

### [sense](https://github.com/quic/sense)

基于RGB摄像头的人体感知交互框架，支持手势识别与活动检测。

- **Stars:** ⭐️ 737
- **Tags:** `gesture-recognition` `activity-recognition` `computer-vision`
- **最后活动时间:** 2021-12-07
...
### [TimeSformer-pytorch](https://github.com/lucidrains/TimeSformer-pytorch)

Facebook AI TimeSformer视频分类模型的PyTorch实现，纯注意力机制的视频理解方案。

- **Stars:** ⭐️ 728
- **Tags:** `video-classification` `transformer` `attention` `video-understanding`
- **最后活动时间:** 2021-08-25

### [TTNet-Real-time-Analysis-System-for-Table-Tennis-Pytorch](https://github.com/maudzung/TTNet-Real-time-Analysis-System-for-Table-Tennis-Pytorch)

TTNet非官方实现，CVPR 2020，实时乒乓球视频时空分析系统，支持事件检测与分割。

- **Stars:** ⭐️ 728
- **Tags:** `video-analysis` `event-detection` `sports-analytics`
- **最后活动时间:** 2024-08-02
...
NIPS 2016论文实现，使用GAN生成具有场景动态变化的视频内容。

- **Stars:** ⭐️ 713
- **Tags:** `video-generation` `gan` `deep-learning` `computer-vision`
- **最后活动时间:** 2018-05-03

### [SkyReels-A2](https://github.com/SkyworkAI/SkyReels-A2)

视频Diffusion Transformer中的任意组合生成框架，支持多元素可控视频创作。

- **Stars:** ⭐️ 706
- **Tags:** `video-generation` `controllable-generation` `diffusion-transformer`
- **最后活动时间:** 2025-06-03
...
ICCV 2025论文，面向自动驾驶的高分辨率长视频生成，支持自适应控制。

- **Stars:** ⭐️ 702
- **Tags:** `video-generation` `autonomous-driving` `diffusion-models`
- **最后活动时间:** 2025-06-26

### [Real-time-GesRec](https://github.com/ahmetgunduz/Real-time-GesRec)

基于PyTorch的实时手势识别系统，支持EgoGesture、Jester等多个主流数据集，适用于视频理解场景。

- **Stars:** ⭐️ 692
- **Tags:** `gesture-recognition` `pytorch` `video-processing` `cnn`
- **最后活动时间:** 2022-12-29

### [MovieChat](https://github.com/rese1f/MovieChat)

CVPR 2024论文，实现长视频理解的稀疏记忆机制，支持密集token到稀疏记忆的转换。

- **Stars:** ⭐️ 689
- **Tags:** `video-understanding` `multimodal` `llm`
- **最后活动时间:** 2025-01-29

### [LipNet](https://github.com/rizkiarm/LipNet)

端到端唇读神经网络实现，从视频预测文本，开创性的唇读研究项目。

- **Stars:** ⭐️ 688
- **Tags:** `lipreading` `video-understanding` `keras` `deep-learning`
- **最后活动时间:** 2022-11-22

### [CityDreamer](https://github.com/hzxie/CityDreamer)
...
### [vehicle-detection](https://github.com/JunshengFu/vehicle-detection)

车辆检测管道，支持YOLO深度学习和SVM+HOG两种方法。

- **Stars:** ⭐️ 676
- **Tags:** `vehicle-detection` `yolo` `svm` `opencv`
- **最后活动时间:** 2024-04-18
...
基于Transformer的多目标跟踪模型，实现检测与跟踪的统一框架。

- **Stars:** ⭐️ 673
- **Tags:** `multi-object-tracking` `transformer` `detection`
- **最后活动时间:** 2023-04-30

### [StoryGen-Atelier](https://github.com/0xsline/StoryGen-Atelier)
...
MagViT2视频Tokenizer的PyTorch实现，支持高效视频生成与压缩。

- **Stars:** ⭐️ 661
- **Tags:** `video-tokenizer` `video-generation` `transformer` `finite-scalar-quantization`
- **最后活动时间:** 2025-01-12

### [motion-cosegmentation](https://github.com/AliaksandrSiarohin/motion-cosegmentation)

运动监督协同部件分割论文代码，实现视频中物体部件的自监督分割。

- **Stars:** ⭐️ 660
- **Tags:** `motion-segmentation` `self-supervised` `video-segmentation` `co-segmentation`
- **最后活动时间:** 2023-04-20

### [Automatic-Youtube-Reddit-Text-To-Speech-Video-Generator-and-Uploader](https://github.com/HA6Bots/Automatic-Youtube-Reddit-Text-To-Speech-Video-Generator-and-Uploader)

自动化Reddit内容转YouTube视频工具，集成TTS语音合成、视频生成和自动上传功能，适合内容创作者批量生产视频。

- **Stars:** ⭐️ 657
- **Tags:** `TTS` `Video Generation` `Automation` `YouTube`
- **最后活动时间:** 2023-01-29
...
### [ExAvatar_RELEASE](https://github.com/mks0601/ExAvatar_RELEASE)

ECCV 2024论文官方实现，表现力丰富的全身3D高斯虚拟人。数字人领域前沿工作。

- **Stars:** ⭐️ 651
- **Tags:** `3d-avatar` `gaussian-splatting` `motion-capture`
- **最后活动时间:** 2025-05-07

### [AnyV2V](https://github.com/TIGER-AI-Lab/AnyV2V)

TMLR2024论文，无需调优的视频到视频编辑框架。

- **Stars:** ⭐️ 650
- **Tags:** `video-editing` `generative-ai` `video-synthesis`
- **最后活动时间:** 2024-10-29
...
ICML 2025官方实现，基于历史引导的视频扩散生成模型。

- **Stars:** ⭐️ 648
- **Tags:** `diffusion-models` `video-generation` `transformer`
- **最后活动时间:** 2025-07-01

### [wav2lip_288x288](https://github.com/primepake/wav2lip_288x288)

基于深度学习的音频驱动说话人脸生成模型，支持288x288分辨率及训练流水线。

- **Stars:** ⭐️ 644
- **Tags:** `Talking Face` `Deep Learning` `Lip Sync`
- **最后活动时间:** 2025-08-13

### [MiniGPT4-video](https://github.com/Vision-CAIR/MiniGPT4-video)

用于视频理解的模型，支持长视频和短视频的问答与检索任务。

- **Stars:** ⭐️ 641
- **Tags:** `video-understanding` `multimodal-llm` `video-qa` `gpt4`
- **最后活动时间:** 2024-12-10
...
PyTorch实现的孪生网络目标跟踪算法，基于论文"Fully-Convolutional Siamese Networks for Object Tracking"。

- **Stars:** ⭐️ 634
- **Tags:** `pytorch` `siamese-network` `object-tracking` `deep-learning`
- **最后活动时间:** 2020-10-27

### [trackformer](https://github.com/timmeinhardt/trackformer)

CVPR 2022论文实现，基于Transformer的多目标跟踪框架。

- **Stars:** ⭐️ 628
- **Tags:** `object-tracking` `transformer` `cvpr` `computer-vision`
- **最后活动时间:** 2023-09-12

### [Few-Shot-Patch-Based-Training](https://github.com/OndrejTexler/Few-Shot-Patch-Based-Training)

SIGGRAPH 2020官方实现，支持交互式视频风格化的小样本补丁训练方法。

- **Stars:** ⭐️ 627
- **Tags:** `video-stylization` `gan` `style-transfer` `pytorch`
- **最后活动时间:** 2021-04-16

### [scanner](https://github.com/scanner-research/scanner)

大规模高效视频分析框架，支持GPU加速的视频处理，适用于计算机视觉和视频理解任务。

- **Stars:** ⭐️ 624
- **Tags:** `video-analysis` `gpu` `computer-vision` `big-data` `python`
- **最后活动时间:** 2023-06-01

### [LipGAN](https://github.com/Rudrabha/LipGAN)

基于GAN的唇形同步生成模型，可实现人脸视频中唇部动作与任意语音的精准匹配，用于自动人脸翻译和视频配音。

- **Stars:** ⭐️ 615
- **Tags:** `gan` `lip-sync` `video-generation` `face-translation`
- **最后活动时间:** 2025-06-22

### [mocap4face](https://github.com/facemoji/mocap4face)

跨平台面部动作捕捉SDK，可从照片或视频中实时生成blendshapes和3D头部姿态，适用于虚拟形象和VTuber应用。

- **Stars:** ⭐️ 612
- **Tags:** `Face Tracking` `Motion Capture` `Computer Vision`
- **最后活动时间:** 2022-11-29

### [People-Counting-in-Real-Time](https://github.com/saimj7/People-Counting-in-Real-Time)

基于IP摄像头的实时人流计数系统，使用SSD目标检测和多线程处理。

- **Stars:** ⭐️ 611
- **Tags:** `people-counting` `ssd` `opencv` `real-time`
- **最后活动时间:** 2023-08-15

### [EverybodyDanceNow_reproduce_pytorch](https://github.com/yanx27/EverybodyDanceNow_reproduce_pytorch)

Everybody Dance Now论文的PyTorch复现，实现姿态到视频的生成转换。

- **Stars:** ⭐️ 609
- **Tags:** `everybody-dance-now` `pose2pose` `pix2pixhd` `pytorch`
- **最后活动时间:** 2020-07-21

### [vidi](https://github.com/bytedance/vidi)
...
### [mocogan](https://github.com/megvii-research/CREStereo)

MoCoGAN论文实现，通过分解运动和内容实现视频生成。

- **Stars:** ⭐️ 605
- **Tags:** `video-generation` `gan` `computer-vision`
- **最后活动时间:** 2023-02-10

### [sora-extend](https://github.com/mshumer/sora-extend)
...
### [FuSta](https://github.com/alex04072000/FuSta)

ICCV2021论文实现，基于混合神经融合的全帧视频稳定方法。结合视图合成技术实现高质量视频防抖。

- **Stars:** ⭐️ 592
- **Tags:** `video-stabilization` `view-synthesis` `neural-fusion` `pytorch`
- **最后活动时间:** 2023-12-23

### [VLog](https://github.com/showlab/VLog)

CVPR 2025 论文项目，将视频叙述转化为词汇表，实现视频长文档理解。

- **Stars:** ⭐️ 590
- **Tags:** `video-language` `langchain` `whisper` `llm`
- **最后活动时间:** 2025-03-13
...
从单目视频直接重建3D人体骨架运动的深度神经网络。ToG 2020论文实现。

- **Stars:** ⭐️ 587
- **Tags:** `3d-pose-estimation` `motion-capture` `deep-learning`
- **最后活动时间:** 2022-04-28

### [SkyReels-A1](https://github.com/SkyworkAI/SkyReels-A1)

基于视频Diffusion Transformer的表情丰富人像动画生成系统。

- **Stars:** ⭐️ 584
- **Tags:** `portrait-animation` `video-diffusion` `face-animation`
- **最后活动时间:** 2025-06-05
...
### [Diffuman4D](https://github.com/zju3dv/Diffuman4D)
...
### [MonoPort](https://github.com/Project-Splinter/MonoPort)

单目实时体积化人体表演捕捉系统，支持虚拟会议和VR应用。SIGGRAPH 2020和ECCV 2020论文。

- **Stars:** ⭐️ 576
- **Tags:** `3d-reconstruction` `performance-capture` `pytorch`
- **最后活动时间:** 2022-06-28

### [siamfc-tf](https://github.com/torrvision/siamfc-tf)

TensorFlow实现的SiamFC目标跟踪算法。

- **Stars:** ⭐️ 572
- **Tags:** `object-tracking` `siamese-network` `tensorflow`
- **最后活动时间:** 2023-08-16

### [VEnhancer](https://github.com/Vchitect/VEnhancer)

视频生成的生成式时空增强工具，支持超分辨率与帧插值。

- **Stars:** ⭐️ 569
- **Tags:** `video-enhancement` `diffusion-models` `video-super-resolution`
- **最后活动时间:** 2024-09-16
...
视频视觉Transformer(ViViT)的PyTorch实现，用于视频理解与分类任务。

- **Stars:** ⭐️ 557
- **Tags:** `video-transformer` `vision-transformer` `pytorch`
- **最后活动时间:** 2021-06-21
...
### [nuwa-pytorch](https://github.com/lucidrains/nuwa-pytorch)

NÜWA注意力网络的PyTorch实现，用于文本到视频合成的SOTA模型。

- **Stars:** ⭐️ 549
- **Tags:** `text-to-video` `attention-mechanism` `deep-learning` `pytorch`
- **最后活动时间:** 2023-01-17

### [kinetics_i3d_pytorch](https://github.com/hassony2/kinetics_i3d_pytorch)

基于Inception骨干网络的I3D视频理解模型PyTorch实现，支持动作识别与视频分类任务。

- **Stars:** ⭐️ 548
- **Tags:** `i3d` `video-understanding` `action-recognition` `pytorch` `3d-cnn`
- **最后活动时间:** 2024-05-23

### [wav2lip-hq](https://github.com/Markfryazino/wav2lip-hq)

Wav2Lip扩展项目，支持高质量视频的唇形同步生成。

- **Stars:** ⭐️ 547
- **Tags:** `lip-sync` `deep-learning` `video-generation`
- **最后活动时间:** 2023-02-07

### [VideoTuna](https://github.com/VideoVerses/VideoTuna)

视频生成模型微调工具，支持文本到视频生成的内容创作框架。

- **Stars:** ⭐️ 546
- **Tags:** `aigc` `text-to-video` `video-generation` `fine-tuning`
- **最后活动时间:** 2025-09-15

### [SplattingAvatar](https://github.com/initialneil/SplattingAvatar)

CVPR2024论文，基于高斯泼溅技术的3D头像生成与渲染官方实现。

- **Stars:** ⭐️ 546
- **Tags:** `3d-avatar` `gaussian-splatting` `rendering`
- **最后活动时间:** 2024-10-28

### [STTN](https://github.com/researchmm/STTN)

ECCV 2020 视频修复模型，利用时空Transformer实现高质量视频内容补全与修复。

- **Stars:** ⭐️ 546
- **Tags:** `video-inpainting` `transformer` `spatial-temporal` `computer-vision`
- **最后活动时间:** 2025-06-18

### [FreeInit](https://github.com/TianxingWu/FreeInit)

ECCV 2024论文实现，解决视频扩散模型初始化差距问题，提升视频生成质量。

- **Stars:** ⭐️ 545
- **Tags:** `aigc` `text-to-video` `video-diffusion` `video-generation`
- **最后活动时间:** 2024-01-18
...
### [sign-language-gesture-recognition](https://github.com/hthuwal/sign-language-gesture-recognition)

基于CNN和RNN的视频手语识别系统，使用InceptionV3和LSTM实现手势序列识别。

- **Stars:** ⭐️ 539
- **Tags:** `Sign Language` `CNN` `LSTM` `Computer Vision` `TensorFlow`
- **最后活动时间:** 2020-09-27

### [dain-ncnn-vulkan](https://github.com/nihui/dain-ncnn-vulkan)

基于DAIN的AI视频插帧工具，使用ncnn实现跨平台GPU加速推理。

- **Stars:** ⭐️ 538
- **Tags:** `video-interpolation` `dain` `ncnn` `vulkan`
- **最后活动时间:** 2023-10-29

### [Faceswap-Deepfake-Pytorch](https://github.com/Oldpan/Faceswap-Deepfake-Pytorch)

基于PyTorch的人脸替换工具，实现Deepfake视频生成。

- **Stars:** ⭐️ 538
- **Tags:** `faceswap` `deepfake` `pytorch` `face-swap`
- **最后活动时间:** 2019-01-01

### [Pandora](https://github.com/maitrix-org/Pandora)

支持自然语言动作和视频状态的通用世界模型。

- **Stars:** ⭐️ 535
- **Tags:** `world-model` `video-generation` `natural-language`
- **最后活动时间:** 2024-09-23

### [tarsier](https://github.com/bytedance/tarsier)

大规模视频语言模型家族，专注于生成高质量视频描述和通用视频理解任务。

- **Stars:** ⭐️ 532
- **Tags:** `video-language-model` `multimodal` `video-understanding` `llm`
- **最后活动时间:** 2025-08-14

### [EventVAD](https://github.com/YihuaJerry/EventVAD)

MM 2025论文实现，无需训练的事件感知视频异常检测方法。

- **Stars:** ⭐️ 525
- **Tags:** `video-anomaly-detection` `multimodal` `video-analysis`
- **最后活动时间:** 2025-07-09

### [Deep-Video-Inpainting](https://github.com/mcahny/Deep-Video-Inpainting)

CVPR 2019论文官方PyTorch实现，深度视频修复算法。

- **Stars:** ⭐️ 524
- **Tags:** `video-inpainting` `deep-learning` `computer-vision` `cvpr2019`
- **最后活动时间:** 2020-12-10

### [VolumetricCapture](https://github.com/VCL3D/VolumetricCapture)

多传感器采集系统，用于自由视点视频和体积视频的录制与重建。

- **Stars:** ⭐️ 524
- **Tags:** `volumetric-video` `multi-sensor` `free-viewpoint` `performance-capture`
- **最后活动时间:** 2025-07-31

### [predrnn-pytorch](https://github.com/thuml/predrnn-pytorch)

NIPS'17官方论文实现，使用时空LSTM进行视频预测的循环神经网络。

- **Stars:** ⭐️ 522
- **Tags:** `video-prediction` `lstm` `spatiotemporal` `pytorch`
- **最后活动时间:** 2023-11-04
...
### [Open-OmniVCus](https://github.com/caiyuanhao1998/Open-OmniVCus)
...
支持实时摄像头和离线视频处理的目标检测项目，基于TensorFlow实现。

- **Stars:** ⭐️ 516
- **Tags:** `object-detection` `tensorflow` `real-time` `video-processing`
- **最后活动时间:** 2020-02-10

### [virtual-background](https://github.com/Volcomix/virtual-background)

基于TensorFlow和MediaPipe的浏览器端视频虚拟背景实现，支持实时视频流分割与背景替换。

- **Stars:** ⭐️ 515
- **Tags:** `Video Segmentation` `TensorFlow.js` `MediaPipe` `WebGL`
- **最后活动时间:** 2024-04-07

### [FLAVR](https://github.com/tarun005/FLAVR)

高效的视频帧插值技术，支持2x-8x慢动作效果和视频帧生成。

- **Stars:** ⭐️ 515
- **Tags:** `video-interpolation` `deep-learning` `computer-vision` `video`
- **最后活动时间:** 2024-05-07
...
ECCV 2024论文项目，基于实体表示的运动控制框架，可对任意物体实现精确的拖拽式运动控制。

- **Stars:** ⭐️ 505
- **Tags:** `motion-control` `video-generation` `drag-based-editing` `ECCV2024`
- **最后活动时间:** 2024-07-02
...
### [Tensorflow_Object_Tracking_Video](https://github.com/DrewNF/Tensorflow_Object_Tracking_Video)

基于TensorFlow的视频目标跟踪系统，支持定位、检测和分类，曾参与ImageNET VID竞赛。

- **Stars:** ⭐️ 504
- **Tags:** `object-tracking` `tensorflow` `video` `detection` `imagenet`
- **最后活动时间:** 2020-01-21

### [fantasy-portrait](https://github.com/Fantasy-AMAP/fantasy-portrait)

基于表情增强扩散Transformer的多角色肖像动画生成。

- **Stars:** ⭐️ 502
- **Tags:** `diffusion-models` `portrait-animation` `video-generation`
- **最后活动时间:** 2025-08-20

### [Framer](https://github.com/aim-uofa/Framer)

ICLR 2025论文实现，交互式视频帧插值方法，生成高质量中间帧。

- **Stars:** ⭐️ 502
- **Tags:** `frame-interpolation` `video-generation` `video-processing` `pytorch`
- **最后活动时间:** 2025-01-09
...
统一多模态理解与生成模型系列，支持任意到任意转换。

- **Stars:** ⭐️ 17.7k
- **Tags:** `Multimodal` `Vision-Language` `Foundation Model`
- **最后活动时间:** 2025-02-01

### [InternVL](https://github.com/OpenGVLab/InternVL)

CVPR 2024 Oral开源多模态模型，性能接近GPT-4o的领先方案。

- **Stars:** ⭐️ 9.9k
- **Tags:** `GPT-4o` `Multimodal` `Open Source`
- **最后活动时间:** 2025-09-22
...
开源视觉语言模型，支持图像理解与多模态对话，性能达到业界领先水平。

- **Stars:** ⭐️ 6.7k
- **Tags:** `Vision-Language` `Multimodal` `Open Source`
- **最后活动时间:** 2024-05-29

### [Qwen-VL](https://github.com/QwenLM/Qwen-VL)

阿里云开源的视觉语言大模型，支持图像理解与多语言对话能力。

- **Stars:** ⭐️ 6.6k
- **Tags:** `Vision-Language` `Alibaba` `Open Source`
- **最后活动时间:** 2024-08-07
...
基于 MediaPipe/TensorFlow.js 的面部、姿态和手指追踪模型，用于 VTuber 和动作捕捉应用。

- **Stars:** ⭐️ 5.6k
- **Tags:** `mediapipe` `tensorflowjs` `pose-estimation` `face-detection` `vtuber`
- **最后活动时间:** 2025-08-18
...
ICML 2024论文实现，支持任意到任意模态转换的多模态大语言模型。

- **Stars:** ⭐️ 3.6k
- **Tags:** `Multimodal` `LLM` `ICML 2024`
- **最后活动时间:** 2025-05-13

### [Otter](https://github.com/EvolvingLMMs-Lab/Otter)

基于OpenFlamingo的多模态模型，在MIMIC-IT数据集上训练，具备强大的指令遵循和上下文学习能力。

- **Stars:** ⭐️ 3.4k
- **Tags:** `Multimodal` `Vision-Language` `Instruction Tuning`
- **最后活动时间:** 2024-03-05

### [MGM](https://github.com/JIA-Lab-research/MGM)

Mini-Gemini官方实现，挖掘多模态视觉语言模型潜力的创新研究项目。

- **Stars:** ⭐️ 3.3k
- **Tags:** `vision-language-model` `large-language-models` `multimodal`
- **最后活动时间:** 2024-05-04

### [Mask2Former](https://github.com/facebookresearch/Mask2Former)

CVPR论文官方实现，基于掩码注意力机制的通用图像分割Transformer模型。

- **Stars:** ⭐️ 3.3k
- **Tags:** `image-segmentation` `transformer` `computer-vision`
- **最后活动时间:** 2024-07-29

### [Video-LLaMA](https://github.com/DAMO-NLP-SG/Video-LLaMA)

EMNLP 2023 Demo，面向视频理解的指令微调音视频语言模型，支持多模态视频理解任务。

- **Stars:** ⭐️ 3.1k
- **Tags:** `video-language-pretraining` `vision-language-pretraining` `multimodal` `llama`
- **最后活动时间:** 2024-06-04
...
ECCV2018论文官方实现，基于PyTorch的人体姿态估计与跟踪模型，支持COCO和MPII数据集。

- **Stars:** ⭐️ 3.0k
- **Tags:** `human-pose-estimation` `deep-learning` `pytorch` `computer-vision`
- **最后活动时间:** 2022-11-28

### [MTCNN_face_detection_alignment](https://github.com/kpzhang93/MTCNN_face_detection_alignment)

基于多任务级联卷积神经网络的人脸检测与对齐算法实现，经典人脸检测方案。

- **Stars:** ⭐️ 2.9k
- **Tags:** `face-detection` `mtcnn` `computer-vision` `deep-learning`
- **最后活动时间:** 2022-10-11

### [LoFTR](https://github.com/zju3dv/LoFTR)

CVPR 2021论文实现，基于Transformer的无检测器局部特征匹配方法，用于3D视觉和位姿估计。

- **Stars:** ⭐️ 2.8k
- **Tags:** `feature-matching` `3d-vision` `transformer` `pose-estimation`
- **最后活动时间:** 2024-05-31

### [Detectron.pytorch](https://github.com/roytseng-tw/Detectron.pytorch)

Facebook Detectron的PyTorch实现，支持Mask R-CNN等目标检测与实例分割模型。

- **Stars:** ⭐️ 2.8k
- **Tags:** `object-detection` `mask-rcnn` `pytorch` `instance-segmentation`
- **最后活动时间:** 2019-09-05

### [NUWA](https://github.com/microsoft/NUWA)

统一的3D Transformer视觉合成管线，支持多种视觉生成任务。

- **Stars:** ⭐️ 2.8k
- **Tags:** `3d-generation` `transformer` `visual-synthesis`
- **最后活动时间:** 2023-05-29

### [DINO](https://github.com/IDEA-Research/DINO)

ICLR 2023论文官方实现，基于改进去噪锚框的端到端目标检测DETR变体。

- **Stars:** ⭐️ 2.8k
- **Tags:** `object-detection` `detr` `transformer` `computer-vision`
- **最后活动时间:** 2024-07-31

### [SNIPER](https://github.com/mahyarnajibi/SNIPER)

高效的多尺度目标检测训练与推理算法，支持AutoFocus自动聚焦机制。

- **Stars:** ⭐️ 2.7k
- **Tags:** `object-detection` `multi-scale` `computer-vision` `deep-learning`
- **最后活动时间:** 2021-08-22
...
ICML 2022论文官方实现，统一架构的多模态预训练模型，支持图像描述、视觉问答、文本生成图像等多种任务。

- **Stars:** ⭐️ 2.6k
- **Tags:** `multimodal` `vision-language` `pretrained-models` `image-captioning` `text-to-image`
- **最后活动时间:** 2024-04-24

### [lanenet-lane-detection](https://github.com/MaybeShewill-CV/lanenet-lane-detection)

LaneNet车道线检测模型非官方实现，支持实时车道线检测与实例分割。

- **Stars:** ⭐️ 2.5k
- **Tags:** `lane-detection` `autonomous-driving` `instance-segmentation` `tensorflow`
- **最后活动时间:** 2023-12-08

### [CenterTrack](https://github.com/xingyizhou/CenterTrack)

基于中心点的联合目标检测与跟踪算法，实现高效实时多目标跟踪。

- **Stars:** ⭐️ 2.5k
- **Tags:** `object-tracking` `object-detection` `centerpoint` `computer-vision`
- **最后活动时间:** 2024-06-17

### [mtcnn](https://github.com/ipazc/mtcnn)

TensorFlow版MTCNN人脸检测Python包，支持人脸检测与关键点定位。

- **Stars:** ⭐️ 2.5k
- **Tags:** `face-detection` `mtcnn` `tensorflow` `landmark-detection`
- **最后活动时间:** 2024-10-08

### [Towards-Realtime-MOT](https://github.com/Zhongdao/Towards-Realtime-MOT)

联合检测与嵌入的快速多目标跟踪方案，实现实时多行人跟踪。

- **Stars:** ⭐️ 2.4k
- **Tags:** `multi-object-tracking` `pedestrian-tracking` `realtime` `deep-learning`
- **最后活动时间:** 2021-12-29
...
大型视觉语言模型的混合专家架构实现，发表于TMM 2025。

- **Stars:** ⭐️ 2.3k
- **Tags:** `mixture-of-experts` `vision-language-model` `multimodal`
- **最后活动时间:** 2025-07-15
...
### [deepseek-ocr.rs](https://github.com/TimmyOVO/deepseek-ocr.rs)
...
卷积循环神经网络（CRNN），用于图像序列识别，是OCR领域的经典深度学习模型。

- **Stars:** ⭐️ 2.1k
- **Tags:** `ocr` `deep-learning` `computer-vision` `sequence-recognition`
- **最后活动时间:** 2019-03-04

### [yolor](https://github.com/WongKinYiu/yolor)

YOLOR统一网络目标检测模型实现，单模型支持多任务学习。

- **Stars:** ⭐️ 2.0k
- **Tags:** `object-detection` `yolo` `pytorch` `representation-learning`
- **最后活动时间:** 2024-11-03
...
ECCV 2024论文官方实现，扩展大型视觉语言模型的视觉词汇表。

- **Stars:** ⭐️ 1.9k
- **Tags:** `vision-language-model` `multimodal` `vocabulary-scaling`
- **最后活动时间:** 2024-12-30

### [CRNN_Chinese_Characters_Rec](https://github.com/Sierkinhane/CRNN_Chinese_Characters_Rec)

基于CRNN的中文字符识别项目，支持中文场景文字识别。

- **Stars:** ⭐️ 1.9k
- **Tags:** `ocr` `chinese` `pytorch` `deep-learning`
- **最后活动时间:** 2022-11-13
...
NeurIPS 2022 Spotlight论文，掩码自编码器实现视频自监督预训练，数据效率显著提升。

- **Stars:** ⭐️ 1.7k
- **Tags:** `video-transformer` `masked-autoencoder` `self-supervised-learning` `vision-transformer`
- **最后活动时间:** 2023-12-08
...
基于迁移学习的高质量单目深度估计模型，使用编码器-解码器架构实现精准的深度预测。

- **Stars:** ⭐️ 1.6k
- **Tags:** `深度估计` `计算机视觉` `迁移学习`
- **最后活动时间:** 2022-12-07

### [HealthGPT](https://github.com/ZJU4HealthCare/HealthGPT)
...
先进视觉语言基础模型，在60个公开基准测试中38个达到SOTA性能。

- **Stars:** ⭐️ 1.6k
- **Tags:** `vision-language-model` `multimodal` `foundation-model`
- **最后活动时间:** 2025-06-14

### [ViLT](https://github.com/dandelin/ViLT)

ICML 2021论文实现，无卷积或区域监督的视觉-语言Transformer模型。

- **Stars:** ⭐️ 1.5k
- **Tags:** `vision-and-language` `transformer` `multimodal`
- **最后活动时间:** 2024-04-03
...
CVPR 2023论文，混合注意力Transformer用于图像超分辨率和恢复任务。
...
基于Keras的OCR工具包，集成CRAFT文本检测器和CRNN识别模型，开箱即用。

- **Stars:** ⭐️ 1.5k
- **Tags:** `ocr` `keras` `text-detection` `deep-learning`
- **最后活动时间:** 2025-09-22
...
SSD目标检测的PyTorch实现，支持MobileNet和VGG骨干网络。

- **Stars:** ⭐️ 1.4k
- **Tags:** `object-detection` `ssd` `pytorch` `onnx`
- **最后活动时间:** 2023-03-11
...
鲁棒的多行人跟踪算法，结合YOLOv7/YOLOX实现高效目标跟踪。

- **Stars:** ⭐️ 1.4k
- **Tags:** `multi-object-tracking` `yolov7` `pytorch` `computer-vision`
- **最后活动时间:** 2024-08-08
...
CVPR 2022 Oral论文，证明简单池化操作即可替代注意力机制，揭示MetaFormer架构本质。

- **Stars:** ⭐️ 1.4k
- **Tags:** `vision-transformer` `image-classification` `metaformer` `pytorch`
- **最后活动时间:** 2024-06-01

### [unimatch](https://github.com/autonomousvision/unimatch)

TPAMI 2023 统一模型，将光流估计、立体匹配和深度估计整合到同一Transformer框架中。

- **Stars:** ⭐️ 1.4k
- **Tags:** `optical-flow` `depth-estimation` `stereo-matching` `transformer`
- **最后活动时间:** 2025-01-04
...
数学公式OCR增强版，支持中英文手写印刷公式识别，基于LaTeX抽象语法树。

- **Stars:** ⭐️ 1.3k
- **Tags:** `ocr` `math-formula` `latex` `deep-learning`
- **最后活动时间:** 2024-06-11

### [CTPN](https://github.com/tianzhi0549/CTPN)

连接主义文本提议网络，用于自然场景文本检测（ECCV'16），是场景文本检测的经典方法。

- **Stars:** ⭐️ 1.3k
- **Tags:** `ocr` `text-detection` `deep-learning` `scene-text`
- **最后活动时间:** 2021-10-15
...
### [VisionLLM](https://github.com/OpenGVLab/VisionLLM)

视觉语言大模型系列，将大语言模型与目标检测等视觉任务相结合的通用模型框架。

- **Stars:** ⭐️ 1.1k
- **Tags:** `large-language-models` `generalist-model` `object-detection` `vision-language`
- **最后活动时间:** 2025-02-27

### [HRNet-Facial-Landmark-Detection](https://github.com/HRNet/HRNet-Facial-Landmark-Detection)

人脸关键点检测官方实现，基于高分辨率网络用于视觉识别任务。

- **Stars:** ⭐️ 1.1k
- **Tags:** `facial-landmarks` `hrnet` `computer-vision` `deep-learning`
- **最后活动时间:** 2022-08-12

### [ssd_keras](https://github.com/rykov8/ssd_keras)

SSD单次多框检测器的Keras实现，用于实时目标检测任务。
...
首个能够阅读胸部X光片并生成报告的中文多模态医学大模型，助力医学影像智能分析。

- **Stars:** ⭐️ 1.1k
- **Tags:** `large-language-models` `medical` `multimodal` `xray`
- **最后活动时间:** 2024-11-20

### [ONE-PEACE](https://github.com/OFA-Sys/ONE-PEACE)

跨视觉、音频、语言模态的通用表示模型，探索无限模态的统一表示。

- **Stars:** ⭐️ 1.1k
- **Tags:** `multimodal` `foundation-model` `representation-learning`
- **最后活动时间:** 2024-10-06

### [Bunny](https://github.com/BAAI-DCAI/Bunny)

轻量级多模态模型家族，支持中英文，提供高效的多模态大语言模型解决方案。

- **Stars:** ⭐️ 1.1k
- **Tags:** `MLLM` `Lightweight` `Multimodal`
- **最后活动时间:** 2024-11-18
...
DBNet的PyTorch实现，基于可微分二值化的实时场景文本检测方法。

- **Stars:** ⭐️ 1.0k
- **Tags:** `ocr` `text-detection` `pytorch` `real-time`
- **最后活动时间:** 2022-12-29
...
### [TextBoxes_plusplus](https://github.com/MhLiao/TextBoxes_plusplus)

TextBoxes++单镜头定向场景文本检测器，用于自然场景文本检测。

- **Stars:** ⭐️ 959
- **Tags:** `ocr` `scene-text` `text-detection` `deep-learning`
- **最后活动时间:** 2023-10-22

### [Chat-UniVi](https://github.com/PKU-YuanGroup/Chat-UniVi)

CVPR 2024 Highlight，统一视觉表示赋能大语言模型实现图像与视频理解。

- **Stars:** ⭐️ 946
- **Tags:** `vision-language-model` `video-understanding` `image-understanding` `multimodal`
- **最后活动时间:** 2024-10-16
...
Molmo视觉语言模型的官方代码实现，前沿多模态AI研究项目。
...
CVPR 2024论文，支持关注任意区域的增强型CLIP模型。

- **Stars:** ⭐️ 869
- **Tags:** `clip` `vision-language` `attention`
- **最后活动时间:** 2025-07-20

### [Face-X](https://github.com/akshitagupta15june/Face-X)
...
支持多语言的OpenAI CLIP文本编码器，扩展CLIP模型的多语言能力。

- **Stars:** ⭐️ 828
- **Tags:** `clip` `multilingual` `vision-language` `text-encoder`
- **最后活动时间:** 2023-05-15
...
CVPR 2022 Oral论文，通过全局匹配机制学习光流估计，替代传统代价体构建方法。

- **Stars:** ⭐️ 779
- **Tags:** `optical-flow` `transformer` `global-matching` `computer-vision`
- **最后活动时间:** 2024-02-20
...
基于规则强化学习的多模态推理前沿探索项目，提升复杂视觉推理能力。

- **Stars:** ⭐️ 772
- **Tags:** `Multimodal Reasoning` `Reinforcement Learning` `Research`
- **最后活动时间:** 2025-09-07

### [ov-seg](https://github.com/facebookresearch/ov-seg)

开放词汇语义分割官方实现，结合Mask-adapted CLIP实现零样本分割能力。

- **Stars:** ⭐️ 754
- **Tags:** `open-vocabulary` `semantic-segmentation` `clip` `zero-shot`
- **最后活动时间:** 2023-10-17

### [Stark](https://github.com/researchmm/Stark)

ICCV 2021 目标跟踪模型，利用时空Transformer实现精准的视觉目标跟踪。

- **Stars:** ⭐️ 709
- **Tags:** `visual-tracking` `transformer` `computer-vision`
- **最后活动时间:** 2024-04-13

### [BiomedGPT](https://github.com/taokz/BiomedGPT)

面向多样化生物医学任务的通用视觉语言基础模型。

- **Stars:** ⭐️ 708
- **Tags:** `biomedical` `vision-language-model` `multimodal`
- **最后活动时间:** 2025-07-08
...
CVPR 2024论文，首个面向遥感领域的接地大型视觉语言模型，支持地理空间图像理解与对话。

- **Stars:** ⭐️ 701
- **Tags:** `VLM` `Remote Sensing` `CVPR 2024`
- **最后活动时间:** 2024-11-28

### [Matterport3DSimulator](https://github.com/peteanderson80/Matterport3DSimulator)

基于真实全景图像的强化学习研究平台，支持视觉语言导航任务。

- **Stars:** ⭐️ 684
- **Tags:** `vision-language` `reinforcement-learning` `simulator` `navigation`
- **最后活动时间:** 2024-07-12

### [OmniVinci](https://github.com/NVlabs/OmniVinci)
...
### [Multimodal-Toolkit](https://github.com/georgian-io/Multimodal-Toolkit)
...
### [Seg-Zero](https://github.com/JIA-Lab-research/Seg-Zero)
...
### [SD-VLM](https://github.com/cpystan/SD-VLM)
...
CVPR 2021 Oral论文，基于注意力机制的3D点云配准方法，解决低重叠场景下的点云对齐问题。

- **Stars:** ⭐️ 594
- **Tags:** `point-cloud` `3d-vision` `transformer` `registration`
- **最后活动时间:** 2025-02-20

### [Vision-DeepResearch](https://github.com/Osilly/Vision-DeepResearch)
...
统一高效的大型多模态模型，支持图像、高分辨率图像和视频的理解处理。

- **Stars:** ⭐️ 564
- **Tags:** `Multimodal` `Efficient` `Vision Language`
- **最后活动时间:** 2025-06-29

### [CRNN-Keras](https://github.com/qjadud1994/CRNN-Keras)

CRNN卷积循环神经网络实现，用于OCR光学字符识别和车牌识别。

- **Stars:** ⭐️ 545
- **Tags:** `ocr` `crnn` `keras` `license-plate`
- **最后活动时间:** 2020-05-25
...
ACL 2024论文，使用医学视觉语言模型进行胸部X光片摘要生成。

- **Stars:** ⭐️ 526
- **Tags:** `medical-imaging` `vision-language` `radiology`
- **最后活动时间:** 2024-08-08

### [RemoteCLIP](https://github.com/ChenDelong1999/RemoteCLIP)

IEEE TGRS论文，面向遥感领域的视觉语言基础模型。

- **Stars:** ⭐️ 526
- **Tags:** `remote-sensing` `vision-language` `clip`
- **最后活动时间:** 2024-06-27
...
### [Robust-R1](https://github.com/jqtangust/Robust-R1)
...
### [GPT4Scene-and-VLN-R1](https://github.com/Qi-Zhangyang/GPT4Scene-and-VLN-R1)
