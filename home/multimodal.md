...
由光明实验室打造的3D数字人系统，集成了语音识别、语音合成、自然语言理解与嘴型动画驱动。支持Windows、Linux和Android平台快速部署。

- **Stars:** ⭐️ 1.2k
- **Tags:** `3dhuman` `ai` `digital-human` `tts` `stt` `nlu`
- **最后活动时间:** 2026-01-08
...
### [GMTalker](https://github.com/feima09/GMTalker)
