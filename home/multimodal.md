...
迈向音乐生成的基础模型，提供高质量的音频生成能力。

- **Stars:** ⭐️ 4.7k
- **Tags:** `music-generation` `audio` `foundation-model`
- **最后活动时间:** 2026-02-15
...
高质量的语音分析、操作与合成系统（声码器）。广泛用于语音处理研究与音频生成。

- **Stars:** ⭐️ 1.3k
- **Tags:** `speech-synthesis` `speech-analysis` `vocoder`
- **最后活动时间:** 2026-02-18
...
- **Stars:** ⭐️ 8.2k
- **Tags:** `image-generation` `text-to-image` `foundation-model` `qwen`
- **最后活动时间:** 2026-02-10
...
NeurIPS 2023 论文官方代码，用于大规模表达性人体姿态和形状估计。能够从单张图像精准预测人体的3D姿态、形状及表情。

- **Stars:** ⭐️ 1.2k
- **Tags:** `pose-estimation` `human-shape` `computer-vision` `3d-reconstruction`
- **最后活动时间:** 2026-02-12
...
ICLR 2026 Oral 论文项目，提出了一种基于在线扩散强化与正向过程的扩散模型新方法。主要应用于图像生成与强化学习结合的前沿研究。

- **Stars:** ⭐️ 1.0k
- **Tags:** `diffusion-models` `reinforcement-learning` `image-generation` `iclr-2026`
- **最后活动时间:** 2026-02-10
...
- **Stars:** ⭐️ 566
- **Tags:** `comfyui` `custom-nodes` `video-generation` `ai-workflow`
- **最后活动时间:** 2026-02-09
