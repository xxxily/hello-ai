...
开源的自托管AI代码审查机器人，基于Vercel构建，可自动分析代码质量并提供智能建议。

- **Stars:** ⭐️ 1.6k
- **Tags:** `ai` `code-review` `vercel` `automation`
- **最后活动时间:** 2026-03-06
...
Claude Code 中文开发套件，一键安装完整中文化体验，集成 MCP 服务器与安全扫描。

- **Stars:** ⭐️ 1.4k
- **Tags:** `claude-code` `chinese` `mcp` `sdk`
- **最后活动时间:** 2026-03-12
...
AI代码可视化工具，通过交互式图表帮助开发者理解AI生成的代码库结构。

- **Stars:** ⭐️ 1.3k
- **Tags:** `code-visualization` `ai-code` `developer-tools`
- **最后活动时间:** 2026-03-13
...
AI驱动的Vim代码助手插件，支持OpenAI和ChatGPT，为Vim和Neovim提供智能代码补全和对话功能。
...
允许用户在终端、VSCode扩展或Discord中免费使用Claude Code的开发者工具。

- **Stars:** ⭐️ 889
- **Tags:** `ai` `claude` `cli` `vscode`
- **最后活动时间:** 2026-03-05
...
Claude Code 自动化代码审查循环插件，集成 Codex 实现代码质量持续改进。
...
专为 Home Assistant 定制的 Visual Studio Code 扩展，提供代码补全和配置语法高亮等功能。极大提升了开发者的智能家居配置效率。

- **Stars:** ⭐️ 705
- **Tags:** `vscode` `home-assistant` `ide` `extension` `developer-tools`
- **最后活动时间:** 2026-03-10
...
开源 LLM 网关工具，支持 DeepSeek、Gemini、Kimi-K2 等模型，内置提示注入安全研究功能，无需 API 密钥。

- **Stars:** ⭐️ 846
- **Tags:** `LLM Gateway` `Security Research` `CLI` `Prompt Injection`
- **最后活动时间:** 2026-03-13
...
### [tapestry-skills](https://github.com/michalparkola/tapestry-skills)

Claude Code技能扩展，支持自动下载文章、PDF和YouTube视频字幕等资源。极大提升AI助手的数据获取能力。

- **Stars:** ⭐️ 538
- **Tags:** `claude-code` `prompt-engineering` `data-extraction` `automation`
- **最后活动时间:** 2026-03-11
...
### [ui](https://github.com/creativetimofficial/ui)

开源UI组件库与AI代理工具集，支持通过Registry和MCP协议无缝集成到开发工作流中，加速AI应用开发。

- **Stars:** ⭐️ 12.0k
- **Tags:** `UI Components` `AI Agents` `MCP`
- **最后活动时间:** 2026-03-14
...
语言技术平台，提供中文分词、词性标注、命名实体识别等NLP核心功能。

- **Stars:** ⭐️ 5.3k
- **Tags:** `Chinese NLP` `SDK` `NLP Platform`
- **最后活动时间:** 2026-03-11
...
时间序列智能机器学习框架，支持异常检测、预测和AutoML功能。
...
### [keras-attention](https://github.com/philipperemy/keras-attention)

Keras注意力层实现，支持Luong和Bahdanau两种经典注意力机制评分方式。

- **Stars:** ⭐️ 2.8k
- **Tags:** `attention-mechanism` `keras` `deep-learning`
- **最后活动时间:** 2026-03-12
...
- **Stars:** ⭐️ 2.6k
- **Tags:** `survival-analysis` `statistics` `python`
- **最后活动时间:** 2026-03-07
...
将LLM无缝集成为Python函数的轻量级框架，支持Pydantic类型注解，让AI调用像普通函数一样简单。
...
专为波斯语设计的多功能AI开发库，支持图像描述、OCR和语音识别等多种任务。为开发者提供便捷的API以构建波斯语AI应用。

- **Stars:** ⭐️ 1.0k
- **Tags:** `persian-nlp` `persian-ocr` `persian-speech-recognition` `ai-library`
- **最后活动时间:** 2026-03-09
...
韩语自然语言处理Python库，提供分词、词性标注、词语提取等功能。
...
Go语言AI/LLM应用开发框架，支持构建包含嵌入、向量索引和流水线的智能应用。

- **Stars:** ⭐️ 834
- **Tags:** `Go` `LLM Framework` `Vector`
- **最后活动时间:** 2026-03-15

### [human-learn](https://github.com/koaning/human-learn)

基于scikit-learn的机器学习工具库，提供直观的模型构建和基准测试功能。

- **Stars:** ⭐️ 833
- **Tags:** `machine-learning` `scikit-learn` `benchmark` `python`
- **最后活动时间:** 2026-03-09
...
### [TavilyProxyManager](https://github.com/xuncv/TavilyProxyManager)

一个透明的 Tavily API 反向代理，将多个 API Key 额度汇聚在单一 Master Key 下管理。提供内置 Web UI 用于轻松管理 Key、用量监控及请求日志。

- **Stars:** ⭐️ 512
- **Tags:** `proxy` `tavily` `api-management` `ai-tools`
- **最后活动时间:** 2026-03-12
