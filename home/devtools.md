...
使用 ChatGPT 自动生成 Git 提交信息的开发工具，帮助开发者快速编写规范的 commit message。

- **Stars:** ⭐️ 1.6k
- **Tags:** `chatgpt` `git` `commit` `automation` `developer-tools`
- **最后活动时间:** 2024-07-15
...
GPT代码生成示例集合，展示大语言模型在编程任务中的应用。

- **Stars:** ⭐️ 1.9k
- **Tags:** `gpt` `codex` `coding` `prompt-engineering`
- **最后活动时间:** 2025-12-11
...
AI驱动的代码迁移工具，轻松将代码库从一种框架或语言迁移到另一种。

- **Stars:** ⭐️ 7.0k
- **Tags:** `code-migration` `gpt` `codebase` `framework`
- **最后活动时间:** 2024-09-17
...
OpenCV 的 Node.js 绑定库，让开发者能够在 Node.js 环境中使用 OpenCV 的计算机视觉功能。

- **Stars:** ⭐️ 4.4k
- **Tags:** `opencv` `nodejs` `computer-vision` `bindings`
- **最后活动时间:** 2024-07-09
...
Spotify开源的Python可视化库，让数据科学家轻松创建美观的图表。

- **Stars:** ⭐️ 3.6k
- **Tags:** `visualization` `bokeh` `python` `data-science` `plotting`
- **最后活动时间:** 2024-10-16
...
Tesseract OCR的.NET封装库，为.NET开发者提供便捷的OCR文字识别API接口。

- **Stars:** ⭐️ 2.5k
- **Tags:** `ocr` `dotnet` `tesseract` `wrapper`
- **最后活动时间:** 2025-04-29
...
Burpsuite验证码识别插件，支持关键词识别和免费OCR库，用于安全测试中的验证码自动识别。

- **Stars:** ⭐️ 1.9k
- **Tags:** `ocr` `captcha` `burpsuite` `security` `automation`
- **最后活动时间:** 2025-08-26
...
R语言数据科学核心工具集，提供数据清洗、可视化和分析的统一工作流。

- **Stars:** ⭐️ 1.8k
- **Tags:** `r` `data-science` `tidyverse` `data-analysis`
- **最后活动时间:** 2025-06-18
...
敏捷数据准备框架，支持Pandas、Dask、Spark等后端，简化数据清洗与转换流程。

- **Stars:** ⭐️ 1.5k
- **Tags:** `data-cleaning` `data-preparation` `pandas` `dask` `pyspark` `etl`
- **最后活动时间:** 2024-12-02
...
R语言数据清洗工具包，提供简洁的数据处理、表格化和脏数据修复功能。

- **Stars:** ⭐️ 1.4k
- **Tags:** `data-cleaning` `r` `data-analysis` `tidyverse`
- **最后活动时间:** 2024-12-23
...
PyTorch的JAX风格可组合函数变换库，支持自动向量化和高阶梯度计算。

- **Stars:** ⭐️ 1.4k
- **Tags:** `pytorch` `jax` `autodiff` `functional-programming`
- **最后活动时间:** 2025-08-21
...
快速可微分的模型预测控制求解器，适用于PyTorch中的控制与优化任务。

- **Stars:** ⭐️ 1.0k
- **Tags:** `pytorch` `model-predictive-control` `optimization`
- **最后活动时间:** 2024-08-27
...
基于Minecraft的样本高效强化学习竞赛平台，提供Python开发包。

- **Stars:** ⭐️ 930
- **Tags:** `reinforcement-learning` `minecraft` `environment` `competition`
- **最后活动时间:** 2025-01-22
...
dbt扩展工具，支持在dbt流程中运行Python代码，实现异常检测和机器学习模型构建。

- **Stars:** ⭐️ 857
- **Tags:** `dbt` `machine-learning` `python` `data-pipeline`
- **最后活动时间:** 2024-04-05
...
快速可微分的二次规划求解器，专为PyTorch深度学习优化设计。

- **Stars:** ⭐️ 785
- **Tags:** `pytorch` `optimization` `quadratic-programming` `deep-learning`
- **最后活动时间:** 2024-09-03
...
### [php-nlp-tools](https://github.com/angeloskath/php-nlp-tools)

PHP自然语言处理工具库，提供分词、分类、情感分析等功能。

- **Stars:** ⭐️ 764
- **Tags:** `nlp` `php` `text-processing`
- **最后活动时间:** 2024-07-22
...
开源Python库，专为机器学习应用提供时序数据预处理和特征工程功能。

- **Stars:** ⭐️ 708
- **Tags:** `time-series` `feature-engineering` `python` `preprocessing`
- **最后活动时间:** 2025-10-29
...
### [Multi-Human-Parsing](https://github.com/ZhaoJ9014/Multi-Human-Parsing)

多人人体解析官方仓库，提供人体分割、实例分割和场景理解能力。

- **Stars:** ⭐️ 686
- **Tags:** `human-parsing` `instance-segmentation` `computer-vision` `detection`
- **最后活动时间:** 2025-03-20

### [ssm](https://github.com/lindermanlab/ssm)

状态空间模型的贝叶斯学习与推断库，支持时间序列建模和预测。

- **Stars:** ⭐️ 683
- **Tags:** `bayesian` `state-space-models` `time-series` `inference`
- **最后活动时间:** 2025-05-09
...
R语言超内存数据并行处理框架，支持磁盘存储的大规模数据操作。

- **Stars:** ⭐️ 597
- **Tags:** `big-data` `r` `data-manipulation` `parallel-computing`
- **最后活动时间:** 2024-09-10
