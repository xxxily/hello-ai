...
### [openai-realtime-solar-system](https://github.com/openai/openai-realtime-solar-system)

演示如何使用 OpenAI Realtime API 通过工具调用导航 3D 场景的示例项目。

- **Stars:** ⭐️ 504
- **Tags:** `openai` `realtime-api` `3d` `demo`
- **最后活动时间:** 2026-03-04
