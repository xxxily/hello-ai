...
### [next-ai-starter](https://github.com/kleneway/next-ai-starter)

专为AI编码工具优化的全栈启动模板，集成现代开发工具链，帮助开发者快速构建AI应用。

- **Stars:** ⭐️ 511
- **Tags:** `ai-tools` `nextjs` `starter-kit` `boilerplate`
- **最后活动时间:** 2025-10-15
...
使用JSX语法设计LLM提示词的创新框架，让提示词工程像React组件一样结构化和可复用。

- **Stars:** ⭐️ 2.8k
- **Tags:** `prompt-engineering` `jsx` `llm` `typescript`
- **最后活动时间:** 2025-10-15
