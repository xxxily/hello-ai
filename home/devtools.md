...
探索并改进用于代码生成的掩码扩散模型，提升代码生成的理解与效果。

- **Stars:** ⭐️ 804
- **Tags:** `code-generation` `diffusion-models` `llm` `machine-learning`
- **最后活动时间:** 2025-07-09
...
用于交互式主题模型可视化的Python库，帮助理解和解释LDA等主题模型的结果。

- **Stars:** ⭐️ 1.8k
- **Tags:** `nlp` `topic-modeling` `visualization` `lda`
- **最后活动时间:** 2025-12-04
...
面向数组处理的研究型编程语言，属于Haskell/ML家族，支持可微编程。
...
Ruby语言Tesseract OCR封装库，提供简洁的API进行光学字符识别。

- **Stars:** ⭐️ 879
- **Tags:** `ruby` `tesseract` `ocr` `library`
- **最后活动时间:** 2025-04-30
...
高效的国际化地址解析和规范化Python库，基于libpostal实现。

- **Stars:** ⭐️ 869
- **Tags:** `nlp` `address-parser` `python`
- **最后活动时间:** 2025-11-01
...
NumPy的C#/F#绑定库，为.NET平台提供科学计算和机器学习的基础数值计算能力。

- **Stars:** ⭐️ 751
- **Tags:** `numpy` `csharp` `fsharp` `scientific-computing` `machine-learning`
- **最后活动时间:** 2025-10-24
...
NVIDIA开源的单头文件C++库，简化CUDA运行时编译(NVRTC)，方便AI开发者动态编译GPU内核。

- **Stars:** ⭐️ 569
- **Tags:** `cuda` `jit-compilation` `nvrtc` `gpu-computing`
- **最后活动时间:** 2025-09-15
...
### [claude2api](https://github.com/yushangxiao/claude2api)

将Claude网页服务转换为API服务的工具，支持识图、文件上传和思考输出等功能。

- **Stars:** ⭐️ 561
- **Tags:** `claude` `api` `proxy` `llm`
- **最后活动时间:** 2025-07-01
