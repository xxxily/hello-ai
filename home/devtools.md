...
可视化AI/LLM工作流代码库的工具，帮助开发者理解和分析AI系统架构。

- **Stars:** ⭐️ 642
- **Tags:** `llm` `visualization` `system-design` `ai-workflow`
- **最后活动时间:** 2026-02-11
...
### [Clavix](https://github.com/bobvibes/Clavix)

将模糊想法转化为生产级提示词的工具，能够分析需求差距并生成产品需求文档。通过 CLEAR 框架大幅增强 AI 编码工作流。

- **Stars:** ⭐️ 671
- **Tags:** `prompt-engineering` `ai-coding` `prd` `workflow`
- **最后活动时间:** 2026-02-18
...
Node.js的自然语言处理通用库，支持分词、词干提取、分类等多种NLP功能。非常适合在JavaScript环境中快速集成基础的自然语言处理能力。

- **Stars:** ⭐️ 10.9k
- **Tags:** `nlp` `natural-language-processing` `nodejs`
- **最后活动时间:** 2026-02-22
...
Ollama官方JavaScript SDK，用于在Node.js和浏览器中轻松调用本地大语言模型API，支持流式响应和模型管理。

- **Stars:** ⭐️ 4.3k
- **Tags:** `ollama` `javascript` `llm` `sdk`
- **最后活动时间:** 2026-02-18
...
OpenClaw 任务控制仪表板，用于监控和管理 AI 智能体任务执行状态。
...
为scikit-learn管道提供实用嵌入工具的Python库，简化机器学习工作流中的特征提取与向量化处理。

- **Stars:** ⭐️ 525
- **Tags:** `embeddings` `scikit-learn` `machine-learning` `feature-extraction`
- **最后活动时间:** 2026-02-12
