...
### [scrape-it-now](https://github.com/clemlesne/scrape-it-now)

专为AI设计的网页爬虫工具，支持并行处理并输出高质量Markdown内容，适合用于AI训练数据采集。

- **Stars:** ⭐️ 540
- **Tags:** `ai` `scraper` `cli` `markdown`
- **最后活动时间:** 2025-11-03
...
### [GraphRAG](https://github.com/JayLZhou/GraphRAG)

深入研究GraphRAG技术的项目，探索知识图谱与检索增强生成的结合应用。

- **Stars:** ⭐️ 1.5k
- **Tags:** `graphrag` `knowledge-graph` `rag` `llm`
- **最后活动时间:** 2025-07-01
