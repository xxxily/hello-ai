...
### [the_well](https://github.com/PolymathicAI/the_well)
...
DeepMind开源的数学问答数据集生成工具，可生成约学校难度级别的数学问题与答案对，适用于训练和评估AI模型的数学推理能力。

- **Stars:** ⭐️ 1.9k
- **Tags:** `dataset` `mathematics` `machine-learning` `deepmind`
- **最后活动时间:** 2024-12-23
...
用于恶意软件检测研究的基准数据集，为机器学习安全研究提供标准化评估资源。

- **Stars:** ⭐️ 1.1k
- **Tags:** `malware-detection` `security` `machine-learning` `benchmark` `dataset`
- **最后活动时间:** 2024-11-22
...
一个大型、精心策划的基准测试数据集仓库，用于评估监督机器学习算法的性能。提供标准化数据集便于模型对比和实验。

- **Stars:** ⭐️ 857
- **Tags:** `machine-learning` `benchmark-datasets` `supervised-learning` `evaluation`
- **最后活动时间:** 2025-02-25
...
包含70万条中文对联的数据集，适用于NLP模型训练、文本生成和传统文化AI应用开发。

- **Stars:** ⭐️ 745
- **Tags:** `dataset` `nlp` `chinese` `couplet` `text-generation`
- **最后活动时间:** 2025-02-05
...
指代表达数据集API，提供视觉-语言任务中指代表达理解的数据集访问接口。

- **Stars:** ⭐️ 562
- **Tags:** `referring-expression` `computer-vision` `vision-language` `dataset-api`
- **最后活动时间:** 2024-08-27
...
Google推出的协作式大语言模型基准测试套件，用于测量和推断语言模型的能力边界。包含200+任务，是评估LLM能力的重要工具。

- **Stars:** ⭐️ 3.2k
- **Tags:** `llm-benchmark` `language-models` `evaluation`
- **最后活动时间:** 2024-07-19
...
Numenta异常检测基准测试套件，用于评估和比较异常检测算法的性能。包含真实世界数据集和标准化评估指标。

- **Stars:** ⭐️ 2.1k
- **Tags:** `anomaly-detection` `benchmark` `time-series`
- **最后活动时间:** 2024-12-03
...
大规模强化学习基准测试环境，为机器人学习和AI智能体研究提供标准化评估框架。

- **Stars:** ⭐️ 1.7k
- **Tags:** `reinforcement-learning` `benchmark` `robotics` `machine-learning` `evaluation`
- **最后活动时间:** 2025-01-25
...
实用型大语言模型基准测试，基于真实问题场景评估LLM的实际解决问题能力。

- **Stars:** ⭐️ 1.0k
- **Tags:** `llm-benchmark` `evaluation` `applied-ai`
- **最后活动时间:** 2025-04-27
...
深度伪造检测的综合基准测试平台，提供标准化的评估框架和多种检测算法对比。

- **Stars:** ⭐️ 1.0k
- **Tags:** `deepfake-detection` `benchmark` `computer-vision` `forensics`
- **最后活动时间:** 2025-08-20

### [arena-hard-auto](https://github.com/lmarena/arena-hard-auto)

自动化大语言模型基准测试工具，用于评估和对比LLM性能表现。

- **Stars:** ⭐️ 1.0k
- **Tags:** `llm-benchmark` `evaluation` `automated-testing`
- **最后活动时间:** 2025-06-21
...
模型量化基准测试平台，用于评估和对比不同模型量化方法的性能与精度。

- **Stars:** ⭐️ 862
- **Tags:** `quantization` `model-compression` `benchmark` `optimization`
- **最后活动时间:** 2025-04-20
...
基于中国高考题目的LLM评估框架，用于全面测试大语言模型的知识理解和推理能力。

- **Stars:** ⭐️ 734
- **Tags:** `llm-evaluation` `benchmark` `chinese-nlp` `gaokao`
- **最后活动时间:** 2025-01-07
...
### [benchmark](https://github.com/getomni-ai/benchmark)

OCR光学字符识别模型基准测试工具，用于评估不同OCR引擎的性能表现。

- **Stars:** ⭐️ 627
- **Tags:** `ocr` `benchmark` `computer-vision` `text-recognition`
- **最后活动时间:** 2025-10-21
...
计算分割任务表面距离性能指标的库，适用于医学图像分析评估。

- **Stars:** ⭐️ 595
- **Tags:** `segmentation-metrics` `evaluation` `medical-imaging` `surface-distance`
- **最后活动时间:** 2025-02-19
...
一个轻量级适配器，将Segment Anything Model适配到医学影像分割任务中，发表于医学影像分析期刊MedIA。

- **Stars:** ⭐️ 1.3k
- **Tags:** `medical-imaging` `segment-anything` `adapter` `deep-learning`
- **最后活动时间:** 2025-09-08
...
Google Research鲁棒损失函数的PyTorch移植版本，用于提升模型训练的稳定性。

- **Stars:** ⭐️ 698
- **Tags:** `pytorch` `loss-function` `deep-learning`
- **最后活动时间:** 2025-09-04
...
通过平均多个微调模型的权重来提升准确率，无需增加推理时间的模型优化技术。

- **Stars:** ⭐️ 511
- **Tags:** `model-merging` `fine-tuning` `optimization`
- **最后活动时间:** 2024-07-15
