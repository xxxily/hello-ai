...
《自动驾驶中的SLAM技术》配套开源代码，理论与实践结合。

- **Stars:** ⭐️ 2.5k
- **Tags:** `slam` `autonomous-driving` `robotics` `tutorial`
- **最后活动时间:** 2025-11-13
...
Gemini CLI 使用技巧与最佳实践合集，帮助开发者更高效地使用 Google Gemini AI 命令行工具。

- **Stars:** ⭐️ 2.3k
- **Tags:** `gemini` `gemini-api` `gemini-cli` `tips` `tutorial`
- **最后活动时间:** 2025-10-19
...
持续追踪arXiv上大语言模型与强化学习交叉研究的论文合集，欢迎提交PR推荐优质论文。

- **Stars:** ⭐️ 550
- **Tags:** `llm` `reinforcement-learning` `papers` `control`
- **最后活动时间:** 2025-11-17
